...
2금융권 예금은 무조건 위험한가? &nbsp; 무조건 위험하다고 볼 수는 없다. 다만 금융회사와 상품에 따라 안정성과 보호 여부가 다르다. 가입 전 예금자보호 대상인지 확인하고, 원금과 이자를 합쳐 금융회사별 보호 한도 안에서 관리하는 것이 좋다.`}).add({id:1,href:"/posts/high-oil-price-support-2026/",title:"2026년 고유가 피해지원금 총정리: 대상, 금액, 신...",description:"2026년 고유가 피해지원금의 의미, 지급 대상과 금액, 신청 기간, 온라인·오프라인 신청 방법, 사용기한과 사용처를 초보자도 이해하기 쉽게 정리했다.",content:`기름값이 오르면 주유비만 오르는 게 아니다. 물류비가 올라가고, 장바구니 물가도 영향을 받고, 출퇴근이나 생업에 차를 써야 하는 사람은 매달 고정비가 바로 늘어난다. 특히 소득이 빠르게 늘지 않는 상황에서 유가, 환율, 물가가 동시에 오르면 생활비 부담이 꽤 크게 느껴진다.
...
지금 같은 시장에서 초보자는 어떻게 투자해야 할까? &nbsp; 한 가지 테마에 몰아넣기보다 분산해서 접근하는 것이 좋다. AI 반도체, 전력 인프라, 우량 지수 ETF, 현금 비중을 나누고, 급등한 종목은 실적과 밸류에이션을 확인한 뒤 접근하는 편이 안전하다.`}).add({id:3,href:"/about/",title:"About Me",description:"Money is a great servant but a bad master.",content:`지금까지 나는 &lsquo;대출은 절대 받으면 안 되는 것&rsquo;, &lsquo;주식은 손실 위험이 크니 멀리해야 하는 것&rsquo;, &lsquo;본인이 관리만 잘한다면 연금은 불필요한 것&rsquo;이라 굳게 믿어왔다. 특히 인구 감소가 시작되면 주택 가격은 결국 무너질 것이라 확신했다.
...
money.devkuma.com &nbsp; 주제는 아주 노골적으로 &lsquo;돈&rsquo; 이다. 금융, 경제, 대출, 주식, 세금, 부동산 등 자본주의 시대를 살아가기 위해 필수적인 지식들을 하나하나 쌓아갈 예정이다. 늦은 만큼 더 치열하게 흡수하고 기록하며, 더 이상 무지가 부끄러움이 되지 않도록 나만의 경제 지도를 그려나가려 한다.`}).add({id:4,href:"/posts/bis-capital-ratio/",title:"BIS 비율이란? 은행 건전성을 보는 자본 적정성 지표...",description:"BIS 비율의 뜻과 계산 공식, 위험가중자산과 자기자본의 의미, 은행 건전성 평가에서 중요한 이유와 한계를 초보자도 이해하기 쉽게 정리했다.",content:`은행은 평소에는 안전해 보인다. 예금을 받고, 대출을 해주고, 이자를 받는 구조라 단순해 보이기도 한다. 하지만 은행의 자산 대부분은 대출과 투자자산이다. 경기 침체가 오거나 부동산 가격이 급락하거나 기업이 대출을 갚지 못하면 은행도 손실을 볼 수 있다.
...
BIS 비율이 낮아지면 은행은 무엇을 할까? &nbsp; 은행은 자기자본을 늘리거나 위험가중자산을 줄이는 방식으로 BIS 비율을 개선할 수 있다. 증자, 이익 유보, 후순위채 발행, 고위험 대출 축소, 자산 매각 등이 대표적인 방법이다.`}).add({id:5,href:"/posts/build-transfer-lease/",title:"BTL이란? Build Transfer Lease 민간...",description:"BTL의 뜻과 등장 배경, 사업 추진 절차, 정부와 민간사업자의 역할, 장점과 단점, BTO와의 차이를 초보자도 이해하기 쉽게 정리했다.",content:`학교, 병원, 군 시설, 문화시설 같은 공공시설은 필요하지만 한 번에 큰 돈이 들어간다. 정부나 지방자치단체 입장에서는 당장 지어야 할 시설은 많은데 예산은 한정되어 있다. 그렇다고 모든 사업을 뒤로 미루면 주민이 이용할 공공서비스가 부족해진다.
...
ETF를 고를 때 수익률이 가장 중요한가? &nbsp; 최근 수익률만 보는 것은 위험하다. ETF를 고를 때는 추종 지수, 구성 종목, 총보수, 순자산 규모, 거래량, 환헤지 여부를 함께 확인해야 한다. 수익률은 그 결과를 보여주는 지표일 뿐, 상품의 구조를 대신 설명해주지는 않는다.`}).add({id:7,href:"/posts/hbm-ai-semiconductor-memory/",title:"HBM이란? AI 반도체와 SK하이닉스 삼성전자 주가가...",description:"HBM이 무엇인지, AI 반도체에서 왜 중요한지, SK하이닉스와 삼성전자 주가가 HBM 기대감에 움직인 이유를 초보자도 이해하기 쉽게 정리했다.",content:`요즘 주식을 공부하다 보면 반도체, AI, 엔비디아, HBM이라는 단어가 계속 나온다. 처음에는 모두 따로 노는 말처럼 보이지만, 실제로는 하나의 흐름으로 연결되어 있다. AI 서비스를 돌리려면 고성능 반도체가 필요하고, 그 반도체가 제 성능을 내려면 데이터를 아주 빠르게 주고받는 메모리가 필요하다. 여기서 등장하는 핵심 부품이 HBM이다.
...
처음 사는 S&amp;P500 ETF는 몇 주부터 시작하면 좋을까? &nbsp; 처음이라면 1주로 충분하다. 중요한 것은 큰돈을 넣는 것이 아니라 매수, 체결, 평가손익, 분배금, 세금 안내를 직접 확인하는 경험이다. 1주를 사보고 상품 구조를 이해한 뒤에 적립식 투자 여부를 정해도 늦지 않다.`}).add({id:11,href:"/posts/sp500-vs-schd-which-to-buy/",title:"S&P500 vs SCHD, 뭐 사야 할까? 수익률부터...",description:"S&P500과 SCHD 중 무엇을 사야 할지 고민이라면 이 글 하나로 끝내자. 수익률, 배당, 투자 성향별 추천까지 초보자 기준으로 쉽게 정리했다.",content:`S&amp;P500 vs SCHD, 처음 투자 시작할 때 거의 무조건 마주치는 고민이다.
...
Q3. 둘 중 하나만 꼭 골라야 한다면? &nbsp; 초보자 기준에서는 S&amp;P500을 먼저 선택하는 게 더 합리적이다. 이후 상황에 따라 SCHD를 추가하면 된다.`}).add({id:12,href:"/posts/vix-index/",title:"VIX 지수란? 공포지수로 보는 주식시장 변동성과 투자...",description:"VIX 지수의 뜻과 계산 원리, S&P500과의 관계, 투자자가 활용하는 방법, VIX 선물과 ETF 투자 시 주의할 점을 쉽게 정리했다.",content:`주식시장이 크게 흔들릴 때 뉴스에서 자주 나오는 말이 있다. 바로 VIX 지수다. &ldquo;공포지수가 급등했다&rdquo;, &ldquo;VIX가 안정되면서 증시가 반등했다&rdquo; 같은 표현을 한 번쯤 봤을 것이다.
...
경기지역화폐 카드를 받기 전에도 충전할 수 있을까? &nbsp; 지역과 카드 상태에 따라 앱에서 충전 메뉴가 보일 수 있지만, 실제 결제는 카드 등록 이후 가능한 경우가 많다. 처음 신청했다면 카드를 수령한 뒤 앱에 등록하고 계좌 연결까지 마친 다음 충전하는 흐름으로 보는 것이 안전하다.`}).add({id:14,href:"/posts/how-to-study-economics/",title:"경제 공부하는 방법, 금융 문맹을 벗어나기 위한 현실적...",description:"경제 공부를 어디서부터 시작해야 할지 모르는 초보자를 위해 기본 용어, 경제 뉴스 읽기, 책 선택, 가계부와 소액 투자까지 현실적인 공부 방법을 정리했다.",content:`경제 공부를 해야겠다고 마음먹는 순간은 대개 불편함에서 온다. 월급은 들어오는데 돈이 어디로 나가는지 모르겠고, 금리가 오른다는데 내 대출이 왜 부담스러워지는지 모르겠고, 뉴스에서는 환율과 물가 이야기가 계속 나오는데 내 생활과 어떻게 연결되는지 감이 잡히지 않는다.
...
위기 때 주식은 모두 팔아야 할까? &nbsp; 모든 주식을 감정적으로 매도하는 것은 위험할 수 있다. 당장 쓸 돈으로 투자했다면 줄이는 것이 맞지만, 장기 자금이라면 비상금과 부채 상황을 먼저 확인한 뒤 분할 매수나 리밸런싱 기준에 따라 판단하는 것이 낫다.`}).add({id:17,href:"/posts/spillover-effect/",title:"경제용어: 스필오버 효과, 경제에서 좋은 영향과 나쁜 ...",description:"스필오버 효과의 뜻과 경제, 관광, 조직관리, 상권에서 나타나는 긍정적 영향과 부정적 영향을 초보자도 이해하기 쉽게 정리했다.",content:`경제 기사를 읽다 보면 &ldquo;스필오버 효과&quot;라는 표현이 종종 나온다. 영어로는 Spillover Effect라고 하고, 말 그대로 어떤 영향이 한곳에만 머무르지 않고 주변으로 흘러넘치는 현상을 뜻한다.
...
투자할 때도 스필오버 효과를 볼 수 있을까? &nbsp; 볼 수 있다. 특정 산업의 대규모 투자가 장비, 소재, 부품, 물류 기업으로 번질 수 있고, 한 나라의 금리 변화가 다른 나라 주식시장과 환율에 영향을 줄 수도 있다. 투자자는 직접 수혜주뿐 아니라 주변으로 번지는 영향을 함께 살펴볼 필요가 있다.`}).add({id:18,href:"/posts/financial-freedom-roadmap/",title:"경제적 자유, 누구나 이룰 수 있는 실천 로드맵",description:"경제적 자유를 막연한 꿈이 아니라 실천 가능한 목표로 만들기 위해 지출 관리, 비상금, 부채 정리, 투자, 부수입 로드맵을 정리했다.",content:`경제적 자유라는 말을 들으면 거창하게 느껴진다. 회사를 그만두고, 건물주가 되고, 배당금만으로 여행을 다니는 모습을 떠올리기 쉽다. 하지만 현실적인 경제적 자유는 그런 장면보다 훨씬 작고 구체적인 곳에서 시작된다.
...
경제적 자유를 위해 투자는 꼭 해야 할까? &nbsp; 장기적으로는 투자가 필요할 가능성이 크다. 저축만으로는 물가 상승과 노후 생활비를 감당하기 어려울 수 있기 때문이다. 다만 비상금과 고금리 부채 정리가 먼저이고, 투자는 이해할 수 있는 상품부터 천천히 시작하는 것이 좋다.`}).add({id:19,href:"/posts/fixed-variable-loan-interest/",title:"고정금리와 변동금리 차이 쉽게 정리: 대출받을 때 어떤...",description:"고정금리와 변동금리의 뜻, 대출금리 계산 구조, 시장금리 상승기와 하락기 선택 기준, 혼합금리까지 초보자도 이해하기 쉽게 정리했다.",content:`대출을 알아보다 보면 가장 헷갈리는 말 중 하나가 고정금리와 변동금리다. 은행 앱에서는 금리 숫자만 크게 보이지만, 실제로 중요한 것은 그 금리가 앞으로 계속 같은지, 일정 주기마다 바뀌는지다.
...
주식을 손해 보고 팔아도 증권거래세를 내야 할까? &nbsp; 내야 한다. 증권거래세는 이익이 아니라 매도 거래금액에 붙는 세금이다. 손실을 보고 팔아도 매도금액을 기준으로 세금이 계산되므로 잦은 매매를 할수록 거래비용이 누적될 수 있다.`}).add({id:22,href:"/posts/gross-domestic-product-gdp/",title:"국내총생산 GDP 뜻 쉽게 정리, 명목GDP와 실질GD...",description:"국내총생산 GDP의 뜻과 계산 개념, 명목GDP와 실질GDP의 차이, 1인당 GDP와 GNI까지 초보자도 이해하기 쉽게 정리했다.",content:`경제 뉴스를 보다 보면 GDP라는 단어가 정말 자주 나온다. &ldquo;한국 GDP 성장률&rdquo;, &ldquo;1인당 GDP&rdquo;, &ldquo;명목 GDP&rdquo;, &ldquo;실질 GDP&rdquo; 같은 표현이 계속 등장한다.
...
개인 투자자는 그레이 캐피털리즘을 왜 신경 써야 할까? &nbsp; 회색 지대 전략으로 이익을 내는 기업은 단기 실적이 좋아 보일 수 있다. 하지만 소비자 신뢰 하락, 규제 강화, 소송, 불매운동 같은 리스크가 생기면 기업가치가 흔들릴 수 있다. 투자자는 숫자만 보지 말고 그 숫자가 만들어지는 방식도 함께 봐야 한다.`}).add({id:25,href:"/posts/employment-income-tax-vs-global-income-tax/",title:"근로소득세와 종합소득세 차이, 직장인과 사업자는 세금 ...",description:"근로소득세와 종합소득세의 차이, 직장인 연말정산과 사업자 5월 신고, 부업 소득이 있는 직장인이 종합소득세를 신고해야 하는 경우를 쉽게 정리했다.",content:`나는 직장인이라 월급에서 근로소득세가 빠진다. 그런데 사업을 하는 친구는 매년 5월에 종합소득세를 신고한다고 했다. 둘 다 소득에 붙는 세금인 것 같은데, 왜 이름도 다르고 신고 방식도 다를까.
...
Q3. 이거 하나로 충분할까? &nbsp; 기초는 충분하다. 이후에는 뉴스나 투자 서적으로 확장하면 된다.`}).add({id:27,href:"/posts/financial-intelligence/",title:"금융 지능이란?",description:`금융 지능(Financial Intelligence) 은 쉽게 말해서 돈의 흐름을 이해하고, 합리적으로 돈을 관리하고, 장기적으로 자산을 늘릴 수 있는 능력을 의미한다.
...
금융 지식 감정 통제 실제 경험 결론적으로 금융 지능은 금융 지식, 합리적 판단 능력, 그리고 실제 재무 관리 경험이 결합된 개념이며, 개인의 경제적 안정과 자산 형성에 핵심적인 역할을 수행한다.`}).add({id:28,href:"/posts/base-rate-deposit-loan-interest/",title:"기준금리가 오르면 예금금리와 대출금리는 왜 같이 움직일까",description:"기준금리의 뜻과 예금금리, 대출금리의 차이, 기준금리 인상과 인하가 은행 예금과 대출 이자에 반영되는 과정을 초보자도 이해하기 쉽게 정리했다.",content:`뉴스에서 &ldquo;한국은행이 기준금리를 올렸다&quot;는 말을 들으면 바로 궁금해진다. 그러면 내 예금 이자도 오를까. 대출 이자는 언제부터 늘어날까. 은행 앱에서 보는 금리는 왜 뉴스에 나온 기준금리와 숫자가 다를까.
...
예금금리보다 대출금리가 더 높은 이유는 무엇일까? &nbsp; 은행은 예금으로 돈을 조달하고 대출로 돈을 운용한다. 대출금리에는 은행의 조달비용뿐 아니라 운영비, 신용위험, 가산금리 등이 반영된다. 그래서 일반적으로 대출금리는 예금금리보다 높게 형성된다.`}).add({id:29,href:"/posts/multi-homeowner-capital-gains-tax-surcharge/",title:"다주택자 양도소득세 중과 5월 10일부터 시행: 대상,...",description:"2026년 5월 10일부터 다시 적용될 다주택자 양도소득세 중과의 뜻, 대상, 세율, 장기보유특별공제 배제, 매도 전 체크할 내용을 쉽게 정리했다.",content:`집을 여러 채 갖고 있는 사람에게 가장 민감한 세금 중 하나가 양도소득세다. 집을 보유하는 동안에는 재산세나 종부세가 부담이고, 집을 팔 때는 양도소득세가 부담이 된다. 특히 다주택자가 조정대상지역 주택을 팔 때 적용되는 양도세 중과 는 세금 차이가 꽤 크게 벌어질 수 있다.
...
Q3. 복리 효과는 언제부터 크게 느껴지나? &nbsp; 기간이 길어질수록 차이가 커진다. 짧게 보면 거의 비슷하지만, 5년, 10년, 20년처럼 장기로 갈수록 복리의 장점이 확실해진다.`}).add({id:31,href:"/posts/loan-ltv-dti-dsr/",title:"대출 받을 때 알아야 하는 LTV, DTI, DSR",description:" ",content:`LTV, DTI, DSR은 금융기관이 주택담보대출 심사 시 차주(借主, 돈을 빌리는 사람)의 상환 능력과 담보 가치를 평가하기 위해 사용하는 대표적인 규제 지표이다. 즉, 은행이 &ldquo;이 사람이 얼마나 대출을 감당할 수 있는지&rdquo; 판단하는 핵심 지표라고 할 수 있다.
...
사람들이 자주 오해하는 점 &nbsp; LTV 70%면 무조건 70% 대출 가능 → DSR에서 막히면 불가능 소득 높으면 대출 무조건 많이 가능 → LTV 제한 있음 한 줄 정리 &nbsp; LTV = 집 기준 DTI = 주담대 중심 소득 기준 DSR = 전체 빚 기준 (현재 핵심)`}).add({id:32,href:"/posts/loan-repayment-methods/",title:"대출 상환 방법 쉽게 정리, 원리금 균등·원금 균등·만...",description:"대출 상환 방법은 매달 갚는 금액과 총이자 비용을 크게 바꾼다. 원리금 균등, 원금 균등, 만기 일시, 거치 후 상환의 차이를 쉽게 정리한다.",content:`대출을 받을 때 금리만 보는 경우가 많다. 물론 금리는 중요하다. 그런데 실제로 매달 내 통장에서 빠져나가는 돈은 &ldquo;상환 방법&quot;에 따라 크게 달라진다.
...
정기보험 보험 기간이 정해져 있는 보험이다. 대부분 해약해도 해약환급금이 없거나 매우 적은 소멸성 보험으로 보험료가 저렴하고 가입하기 쉽다는 특징이 있다. 양로보험 정기보험과 마찬가지로 보험기간이 정해져 있으며, 보험기간 중 사망하면 사망보험금을, 만기까지 생존해 있으면 만기보험금을 받을 수 있다. 사망보험금과 만기보험금이 동일한 금액으로 &lsquo;생사혼합형 보험&rsquo;이라고도 한다. 종신보험 피보험자가 사망할 때까지 보장이 지속되는 보험이다. 사망 시점에 사망보험금이 지급된다. 보험료는 정기보험에 비해 비싸고, 보험기간 중 중도해지 시 해약환급금이 지급된다. 보험료는 정기보험에 비해 비싸다.`}).add({id:35,href:"/posts/value-added-tax-basics/",title:"부가가치세란 어떤 세금일까, 부가세 별도와 계산 방법 ...",description:"부가가치세의 뜻과 부가세 별도 의미, 최종소비자와 사업자의 관계, 매출세액과 매입세액을 이용한 계산 방법과 신고 기간을 쉽게 정리했다.",content:`물건을 사거나 서비스를 이용할 때 &ldquo;부가세 포함&rdquo;, &ldquo;부가세 별도&quot;라는 말을 자주 듣는다. 특히 견적서를 받을 때 100만 원이라고 생각했는데 마지막에 부가세 10만 원이 붙어 110만 원이 되는 경우가 있다. 그냥 내라고 하니까 내기는 하지만, 이 돈이 정확히 어떤 세금인지 헷갈릴 수 있다.
...
양성화 가능하다고 하면 매수해도 될까? &nbsp; 양성화 가능하다는 말만으로 매수하면 위험하다. 관할 구청에서 해당 건축물이 실제로 양성화 대상인지, 어떤 비용과 절차가 필요한지 확인해야 한다. 가능성이 아니라 확인된 사실을 기준으로 판단해야 한다.`}).add({id:39,href:"/posts/samsung-securities-isa-event/",title:"삼성증권 중개형 ISA 개설 이벤트 혜택 정리: 신규·...",description:"삼성증권 중개형 ISA 이벤트의 기간, 신규 개설 혜택, 타사 ISA 이전 금액 2배 인정, 국내주식 첫 거래 혜택과 주의사항을 쉽게 정리했다.",content:`요즘 ISA 계좌 하나쯤은 다들 고민한다. 절세에 좋다는 건 알겠는데, 막상 만들려고 하면 증권사도 많고 이벤트도 자주 바뀌어서 언제 개설해야 할지 애매하다.
...
삼성증권 중개형 ISA 이벤트 확인 &nbsp; 삼성증권 중개형 ISA 이벤트 핵심 요약 &nbsp; 내용이 조금 많아서 핵심만 먼저 보면 이렇다.
...
신용대출을 빨리 갚으면 좋은가? &nbsp; 이자 부담을 줄일 수 있다는 점에서는 좋다. 다만 건별 신용대출은 상품에 따라 중도상환수수료가 있을 수 있으므로, 조기 상환 전에 수수료와 절감되는 이자를 함께 비교해야 한다.`}).add({id:43,href:"/posts/medical-expense-insurance-non-covered-items/",title:"실비보험 비급여 보장 총정리, 급여와 비급여 차이부터 ...",description:"실비보험에서 헷갈리는 급여와 비급여 차이, 비급여 보장 항목, 자기부담금, 도수치료·MRI·수액 청구 시 주의할 점을 누구나 이해하기 쉽게 정리하였다.",content:`병원비 영수증을 보면 급여, 비급여라는 단어가 나온다. 처음에는 그냥 병원에서 쓰는 어려운 말처럼 보이지만, 실비보험을 청구할 때는 이 두 단어를 반드시 알아야 한다. 내가 낸 병원비 중 어디까지 건강보험이 적용됐는지, 어디까지 실비보험으로 받을 수 있는지가 여기서 갈리기 때문이다.
...
비급여 진료를 받으면 어떤 서류를 챙겨야 할까? &nbsp; 기본적으로 진료비 영수증과 진료비 세부내역서를 챙기는 것이 좋다. 항목에 따라 처방전, 진단서, 의사 소견서, 통원확인서가 추가로 필요할 수 있으므로 보험사 앱의 청구 안내를 함께 확인해야 한다.`}).add({id:44,href:"/posts/medical-expense-insurance-claim-documents/",title:"실비보험 청구서류 정리, 통원·입원·약제비 청구 방법까...",description:"실비보험의 뜻과 통원·입원·약제비 청구서류, 진료비 영수증과 세부내역서 차이, 청구기간과 실손24 활용법을 누구나 이해하기 쉽게 정리하였다.",content:`살면서 아프지 않은 사람은 거의 없다. 가벼운 감기처럼 병원비가 몇천 원으로 끝날 때도 있지만, 검사나 치료가 이어지면 갑자기 몇십만 원이 나가기도 한다. 여유 자금이 있으면 버틸 수 있지만, 예상하지 못한 병원비는 누구에게나 부담이 된다.
...
주가가 떨어지면 무조건 버텨야 할까? &nbsp; 무조건 버티는 것은 장기투자가 아니다. 회사의 실적과 경쟁력이 유지되는데 시장 전체 하락으로 빠진 것인지, 기업 자체의 문제가 생긴 것인지 확인해야 한다. 처음 매수한 이유가 깨졌다면 매도도 검토해야 한다.`}).add({id:47,href:"/posts/pension-savings-irp-tax-credit/",title:"연금저축·IRP 세액공제 총정리: 한도, 환급액, IS...",description:"연금저축과 IRP 세액공제 한도, 소득별 공제율, 최대 환급액, ISA 만기자금 전환까지 연말정산 전에 알아둘 내용을 초보자 눈높이로 정리했다.",content:`연말정산을 할 때마다 &ldquo;이번에는 돌려받을까, 더 낼까&rdquo; 하는 생각이 먼저 든다. 연말정산은 1년 동안 미리 낸 세금과 실제로 부담해야 할 세금을 다시 맞추는 과정이다. 미리 낸 세금이 많으면 환급을 받고, 적게 냈으면 추가로 납부한다.
...
미국 직원은 팁을 못 받으면 최저임금도 못 받는 걸까? &nbsp; 연방 기준으로는 팁과 현금 임금을 합친 금액이 최저임금에 미치지 못하면 고용주가 차액을 보전해야 한다. 다만 실제 현장에서는 팁이 직원 소득에서 큰 비중을 차지하고, 주마다 임금 기준도 다르기 때문에 팁이 생계와 깊게 연결되어 있다.`}).add({id:49,href:"/posts/withholding-tax-system/",title:"원천징수 제도 뜻 쉽게 정리, 세전·세후 월급 차이까지...",description:"원천징수 제도의 뜻과 원천징수의무자, 세전·세후 월급 차이, 근로소득세가 미리 빠지는 이유, 연말정산과의 관계를 누구나 이해하기 쉽게 정리하였다.",content:`월급을 받으면 세전, 세후라는 말을 자주 듣는다. 연봉 계약서에는 분명 5,000만 원이라고 적혀 있는데, 실제 통장에 들어오는 돈을 계산해보면 생각보다 적다. 대략 &ldquo;세금 떼고 들어오는 돈이구나&rdquo; 정도는 알지만, 정확히 무엇이 빠지는지는 헷갈린다.
...
원천징수하면 세금 신고를 안 해도 될까? &nbsp; 직장인은 보통 회사의 연말정산으로 대부분 정리되지만, 다른 소득이 있거나 프리랜서·사업소득이 있는 경우 종합소득세 신고가 필요할 수 있다. 원천징수는 최종 확정이 아니라 미리 낸 세금인 경우가 많다.`}).add({id:50,href:"/posts/bank-vs-savings-bank/",title:"은행과 저축은행의 차이",description:`은행은 제1금융권이라고 하고, 이를 제외한 대부분의 금융기관을 제2금융권이라고 한다.
...
아무나 전입세대확인서를 발급받을 수 있을까? &nbsp; 아니다. 개인정보가 포함된 서류라서 소유자, 임차인, 매매계약자, 임대차계약자, 금융기관 등 법령상 신청 자격이 있는 사람이나 기관이 신청할 수 있다. 신청 유형에 따라 계약서, 위임장, 신분증 같은 서류가 필요할 수 있다.`}).add({id:55,href:"/posts/stock-pdr/",title:"주식 PDR 뜻과 유래, 주가꿈비율을 쉽게 이해하는 방법",description:"주식 PDR의 뜻과 유래, PER·PBR로 설명하기 어려운 성장주를 볼 때 왜 등장했는지, 투자자가 PDR을 해석할 때 주의할 점을 쉽게 정리했다.",content:`주식 공부를 하다 보면 낯선 용어 때문에 막막할 때가 많다. PER, PBR, ROE도 겨우 익숙해졌는데 어느 순간 뉴스나 리포트에서 PDR이라는 말이 나온다.
처음 보면 &ldquo;또 새로운 공식이 생긴 건가?&rdquo;, &ldquo;이걸 모르면 성장주 투자를 못 하는 건가?&rdquo; 하는 생각이 들 수 있다. 나도 처음 투자 공부를 할 때 이런 용어를 보면 그냥 넘기기 일쑤였다. 그런데 나중에 보니 이런 개념 하나가 시장 분위기를 이해하는 데 꽤 도움이 됐다.
특히 &ldquo;왜 이 기업은 이익이 적은데도 주가가 이렇게 비쌀까?&rdquo;, &ldquo;PER로 보면 말이 안 되는데 투자자들은 왜 계속 사는 걸까?&rdquo; 같은 궁금증이 생길 때 PDR이라는 말이 등장한다.
다만 먼저 짚고 넘어갈 부분이 있다. 해외 금융 용어에서 PDR은 Price-Dividend Ratio, 즉 주가배당비율을 뜻하는 경우도 있다. 하지만 국내 주식 뉴스와 증권가에서 성장주를 설명할 때 말하는 PDR은 보통 Price to Dream Ratio, 우리말로 주가꿈비율을 뜻한다. 이 글에서는 국내 주식 투자자들이 자주 접하는 주가꿈비율 PDR을 중심으로 정리했다.
주식 PDR 뜻부터 쉽게 이해하기 &nbsp; PDR은 Price to Dream Ratio의 약자다. 직역하면 &ldquo;꿈 대비 주가 비율&quot;이고, 국내에서는 주로 주가꿈비율이라고 부른다.
말이 조금 낯설지만 의미는 단순하다. 기업의 현재 실적만으로는 설명하기 어려운 높은 주가를, 미래 성장 가능성이나 시장의 기대감으로 해석하려는 개념이다.
전통적인 주식 분석에서는 PER이나 PBR을 많이 쓴다. PER은 기업이 벌어들이는 이익 대비 주가가 얼마나 비싼지를 보고, PBR은 기업의 순자산 대비 주가가 얼마나 비싼지를 본다.
그런데 성장주 중에는 아직 이익이 크지 않거나 적자인데도 주가가 높게 형성되는 기업이 있다. 전기차, 2차전지, 바이오, 인공지능, 플랫폼 기업처럼 미래 시장을 크게 바꿀 수 있다고 기대받는 기업들이 대표적이다.
이런 기업은 PER로 보면 너무 비싸 보이거나 아예 계산이 어려울 수 있다. 이익이 적거나 적자이면 PER이 매우 높게 나오거나 의미가 없어지기 때문이다. 그래서 &ldquo;현재 이익이 아니라 미래의 꿈을 보고 가격이 붙었다&quot;는 표현으로 PDR이 쓰이기 시작했다.
구분 의미 PDR Price to Dream Ratio 한국어 표현 주가꿈비율 핵심 의미 미래 성장 기대 대비 현재 주가 수준 주로 쓰이는 대상 성장주, 테마주, 혁신 산업 기업 주의점 공식 회계 지표처럼 정교하게 확정된 지표는 아님 한 줄로 정리하면 PDR은 기업이 지금 벌어들이는 돈보다 앞으로 만들어낼 가능성에 시장이 얼마를 지불하고 있는지 보는 개념이다.
PDR은 왜 등장했을까 &nbsp; PDR이 주목받은 배경에는 코로나19 이후 성장주 급등장이 있다. 2020년 이후 전 세계적으로 금리가 낮아지고 유동성이 풍부해지면서 투자자들은 현재 실적보다 미래 성장성을 더 크게 보기 시작했다.
당시 전기차, 2차전지, 바이오, 인터넷, 게임, 플랫폼 같은 산업의 주가가 크게 올랐다. 문제는 기존 밸류에이션 지표로는 이 주가를 설명하기 어려웠다는 점이다.
예를 들어 어떤 기업이 아직 순이익을 거의 내지 못한다고 해보자. PER로 보면 이 기업은 너무 비싸거나 분석이 불가능하다. 하지만 투자자들은 그 기업이 미래에 거대한 시장을 장악할 수 있다고 믿고 주식을 산다. 이때 주가에는 현재 이익이 아니라 미래 시장에 대한 기대가 반영된다.
한국투자증권이 2020년에 주가꿈비율이라는 개념을 제시하며 PDR이 더 널리 알려졌다. 기존의 PER, PBR만으로는 성장 기업의 주가를 설명하기 어렵다는 문제의식에서 나온 것이다.
쉽게 말하면 PDR은 이런 질문에서 출발한다.
질문 PDR 관점 지금 돈을 많이 벌고 있나? 반드시 그렇지는 않다 그런데 왜 시가총액이 큰가? 미래 시장을 선점할 기대가 크기 때문이다 기존 지표로 설명 가능한가? PER, PBR만으로는 부족할 수 있다 무엇을 봐야 하나? 미래 시장 규모와 점유율 가능성 PDR은 기업의 &ldquo;꿈&quot;이라는 다소 추상적인 단어를 쓰지만, 실제로는 미래 시장 규모와 기업의 시장점유율 가능성을 생각해보자는 취지에 가깝다.
PDR은 어떻게 계산할까 &nbsp; PDR은 PER처럼 모든 증권 앱에서 표준으로 제공되는 지표는 아니다. 또 회계 기준으로 딱 떨어지는 공식 지표도 아니다. 그래서 일반 투자자가 정밀하게 계산하기는 쉽지 않다.
다만 개념적으로는 다음과 같이 이해할 수 있다.
PDR = 기업가치 / 꿈의 가치여기서 기업가치는 보통 시가총액을 뜻한다. 꿈의 가치는 기업이 앞으로 진출할 수 있는 전체 시장 규모와 그 기업이 차지할 수 있는 시장점유율을 바탕으로 추정한다.
조금 더 풀어 쓰면 이런 구조다.
PDR = 시가총액 / (전체 시장 규모 x 예상 시장점유율)예를 들어 어떤 기업의 시가총액이 10조 원이라고 하자. 이 기업이 노리는 미래 시장 규모가 100조 원이고, 장기적으로 10% 점유율을 차지할 수 있다고 본다면 이 기업의 꿈의 가치는 10조 원으로 볼 수 있다. 이 경우 PDR은 1이 된다.
물론 현실은 훨씬 복잡하다. 미래 시장 규모는 예측이 어렵고, 시장점유율도 경쟁 상황에 따라 크게 달라진다. 그래서 PDR은 숫자 자체보다 &ldquo;시장이 이 기업에 어떤 미래를 기대하고 있는가&quot;를 역산해보는 데 의미가 있다.
항목 설명 시가총액 시장이 현재 평가하는 기업 전체 가격 전체 시장 규모 기업이 진출할 수 있는 미래 산업의 크기 예상 시장점유율 그 기업이 장기적으로 차지할 수 있다고 보는 비중 PDR 해석 현재 주가가 미래 기대를 얼마나 반영했는지 확인 PDR이 낮다고 무조건 싸다는 뜻도 아니고, 높다고 무조건 비싸다는 뜻도 아니다. 중요한 것은 그 기업의 꿈이 현실이 될 가능성이다.
PER, PBR, PDR 차이 &nbsp; PDR을 이해하려면 PER, PBR과 비교하는 것이 가장 쉽다.
PER은 이익을 기준으로 한다. 기업이 1년에 벌어들이는 순이익 대비 주가가 몇 배인지 보는 지표다. 안정적으로 돈을 버는 기업을 평가할 때 많이 쓴다.
PBR은 자산을 기준으로 한다. 기업이 가진 순자산 대비 주가가 몇 배인지 보는 지표다. 은행, 보험, 제조업처럼 자산 규모가 중요한 업종에서 자주 활용된다.
PDR은 미래 기대를 기준으로 한다. 지금 이익이나 자산보다 앞으로 만들 수 있는 시장, 기술, 플랫폼, 네트워크 효과에 초점을 둔다.
구분 기준 주로 보는 기업 장점 한계 PER 순이익 이익이 안정적인 기업 계산이 쉽고 비교가 편함 적자 기업에는 적용이 어려움 PBR 순자산 금융, 제조, 자산주 장부가치와 비교 가능 무형자산·성장성 반영이 약함 PDR 미래 성장 기대 성장주, 혁신 기업 미래 시장 가능성을 볼 수 있음 추정이 많고 주관적임 예를 들어 전통 제조업 기업은 PER과 PBR이 더 유용할 수 있다. 이미 벌고 있는 돈과 보유 자산이 중요하기 때문이다.
반면 아직 이익은 작지만 미래 시장을 크게 바꿀 수 있는 기업은 PER이나 PBR만으로 평가하기 어렵다. 이때 PDR 관점이 보조적으로 쓰일 수 있다.
PDR을 투자에 활용하는 방법 &nbsp; PDR은 숫자를 외우는 지표라기보다 질문을 던지는 도구에 가깝다. 특히 성장주를 볼 때 다음 질문을 해보면 도움이 된다.
첫째, 이 기업이 말하는 미래 시장이 실제로 커질 수 있는가. 시장 규모가 작거나 성장성이 낮다면 아무리 멋진 스토리도 주가를 오래 지탱하기 어렵다.
둘째, 이 기업이 그 시장에서 의미 있는 점유율을 가져갈 수 있는가. 미래 산업이 커지는 것과 특정 기업이 돈을 버는 것은 다른 문제다. 전기차 시장이 커진다고 해서 모든 전기차 기업이 성공하는 것은 아니다.
셋째, 현재 시가총액이 이미 너무 많은 기대를 반영한 것은 아닌가. 좋은 기업이라도 가격이 너무 비싸면 투자 수익률은 낮아질 수 있다.
넷째, 꿈이 실적으로 바뀌고 있는지 확인해야 한다. 매출 증가, 영업이익 개선, 고객 수 증가, 기술 상용화, 수주 잔고 같은 현실 지표가 따라와야 한다.
확인할 질문 봐야 할 내용 시장은 커지는가? 전체 산업 성장률, 규제, 수요 변화 기업은 이길 수 있는가? 기술력, 브랜드, 자본력, 진입장벽 가격은 합리적인가? 시가총액, 경쟁사 비교, 기대 반영 수준 꿈이 실적으로 바뀌는가? 매출, 이익률, 수주, 이용자 수 개인적으로는 PDR을 볼 때 &ldquo;이 회사가 정말 대단한가?&ldquo;보다 &ldquo;현재 주가가 이미 얼마나 큰 성공을 전제로 하고 있는가?&ldquo;를 먼저 생각하는 편이 낫다고 본다. 성장주는 꿈이 크기 때문에 주가가 빠르게 오르지만, 그 꿈이 조금만 흔들려도 하락 폭이 커질 수 있기 때문이다.
PDR 사용할 때 주의할 점 &nbsp; PDR은 흥미로운 개념이지만 조심해서 써야 한다. 가장 큰 이유는 &ldquo;꿈&quot;이라는 말 자체가 주관적이기 때문이다.
미래 시장 규모는 예측일 뿐이다. 산업 보고서마다 숫자가 다르고, 기술 발전 속도나 규제 변화에 따라 시장의 크기가 크게 달라질 수 있다. 예상 시장점유율도 마찬가지다. 지금은 유망해 보여도 경쟁자가 늘어나면 점유율은 낮아질 수 있다.
또 PDR은 고평가를 정당화하는 말로 쓰일 위험이 있다. &ldquo;이 기업은 꿈이 크니까 비싸도 괜찮다&quot;는 식으로만 해석하면 투자 판단이 흐려진다. 좋은 스토리와 좋은 투자는 다르다. 아무리 성장 산업이라도 너무 높은 가격에 사면 장기 수익률이 기대보다 낮을 수 있다.
특히 테마주에서는 더 조심해야 한다. AI, 로봇, 바이오, 우주항공 같은 단어가 붙었다고 해서 모든 기업이 실제 수혜를 보는 것은 아니다. 매출과 이익으로 연결되지 않는 꿈은 결국 주가에서 빠질 수 있다.
주의할 점 이유 꿈은 숫자로 확정하기 어렵다 시장 규모와 점유율 추정이 주관적임 고평가를 합리화할 수 있다 비싼 주가를 무리하게 정당화할 위험 테마주에 휘둘릴 수 있다 실제 실적과 무관한 기대가 붙을 수 있음 금리 변화에 민감하다 성장주의 미래 가치 할인율이 달라짐 실적 확인이 필요하다 꿈이 매출과 이익으로 바뀌어야 함 저도 예전에 &ldquo;미래 산업&quot;이라는 말만 보고 관심을 가졌던 종목이 있었다. 그런데 시간이 지나도 매출이 늘지 않고, 회사가 내세운 계획도 계속 미뤄졌다. 그때 느낀 점은 단순했다. 꿈은 출발점일 수 있지만, 투자의 근거가 되려면 결국 숫자로 확인되어야 한다.
정리 &nbsp; 주식 PDR은 국내 주식시장에서 주로 Price to Dream Ratio, 즉 주가꿈비율을 뜻한다. 기업의 현재 이익이나 자산만으로 설명하기 어려운 높은 주가를 미래 성장 가능성과 시장 기대감으로 해석하려는 개념이다.
PDR은 코로나19 이후 성장주가 크게 오르면서 더 많이 알려졌다. PER, PBR로 설명하기 어려운 전기차, 2차전지, 바이오, 플랫폼 같은 기업을 볼 때 &ldquo;시장이 어떤 꿈을 가격에 반영하고 있는가&quot;를 생각하게 해준다.
다만 PDR은 정밀한 공식 지표라기보다 보조적인 사고 도구에 가깝다. 미래 시장 규모, 예상 점유율, 경쟁력, 실적 전환 가능성을 함께 봐야 한다. &ldquo;꿈이 크다&quot;는 말만으로 비싼 주가가 모두 정당화되지는 않는다.
투자할 때 중요한 것은 꿈과 현실의 균형이다. 좋은 성장주는 큰 꿈을 가지고 있지만, 좋은 투자는 그 꿈이 실적으로 바뀔 가능성과 현재 가격을 함께 따져볼 때 만들어진다.
자주 묻는 질문 &nbsp; PDR은 정확히 무슨 뜻인가? &nbsp; 국내 주식 뉴스에서 말하는 PDR은 보통 Price to Dream Ratio, 즉 주가꿈비율을 뜻한다. 기업의 미래 성장 가능성이나 시장의 기대감 대비 현재 주가가 어느 정도인지 생각해보는 개념이다.
PDR이 낮으면 무조건 좋은 주식일까? &nbsp; 아니다. PDR은 미래 시장 규모와 예상 점유율을 어떻게 잡느냐에 따라 달라진다. 추정이 주관적이기 때문에 낮게 보인다고 무조건 저평가라고 판단하면 위험하다.
PDR은 PER이나 PBR보다 더 중요한 지표일까? &nbsp; 그렇지는 않다. PER, PBR은 현재 이익과 자산을 보는 지표이고, PDR은 미래 기대를 보는 보조 개념이다. 성장주를 볼 때 참고할 수 있지만, 매출·이익·현금흐름 같은 기본 지표와 함께 봐야 한다.`}).add({id:56,href:"/posts/stock-leverage/",title:"주식 레버리지란 무엇인가? 초보자를 위한 쉬운 설명과 ...",description:"주식 레버리지는 적은 돈으로 더 큰 금액을 투자하는 방식이다. 수익도 커질 수 있지만 손실과 이자, 강제 청산 위험도 함께 커진다.",content:`주식 투자를 하다 보면 &ldquo;레버리지&quot;라는 말을 자주 듣게 된다. 특히 레버리지 ETF, 신용거래, 미수거래, 선물 같은 단어와 함께 등장한다.
...
Q3. 2배 레버리지와 3배 레버리지 중 무엇이 더 좋을까? &nbsp; 배율이 높을수록 수익 기회도 커지지만 손실 속도도 빨라진다. 초보자라면 3배 레버리지는 특히 조심해야 한다. 배율을 고르기 전에 손실이 났을 때 얼마까지 감당할 수 있는지 먼저 계산하는 것이 중요하다.`}).add({id:57,href:"/posts/stock-sidecar/",title:"주식 사이드카란? 발동 기준과 서킷브레이커 차이를 쉽게 정리",description:"주식 사이드카의 뜻, 코스피와 코스닥 발동 기준, 프로그램 매매 제한 효과, 서킷브레이커와의 차이, 투자자가 주의할 점을 쉽게 정리했다.",content:`주식 뉴스를 보다 보면 갑자기 **&ldquo;사이드카 발동&rdquo;**이라는 말이 나올 때가 있다. 처음 들으면 자동차 이야기 같기도 하고, 정확히 무엇을 뜻하는지 헷갈리기 쉽다.
...
공매도와 무차입 공매도는 같은 말일까? &nbsp; 다르다. 일반적인 공매도는 주식을 빌린 뒤 파는 차입 공매도다. 반면 무차입 공매도는 주식을 빌리지 않고 먼저 파는 방식으로, 국내에서는 원칙적으로 금지되어 있다. 투자자가 문제 삼는 경우도 대부분 불법적인 무차입 공매도나 제도 운영의 불공정성에 대한 우려와 관련이 있다.`}).add({id:60,href:"/posts/blue-chip-yellow-chip-red-chip/",title:"주식 용어: 블루칩 옐로우칩 레드칩 뜻과 차이 쉽게 이해하기",description:"주식시장에서 자주 쓰이는 블루칩, 옐로우칩, 레드칩의 뜻과 차이를 초보 투자자도 이해할 수 있게 사례와 함께 정리했다.",content:`주식 뉴스를 보다 보면 &ldquo;블루칩 중심으로 매수세가 들어왔다&rdquo;, &ldquo;옐로우칩이 강세를 보였다&rdquo;, &ldquo;홍콩 증시의 레드칩이 주목받았다&rdquo; 같은 표현을 만날 때가 있다. 처음 들으면 색깔로 주식을 나누는 것처럼 느껴지지만, 실제로는 기업의 규모, 안정성, 시장에서의 위치를 설명하는 용어다.
...
주택담보대출은 고정금리와 변동금리 중 무엇이 좋을까? &nbsp; 정답은 없다. 금리 상승이 걱정되고 월 상환액을 안정적으로 관리하고 싶다면 고정금리나 혼합형이 편할 수 있다. 반대로 금리 하락 가능성을 보고 초기 금리를 낮추고 싶다면 변동금리를 검토할 수 있다. 다만 변동금리는 금리가 오를 때 상환 부담이 커질 수 있다.`}).add({id:66,href:"/posts/house-type/",title:"주택의 종류",description:"주택 종류에 대해서 알아본다.",content:`주택이란? &nbsp; 주택은 주택법 제2조(정의)에 따라서 단독주택과 공동주택으로 구분된다.
...
완제 &nbsp; 대출 받은 금액을 전액 상환하면 대출을 완제하였다고 한다.`}).add({id:71,href:"/posts/carry-trade/",title:"캐리 트레이드란? 금리 차이로 수익을 노리는 외환 투자...",description:"캐리 트레이드의 뜻과 작동 원리, 금리 차익과 환율 변동 수익, 장점과 위험, 개인 투자자가 주의할 점을 쉽게 정리했다.",content:`환율 뉴스를 보다 보면 &ldquo;엔 캐리 트레이드 청산&rdquo;, &ldquo;달러 강세와 캐리 트레이드&rdquo;, &ldquo;고금리 통화로 자금이 이동한다&rdquo; 같은 표현이 나온다. 주식이나 예금보다 낯선 말이라 어렵게 느껴지지만, 핵심은 단순하다. 금리가 낮은 통화로 돈을 조달하고, 금리가 높은 통화에 투자해 차이를 노리는 전략이다.
...
엔 캐리 트레이드는 무엇인가? &nbsp; 엔 캐리 트레이드는 금리가 낮은 엔화로 자금을 조달해 상대적으로 금리가 높은 통화나 자산에 투자하는 전략을 말한다. 일본의 저금리 환경 때문에 오랫동안 대표적인 캐리 트레이드 사례로 언급되었다. 다만 일본 금리와 글로벌 위험 심리가 바뀌면 엔 캐리 트레이드도 빠르게 청산될 수 있다.`}).add({id:72,href:"/posts/kospi-kosdaq-nasdaq/",title:"코스피, 코스닥, 나스닥 간단 설명",description:"주식 투자에 관심이 있다면 반드시 구분해서 이해해야 할 지수가 바로 코스피, 코스닥, 나스닥이다. 각각의 개념과 차이점에 설명한다.",content:`코스피 (KOSPI) &nbsp; 정식 명칭: Korea Composite Stock Price Index 운영 기관: 한국거래소 개념 &nbsp; 대한민국 유가증권시장(대형 우량기업 시장) 에 상장된 기업들의 주가를 종합해 만든 대표 지수이다.
...
Q5. 이자는 언제 들어오나? &nbsp; 보통 한 달에 한 번 특정 요일에 지급되는 경우가 많지만, 최근 인터넷 은행들은 고객이 원할 때 언제든 이자를 받을 수 있는 서비스를 제공하기도 한다. 상품 설명서의 이자 계산 및 지급 시기를 확인해 보는 것이 좋다.`}).add({id:75,href:"/posts/foreign-stock-capital-gains-tax/",title:"해외주식 양도소득세 신고 방법, 250만 원 공제와 세...",description:"해외주식 양도소득세 신고 대상, 국내주식과 다른 과세 방식, 기본공제 250만 원, 세율 22%, 홈택스 신고 방법과 가산세를 쉽게 정리했다.",content:`해외주식을 하다 보면 매수와 매도 타이밍에는 민감해도 세금은 뒤로 미루기 쉽다. 특히 테슬라, 엔비디아, 애플, 마이크로소프트처럼 익숙한 미국 주식으로 수익이 났다면 &ldquo;증권사 계좌에 돈이 들어왔으니 끝난 것 아닌가&quot;라고 생각할 수 있다.
