...
처음 사는 S&amp;P500 ETF는 몇 주부터 시작하면 좋을까? &nbsp; 처음이라면 1주로 충분하다. 중요한 것은 큰돈을 넣는 것이 아니라 매수, 체결, 평가손익, 분배금, 세금 안내를 직접 확인하는 경험이다. 1주를 사보고 상품 구조를 이해한 뒤에 적립식 투자 여부를 정해도 늦지 않다.`}).add({id:28,href:"/posts/sp500-vs-schd-which-to-buy/",title:"S&P500 vs SCHD, 뭐 사야 할까? 수익률부터...",description:"S&P500과 SCHD 중 무엇을 사야 할지 고민이라면 이 글 하나로 끝내자. 수익률, 배당, 투자 성향별 추천까지 초보자 기준으로 쉽게 정리했다.",content:`S&amp;P500 vs SCHD, 처음 투자 시작할 때 거의 무조건 마주치는 고민이다.
...
Q3. 둘 중 하나만 꼭 골라야 한다면? &nbsp; 초보자 기준에서는 S&amp;P500을 먼저 선택하는 게 더 합리적이다. 이후 상황에 따라 SCHD를 추가하면 된다.`}).add({id:29,href:"/posts/tqqq-qld-qqq-nasdaq-etf/",title:"TQQQ QLD QQQ 뜻, 나스닥 100 추종 ETF...",description:"QQQ, QLD, TQQQ의 뜻과 차이를 나스닥 100 ETF 구조, 레버리지 배율, 장단점, 초보 투자자가 조심해야 할 부분까지 쉽게 정리했다.",content:`미국 기술주 투자를 이야기할 때 나스닥 100을 빼놓기 어렵다. 애플, 마이크로소프트, 엔비디아, 아마존, 테슬라처럼 전 세계 투자자가 관심을 갖는 기업들이 많이 들어 있기 때문이다. 그래서 미국 주식에 직접 투자하지 않더라도 &ldquo;나스닥 ETF 하나쯤은 사야 하나?&ldquo;라는 고민을 하게 된다.
...
레버리지 ETF는 왜 횡보장에 불리할 수 있나? &nbsp; 레버리지 ETF는 매일 목표 배율을 맞추는 구조다. 가격이 오르내리는 과정에서 손실과 회복이 반복되면 단순 배율 계산과 다른 결과가 나온다. 특히 변동성이 큰 횡보장에서는 기초지수가 제자리여도 레버리지 ETF 수익률은 나빠질 수 있다.`}).add({id:30,href:"/posts/vix-index/",title:"VIX 지수란? 공포지수로 보는 주식시장 변동성과 투자...",description:"VIX 지수의 뜻과 계산 원리, S&P500과의 관계, 투자자가 활용하는 방법, VIX 선물과 ETF 투자 시 주의할 점을 쉽게 정리했다.",content:`주식시장이 크게 흔들릴 때 뉴스에서 자주 나오는 말이 있다. 바로 VIX 지수다. &ldquo;공포지수가 급등했다&rdquo;, &ldquo;VIX가 안정되면서 증시가 반등했다&rdquo; 같은 표현을 한 번쯤 봤을 것이다.
...
VIX ETF를 장기 보유해도 될까? &nbsp; 주의가 필요하다. VIX ETF나 ETN은 대부분 VIX 선물을 활용하기 때문에 장기 보유 수익률이 VIX 지수와 다르게 움직일 수 있다. 선물 만기 교체 비용과 큰 변동성 때문에 단기 대응 상품에 가까운 경우가 많다.`}).add({id:31,href:"/posts/sole-proprietor-vs-corporation/",title:"개인사업자와 법인사업자 차이, 창업 전에 꼭 알아야 할 기준",description:"창업할 때 개인사업자와 법인사업자 중 무엇을 선택해야 할지 설립 절차, 세금, 책임 범위, 자금 조달, 운영 방식 차이로 쉽게 정리했다.",content:`창업을 준비하다 보면 생각보다 빨리 마주치는 질문이 있다. &ldquo;개인사업자로 시작할까, 법인사업자로 시작할까?&ldquo;라는 문제다. 아이템을 정하고, 상호를 고민하고, 사업장을 알아보는 일도 중요하지만 사업 형태를 어떻게 정하느냐에 따라 세금, 책임, 회계 처리, 투자 유치 방식이 달라진다.
...
경기지역화폐 카드를 받기 전에도 충전할 수 있을까? &nbsp; 지역과 카드 상태에 따라 앱에서 충전 메뉴가 보일 수 있지만, 실제 결제는 카드 등록 이후 가능한 경우가 많다. 처음 신청했다면 카드를 수령한 뒤 앱에 등록하고 계좌 연결까지 마친 다음 충전하는 흐름으로 보는 것이 안전하다.`}).add({id:34,href:"/posts/how-to-study-economics/",title:"경제 공부하는 방법, 금융 문맹을 벗어나기 위한 현실적...",description:"경제 공부를 어디서부터 시작해야 할지 모르는 초보자를 위해 기본 용어, 경제 뉴스 읽기, 책 선택, 가계부와 소액 투자까지 현실적인 공부 방법을 정리했다.",content:`경제 공부를 해야겠다고 마음먹는 순간은 대개 불편함에서 온다. 월급은 들어오는데 돈이 어디로 나가는지 모르겠고, 금리가 오른다는데 내 대출이 왜 부담스러워지는지 모르겠고, 뉴스에서는 환율과 물가 이야기가 계속 나오는데 내 생활과 어떻게 연결되는지 감이 잡히지 않는다.
...
위기 때 주식은 모두 팔아야 할까? &nbsp; 모든 주식을 감정적으로 매도하는 것은 위험할 수 있다. 당장 쓸 돈으로 투자했다면 줄이는 것이 맞지만, 장기 자금이라면 비상금과 부채 상황을 먼저 확인한 뒤 분할 매수나 리밸런싱 기준에 따라 판단하는 것이 낫다.`}).add({id:37,href:"/posts/spillover-effect/",title:"경제용어: 스필오버 효과, 경제에서 좋은 영향과 나쁜 ...",description:"스필오버 효과의 뜻과 경제, 관광, 조직관리, 상권에서 나타나는 긍정적 영향과 부정적 영향을 초보자도 이해하기 쉽게 정리했다.",content:`경제 기사를 읽다 보면 &ldquo;스필오버 효과&quot;라는 표현이 종종 나온다. 영어로는 Spillover Effect라고 하고, 말 그대로 어떤 영향이 한곳에만 머무르지 않고 주변으로 흘러넘치는 현상을 뜻한다.
...
투자할 때도 스필오버 효과를 볼 수 있을까? &nbsp; 볼 수 있다. 특정 산업의 대규모 투자가 장비, 소재, 부품, 물류 기업으로 번질 수 있고, 한 나라의 금리 변화가 다른 나라 주식시장과 환율에 영향을 줄 수도 있다. 투자자는 직접 수혜주뿐 아니라 주변으로 번지는 영향을 함께 살펴볼 필요가 있다.`}).add({id:38,href:"/posts/financial-freedom-roadmap/",title:"경제적 자유, 누구나 이룰 수 있는 실천 로드맵",description:"경제적 자유를 막연한 꿈이 아니라 실천 가능한 목표로 만들기 위해 지출 관리, 비상금, 부채 정리, 투자, 부수입 로드맵을 정리했다.",content:`경제적 자유라는 말을 들으면 거창하게 느껴진다. 회사를 그만두고, 건물주가 되고, 배당금만으로 여행을 다니는 모습을 떠올리기 쉽다. 하지만 현실적인 경제적 자유는 그런 장면보다 훨씬 작고 구체적인 곳에서 시작된다.
...
적금 개설도 포함이 되나요? &nbsp; 입/출금 계좌만 해당된다. 적금이나 예금 게좌는 하루에 여러개 개설하여도 가능하다.`}).add({id:40,href:"/posts/fixed-variable-loan-interest/",title:"고정금리와 변동금리 차이 쉽게 정리: 대출받을 때 어떤...",description:"고정금리와 변동금리의 뜻, 대출금리 계산 구조, 시장금리 상승기와 하락기 선택 기준, 혼합금리까지 초보자도 이해하기 쉽게 정리했다.",content:`대출을 알아보다 보면 가장 헷갈리는 말 중 하나가 고정금리와 변동금리다. 은행 앱에서는 금리 숫자만 크게 보이지만, 실제로 중요한 것은 그 금리가 앞으로 계속 같은지, 일정 주기마다 바뀌는지다.
...
주식을 손해 보고 팔아도 증권거래세를 내야 할까? &nbsp; 내야 한다. 증권거래세는 이익이 아니라 매도 거래금액에 붙는 세금이다. 손실을 보고 팔아도 매도금액을 기준으로 세금이 계산되므로 잦은 매매를 할수록 거래비용이 누적될 수 있다.`}).add({id:44,href:"/posts/gross-domestic-product-gdp/",title:"국내총생산 GDP 뜻 쉽게 정리, 명목GDP와 실질GD...",description:"국내총생산 GDP의 뜻과 계산 개념, 명목GDP와 실질GDP의 차이, 1인당 GDP와 GNI까지 초보자도 이해하기 쉽게 정리했다.",content:`경제 뉴스를 보다 보면 GDP라는 단어가 정말 자주 나온다. &ldquo;한국 GDP 성장률&rdquo;, &ldquo;1인당 GDP&rdquo;, &ldquo;명목 GDP&rdquo;, &ldquo;실질 GDP&rdquo; 같은 표현이 계속 등장한다.
...
개인 투자자는 그레이 캐피털리즘을 왜 신경 써야 할까? &nbsp; 회색 지대 전략으로 이익을 내는 기업은 단기 실적이 좋아 보일 수 있다. 하지만 소비자 신뢰 하락, 규제 강화, 소송, 불매운동 같은 리스크가 생기면 기업가치가 흔들릴 수 있다. 투자자는 숫자만 보지 말고 그 숫자가 만들어지는 방식도 함께 봐야 한다.`}).add({id:48,href:"/posts/employment-income-tax-vs-global-income-tax/",title:"근로소득세와 종합소득세 차이, 직장인과 사업자는 세금 ...",description:"근로소득세와 종합소득세의 차이, 직장인 연말정산과 사업자 5월 신고, 부업 소득이 있는 직장인이 종합소득세를 신고해야 하는 경우를 쉽게 정리했다.",content:`나는 직장인이라 월급에서 근로소득세가 빠진다. 그런데 사업을 하는 친구는 매년 5월에 종합소득세를 신고한다고 했다. 둘 다 소득에 붙는 세금인 것 같은데, 왜 이름도 다르고 신고 방식도 다를까.
...
Q3. 이거 하나로 충분할까? &nbsp; 기초는 충분하다. 이후에는 뉴스나 투자 서적으로 확장하면 된다.`}).add({id:51,href:"/posts/financial-intelligence/",title:"금융 지능이란?",description:`금융 지능(Financial Intelligence) 은 쉽게 말해서 돈의 흐름을 이해하고, 합리적으로 돈을 관리하고, 장기적으로 자산을 늘릴 수 있는 능력을 의미한다.
...
금융 지식 감정 통제 실제 경험 결론적으로 금융 지능은 금융 지식, 합리적 판단 능력, 그리고 실제 재무 관리 경험이 결합된 개념이며, 개인의 경제적 안정과 자산 형성에 핵심적인 역할을 수행한다.`}).add({id:52,href:"/posts/",title:"금융의 모든 지식!",description:"금융 문맹 탈출 프로젝트",content:""}).add({id:53,href:"/posts/bond-investing-when-rates-fall/",title:"기준금리가 내려가면 채권 가격은 왜 오를까? 금리 하락...",description:"기준금리와 채권 가격의 반비례 관계, 금리 하락기에 채권 투자가 주목받는 이유, 직접 채권과 채권 ETF 선택 기준을 초보자도 이해하기 쉽게 정리했다.",content:`채권 투자를 처음 공부하면 가장 자주 듣는 말이 있다. &ldquo;금리가 내려가면 채권 가격은 오른다&quot;는 말이다. 말 자체는 간단한데, 막상 왜 그런지 설명하려면 조금 헷갈린다. 예금 금리가 내려가면 이자를 덜 받는 것 같은데, 채권 가격은 왜 올라간다는 걸까.
...
예금금리보다 대출금리가 더 높은 이유는 무엇일까? &nbsp; 은행은 예금으로 돈을 조달하고 대출로 돈을 운용한다. 대출금리에는 은행의 조달비용뿐 아니라 운영비, 신용위험, 가산금리 등이 반영된다. 그래서 일반적으로 대출금리는 예금금리보다 높게 형성된다.`}).add({id:55,href:"/news/2026/basic-pension-law/",title:"기초연금법 시행령 개정, 7월부터 재신청 없이 자동 신...",description:"기초연금법 시행령 개정안이 국무회의를 통과했다. 7월부터 수급희망 이력관리 대상자는 자격이 확인되면 재신청 없이 기초연금 신청으로 간주된다.",content:`이번 브리핑은 2026년 5월 26일 국무회의에서 의결된 기초연금법 시행령 개정안을 중심으로, 2026년 3월 27일부터 5월 26일까지 나온 입법예고, 복지안전매트 대책, 주요 언론 보도를 함께 정리했다. 최근 7일 안에는 같은 국무회의 의결 보도가 대부분이라, 정책 배경을 설명하기 위해 실제 조사 범위를 넓혔다.
...
DIA ETF는 배당을 받을 수 있나? &nbsp; DIA는 다우지수 구성 종목을 담는 ETF이므로 보유 종목에서 발생한 배당을 바탕으로 분배금을 지급할 수 있다. 다만 분배금 규모와 지급 시점은 ETF 운용 상황과 보유 종목 배당에 따라 달라진다. 해외 상장 ETF를 직접 보유하면 미국 배당 원천징수와 국내 세금도 함께 고려해야 한다.`}).add({id:58,href:"/posts/multi-homeowner-capital-gains-tax-surcharge/",title:"다주택자 양도소득세 중과 5월 10일부터 시행: 대상,...",description:"2026년 5월 10일부터 다시 적용될 다주택자 양도소득세 중과의 뜻, 대상, 세율, 장기보유특별공제 배제, 매도 전 체크할 내용을 쉽게 정리했다.",content:`집을 여러 채 갖고 있는 사람에게 가장 민감한 세금 중 하나가 양도소득세다. 집을 보유하는 동안에는 재산세나 종부세가 부담이고, 집을 팔 때는 양도소득세가 부담이 된다. 특히 다주택자가 조정대상지역 주택을 팔 때 적용되는 양도세 중과 는 세금 차이가 꽤 크게 벌어질 수 있다.
...
Q3. 복리 효과는 언제부터 크게 느껴지나? &nbsp; 기간이 길어질수록 차이가 커진다. 짧게 보면 거의 비슷하지만, 5년, 10년, 20년처럼 장기로 갈수록 복리의 장점이 확실해진다.`}).add({id:60,href:"/posts/loan-ltv-dti-dsr/",title:"대출 받을 때 알아야 하는 LTV, DTI, DSR",description:" ",content:`LTV, DTI, DSR은 금융기관이 주택담보대출 심사 시 차주(借主, 돈을 빌리는 사람)의 상환 능력과 담보 가치를 평가하기 위해 사용하는 대표적인 규제 지표이다. 즉, 은행이 &ldquo;이 사람이 얼마나 대출을 감당할 수 있는지&rdquo; 판단하는 핵심 지표라고 할 수 있다.
...
사람들이 자주 오해하는 점 &nbsp; LTV 70%면 무조건 70% 대출 가능 → DSR에서 막히면 불가능 소득 높으면 대출 무조건 많이 가능 → LTV 제한 있음 한 줄 정리 &nbsp; LTV = 집 기준 DTI = 주담대 중심 소득 기준 DSR = 전체 빚 기준 (현재 핵심)`}).add({id:61,href:"/posts/loan-repayment-methods/",title:"대출 상환 방법 쉽게 정리, 원리금 균등·원금 균등·만...",description:"대출 상환 방법은 매달 갚는 금액과 총이자 비용을 크게 바꾼다. 원리금 균등, 원금 균등, 만기 일시, 거치 후 상환의 차이를 쉽게 정리한다.",content:`대출을 받을 때 금리만 보는 경우가 많다. 물론 금리는 중요하다. 그런데 실제로 매달 내 통장에서 빠져나가는 돈은 &ldquo;상환 방법&quot;에 따라 크게 달라진다.
...
대출을 빨리 갚고 싶다면 어떤 순서가 좋을까? &nbsp; 일반적으로 금리가 높은 대출부터 먼저 갚는 것이 효율적이다. 다만 중도상환수수료가 있는 상품도 있으므로 실제로 갚기 전에는 수수료와 절감되는 이자를 함께 계산해야 한다.`}).add({id:62,href:"/posts/loan-glossary/",title:"대출 용어",description:` 대출이란? 돈을 빌리는 것을 말한다. 그러면 돈은 어디서 빌려야 하나? 흔하게 은행을 생각해 볼 수 있다. 그런데 처음 돈을 빌리기 위해 처음 은행에 가면 도대체 무슨 말을 하는지 알 수가 없다. 실은 나도 그랬고, 지금도 모르는 단어가 나올 때도 있다. 그래서 당황하지 말고 미리 간단히 단어라도 읶혀 가면 도움을 될 것이다. 여기에서는 최대한 쉽게 설명해 보도록 하겠다.
...
완제 &nbsp; 대출 받은 금액을 전액 상환하면 대출을 완제하였다고 한다.`}).add({id:63,href:"/news/2026/taihan-fiberoptics-ai-infrastructure/",title:"대한광통신, AI 데이터센터 광케이블 기대와 1분기 적...",description:"대한광통신은 인캡아메리카 인수와 AI 데이터센터 광케이블 수요 기대가 커졌지만, 1분기 적자 지속과 밸류에이션 부담도 함께 확인됐다.",content:`이번 브리핑은 대한광통신 관련 보도가 최근 7일 안에 충분히 누적되지 않아, 신뢰할 만한 기사와 공시가 확인되는 2026년 4월 20일부터 2026년 5월 20일까지의 자료를 함께 정리했다.
...
한줄 요약 &nbsp; 대한광통신은 AI 데이터센터 광케이블과 북미 현지 생산 거점이라는 강한 성장 스토리를 확보했지만, 2026년 1분기 적자 지속 이후에는 인캡아메리카 연결 효과와 실제 수주 매출 전환을 숫자로 증명해야 하는 국면에 들어섰다.`}).add({id:64,href:"/posts/deposit-loan-interest-basics/",title:"돈을 맡기면 왜 이자를 줄까? 예금금리와 대출금리의 원리",description:"은행에 돈을 맡기면 왜 이자를 주는지, 예금금리와 대출금리는 어떻게 다른지, 은행이 돈을 버는 예대마진 구조까지 초보자 눈높이로 정리했다.",content:`은행에 돈을 맡기면 시간이 지난 뒤 이자가 붙는다. 처음 금융을 배울 때는 이 부분이 조금 이상하게 느껴질 수 있다. 은행이 내 돈을 보관해주는데 왜 오히려 나에게 돈을 더 줄까.
...
장기 미국채 ETF는 안전한 상품인가? &nbsp; 장기 미국채 ETF는 미국채에 투자하지만 가격 변동성이 작지 않다. 금리가 내려가면 크게 오를 수 있지만, 금리가 오르면 크게 떨어질 수 있다. 안정적인 현금 관리 목적이라면 장기채 ETF보다 단기채 상품이 더 적합한 경우가 많다.`}).add({id:68,href:"/posts/memory-semiconductor-supply-crunch/",title:"반도체 메모리 가격 급등, AI 수요가 D램·낸드·HB...",description:"AI 서버 수요로 HBM과 서버 D램 공급이 우선되면서 범용 D램·낸드 가격까지 급등하고 있다. 최근 메모리 반도체 수급과 시장 영향을 정리한다.",content:`주요 내용 &nbsp; 최근 메모리 반도체 시장의 핵심은 &ldquo;AI 서버가 메모리를 빨아들이고 있다&quot;는 점이다. HBM과 서버용 D램, 엔터프라이즈 SSD 수요가 급증하면서 삼성전자, SK하이닉스, 마이크론 등 주요 공급사는 수익성이 높은 서버·AI용 제품에 생산능력을 우선 배분하고 있다.
...
초보자는 개별 배당주와 배당 ETF 중 무엇이 나을까? &nbsp; 개별 기업을 분석하기 어렵다면 배당 ETF로 시작하는 것도 방법이다. 여러 종목에 나누어 투자할 수 있어 특정 기업의 배당 축소나 주가 하락 위험을 줄이는 데 도움이 된다.`}).add({id:72,href:"/posts/bank-run/",title:"뱅크런 뜻과 원인, 실제 사례로 쉽게 이해하는 은행 대...",description:"뱅크런의 뜻과 발생 원인, 실리콘밸리은행 등 실제 사례, 디지털 뱅크런의 특징과 개인이 확인해야 할 예금자보호 기준을 쉽게 정리했다.",content:`은행은 평소에는 가장 안전한 금융기관처럼 느껴진다. 월급이 들어오고, 카드값이 빠져나가고, 정기예금과 적금을 맡겨두는 곳이기 때문이다. 그런데 금융 뉴스에서 가끔 &ldquo;뱅크런 우려&rdquo;, &ldquo;대규모 예금 인출&rdquo;, &ldquo;은행 유동성 위기&rdquo; 같은 표현이 나오면 갑자기 불안해진다.
...
정기보험 보험 기간이 정해져 있는 보험이다. 대부분 해약해도 해약환급금이 없거나 매우 적은 소멸성 보험으로 보험료가 저렴하고 가입하기 쉽다는 특징이 있다. 양로보험 정기보험과 마찬가지로 보험기간이 정해져 있으며, 보험기간 중 사망하면 사망보험금을, 만기까지 생존해 있으면 만기보험금을 받을 수 있다. 사망보험금과 만기보험금이 동일한 금액으로 &lsquo;생사혼합형 보험&rsquo;이라고도 한다. 종신보험 피보험자가 사망할 때까지 보장이 지속되는 보험이다. 사망 시점에 사망보험금이 지급된다. 보험료는 정기보험에 비해 비싸고, 보험기간 중 중도해지 시 해약환급금이 지급된다. 보험료는 정기보험에 비해 비싸다.`}).add({id:76,href:"/posts/value-added-tax-basics/",title:"부가가치세란 어떤 세금일까, 부가세 별도와 계산 방법 ...",description:"부가가치세의 뜻과 부가세 별도 의미, 최종소비자와 사업자의 관계, 매출세액과 매입세액을 이용한 계산 방법과 신고 기간을 쉽게 정리했다.",content:`물건을 사거나 서비스를 이용할 때 &ldquo;부가세 포함&rdquo;, &ldquo;부가세 별도&quot;라는 말을 자주 듣는다. 특히 견적서를 받을 때 100만 원이라고 생각했는데 마지막에 부가세 10만 원이 붙어 110만 원이 되는 경우가 있다. 그냥 내라고 하니까 내기는 하지만, 이 돈이 정확히 어떤 세금인지 헷갈릴 수 있다.
...
사모펀드가 위험한 이유는 무엇인가? &nbsp; 투자 대상이 복잡하고, 비상장 자산처럼 가격 확인이 어려운 자산에 투자하는 경우가 많으며, 자금이 오래 묶일 수 있기 때문이다. 수익 가능성이 큰 만큼 손실 가능성과 환매 제한도 함께 봐야 한다.`}).add({id:82,href:"/posts/samsung-electro-mechanics-ai-components/",title:"삼성전기, AI 부품 대형 수주와 MLCC·FC-BGA...",description:"삼성전기가 1.5조원대 실리콘 커패시터 공급계약과 AI 서버용 MLCC·FC-BGA 수요 확대로 주가와 실적 기대가 동시에 재평가되고 있다.",content:`주요 내용 &nbsp; 삼성전기 이슈의 중심은 AI 서버용 고부가 부품이다. 2026년 5월 20일 회사가 약 1조 5,000억 원 규모의 실리콘 커패시터 공급계약을 발표하면서, 기존 MLCC와 FC-BGA 중심의 성장 기대에 새로운 축이 더해졌다.
...
한줄 요약 &nbsp; 삼성전자 노사는 5월 20일 오전 결렬 후 같은 날 밤 잠정합의안을 마련해 21일 총파업을 유보했으며, 시장의 다음 관심은 5월 22~27일 조합원 찬반투표 결과와 성과급 제도 변화로 이동했다.`}).add({id:84,href:"/posts/samsung-securities-isa-event/",title:"삼성증권 중개형 ISA 개설 이벤트 혜택 정리: 신규·...",description:"삼성증권 중개형 ISA 이벤트의 기간, 신규 개설 혜택, 타사 ISA 이전 금액 2배 인정, 국내주식 첫 거래 혜택과 주의사항을 쉽게 정리했다.",content:`요즘 ISA 계좌 하나쯤은 다들 고민한다. 절세에 좋다는 건 알겠는데, 막상 만들려고 하면 증권사도 많고 이벤트도 자주 바뀌어서 언제 개설해야 할지 애매하다.
...
상품권을 받으려고 국내주식을 거래해도 될까? &nbsp; 원래 국내주식이나 ETF를 살 계획이 있었다면 이벤트 혜택을 함께 확인해볼 수 있다. 하지만 상품권 5,000원을 받기 위해 필요 없는 거래를 만드는 것은 좋지 않다. 주식 거래에는 가격 변동 위험이 있고, 작은 이벤트 혜택보다 투자 손실이 훨씬 클 수 있다.`}).add({id:85,href:"/posts/delisting-rules-tightened/",title:"상장폐지 요건 강화, 동전주와 부실기업 퇴출 기준 쉽게 정리",description:"상장폐지 뜻부터 2026년 강화되는 시가총액, 동전주, 완전자본잠식, 공시위반 기준과 개인 투자자가 확인해야 할 점을 쉽게 정리했다.",content:`주식을 하다 보면 &ldquo;상장폐지&quot;라는 말이 가장 무섭게 들릴 때가 있다. 주가가 많이 빠지는 것도 힘들지만, 상장폐지는 아예 시장에서 거래할 자격을 잃는 일이기 때문이다. 특히 코스닥 소형주나 동전주를 매매하는 사람이라면 상장폐지 요건이 어떻게 바뀌는지 꼭 알아둘 필요가 있다.
...
초보자는 어떻게 접근하는 것이 좋나? &nbsp; 처음에는 종목명보다 산업 구조를 먼저 이해하는 것이 좋다. 이후 실제 매출 가능성, 공시, 사업 협약, 밸류에이션을 확인하고, 투자하더라도 전체 자산 중 작은 비중으로 접근하는 편이 안전하다.`}).add({id:88,href:"/posts/why-stablecoins-were-created/",title:"스테이블코인은 왜 만들어졌을까? 비트코인과 다른 점 쉽...",description:"스테이블코인이 비트코인의 가격 변동성 문제에서 어떻게 탄생했는지, USDT와 USDC의 역할, 송금·결제·디지털자산 시장에서의 쓰임새를 쉽게 설명한다.",content:`스테이블코인이라는 말을 자주 듣지만, 처음 접하면 조금 헷갈린다. 코인인데 가격이 안정적이라니, 비트코인이나 이더리움처럼 오르내리는 자산과 무엇이 다른지 감이 잘 오지 않는다.
...
스테이블코인은 은행 송금을 대체할 수 있나? &nbsp; 일부 영역에서는 가능성이 있다. 지갑 간 전송은 빠르고 국경을 넘기 쉽기 때문이다. 다만 실제 생활에서 쓰려면 규제, 신원확인, 세금, 현금화, 소비자 보호 문제가 함께 해결되어야 한다.`}).add({id:89,href:"/posts/personal-credit-loan-basics/",title:"신용대출 완벽 개념정리: 뜻, 금리, 한도, 마이너스통...",description:"신용대출의 뜻과 담보대출과의 차이, 금리와 한도 결정 기준, 건별대출과 마이너스통장, 상환 방식과 주의사항을 초보자도 이해하기 쉽게 정리했다.",content:`급하게 돈이 필요할 때 가장 먼저 떠올리는 대출이 신용대출이다. 집이나 자동차 같은 담보가 없어도 신청할 수 있고, 모바일 앱으로 비교적 빠르게 한도와 금리를 확인할 수 있기 때문이다.
...
Q5. 신탁형 ISA는 원금보장 상품인가? &nbsp; 아니다. 계좌 안에 예금보호 대상 상품이 있으면 해당 상품은 보호 대상이 될 수 있지만, 펀드나 주식 같은 투자성 상품은 원금손실이 발생할 수 있다.`}).add({id:92,href:"/posts/medical-expense-insurance-non-covered-items/",title:"실비보험 비급여 보장 총정리, 급여와 비급여 차이부터 ...",description:"실비보험에서 헷갈리는 급여와 비급여 차이, 비급여 보장 항목, 자기부담금, 도수치료·MRI·수액 청구 시 주의할 점을 누구나 이해하기 쉽게 정리하였다.",content:`병원비 영수증을 보면 급여, 비급여라는 단어가 나온다. 처음에는 그냥 병원에서 쓰는 어려운 말처럼 보이지만, 실비보험을 청구할 때는 이 두 단어를 반드시 알아야 한다. 내가 낸 병원비 중 어디까지 건강보험이 적용됐는지, 어디까지 실비보험으로 받을 수 있는지가 여기서 갈리기 때문이다.
...
비급여 진료를 받으면 어떤 서류를 챙겨야 할까? &nbsp; 기본적으로 진료비 영수증과 진료비 세부내역서를 챙기는 것이 좋다. 항목에 따라 처방전, 진단서, 의사 소견서, 통원확인서가 추가로 필요할 수 있으므로 보험사 앱의 청구 안내를 함께 확인해야 한다.`}).add({id:93,href:"/posts/medical-expense-insurance-claim-documents/",title:"실비보험 청구서류 정리, 통원·입원·약제비 청구 방법까...",description:"실비보험의 뜻과 통원·입원·약제비 청구서류, 진료비 영수증과 세부내역서 차이, 청구기간과 실손24 활용법을 누구나 이해하기 쉽게 정리하였다.",content:`살면서 아프지 않은 사람은 거의 없다. 가벼운 감기처럼 병원비가 몇천 원으로 끝날 때도 있지만, 검사나 치료가 이어지면 갑자기 몇십만 원이 나가기도 한다. 여유 자금이 있으면 버틸 수 있지만, 예상하지 못한 병원비는 누구에게나 부담이 된다.
...
주가가 떨어지면 무조건 버텨야 할까? &nbsp; 무조건 버티는 것은 장기투자가 아니다. 회사의 실적과 경쟁력이 유지되는데 시장 전체 하락으로 빠진 것인지, 기업 자체의 문제가 생긴 것인지 확인해야 한다. 처음 매수한 이유가 깨졌다면 매도도 검토해야 한다.`}).add({id:96,href:"/news/2026/nvidia-earnings-preview/",title:"엔비디아 1분기 실적 발표 전 관전 포인트, AI 반도...",description:"엔비디아가 2026년 5월 21일 한국시간 새벽 2027회계연도 1분기 실적을 발표한다. 매출 컨센서스, 블랙웰 출하, 중국 수출 변수와 국내 반도체주 영향을 정리한다.",content:`이번 브리핑은 2026년 5월 15일부터 5월 20일까지 나온 엔비디아 실적 발표 일정, 시장 컨센서스, AI 반도체 수요, 중국 수출 규제, 국내 반도체주 영향 관련 보도를 중심으로 정리했다. 작성 시점은 2026년 5월 20일 밤 한국시간으로, 엔비디아의 2027회계연도 1분기 실적은 아직 공식 발표 전이다.
...
한줄 요약 &nbsp; 엔비디아의 5월 실적 발표는 매출 서프라이즈보다 2분기 가이던스, 블랙웰 출하, 중국 매출 회복 가능성, HBM 수요 지속성을 확인하는 이벤트이며 국내 반도체주 투자심리에도 곧바로 영향을 줄 수 있다.`}).add({id:97,href:"/posts/pension-savings-irp-tax-credit/",title:"연금저축·IRP 세액공제 총정리: 한도, 환급액, IS...",description:"연금저축과 IRP 세액공제 한도, 소득별 공제율, 최대 환급액, ISA 만기자금 전환까지 연말정산 전에 알아둘 내용을 초보자 눈높이로 정리했다.",content:`연말정산을 할 때마다 &ldquo;이번에는 돌려받을까, 더 낼까&rdquo; 하는 생각이 먼저 든다. 연말정산은 1년 동안 미리 낸 세금과 실제로 부담해야 할 세금을 다시 맞추는 과정이다. 미리 낸 세금이 많으면 환급을 받고, 적게 냈으면 추가로 납부한다.
...
연말에 한 번에 넣어도 세액공제가 될까? &nbsp; 해당 과세기간 안에 납입했다면 연말에 한 번에 넣어도 세액공제 대상이 될 수 있다. 다만 금융회사별 입금 마감 시간이나 처리일이 다를 수 있으니 12월 말에 너무 늦게 넣는 건 피하는 게 좋다.`}).add({id:98,href:"/posts/deposit-vs-savings/",title:"예금과 적금 차이, 이자 계산까지 쉽게 이해하기",description:"예금과 적금은 돈을 맡기는 방식부터 이자 계산 구조까지 다르다. 목돈이 있을 때와 매달 저축할 때 어떤 상품이 유리한지 쉽게 설명한다.",content:`예금과 적금은 둘 다 은행에 돈을 맡기고 이자를 받는 저축 상품이다. 그런데 막상 가입하려고 보면 &ldquo;예금이랑 적금이 뭐가 다르지?&rdquo;, &ldquo;금리가 같으면 이자도 같은 것 아닌가?&rdquo; 같은 생각이 들 수 있다.
...
미국 직원은 팁을 못 받으면 최저임금도 못 받는 걸까? &nbsp; 연방 기준으로는 팁과 현금 임금을 합친 금액이 최저임금에 미치지 못하면 고용주가 차액을 보전해야 한다. 다만 실제 현장에서는 팁이 직원 소득에서 큰 비중을 차지하고, 주마다 임금 기준도 다르기 때문에 팁이 생계와 깊게 연결되어 있다.`}).add({id:100,href:"/posts/withholding-tax-system/",title:"원천징수 제도 뜻 쉽게 정리, 세전·세후 월급 차이까지...",description:"원천징수 제도의 뜻과 원천징수의무자, 세전·세후 월급 차이, 근로소득세가 미리 빠지는 이유, 연말정산과의 관계를 누구나 이해하기 쉽게 정리하였다.",content:`월급을 받으면 세전, 세후라는 말을 자주 듣는다. 연봉 계약서에는 분명 5,000만 원이라고 적혀 있는데, 실제 통장에 들어오는 돈을 계산해보면 생각보다 적다. 대략 &ldquo;세금 떼고 들어오는 돈이구나&rdquo; 정도는 알지만, 정확히 무엇이 빠지는지는 헷갈린다.
...
은행을 고를 때는 이름값만 보지 말고 내가 실제로 쓸 기능을 기준으로 보면 된다. 급여 계좌, 자동이체, 대출, 예금 금리, 모바일 앱 사용성, 지점 접근성, 보안 기능을 함께 비교하면 내 생활에 맞는 은행을 고르기 훨씬 쉽다.`}).add({id:102,href:"/posts/bank-vs-savings-bank/",title:"은행과 저축은행의 차이",description:`은행은 제1금융권이라고 하고, 이를 제외한 대부분의 금융기관을 제2금융권이라고 한다.
...
Q5. 일임형 ISA 수수료는 얼마나 중요한가? &nbsp; 매우 중요하다. 일임운용 수수료뿐 아니라 포트폴리오에 들어 있는 펀드나 ETF의 보수까지 장기 수익률에 영향을 준다. 가입 전 총비용을 확인해야 한다.`}).add({id:105,href:"/posts/funding-plan-for-home-purchase/",title:"자금조달계획서 제출 대상과 증빙서류 총정리: 작성 방법...",description:"자금조달계획서가 무엇인지, 제출 대상과 기한, 자기자금·대출·증여 작성 방법, 증빙서류와 반려를 막는 체크포인트까지 누구나 이해하기 쉽게 정리하였다.",content:`집을 사기로 마음먹고 계약까지 진행하면 생각보다 많은 서류를 만나게 된다. 그중 처음 집을 사는 사람이 가장 헷갈려 하는 서류가 자금조달계획서다. 이름부터 딱딱하고, 돈의 출처를 적어야 한다고 하니 괜히 긴장되기도 한다.
...
관리사무소가 납부확인서를 안 주면 어떻게 하나? &nbsp; 아파트 사용자가 장기수선충당금 납부 확인을 요구하면 관리주체는 지체 없이 확인서를 발급해야 한다. 먼저 관리사무소에 정식으로 요청하고, 필요하면 요청 날짜와 담당자, 답변 내용을 기록해두는 것이 좋다.`}).add({id:108,href:"/posts/reconstruction-redevelopment-difference/",title:"재건축 재개발 차이, 분담금과 이주비 절차까지 쉽게 정리",description:"재건축과 재개발의 차이, 사업 절차, 조합원 요건, 분담금과 부담금, 이주비와 주거이전비까지 초보자 기준으로 쉽게 정리했다.",content:`부동산 뉴스를 보다 보면 재건축과 재개발이라는 말이 자주 나온다. 둘 다 오래된 주거 환경을 새롭게 바꾸는 사업이라 비슷해 보이지만, 실제로는 대상과 절차, 돈이 들어가는 방식이 꽤 다르다.
...
아무나 전입세대확인서를 발급받을 수 있을까? &nbsp; 아니다. 개인정보가 포함된 서류라서 소유자, 임차인, 매매계약자, 임대차계약자, 금융기관 등 법령상 신청 자격이 있는 사람이나 기관이 신청할 수 있다. 신청 유형에 따라 계약서, 위임장, 신분증 같은 서류가 필요할 수 있다.`}).add({id:111,href:"/posts/tax-saving-vs-tax-evasion/",title:"절세와 탈세 차이, 합법적으로 세금 줄이는 기준과 탈세 사례",description:"절세와 탈세의 차이를 세법상 기준, 증빙자료, 소득공제와 세액공제, 가공경비와 수입 누락 사례로 초보자도 이해하기 쉽게 정리했다.",content:`세금은 가능하면 줄이고 싶다. 월급을 받는 사람도 연말정산 환급액이 커지면 기분이 좋고, 사업자는 종합소득세나 부가가치세 신고 때 비용을 빠짐없이 인정받고 싶다. 그런데 여기서 자주 헷갈리는 말이 있다. 바로 &ldquo;절세&quot;와 &ldquo;탈세&quot;다.
...
사이드카와 서킷브레이커 중 무엇이 더 강한 조치일까? &nbsp; 서킷브레이커가 더 강한 조치다. 사이드카는 프로그램 매매만 제한하지만, 서킷브레이커는 시장 전체 매매를 일정 시간 중단한다. 따라서 투자자가 체감하는 영향도 서킷브레이커가 훨씬 크다.`}).add({id:116,href:"/posts/fractional-stock-trading/",title:"주식 소수점 거래 방법과 장단점, 주식 모으기로 소액 ...",description:"주식 소수점 거래의 뜻과 장단점, 주문 방법, 주식 모으기 활용법, 수수료와 의결권 등 초보자가 꼭 확인할 주의점을 쉽게 정리했다.",content:`비싼 주식을 사고 싶은데 한 주 가격이 부담스러울 때가 있다. SK하이닉스, 현대자동차, 삼성바이오로직스처럼 한 주 가격이 몇십만 원을 넘는 종목은 초보자가 선뜻 매수하기 어렵다. 관심은 있지만 &ldquo;일단 한 주부터 사보자&quot;는 말 자체가 부담이 되는 경우가 많다.
...
해외 주식도 같은 계좌에서 살 수 있을까? &nbsp; 대부분의 증권사 종합매매계좌에서 해외 주식 거래를 신청하면 가능하다. 다만 해외 주식은 환전, 거래 시간, 세금, 수수료가 국내 주식과 다르다. 미국 주식을 살 생각이라면 해외 주식 거래 신청뿐 아니라 환율과 양도소득세도 함께 공부하는 것이 좋다.`}).add({id:118,href:"/posts/stock-deposit/",title:"주식 예수금 뜻: D+2 출금, 주문가능금액, 미수금까...",description:"주식 예수금의 뜻과 D+2 출금 구조, 주문가능금액과 출금가능금액의 차이, 미수금과 반대매매 위험까지 초보자 눈높이로 정리했다.",content:`주식을 처음 팔아보면 이상한 순간이 온다. 분명히 매도 체결은 됐는데 은행 계좌로 바로 돈을 빼려고 하면 출금 가능 금액이 늘어나지 않는다. 앱에는 예수금, D+1, D+2, 주문가능금액 같은 말이 같이 나오니 더 헷갈린다.
...
공매도와 무차입 공매도는 같은 말일까? &nbsp; 다르다. 일반적인 공매도는 주식을 빌린 뒤 파는 차입 공매도다. 반면 무차입 공매도는 주식을 빌리지 않고 먼저 파는 방식으로, 국내에서는 원칙적으로 금지되어 있다. 투자자가 문제 삼는 경우도 대부분 불법적인 무차입 공매도나 제도 운영의 불공정성에 대한 우려와 관련이 있다.`}).add({id:121,href:"/posts/blue-chip-yellow-chip-red-chip/",title:"주식 용어: 블루칩 옐로우칩 레드칩 뜻과 차이 쉽게 이해하기",description:"주식시장에서 자주 쓰이는 블루칩, 옐로우칩, 레드칩의 뜻과 차이를 초보 투자자도 이해할 수 있게 사례와 함께 정리했다.",content:`주식 뉴스를 보다 보면 &ldquo;블루칩 중심으로 매수세가 들어왔다&rdquo;, &ldquo;옐로우칩이 강세를 보였다&rdquo;, &ldquo;홍콩 증시의 레드칩이 주목받았다&rdquo; 같은 표현을 만날 때가 있다. 처음 들으면 색깔로 주식을 나누는 것처럼 느껴지지만, 실제로는 기업의 규모, 안정성, 시장에서의 위치를 설명하는 용어다.
...
주택담보대출은 고정금리와 변동금리 중 무엇이 좋을까? &nbsp; 정답은 없다. 금리 상승이 걱정되고 월 상환액을 안정적으로 관리하고 싶다면 고정금리나 혼합형이 편할 수 있다. 반대로 금리 하락 가능성을 보고 초기 금리를 낮추고 싶다면 변동금리를 검토할 수 있다. 다만 변동금리는 금리가 오를 때 상환 부담이 커질 수 있다.`}).add({id:128,href:"/posts/house-type/",title:"주택의 종류",description:"주택 종류에 대해서 알아본다.",content:`주택이란? &nbsp; 주택은 주택법 제2조(정의)에 따라서 단독주택과 공동주택으로 구분된다.
...
아파트 &nbsp; 주택으로 쓰는 층수가 5층 이상인 주택을 말한다.`}).add({id:129,href:"/posts/isa-account-type/brokerage/",title:"ISA 중개형",description:"중개형 ISA의 뜻, 가입 자격, 납입한도, 비과세와 분리과세 혜택, 편입 가능 상품, 중도인출, 만기 후 연금계좌 이전까지 쉽게 정리했다.",content:`주식이나 ETF 투자를 시작하면 세금 이야기를 피하기 어렵다. 배당소득세, 이자소득세, 해외 ETF 과세, 금융소득종합과세 같은 단어가 나오면 투자보다 세금이 더 어렵게 느껴진다.
...
처음이라면 주거래 은행과 연결이 편한 증권사 하나, 수수료와 주문 기능이 좋은 증권사 하나를 비교해보는 것부터 시작해도 충분하다. 이후 투자 방식이 정해지면 해외 주식, 공모주, 연금 계좌처럼 목적에 맞게 증권사 계좌를 추가하면 된다.`}).add({id:131,href:"/posts/direct-vs-indirect-investing/",title:"직접투자와 간접투자 차이, 종류와 장단점 쉽게 정리",description:"직접투자와 간접투자의 뜻, 대표적인 종류, 각각의 장점과 단점, 초보자가 어떤 방식으로 시작하면 좋은지 현실적인 기준으로 정리하였다.",content:`투자를 시작하려고 하면 가장 먼저 부딪히는 고민이 있다. 내가 직접 종목을 고를 것인지, 아니면 펀드나 ETF처럼 누군가 운용하는 상품을 활용할 것인지다. 주변에서는 &ldquo;좋은 주식을 직접 사야 돈을 번다&quot;고 말하기도 하고, 또 다른 쪽에서는 &ldquo;초보자는 분산투자 상품부터 해야 한다&quot;고 말한다.
...
간접투자는 안전한 투자인가? &nbsp; 간접투자도 원금 손실이 날 수 있다. 펀드나 ETF가 여러 자산에 나눠 투자한다고 해서 손실이 사라지는 것은 아니다. 투자 대상, 보수, 환매 조건, 변동성을 확인해야 한다.`}).add({id:132,href:"/posts/rolling-effect/",title:"채권 용어: 롤링 효과, 채권 가격이 만기가 가까워질수...",description:"롤링 효과의 뜻과 채권 가격, 잔존기간, 수익률곡선의 관계를 초보자도 이해하기 쉽게 예시와 함께 정리했다.",content:`채권 투자를 공부하다 보면 &ldquo;롤링 효과&quot;라는 용어를 듣게 된다. 처음 들으면 어려운 전문 용어처럼 느껴지지만, 핵심은 단순하다. 시간이 지나면서 채권의 남은 만기가 짧아지고, 그 과정에서 채권 가격이 오를 수 있다는 뜻이다.
...
카드를 고를 때는 &ldquo;혜택이 많다&quot;는 말보다 내 소비 패턴에 맞는지를 먼저 봐야 한다. 전월 실적, 할인 한도, 제외 업종, 연회비를 확인하고, 사용하지 않은 포인트는 카드포인트 통합조회에서 주기적으로 확인하면 카드 생활을 더 알뜰하게 관리할 수 있다.`}).add({id:136,href:"/posts/carry-trade/",title:"캐리 트레이드란? 금리 차이로 수익을 노리는 외환 투자...",description:"캐리 트레이드의 뜻과 작동 원리, 금리 차익과 환율 변동 수익, 장점과 위험, 개인 투자자가 주의할 점을 쉽게 정리했다.",content:`환율 뉴스를 보다 보면 &ldquo;엔 캐리 트레이드 청산&rdquo;, &ldquo;달러 강세와 캐리 트레이드&rdquo;, &ldquo;고금리 통화로 자금이 이동한다&rdquo; 같은 표현이 나온다. 주식이나 예금보다 낯선 말이라 어렵게 느껴지지만, 핵심은 단순하다. 금리가 낮은 통화로 돈을 조달하고, 금리가 높은 통화에 투자해 차이를 노리는 전략이다.
...
콜옵션과 풋옵션은 초보자가 직접 투자해도 괜찮나? &nbsp; 옵션은 만기, 변동성, 시간 가치가 얽힌 파생상품이라 초보자가 바로 직접 거래하기에는 어렵다. 먼저 구조와 손익 계산을 이해하고, 옵션 전략이 들어간 금융상품을 볼 때 설명서를 읽는 용도로 접근하는 것이 현실적이다.`}).add({id:141,href:"/posts/land-transaction-permit-system/",title:"토지거래허가제란? 실거주 의무와 계약 전 체크 포인트 ...",description:"토지거래허가제가 무엇인지, 허가 대상과 실거주 의무, 허가 없는 계약의 효력, 계약 전 확인해야 할 서류와 위반 시 제재를 쉽게 정리했다.",content:`부동산 뉴스를 보다 보면 &ldquo;토지거래허가구역&rdquo;, &ldquo;토허제&rdquo;, &ldquo;실거주 2년&rdquo; 같은 말이 자주 나온다. 이름만 보면 땅을 사고팔 때만 해당되는 제도처럼 느껴지지만, 실제로는 아파트 매매에도 영향을 줄 수 있다. 특히 서울 전역이나 경기 일부 지역처럼 아파트가 토지거래허가구역으로 지정된 곳에서는 일반적인 매매계약처럼 생각하고 접근하면 낭패를 볼 수 있다.
...
DB형에서 DC형으로 바꾸는 것이 좋을까? &nbsp; 임금피크제, 임금 정체, 투자 성향, 퇴직까지 남은 기간에 따라 다르다. 한 번 전환하면 되돌리기 어려운 경우도 있으므로 회사 퇴직연금 규약과 금융회사 안내를 확인한 뒤 결정하는 것이 좋다.`}).add({id:143,href:"/posts/etf-types-retirement-pension-investing/",title:"ETF 퇴직연금 투자방법",description:"퇴직연금 ETF의 뜻, DC형과 IRP 투자 가능 여부, ETF 매수 방법, 주문 시간, 상품 종류, 위험자산 70% 한도까지 쉽게 정리했다.",content:`퇴직연금 계좌를 열어보면 예금, 펀드, TDF 같은 상품만 있는 줄 알기 쉽다. 그런데 DC형이나 IRP 계좌에서는 ETF도 투자할 수 있다. 노후자금이라고 해서 무조건 예금만 넣어두는 것이 아니라, 증권거래소에 상장된 ETF를 활용해 국내외 주식, 채권, 리츠, 자산배분 상품에 투자할 수 있는 것이다.
...
퇴직연금 ETF도 손실이 날 수 있나? &nbsp; 손실이 날 수 있다. ETF는 예금처럼 원금이 보장되는 상품이 아니며, 주식·채권·환율·금리·시장 상황에 따라 가격이 변동한다. 투자 결과는 가입자에게 귀속된다.`}).add({id:144,href:"/posts/retirement-pension-default-option/",title:"퇴직연금 디폴트옵션",description:"퇴직연금 디폴트옵션의 뜻, 적용 대상, 발동 방식, 위험등급별 포트폴리오와 TDF·BF·SVF·SOC 상품 차이를 초보자도 이해하기 쉽게 정리하였다.",content:`퇴직연금 계좌를 열어두고도 한 번도 운용 상품을 바꿔본 적이 없다면 디폴트옵션을 알아둘 필요가 있다. 퇴직연금은 오래 묵혀두는 돈이라 작은 수익률 차이도 시간이 지나면 꽤 크게 벌어진다.
...
환헤지 ETF와 환노출 ETF는 무엇이 다를까? &nbsp; 환헤지 ETF는 환율 변동 영향을 줄이고 기초 자산 수익률에 더 집중하도록 설계된 상품이고, 환노출 ETF는 환율 변동이 수익률에 반영되는 상품이다. 환율 하락이 걱정되면 환헤지가 유리할 수 있지만, 환헤지 비용이 생길 수 있다.`}).add({id:150,href:"/posts/foreign-stock-capital-gains-tax/",title:"해외주식 양도소득세 신고 방법, 250만 원 공제와 세...",description:"해외주식 양도소득세 신고 대상, 국내주식과 다른 과세 방식, 기본공제 250만 원, 세율 22%, 홈택스 신고 방법과 가산세를 쉽게 정리했다.",content:`해외주식을 하다 보면 매수와 매도 타이밍에는 민감해도 세금은 뒤로 미루기 쉽다. 특히 테슬라, 엔비디아, 애플, 마이크로소프트처럼 익숙한 미국 주식으로 수익이 났다면 &ldquo;증권사 계좌에 돈이 들어왔으니 끝난 것 아닌가&quot;라고 생각할 수 있다.
