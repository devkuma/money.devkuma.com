...
20대의 현실적인 포트폴리오는 주식형 자산 7090%, 안전자산 1030% 정도를 출발점으로 생각할 수 있다. 주식형 자산은 국내외 인덱스 ETF, S&amp;P500 ETF, 나스닥100 ETF, 배당성장 ETF 등을 섞을 수 있다. 개별 종목은 공부용으로 일부만 담는 편이 좋다.
...
30대의 포트폴리오는 상황에 따라 다르지만, 장기투자 자금 기준으로 주식형 자산 6080%, 채권·현금성 자산 2040% 정도를 생각할 수 있다. 다만 주택 구입이 임박했거나 대출을 크게 받을 예정이라면 전체 자산 기준으로 위험자산 비중을 낮추는 것이 현실적이다.
...
40대에는 비상금 규모를 다시 점검해야 한다. 20대에는 36개월 생활비도 충분할 수 있지만, 부양가족이 있다면 6개월1년치 생활비를 현금성 자산으로 두는 것이 더 안정적일 수 있다. 보험, 대출 금리, 상환 계획도 함께 봐야 한다.
투자 포트폴리오는 주식형 자산 5070%, 채권·현금성 자산 3050% 정도를 기준으로 생각할 수 있다. 주식형 자산은 시장 전체 ETF와 우량주, 배당성장주를 중심으로 두고, 고위험 테마주나 레버리지 비중은 줄이는 편이 좋다.
...
50대 포트폴리오는 주식형 자산 4060%, 채권·현금성 자산 4060% 정도를 생각할 수 있다. 다만 은퇴까지 시간이 많이 남았고 소득이 안정적이라면 주식 비중을 조금 더 가져갈 수 있고, 은퇴가 임박했거나 부채가 크다면 더 보수적으로 가야 한다.
...
다만 큰 하락을 견딜 여력은 줄어든다. 그래서 60대 포트폴리오는 주식형 자산 2040%, 채권·현금성 자산 6080% 정도를 출발점으로 생각할 수 있다. 연금 수입이 충분하고 자산이 넉넉한 사람은 주식 비중을 더 가져갈 수 있고, 생활비가 빠듯하거나 건강비 지출이 걱정된다면 더 보수적으로 가야 한다.
...
연말에 한 번에 넣어도 세액공제가 될까? &nbsp; 해당 과세기간 안에 납입했다면 연말에 한 번에 넣어도 세액공제 대상이 될 수 있다. 다만 금융회사별 입금 마감 시간이나 처리일이 다를 수 있으니 12월 말에 너무 늦게 넣는 건 피하는 게 좋다.`}).add({id:103,href:"/posts/deposit-vs-savings/",title:"예금과 적금 차이, 이자 계산까지 쉽게 이해하기",description:"예금과 적금은 돈을 맡기는 방식부터 이자 계산 구조까지 다르다. 목돈이 있을 때와 매달 저축할 때 어떤 상품이 유리한지 쉽게 설명한다.",content:`예금과 적금은 둘 다 은행에 돈을 맡기고 이자를 받는 저축 상품이다. 그런데 막상 가입하려고 보면 &ldquo;예금이랑 적금이 뭐가 다르지?&rdquo;, &ldquo;금리가 같으면 이자도 같은 것 아닌가?&rdquo; 같은 생각이 들 수 있다.
...
미국 직원은 팁을 못 받으면 최저임금도 못 받는 걸까? &nbsp; 연방 기준으로는 팁과 현금 임금을 합친 금액이 최저임금에 미치지 못하면 고용주가 차액을 보전해야 한다. 다만 실제 현장에서는 팁이 직원 소득에서 큰 비중을 차지하고, 주마다 임금 기준도 다르기 때문에 팁이 생계와 깊게 연결되어 있다.`}).add({id:105,href:"/posts/withholding-tax-system/",title:"원천징수 제도 뜻 쉽게 정리, 세전·세후 월급 차이까지...",description:"원천징수 제도의 뜻과 원천징수의무자, 세전·세후 월급 차이, 근로소득세가 미리 빠지는 이유, 연말정산과의 관계를 누구나 이해하기 쉽게 정리하였다.",content:`월급을 받으면 세전, 세후라는 말을 자주 듣는다. 연봉 계약서에는 분명 5,000만 원이라고 적혀 있는데, 실제 통장에 들어오는 돈을 계산해보면 생각보다 적다. 대략 &ldquo;세금 떼고 들어오는 돈이구나&rdquo; 정도는 알지만, 정확히 무엇이 빠지는지는 헷갈린다.
...
은행을 고를 때는 이름값만 보지 말고 내가 실제로 쓸 기능을 기준으로 보면 된다. 급여 계좌, 자동이체, 대출, 예금 금리, 모바일 앱 사용성, 지점 접근성, 보안 기능을 함께 비교하면 내 생활에 맞는 은행을 고르기 훨씬 쉽다.`}).add({id:107,href:"/posts/bank-vs-savings-bank/",title:"은행과 저축은행의 차이",description:`은행은 제1금융권이라고 하고, 이를 제외한 대부분의 금융기관을 제2금융권이라고 한다.
...
Q5. 일임형 ISA 수수료는 얼마나 중요한가? &nbsp; 매우 중요하다. 일임운용 수수료뿐 아니라 포트폴리오에 들어 있는 펀드나 ETF의 보수까지 장기 수익률에 영향을 준다. 가입 전 총비용을 확인해야 한다.`}).add({id:110,href:"/posts/funding-plan-for-home-purchase/",title:"자금조달계획서 제출 대상과 증빙서류 총정리: 작성 방법...",description:"자금조달계획서가 무엇인지, 제출 대상과 기한, 자기자금·대출·증여 작성 방법, 증빙서류와 반려를 막는 체크포인트까지 누구나 이해하기 쉽게 정리하였다.",content:`집을 사기로 마음먹고 계약까지 진행하면 생각보다 많은 서류를 만나게 된다. 그중 처음 집을 사는 사람이 가장 헷갈려 하는 서류가 자금조달계획서다. 이름부터 딱딱하고, 돈의 출처를 적어야 한다고 하니 괜히 긴장되기도 한다.
...
관리사무소가 납부확인서를 안 주면 어떻게 하나? &nbsp; 아파트 사용자가 장기수선충당금 납부 확인을 요구하면 관리주체는 지체 없이 확인서를 발급해야 한다. 먼저 관리사무소에 정식으로 요청하고, 필요하면 요청 날짜와 담당자, 답변 내용을 기록해두는 것이 좋다.`}).add({id:113,href:"/posts/reconstruction-redevelopment-difference/",title:"재건축 재개발 차이, 분담금과 이주비 절차까지 쉽게 정리",description:"재건축과 재개발의 차이, 사업 절차, 조합원 요건, 분담금과 부담금, 이주비와 주거이전비까지 초보자 기준으로 쉽게 정리했다.",content:`부동산 뉴스를 보다 보면 재건축과 재개발이라는 말이 자주 나온다. 둘 다 오래된 주거 환경을 새롭게 바꾸는 사업이라 비슷해 보이지만, 실제로는 대상과 절차, 돈이 들어가는 방식이 꽤 다르다.
...
아무나 전입세대확인서를 발급받을 수 있을까? &nbsp; 아니다. 개인정보가 포함된 서류라서 소유자, 임차인, 매매계약자, 임대차계약자, 금융기관 등 법령상 신청 자격이 있는 사람이나 기관이 신청할 수 있다. 신청 유형에 따라 계약서, 위임장, 신분증 같은 서류가 필요할 수 있다.`}).add({id:116,href:"/posts/tax-saving-vs-tax-evasion/",title:"절세와 탈세 차이, 합법적으로 세금 줄이는 기준과 탈세 사례",description:"절세와 탈세의 차이를 세법상 기준, 증빙자료, 소득공제와 세액공제, 가공경비와 수입 누락 사례로 초보자도 이해하기 쉽게 정리했다.",content:`세금은 가능하면 줄이고 싶다. 월급을 받는 사람도 연말정산 환급액이 커지면 기분이 좋고, 사업자는 종합소득세나 부가가치세 신고 때 비용을 빠짐없이 인정받고 싶다. 그런데 여기서 자주 헷갈리는 말이 있다. 바로 &ldquo;절세&quot;와 &ldquo;탈세&quot;다.
...
사이드카와 서킷브레이커 중 무엇이 더 강한 조치일까? &nbsp; 서킷브레이커가 더 강한 조치다. 사이드카는 프로그램 매매만 제한하지만, 서킷브레이커는 시장 전체 매매를 일정 시간 중단한다. 따라서 투자자가 체감하는 영향도 서킷브레이커가 훨씬 크다.`}).add({id:121,href:"/posts/fractional-stock-trading/",title:"주식 소수점 거래 방법과 장단점, 주식 모으기로 소액 ...",description:"주식 소수점 거래의 뜻과 장단점, 주문 방법, 주식 모으기 활용법, 수수료와 의결권 등 초보자가 꼭 확인할 주의점을 쉽게 정리했다.",content:`비싼 주식을 사고 싶은데 한 주 가격이 부담스러울 때가 있다. SK하이닉스, 현대자동차, 삼성바이오로직스처럼 한 주 가격이 몇십만 원을 넘는 종목은 초보자가 선뜻 매수하기 어렵다. 관심은 있지만 &ldquo;일단 한 주부터 사보자&quot;는 말 자체가 부담이 되는 경우가 많다.
...
해외 주식도 같은 계좌에서 살 수 있을까? &nbsp; 대부분의 증권사 종합매매계좌에서 해외 주식 거래를 신청하면 가능하다. 다만 해외 주식은 환전, 거래 시간, 세금, 수수료가 국내 주식과 다르다. 미국 주식을 살 생각이라면 해외 주식 거래 신청뿐 아니라 환율과 양도소득세도 함께 공부하는 것이 좋다.`}).add({id:123,href:"/posts/stock-deposit/",title:"주식 예수금 뜻: D+2 출금, 주문가능금액, 미수금까...",description:"주식 예수금의 뜻과 D+2 출금 구조, 주문가능금액과 출금가능금액의 차이, 미수금과 반대매매 위험까지 초보자 눈높이로 정리했다.",content:`주식을 처음 팔아보면 이상한 순간이 온다. 분명히 매도 체결은 됐는데 은행 계좌로 바로 돈을 빼려고 하면 출금 가능 금액이 늘어나지 않는다. 앱에는 예수금, D+1, D+2, 주문가능금액 같은 말이 같이 나오니 더 헷갈린다.
...
공매도와 무차입 공매도는 같은 말일까? &nbsp; 다르다. 일반적인 공매도는 주식을 빌린 뒤 파는 차입 공매도다. 반면 무차입 공매도는 주식을 빌리지 않고 먼저 파는 방식으로, 국내에서는 원칙적으로 금지되어 있다. 투자자가 문제 삼는 경우도 대부분 불법적인 무차입 공매도나 제도 운영의 불공정성에 대한 우려와 관련이 있다.`}).add({id:126,href:"/posts/blue-chip-yellow-chip-red-chip/",title:"주식 용어: 블루칩 옐로우칩 레드칩 뜻과 차이 쉽게 이해하기",description:"주식시장에서 자주 쓰이는 블루칩, 옐로우칩, 레드칩의 뜻과 차이를 초보 투자자도 이해할 수 있게 사례와 함께 정리했다.",content:`주식 뉴스를 보다 보면 &ldquo;블루칩 중심으로 매수세가 들어왔다&rdquo;, &ldquo;옐로우칩이 강세를 보였다&rdquo;, &ldquo;홍콩 증시의 레드칩이 주목받았다&rdquo; 같은 표현을 만날 때가 있다. 처음 들으면 색깔로 주식을 나누는 것처럼 느껴지지만, 실제로는 기업의 규모, 안정성, 시장에서의 위치를 설명하는 용어다.
...
주택담보대출은 고정금리와 변동금리 중 무엇이 좋을까? &nbsp; 정답은 없다. 금리 상승이 걱정되고 월 상환액을 안정적으로 관리하고 싶다면 고정금리나 혼합형이 편할 수 있다. 반대로 금리 하락 가능성을 보고 초기 금리를 낮추고 싶다면 변동금리를 검토할 수 있다. 다만 변동금리는 금리가 오를 때 상환 부담이 커질 수 있다.`}).add({id:133,href:"/posts/house-type/",title:"주택의 종류",description:"주택 종류에 대해서 알아본다.",content:`주택이란? &nbsp; 주택은 주택법 제2조(정의)에 따라서 단독주택과 공동주택으로 구분된다.
...
아파트 &nbsp; 주택으로 쓰는 층수가 5층 이상인 주택을 말한다.`}).add({id:134,href:"/posts/isa-account-type/brokerage/",title:"ISA 중개형",description:"중개형 ISA의 뜻, 가입 자격, 납입한도, 비과세와 분리과세 혜택, 편입 가능 상품, 중도인출, 만기 후 연금계좌 이전까지 쉽게 정리했다.",content:`주식이나 ETF 투자를 시작하면 세금 이야기를 피하기 어렵다. 배당소득세, 이자소득세, 해외 ETF 과세, 금융소득종합과세 같은 단어가 나오면 투자보다 세금이 더 어렵게 느껴진다.
...
처음이라면 주거래 은행과 연결이 편한 증권사 하나, 수수료와 주문 기능이 좋은 증권사 하나를 비교해보는 것부터 시작해도 충분하다. 이후 투자 방식이 정해지면 해외 주식, 공모주, 연금 계좌처럼 목적에 맞게 증권사 계좌를 추가하면 된다.`}).add({id:136,href:"/posts/direct-vs-indirect-investing/",title:"직접투자와 간접투자 차이, 종류와 장단점 쉽게 정리",description:"직접투자와 간접투자의 뜻, 대표적인 종류, 각각의 장점과 단점, 초보자가 어떤 방식으로 시작하면 좋은지 현실적인 기준으로 정리하였다.",content:`투자를 시작하려고 하면 가장 먼저 부딪히는 고민이 있다. 내가 직접 종목을 고를 것인지, 아니면 펀드나 ETF처럼 누군가 운용하는 상품을 활용할 것인지다. 주변에서는 &ldquo;좋은 주식을 직접 사야 돈을 번다&quot;고 말하기도 하고, 또 다른 쪽에서는 &ldquo;초보자는 분산투자 상품부터 해야 한다&quot;고 말한다.
...
간접투자는 안전한 투자인가? &nbsp; 간접투자도 원금 손실이 날 수 있다. 펀드나 ETF가 여러 자산에 나눠 투자한다고 해서 손실이 사라지는 것은 아니다. 투자 대상, 보수, 환매 조건, 변동성을 확인해야 한다.`}).add({id:137,href:"/posts/rolling-effect/",title:"채권 용어: 롤링 효과, 채권 가격이 만기가 가까워질수...",description:"롤링 효과의 뜻과 채권 가격, 잔존기간, 수익률곡선의 관계를 초보자도 이해하기 쉽게 예시와 함께 정리했다.",content:`채권 투자를 공부하다 보면 &ldquo;롤링 효과&quot;라는 용어를 듣게 된다. 처음 들으면 어려운 전문 용어처럼 느껴지지만, 핵심은 단순하다. 시간이 지나면서 채권의 남은 만기가 짧아지고, 그 과정에서 채권 가격이 오를 수 있다는 뜻이다.
...
카드를 고를 때는 &ldquo;혜택이 많다&quot;는 말보다 내 소비 패턴에 맞는지를 먼저 봐야 한다. 전월 실적, 할인 한도, 제외 업종, 연회비를 확인하고, 사용하지 않은 포인트는 카드포인트 통합조회에서 주기적으로 확인하면 카드 생활을 더 알뜰하게 관리할 수 있다.`}).add({id:141,href:"/posts/carry-trade/",title:"캐리 트레이드란? 금리 차이로 수익을 노리는 외환 투자...",description:"캐리 트레이드의 뜻과 작동 원리, 금리 차익과 환율 변동 수익, 장점과 위험, 개인 투자자가 주의할 점을 쉽게 정리했다.",content:`환율 뉴스를 보다 보면 &ldquo;엔 캐리 트레이드 청산&rdquo;, &ldquo;달러 강세와 캐리 트레이드&rdquo;, &ldquo;고금리 통화로 자금이 이동한다&rdquo; 같은 표현이 나온다. 주식이나 예금보다 낯선 말이라 어렵게 느껴지지만, 핵심은 단순하다. 금리가 낮은 통화로 돈을 조달하고, 금리가 높은 통화에 투자해 차이를 노리는 전략이다.
...
콜옵션과 풋옵션은 초보자가 직접 투자해도 괜찮나? &nbsp; 옵션은 만기, 변동성, 시간 가치가 얽힌 파생상품이라 초보자가 바로 직접 거래하기에는 어렵다. 먼저 구조와 손익 계산을 이해하고, 옵션 전략이 들어간 금융상품을 볼 때 설명서를 읽는 용도로 접근하는 것이 현실적이다.`}).add({id:146,href:"/posts/land-transaction-permit-system/",title:"토지거래허가제란? 실거주 의무와 계약 전 체크 포인트 ...",description:"토지거래허가제가 무엇인지, 허가 대상과 실거주 의무, 허가 없는 계약의 효력, 계약 전 확인해야 할 서류와 위반 시 제재를 쉽게 정리했다.",content:`부동산 뉴스를 보다 보면 &ldquo;토지거래허가구역&rdquo;, &ldquo;토허제&rdquo;, &ldquo;실거주 2년&rdquo; 같은 말이 자주 나온다. 이름만 보면 땅을 사고팔 때만 해당되는 제도처럼 느껴지지만, 실제로는 아파트 매매에도 영향을 줄 수 있다. 특히 서울 전역이나 경기 일부 지역처럼 아파트가 토지거래허가구역으로 지정된 곳에서는 일반적인 매매계약처럼 생각하고 접근하면 낭패를 볼 수 있다.
...
DB형에서 DC형으로 바꾸는 것이 좋을까? &nbsp; 임금피크제, 임금 정체, 투자 성향, 퇴직까지 남은 기간에 따라 다르다. 한 번 전환하면 되돌리기 어려운 경우도 있으므로 회사 퇴직연금 규약과 금융회사 안내를 확인한 뒤 결정하는 것이 좋다.`}).add({id:148,href:"/posts/etf-types-retirement-pension-investing/",title:"ETF 퇴직연금 투자방법",description:"퇴직연금 ETF의 뜻, DC형과 IRP 투자 가능 여부, ETF 매수 방법, 주문 시간, 상품 종류, 위험자산 70% 한도까지 쉽게 정리했다.",content:`퇴직연금 계좌를 열어보면 예금, 펀드, TDF 같은 상품만 있는 줄 알기 쉽다. 그런데 DC형이나 IRP 계좌에서는 ETF도 투자할 수 있다. 노후자금이라고 해서 무조건 예금만 넣어두는 것이 아니라, 증권거래소에 상장된 ETF를 활용해 국내외 주식, 채권, 리츠, 자산배분 상품에 투자할 수 있는 것이다.
...
퇴직연금 ETF도 손실이 날 수 있나? &nbsp; 손실이 날 수 있다. ETF는 예금처럼 원금이 보장되는 상품이 아니며, 주식·채권·환율·금리·시장 상황에 따라 가격이 변동한다. 투자 결과는 가입자에게 귀속된다.`}).add({id:149,href:"/posts/retirement-pension-default-option/",title:"퇴직연금 디폴트옵션",description:"퇴직연금 디폴트옵션의 뜻, 적용 대상, 발동 방식, 위험등급별 포트폴리오와 TDF·BF·SVF·SOC 상품 차이를 초보자도 이해하기 쉽게 정리하였다.",content:`퇴직연금 계좌를 열어두고도 한 번도 운용 상품을 바꿔본 적이 없다면 디폴트옵션을 알아둘 필요가 있다. 퇴직연금은 오래 묵혀두는 돈이라 작은 수익률 차이도 시간이 지나면 꽤 크게 벌어진다.
...
환헤지 ETF와 환노출 ETF는 무엇이 다를까? &nbsp; 환헤지 ETF는 환율 변동 영향을 줄이고 기초 자산 수익률에 더 집중하도록 설계된 상품이고, 환노출 ETF는 환율 변동이 수익률에 반영되는 상품이다. 환율 하락이 걱정되면 환헤지가 유리할 수 있지만, 환헤지 비용이 생길 수 있다.`}).add({id:155,href:"/posts/foreign-stock-capital-gains-tax/",title:"해외주식 양도소득세 신고 방법, 250만 원 공제와 세...",description:"해외주식 양도소득세 신고 대상, 국내주식과 다른 과세 방식, 기본공제 250만 원, 세율 22%, 홈택스 신고 방법과 가산세를 쉽게 정리했다.",content:`해외주식을 하다 보면 매수와 매도 타이밍에는 민감해도 세금은 뒤로 미루기 쉽다. 특히 테슬라, 엔비디아, 애플, 마이크로소프트처럼 익숙한 미국 주식으로 수익이 났다면 &ldquo;증권사 계좌에 돈이 들어왔으니 끝난 것 아닌가&quot;라고 생각할 수 있다.
...
누수는 화재보험으로 보장될까? &nbsp; 상품과 특약에 따라 가능하다. 다만 기본 화재보험에 자동 포함되지 않을 수 있고, 노후 배관 교체비처럼 보장되지 않는 항목도 있다. 가입 전 누수 특약이 우리 집 손해와 아랫집 배상까지 포함하는지 확인해야 한다.`}).add({id:157,href:"/posts/etf-hedged-unhedged/",title:"환헤지 환노출 ETF 차이",description:"환헤지와 환노출 ETF의 뜻, 상품명 (H) 표시, 환율이 오르거나 내릴 때 수익률이 어떻게 달라지는지 초보자 기준으로 쉽게 정리했다.",content:`해외 주식 ETF를 고르다 보면 상품명 뒤에 (H)가 붙은 것을 자주 보게 된다. 예를 들어 &ldquo;미국S&amp;P500(H)&ldquo;처럼 표시된 상품이다. 처음 보면 단순한 상품 코드처럼 보이지만, 실제로는 환율 변동을 얼마나 반영할지 알려주는 중요한 표시다.
