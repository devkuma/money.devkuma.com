...
일임형 ISA &nbsp; 일임형 ISA는 금융기관의 전문가에게 운용을 맡기는 방식이다. 투자자가 직접 종목이나 상품을 하나하나 고르기보다, 본인의 투자성향에 맞는 포트폴리오를 선택하고 운용은 금융기관이 진행한다.
투자 경험이 적고 상품 선택이 부담스럽다면 일임형이 편할 수 있다. 대신 운용 방식과 수수료를 반드시 확인해야 한다. 알아서 해준다는 말만 보고 가입하면 실제 수익률과 비용 구조를 놓치기 쉽다.
중개형 ISA &nbsp; 중개형 ISA는 일반 주식계좌처럼 투자자가 직접 상품을 사고파는 방식이다. 국내 상장주식, ETF, 펀드 등 직접 투자에 익숙한 사람에게 적합하다. 다만 예금성 상품에는 투자할 수 없고, 증권사에서 가입하는 형태가 일반적이다.
