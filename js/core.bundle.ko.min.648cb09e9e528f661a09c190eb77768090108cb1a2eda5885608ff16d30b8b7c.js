...
지금 같은 시장에서 초보자는 어떻게 투자해야 할까? &nbsp; 한 가지 테마에 몰아넣기보다 분산해서 접근하는 것이 좋다. AI 반도체, 전력 인프라, 우량 지수 ETF, 현금 비중을 나누고, 급등한 종목은 실적과 밸류에이션을 확인한 뒤 접근하는 편이 안전하다.`}).add({id:6,href:"/posts/investment-strategy-by-age/",title:"연령별투자전략",description:"20대부터 60대까지 인생 단계별 투자 목표와 포트폴리오 구성법을 정리했다. 주식, ETF, 채권, 현금 비중을 나이에 맞게 조정하는 기준을 쉽게 설명한다.",content:`투자를 시작할 때 가장 많이 듣는 말 중 하나가 &ldquo;젊을수록 공격적으로, 나이가 들수록 안정적으로&quot;다. 큰 틀에서는 맞는 말이다. 20대는 손실을 회복할 시간이 많고, 60대는 이미 모은 자산을 지키는 것이 중요하기 때문이다.
...
연령별 투자 전략은 &ldquo;나이가 몇 살이니 주식 몇 퍼센트&quot;처럼 기계적으로 정하는 것이 아니다. 나이, 소득, 부채, 가족 상황, 투자 기간, 비상금, 은퇴 목표를 함께 보고 위험을 조절하는 과정이다. 이 글에서는 20대부터 60대까지 각 시기별로 어떤 목표를 먼저 세우고, 어떤 자산 배분을 생각하면 좋은지 정리하였다.
연령별 투자 전략의 기본 원리 &nbsp; 투자 전략에서 나이가 중요한 이유는 시간 때문이다. 20대가 주식시장에서 큰 하락을 겪어도 앞으로 일해서 돈을 벌 시간과 다시 투자할 시간이 많다. 반대로 60대가 은퇴 직후 큰 손실을 겪으면 회복할 시간이 짧고, 생활비 인출까지 겹칠 수 있다.
그래서 전통적으로는 &ldquo;100에서 나이를 뺀 만큼 주식 비중을 가져가라&quot;는 식의 규칙이 자주 언급된다. 예를 들어 30세라면 주식 70%, 채권과 현금 30%를 생각하는 방식이다. 기대수명이 길어진 요즘에는 110이나 120에서 나이를 빼는 방식으로 조금 더 공격적인 배분을 말하기도 한다.
...
결국 연령별 투자 전략의 핵심은 &ldquo;나이에 맞춰 삶을 끼워 넣는 것&quot;이 아니라 &ldquo;내 삶에 맞춰 투자 비중을 조정하는 것&quot;이다.
20대 투자 전략: 종잣돈과 습관이 먼저다 &nbsp; 20대는 투자 기간이 가장 길다. 그래서 성장주, 주식형 ETF, 글로벌 지수 ETF처럼 변동성은 있지만 장기 기대수익률이 높은 자산을 활용하기 좋은 시기다. 다만 20대 투자에서 가장 중요한 것은 종목을 잘 고르는 능력보다 꾸준히 투자하는 습관이다.
...
이 시기에는 소액으로 위험 감내도를 경험해보는 것도 의미가 있다. 계좌가 5% 빠졌을 때도 괜찮은지, 20% 하락하면 불안해서 팔고 싶은지 직접 겪어봐야 한다. 다만 상승장만 경험하고 &ldquo;나는 공격적인 투자자&quot;라고 착각하면 위험하다. 진짜 위험 성향은 하락장에서 드러난다.
...
30대 투자 전략: 큰 지출과 장기투자를 분리한다 &nbsp; 30대는 소득이 늘기 시작하지만 지출도 함께 커진다. 결혼, 전세, 주택 구입, 출산, 이직, 창업 같은 큰 의사결정이 몰리는 시기다. 그래서 30대 투자 전략의 핵심은 돈의 목적을 나누는 것이다.
...
30대는 &ldquo;투자 수익률&quot;과 &ldquo;인생 이벤트 자금&quot;을 섞어 생각하면 흔들리기 쉽다. 장기투자 계좌는 장기투자 계좌대로 두고, 가까운 지출은 별도 계좌에 모아두는 방식이 마음도 편하고 계획도 선명하다.
40대 투자 전략: 자산 축적과 리스크 관리의 균형 &nbsp; 40대는 소득이 꽤 안정되거나 커지는 시기다. 동시에 주택담보대출, 자녀 교육비, 부모님 지원, 생활비 증가가 겹칠 수 있다. 겉으로는 소득이 높아 보여도 실제 여유 현금흐름은 생각보다 작을 수 있다.
이 시기의 핵심은 &ldquo;많이 버니까 더 공격적으로 투자하자&quot;가 아니라 &ldquo;무너지지 않는 구조를 만들자&quot;다. 대출과 고정지출이 큰 상태에서 주식 비중까지 너무 높으면, 시장 하락과 소득 감소가 동시에 왔을 때 버티기 어렵다.
...
40대에는 투자 수익률보다 &ldquo;계속 투자할 수 있는 체력&quot;이 중요하다. 하락장에서 생활비 때문에 주식을 팔지 않도록 현금흐름을 관리하고, 자녀 교육비처럼 시점이 정해진 돈은 미리 안전자산으로 옮겨두는 전략이 필요하다.
50대 투자 전략: 은퇴 전 마지막 점검 &nbsp; 50대는 은퇴 준비가 구체적인 숫자로 다가오는 시기다. 몇 살까지 일할 수 있는지, 국민연금은 언제부터 받을지, 퇴직금은 얼마인지, 주택담보대출은 얼마나 남았는지, 은퇴 후 월 생활비는 어느 정도인지 계산해야 한다.
...
50대에는 연금계좌도 점검해야 한다. 연금저축, IRP, 퇴직연금의 투자 상품이 너무 공격적이거나, 반대로 너무 보수적이라 물가상승을 따라가지 못하는지 확인해야 한다. 은퇴가 가까워질수록 &ldquo;얼마를 벌까&quot;보다 &ldquo;얼마나 오래 버틸 수 있을까&quot;가 더 중요한 질문이 된다.
60대 투자 전략: 자산 보존과 인출 계획 &nbsp; 60대는 자산을 모으는 단계에서 사용하는 단계로 넘어간다. 그래서 투자 전략도 바뀌어야 한다. 이 시기에는 계좌 평가액만 보는 것이 아니라 매달 얼마를 인출해도 되는지, 연금과 배당으로 생활비의 몇 퍼센트를 충당할 수 있는지 계산해야 한다.
...
연령대별 포트폴리오 예시 &nbsp; 아래 비중은 정답이 아니라 출발점이다. 직업 안정성, 부채, 가족 상황, 투자 경험, 연금 준비 정도에 따라 달라질 수 있다.
연령대 핵심 목표 주식형 자산 채권·현금성 자산 중요한 체크포인트 20대 종잣돈, 습관, 경험 70~90% 10~30% 소득 증가, 자동투자, 위험 감내도 파악 30대 큰 지출 준비, 장기투자 분리 60~80% 20~40% 결혼·주택·출산 자금 분리 40대 자산 축적, 가족 리스크 관리 50~70% 30~50% 비상금, 보험, 대출 관리 50대 은퇴 준비, 손실 방어 40~60% 40~60% 연금, 배당, 은퇴 생활비 계산 60대 자산 보존, 인출 계획 20~40% 60~80% 생활비 현금흐름, 의료비, 상속 구분 여기서 말하는 주식형 자산은 개별 주식만 뜻하지 않는다. 국내외 주식 ETF, 배당 ETF, 연금계좌의 주식형 펀드도 포함된다. 채권·현금성 자산은 예금, 파킹통장, MMF, 단기채권, 채권 ETF, 현금성 대기자금 등을 포함해 생각할 수 있다.
비중보다 중요한 것은 목적이다. 5년 안에 쓸 돈은 안전하게, 10년 이상 굴릴 돈은 성장 자산으로, 언제 필요할지 모르는 돈은 비상금으로 나누면 투자 판단이 훨씬 쉬워진다.
정리 &nbsp; 연령별 투자 전략은 나이에 따라 위험을 조금씩 줄여가는 흐름을 기본으로 한다. 20대는 종잣돈과 투자 습관, 30대는 큰 지출과 장기투자의 분리, 40대는 가족과 부채 리스크 관리, 50대는 은퇴 준비, 60대는 자산 보존과 인출 계획이 중심이다.
하지만 나이만으로 포트폴리오를 정하면 부족하다. 같은 나이라도 소득, 부채, 가족 상황, 투자 기간, 연금 준비 정도가 다르다. 그래서 &ldquo;100에서 나이를 뺀 만큼 주식&rdquo; 같은 규칙은 참고만 하고, 실제 비중은 내 삶의 위험까지 포함해 조정해야 한다.
...
자주 묻는 질문 &nbsp; 20대는 무조건 주식 비중을 높게 가져가야 하나? &nbsp; 대체로 장기 투자 기간이 길기 때문에 주식 비중을 높게 가져갈 여지가 있다. 다만 비상금이 없거나, 곧 전세금·학자금·결혼자금처럼 쓸 돈이 있다면 그 돈까지 주식에 넣으면 안 된다. 장기 자금과 단기 자금을 나눠야 한다.
&ldquo;100에서 나이를 뺀 만큼 주식&rdquo; 규칙은 믿을 만한가? &nbsp; 참고용으로는 쓸 수 있다. 하지만 직업 안정성, 부채, 가족 상황, 연금 준비 상태를 반영하지 못한다. 나이가 젊어도 대출과 고정지출이 크면 주식 비중을 낮춰야 할 수 있고, 나이가 많아도 자산과 연금이 충분하면 주식 비중을 어느 정도 유지할 수 있다.
50대부터는 배당주만 투자하면 될까? &nbsp; 배당주는 현금흐름을 만드는 데 도움이 되지만, 배당주만이 정답은 아니다. 배당수익률이 높아 보여도 실적이 나빠지면 배당이 줄 수 있다. 시장 전체 ETF, 배당 ETF, 채권, 현금성 자산을 함께 조합하는 것이 더 안정적이다.
60대는 주식을 모두 팔아야 하나? &nbsp; 아니다. 은퇴 후에도 투자 기간은 10년, 20년 이상 이어질 수 있다. 다만 생활비로 곧 써야 할 돈은 안전자산으로 확보하고, 주식은 장기 자산 일부로 가져가는 방식이 현실적이다.
연령별 비중은 얼마나 자주 조정해야 하나? &nbsp; 매일 조정할 필요는 없다. 보통 6개월 또는 1년에 한 번 정도 점검하면 충분하다. 다만 이직, 결혼, 주택 구입, 출산, 은퇴, 큰 대출 상환처럼 인생 이벤트가 생기면 그때는 포트폴리오를 다시 봐야 한다.`}).add({id:7,href:"/about/",title:"About Me",description:"Money is a great servant but a bad master.",content:`지금까지 나는 &lsquo;대출은 절대 받으면 안 되는 것&rsquo;, &lsquo;주식은 손실 위험이 크니 멀리해야 하는 것&rsquo;, &lsquo;본인이 관리만 잘한다면 연금은 불필요한 것&rsquo;이라 굳게 믿어왔다. 특히 인구 감소가 시작되면 주택 가격은 결국 무너질 것이라 확신했다.
...
money.devkuma.com &nbsp; 주제는 아주 노골적으로 &lsquo;돈&rsquo; 이다. 금융, 경제, 대출, 주식, 세금, 부동산 등 자본주의 시대를 살아가기 위해 필수적인 지식들을 하나하나 쌓아갈 예정이다. 늦은 만큼 더 치열하게 흡수하고 기록하며, 더 이상 무지가 부끄러움이 되지 않도록 나만의 경제 지도를 그려나가려 한다.`}).add({id:8,href:"/posts/bis-capital-ratio/",title:"BIS 비율이란? 은행 건전성을 보는 자본 적정성 지표...",description:"BIS 비율의 뜻과 계산 공식, 위험가중자산과 자기자본의 의미, 은행 건전성 평가에서 중요한 이유와 한계를 초보자도 이해하기 쉽게 정리했다.",content:`은행은 평소에는 안전해 보인다. 예금을 받고, 대출을 해주고, 이자를 받는 구조라 단순해 보이기도 한다. 하지만 은행의 자산 대부분은 대출과 투자자산이다. 경기 침체가 오거나 부동산 가격이 급락하거나 기업이 대출을 갚지 못하면 은행도 손실을 볼 수 있다.
...
BIS 비율이 낮아지면 은행은 무엇을 할까? &nbsp; 은행은 자기자본을 늘리거나 위험가중자산을 줄이는 방식으로 BIS 비율을 개선할 수 있다. 증자, 이익 유보, 후순위채 발행, 고위험 대출 축소, 자산 매각 등이 대표적인 방법이다.`}).add({id:9,href:"/posts/build-transfer-lease/",title:"BTL이란? Build Transfer Lease 민간...",description:"BTL의 뜻과 등장 배경, 사업 추진 절차, 정부와 민간사업자의 역할, 장점과 단점, BTO와의 차이를 초보자도 이해하기 쉽게 정리했다.",content:`학교, 병원, 군 시설, 문화시설 같은 공공시설은 필요하지만 한 번에 큰 돈이 들어간다. 정부나 지방자치단체 입장에서는 당장 지어야 할 시설은 많은데 예산은 한정되어 있다. 그렇다고 모든 사업을 뒤로 미루면 주민이 이용할 공공서비스가 부족해진다.
...
CMA 통장은 어디서 만들 수 있나? &nbsp; 대부분 증권사 앱에서 비대면으로 만들 수 있다. 계좌 개설 전에 CMA 유형, 수익률, 예금자보호 여부, 이체와 출금 수수료, 체크카드와 자동이체 가능 여부를 확인하면 된다. 같은 CMA라도 증권사와 상품 유형에 따라 조건이 꽤 다르다.`}).add({id:11,href:"/posts/cpi-pce-difference/",title:"CPI-PCE",description:"CPI와 PCE의 뜻과 차이, 발표 시기, 연준이 PCE를 선호하는 이유, 주식시장과 기준금리 판단에 쓰는 방법을 쉽게 정리한다.",content:`경제 뉴스를 보다 보면 &ldquo;미국 CPI가 예상보다 높게 나와 금리 인하 기대가 줄었다&quot;거나 &ldquo;PCE 물가지수가 둔화되며 증시가 상승했다&quot;는 문장을 자주 보게 된다. 처음 보면 둘 다 물가 지표 같은데 왜 이름이 다르고, 왜 시장 반응도 다르게 나오는지 헷갈린다.
...
CPI 뜻, 소비자가 직접 내는 가격을 보는 지표 &nbsp; CPI는 Consumer Price Index의 줄임말로, 소비자물가지수라고 부른다. 소비자가 일상에서 직접 구입하는 상품과 서비스의 가격이 얼마나 변했는지 보여주는 지표다.
...
다만 CPI가 낮아졌다고 해서 가격이 예전으로 내려갔다는 뜻은 아니다. 상승률이 낮아졌다는 말은 가격이 오르는 속도가 느려졌다는 의미일 때가 많다. 이 부분을 놓치면 &ldquo;물가가 잡혔다는데 왜 장보기는 여전히 비싸지?&ldquo;라는 착각을 하기 쉽다.
근원 CPI도 같이 보는 이유 &nbsp; 뉴스에서는 CPI와 함께 근원 CPI라는 말도 자주 나온다. 근원 CPI는 가격 변동이 큰 식료품과 에너지를 제외하고 계산한 물가지표다.
...
PCE 뜻, 소비 흐름을 더 넓게 보는 지표 &nbsp; PCE는 Personal Consumption Expenditures의 줄임말로, 개인소비지출 또는 개인소비지출 물가지수라고 부른다. 개인이 상품과 서비스를 소비하는 과정에서 발생한 지출을 바탕으로 물가 변화를 보는 지표다.
...
CPI와 PCE 차이, 핵심은 범위와 민감도다 &nbsp; CPI와 PCE는 둘 다 물가를 보지만 같은 지표가 아니다. 차이를 간단히 정리하면 이렇다.
구분 CPI PCE 이름 소비자물가지수 개인소비지출 물가지수 보는 대상 소비자가 직접 구입한 상품과 서비스 개인 소비와 관련된 직접·간접 지출 체감도 생활물가 체감에 비교적 가까움 경제 전체 소비 흐름 반영에 강함 소비 변화 반영 상대적으로 느림 상대적으로 빠름 시장 반응 발표가 빨라 증시와 채권시장이 민감하게 반응 연준의 통화정책 판단에 중요 CPI는 시장이 빠르게 반응하는 지표다. 발표 시점이 비교적 빠르고, 투자자들이 예상치와 실제 수치를 바로 비교하기 쉽기 때문이다. CPI가 예상보다 높게 나오면 &ldquo;금리를 쉽게 내리기 어렵겠다&quot;는 해석이 나오고, 주식시장이 흔들릴 수 있다.
PCE는 연준이 더 선호하는 물가지표로 알려져 있다. 범위가 넓고 소비 패턴 변화를 더 잘 반영하기 때문이다. 특히 미국 기준금리 방향을 볼 때는 PCE, 그중에서도 식료품과 에너지를 제외한 근원 PCE를 중요하게 본다.
쉽게 말하면 CPI는 &ldquo;시장이 먼저 놀라는 지표&quot;이고, PCE는 &ldquo;연준이 더 깊게 들여다보는 지표&quot;에 가깝다.
왜 CPI와 PCE가 금리와 주식시장에 영향을 줄까 &nbsp; 미국 중앙은행인 연방준비제도는 물가 안정과 고용 안정을 중요한 목표로 삼는다. 물가가 너무 빠르게 오르면 사람들의 구매력이 떨어지고, 기업도 비용 부담이 커진다. 그래서 인플레이션이 높으면 연준은 기준금리를 올리거나 높은 금리를 오래 유지하려는 쪽으로 움직일 수 있다.
...
CPI와 PCE 발표를 볼 때 체크할 것 &nbsp; 경제지표를 볼 때는 실제 수치보다 &ldquo;예상과의 차이&quot;가 더 중요하게 작용할 때가 많다. 시장은 이미 전문가 예상치를 어느 정도 가격에 반영해두기 때문이다.
...
전월 대비: 지난달보다 물가가 얼마나 올랐는지 본다. 전년 대비: 1년 전과 비교해 물가가 얼마나 올랐는지 본다. 예상치 대비: 시장 예상보다 높았는지 낮았는지 본다. 근원 지표: 식료품과 에너지를 제외해 물가의 지속성을 본다. CPI와 PCE는 발표 시기도 다르다. CPI는 보통 매월 중순에 먼저 나오고, PCE는 월말 쪽에 발표되는 경우가 많다. 그래서 시장은 CPI를 보고 먼저 반응한 뒤, PCE로 연준의 판단을 다시 가늠하는 흐름을 보인다.
또 PPI도 함께 보면 좋다. PPI는 생산자물가지수로, 기업이 생산 단계에서 부담하는 가격 변화를 보여준다. 생산 비용이 오르면 시간이 지나 소비자 가격으로 전가될 수 있기 때문에 CPI의 선행 신호처럼 해석되기도 한다.
초보 투자자는 이렇게 이해하면 된다 &nbsp; CPI와 PCE를 완벽하게 계산할 필요는 없다. 중요한 것은 이 지표가 시장에서 어떤 질문에 답하는지 이해하는 것이다.
CPI는 &ldquo;소비자가 직접 느끼는 물가가 얼마나 뜨거운가?&ldquo;를 보는 데 유용하다. 그래서 발표 직후 주식, 채권, 환율이 빠르게 움직일 수 있다.
PCE는 &ldquo;연준이 물가를 어떻게 판단할 가능성이 큰가?&ldquo;를 보는 데 유용하다. 특히 근원 PCE가 계속 높다면 금리 인하 기대가 뒤로 밀릴 수 있다.
...
정리 &nbsp; CPI와 PCE는 모두 인플레이션을 판단하는 중요한 물가지표다. CPI는 소비자가 직접 지출하는 상품과 서비스 가격 변화를 보여주기 때문에 시장이 빠르게 반응한다. PCE는 직접 지출뿐 아니라 간접 지출과 소비 패턴 변화까지 더 넓게 반영하기 때문에 연준이 통화정책을 판단할 때 더 중요하게 본다.
경제 뉴스를 볼 때는 &ldquo;CPI가 올랐다&rdquo;, &ldquo;PCE가 낮아졌다&quot;에서 끝내지 말고 예상치와의 차이, 근원 지표, 전월 대비 흐름, 기준금리 전망까지 연결해서 봐야 한다.
초보자라면 이렇게 기억하면 충분하다. CPI는 시장의 즉각 반응을 보는 지표, PCE는 연준의 금리 판단을 읽는 지표다. 이 두 가지만 구분해도 물가 뉴스와 주식시장 반응이 훨씬 덜 어렵게 보인다.
자주 묻는 질문 &nbsp; CPI와 PCE 중 어떤 지표가 더 중요한가? &nbsp; 둘 다 중요하다. 단기 시장 반응은 CPI가 더 크게 만들 때가 많고, 연준의 기준금리 판단에는 PCE가 더 중요하게 쓰인다.
CPI가 높으면 주식시장은 무조건 하락하나? &nbsp; 무조건은 아니다. 예상치보다 높았는지, 근원 CPI도 높은지, 고용과 경기 흐름이 어떤지에 따라 시장 반응은 달라진다. 다만 CPI가 예상보다 높으면 금리 부담 때문에 주식시장에는 부정적으로 작용하는 경우가 많다.
PCE가 CPI보다 낮게 나오는 경우가 많은 이유는? &nbsp; PCE는 소비자가 비싼 상품 대신 대체 상품을 선택하는 소비 패턴 변화를 더 유연하게 반영한다. 그래서 특정 품목 가격 급등의 영향이 CPI보다 완화되어 나타날 수 있다.
근원 CPI와 근원 PCE는 왜 따로 보나? &nbsp; 식료품과 에너지는 가격 변동이 커서 전체 물가 흐름을 일시적으로 왜곡할 수 있다. 근원 지표는 이런 항목을 제외해 물가 압력이 얼마나 지속적인지 보는 데 도움을 준다.`}).add({id:12,href:"/docs/etf/",title:"ETF",description:"ETF(상장지수펀드, Exchange Traded Fund)",content:""}).add({id:13,href:"/posts/etf-price-nav-premium-discount-tracking-error/",title:"ETF 가격 결정 원리",description:"ETF 가격이 어떻게 결정되는지 NAV, iNAV, 괴리율, LP, 추적오차 개념을 초보자도 이해하기 쉽게 예시와 함께 정리했다.",content:`ETF는 주식처럼 장중에 바로 사고팔 수 있다. 그래서 처음 ETF를 보면 &ldquo;그냥 주식 가격처럼 수요와 공급으로 정해지는 것 아닌가?&ldquo;라고 생각하기 쉽다. 절반은 맞고 절반은 다르다. ETF도 거래소에서 매수자와 매도자가 만나 가격이 정해지지만, 그 뒤에는 ETF가 실제로 들고 있는 자산 가치가 기준으로 깔려 있다.
...
ETF 가격은 왜 일반 주식과 다를까? &nbsp; 개별 주식의 가격은 기업에 대한 기대, 실적, 수급, 시장 분위기 등에 따라 움직인다. 삼성전자 주식을 산다면 삼성전자라는 한 기업의 가치와 투자자 심리가 가격에 크게 반영된다.
ETF는 조금 다르다. ETF는 여러 주식, 채권, 원자재, 파생상품 등을 바구니처럼 담아놓은 펀드가 거래소에 상장된 형태다. 그래서 ETF 1주의 가격은 &ldquo;이 ETF가 실제로 들고 있는 자산이 얼마짜리인가&quot;라는 기준과 연결된다.
...
구분 의미 자산 가치 ETF가 실제로 들고 있는 자산의 1주당 가치 시장가격 투자자들이 거래소에서 실제로 사고파는 가격 ETF를 볼 때는 시장가격만 보면 부족하다. 그 가격이 ETF의 실제 자산 가치와 비교해 적정한지도 함께 봐야 한다.
NAV와 iNAV 뜻 &nbsp; ETF 가격 구조를 이해하려면 먼저 NAV와 iNAV를 알아야 한다. 이름은 어렵지만 개념은 단순하다.
NAV란? &nbsp; NAV는 Net Asset Value의 약자로 순자산가치라고 한다. ETF가 보유한 자산에서 운용 보수 같은 부채를 뺀 뒤, ETF 총 주식 수로 나눈 값이다. 쉽게 말해 ETF 1주가 이론적으로 얼마짜리인지 보여주는 기준이다.
NAV = (ETF 보유 자산 - 부채) / ETF 총 주식 수예를 들어 어떤 ETF가 가진 자산 가치가 1,000억 원이고 부채가 10억 원이며, ETF 주식 수가 1,000만 주라면 1주당 NAV는 9,900원이 된다.
(1,000억 원 - 10억 원) / 1,000만 주 = 9,900원다만 NAV는 보통 장 마감 후 하루에 한 번 계산된다. 그래서 증권사 앱에서 &ldquo;전일 NAV&quot;라고 표시되는 경우가 많다. 어제 장이 끝난 뒤 계산된 기준값이라는 뜻이다.
iNAV란? &nbsp; iNAV는 indicative Net Asset Value의 약자로 실시간 추정 순자산가치라고 보면 된다. ETF는 장중에도 계속 거래되는데 NAV가 하루 한 번만 나오면 투자 판단이 늦어질 수 있다. 그래서 장중에는 ETF가 담고 있는 자산 가격을 반영해 추정 가치인 iNAV를 제공한다.
iNAV는 &ldquo;지금 이 ETF 1주의 적정 가치가 대략 얼마인가&quot;를 보여주는 실시간 참고값이다. 증권사마다 표현이 조금 다를 수 있다. 어떤 곳은 iNAV라고 쓰고, 어떤 곳은 장중 NAV, 추정 NAV, 당일 NAV처럼 표시하기도 한다.
핵심은 이렇다.
구분 NAV iNAV 의미 ETF 1주당 순자산가치 장중 실시간 추정 순자산가치 산출 시점 장 마감 후 1일 1회 중심 장중 실시간 또는 짧은 간격 활용 ETF의 기준 가치 확인 현재 시장가격이 비싼지 싼지 판단 주의점 전일 기준일 수 있음 추정값이라 완전히 정확하지는 않음 ETF 매수 전에는 현재가만 보지 말고 iNAV와의 차이도 함께 보는 습관이 좋다.
괴리율 뜻과 계산 방법 &nbsp; 괴리율은 ETF 시장가격과 기준 가치가 얼마나 벌어졌는지를 보여주는 비율이다. ETF가 실제 가치보다 비싸게 거래되면 플러스 괴리율, 싸게 거래되면 마이너스 괴리율로 볼 수 있다.
...
괴리율 해석 0% 근처 시장가격과 기준 가치가 비슷함 플러스 ETF가 기준 가치보다 비싸게 거래됨 마이너스 ETF가 기준 가치보다 싸게 거래됨 절대값이 큼 가격 왜곡 가능성이 커짐 괴리율이 크다고 해서 무조건 나쁜 ETF라고 단정할 수는 없다. 해외 자산 ETF는 해당 국가 시장이 열려 있지 않거나 환율이 움직이면서 일시적으로 차이가 날 수 있다. 다만 초보자라면 괴리율이 유난히 큰 시점에 시장가 주문으로 급하게 매수하는 것은 피하는 편이 낫다.
LP는 ETF 가격을 어떻게 잡아줄까? &nbsp; LP는 Liquidity Provider의 약자로 유동성 공급자라고 한다. ETF 시장에서 LP는 투자자들이 너무 비싸게 사거나 너무 싸게 팔지 않도록 매수, 매도 호가를 제시하는 역할을 한다.
...
시간대 주의할 점 08:30~09:00 장 시작 전 동시호가 구간 09:00~09:05 장 시작 직후 가격 변동이 큰 구간 15:20~15:30 장 마감 전 동시호가 구간 ETF를 매수하거나 매도할 때는 가능하면 장 시작 직후와 장 마감 직전의 급한 주문을 피하는 것이 좋다. 특히 시장가 주문은 예상보다 불리한 가격에 체결될 수 있으므로, 초보자라면 지정가 주문을 기본으로 사용하는 편이 안전하다.
추적오차는 괴리율과 무엇이 다를까? &nbsp; 괴리율과 추적오차는 둘 다 ETF에서 자주 나오는 용어라 헷갈리기 쉽다. 하지만 보는 대상이 다르다.
괴리율은 ETF의 시장가격과 NAV 또는 iNAV 사이의 차이다. 즉 &ldquo;지금 거래되는 가격이 실제 가치와 얼마나 다른가&quot;를 보는 지표다.
추적오차는 ETF가 따라가려는 기초지수와 ETF의 실제 성과가 얼마나 차이 나는지를 보는 지표다. 즉 &ldquo;이 ETF가 지수를 얼마나 잘 따라가고 있는가&quot;를 보는 지표다.
...
추적오차는 여러 이유로 생긴다.
운용 보수와 기타 비용이 반영된다. 지수 구성 종목을 완전히 똑같이 담기 어려울 수 있다. 배당금 반영 시점이 다를 수 있다. 해외 ETF는 환율과 거래 시간 차이가 영향을 줄 수 있다. 레버리지, 인버스 ETF는 파생상품 운용 구조 때문에 차이가 커질 수 있다. 초보자라면 ETF를 고를 때 수익률만 보지 말고, 같은 지수를 추종하는 ETF끼리 총보수, 거래량, 순자산 규모, 괴리율, 추적오차를 함께 비교하는 것이 좋다.
구분 괴리율 추적오차 비교 대상 시장가격 vs NAV 또는 iNAV ETF 성과 vs 기초지수 확인 목적 지금 비싸게 사는지 확인 지수를 잘 따라가는지 확인 중요 시점 매수, 매도할 때 ETF를 고를 때와 보유 중 점검할 때 ETF 매수 전 확인할 체크리스트 &nbsp; ETF는 편리한 상품이지만 아무 가격에나 사도 되는 상품은 아니다. 특히 초보자는 아래 항목만 확인해도 불필요한 실수를 줄일 수 있다.
체크 항목 보는 이유 현재가와 iNAV 차이 비싸게 매수하는지 확인 괴리율 가격 왜곡 정도 확인 거래량과 호가 간격 원하는 가격에 체결될 가능성 확인 총보수 장기 보유 비용 확인 순자산 규모 상품 안정성과 거래 편의성 확인 추적오차 기초지수를 잘 따라가는지 확인 환헤지 여부 해외 ETF의 환율 영향 확인 실전에서는 이렇게 생각하면 쉽다. 같은 S&amp;P 500 ETF가 여러 개 있다면 무조건 최근 수익률이 가장 높은 상품만 고를 것이 아니라, 거래량이 충분한지, 보수가 낮은지, 추적오차가 크지 않은지, 괴리율이 안정적인지 확인해야 한다.
...
정리 &nbsp; ETF 가격은 단순히 투자자들의 수요와 공급만으로 움직이지 않는다. ETF가 보유한 자산의 가치가 기준이 되고, 실제 시장에서는 그 기준을 중심으로 매수자와 매도자가 거래하면서 가격이 형성된다.
NAV는 ETF 1주의 순자산가치다. iNAV는 장중 실시간으로 추정한 ETF 1주의 가치다. 괴리율은 시장가격과 기준 가치의 차이를 비율로 보여준다. LP는 ETF 가격이 iNAV 근처에서 움직이도록 유동성을 공급한다. 추적오차는 ETF가 기초지수를 얼마나 잘 따라가는지 보여준다. ETF를 매수할 때 현재가만 보고 들어가면 실제 가치보다 비싸게 살 수 있다. 특히 초보자라면 iNAV, 괴리율, 거래량, 호가 간격을 함께 확인하고 지정가 주문을 사용하는 습관을 들이는 것이 좋다. ETF는 구조를 알고 나면 훨씬 편하게 활용할 수 있는 투자 도구다.
자주 묻는 질문 &nbsp; ETF 가격은 주식 가격처럼 수요와 공급으로만 정해지나? &nbsp; ETF도 거래소에서 사고팔리기 때문에 시장가격은 수요와 공급의 영향을 받는다. 다만 ETF는 보유 자산의 가치인 NAV, iNAV가 기준 역할을 한다. 그래서 일반 주식보다 실제 자산 가치와의 차이를 함께 보는 것이 중요하다.
NAV와 iNAV 중 무엇을 더 봐야 하나? &nbsp; 장기적으로 ETF의 기준 가치를 이해할 때는 NAV가 중요하고, 장중 매수와 매도 판단에는 iNAV가 더 유용하다. NAV는 보통 전일 기준일 수 있으므로, 지금 매수하려는 가격이 적정한지 볼 때는 iNAV와 현재가 차이를 확인하는 편이 좋다.
괴리율이 플러스면 무조건 사면 안 되나? &nbsp; 무조건 피해야 하는 것은 아니다. 다만 플러스 괴리율이 크면 ETF를 실제 가치보다 비싸게 살 가능성이 있다. 특히 단기간에 급등한 ETF나 거래량이 적은 ETF는 괴리율을 확인한 뒤 지정가로 신중하게 접근하는 것이 좋다.
LP가 있으면 괴리율은 항상 0%에 가까워지나? &nbsp; 대체로 괴리를 줄이는 역할을 하지만 항상 완벽하지는 않다. 시장 급변, 거래량 부족, 해외 시장 휴장, 환율 변화, 장 시작 직후와 장 마감 직전 같은 상황에서는 괴리율이 커질 수 있다.
추적오차가 작으면 무조건 좋은 ETF인가? &nbsp; 추적오차가 작다는 것은 기초지수를 잘 따라간다는 뜻이므로 중요한 장점이다. 하지만 ETF를 고를 때는 추적오차만 보지 말고 총보수, 거래량, 순자산 규모, 괴리율, 세금, 환헤지 여부도 함께 확인해야 한다.`}).add({id:14,href:"/posts/etf-guide/",title:"ETF 기초 가이드",description:"ETF 뜻과 구조, 주식·펀드와의 차이, 장점과 단점, 투자 전 확인해야 할 기준까지 초보자도 이해하기 쉽게 정리했다.",content:`ETF는 주식 투자를 처음 공부할 때 꽤 자주 만나는 단어다. &ldquo;S&amp;P 500 ETF를 모아간다&rdquo;, &ldquo;코스피 200 ETF에 투자한다&rdquo;, &ldquo;월배당 ETF가 인기다&rdquo; 같은 말을 듣다 보면 ETF가 뭔가 편하고 좋아 보이긴 하는데, 정확히 주식인지 펀드인지 헷갈릴 수 있다.
ETF는 쉽게 말해 주식처럼 사고팔 수 있는 펀드다. 하나의 기업에 투자하는 주식과 달리 여러 종목이나 자산을 한 번에 담을 수 있고, 일반 펀드와 달리 거래소에서 실시간으로 매매할 수 있다. 그래서 ETF는 주식과 펀드의 중간 성격을 가진 투자 상품이라고 이해하면 쉽다.
이 글에서는 ETF의 뜻, 구조, 장점과 단점, 주식·펀드와의 차이를 초보자 기준으로 정리하였다. ETF가 무조건 좋은 상품이라는 뜻은 아니다. 어떤 구조인지 알고 나에게 맞게 쓰는 것이 중요하다.
ETF란 무엇인가? &nbsp; ETF는 Exchange Traded Fund의 줄임말이고, 우리말로는 상장지수펀드라고 부른다. 이름을 나눠보면 뜻이 조금 더 선명해진다.
용어 의미 Exchange Traded 거래소에서 거래된다 Fund 여러 자산을 모아 운용하는 펀드다 ETF 거래소에 상장되어 주식처럼 사고팔 수 있는 펀드다 일반적인 펀드는 은행이나 증권사를 통해 가입하고, 매수와 환매에도 시간이 걸린다. 반면 ETF는 주식시장에 상장되어 있기 때문에 삼성전자나 현대차 주식을 사듯이 증권사 앱에서 바로 주문할 수 있다.
ETF는 보통 특정 지수를 따라가도록 설계된다. 예를 들어 코스피 200 ETF는 코스피 시장을 대표하는 200개 종목의 움직임을 따라가고, S&amp;P 500 ETF는 미국 대표 대형주 500개 기업으로 구성된 지수의 움직임을 따라간다.
여기서 지수란 시장의 흐름을 숫자로 보여주는 기준이다. 코스피, 코스닥, S&amp;P 500, 나스닥 100 같은 지수가 대표적이다. ETF는 이런 지수를 기준으로 움직이도록 만들어진 상품이 많다.
다만 모든 ETF가 주가지수만 따라가는 것은 아니다. 채권, 금, 원유, 리츠, 배당주, 반도체, 2차전지, 인공지능 같은 특정 자산이나 테마를 따라가는 ETF도 있다. 그래서 ETF는 한 기업을 고르는 투자라기보다 &ldquo;어떤 시장이나 자산군에 투자할 것인가&quot;를 고르는 상품에 가깝다.
ETF를 이해하려면 주식과 펀드를 먼저 알아야 한다 &nbsp; ETF는 주식과 펀드의 특징을 함께 가진 상품이다. 그래서 ETF를 이해하려면 주식과 펀드가 어떻게 다른지 먼저 잡아두는 것이 좋다.
주식은 한 기업에 직접 투자하는 방식이다 &nbsp; 주식은 회사의 일부를 소유한다는 증표다. 삼성전자 주식을 사면 삼성전자라는 한 기업의 주주가 되는 것이고, 애플 주식을 사면 애플의 주주가 되는 것이다.
주식 투자의 장점은 내가 원하는 기업을 직접 고를 수 있다는 점이다. 기업이 성장하고 실적이 좋아지면 주가 상승과 배당을 기대할 수 있다. 반대로 그 기업의 실적이 나빠지거나 산업 전망이 꺾이면 손실도 커질 수 있다.
즉 주식은 선택의 자유가 큰 대신 개별 기업 리스크도 크다. 한 기업에 집중 투자하면 수익률이 크게 날 수도 있지만, 반대로 한 기업의 악재에 내 투자금이 크게 흔들릴 수도 있다.
펀드는 여러 투자자의 돈을 모아 운용하는 방식이다 &nbsp; 펀드는 여러 투자자의 돈을 모아 운용사가 대신 투자하는 금융 상품이다. 펀드매니저가 주식, 채권, 부동산, 현금성 자산 등을 골라 포트폴리오를 구성한다.
펀드의 장점은 분산 투자와 전문 운용이다. 내가 직접 종목을 고르지 않아도 되고, 적은 돈으로 여러 자산에 나눠 투자할 수 있다. 하지만 일반 펀드는 매수와 환매가 즉시 이루어지지 않고, 보수와 수수료 구조도 ETF보다 복잡할 수 있다.
또 펀드는 실시간 가격으로 사고파는 상품이 아니다. 기준가가 정해지는 방식으로 거래되기 때문에 오늘 신청해도 실제 적용 가격과 입금 시점이 며칠 뒤가 될 수 있다.
ETF는 주식처럼 거래되는 펀드다 &nbsp; ETF는 펀드처럼 여러 자산을 담고 있지만, 거래 방식은 주식에 가깝다. 증권사 앱에서 현재가를 보고 매수·매도 주문을 넣을 수 있고, 장중 가격 변동도 확인할 수 있다.
비유하면 주식은 내가 노래 한 곡을 직접 고르는 것과 비슷하다. 펀드는 누군가 만들어둔 플레이리스트에 가입하는 것과 비슷하다. ETF는 특정 기준으로 자동 구성되는 인기 차트나 장르별 차트를 사는 것과 비슷하다. 차트 안의 곡은 기준에 따라 바뀌고, 나는 그 차트 전체의 흐름에 투자하는 셈이다.
ETF의 장점 &nbsp; ETF가 많이 활용되는 이유는 분명하다. 적은 돈으로 분산 투자할 수 있고, 거래가 편하며, 비용이 비교적 낮은 편이다. 다만 장점이 투자 성공을 보장한다는 뜻은 아니다. 장점은 어디까지나 상품 구조상의 편의성으로 봐야 한다.
적은 돈으로 분산 투자할 수 있다 &nbsp; ETF의 가장 큰 장점은 분산 투자다. 개별 주식 한 종목만 사면 그 기업의 실적과 이슈에 내 돈이 크게 흔들린다. 하지만 ETF 하나를 사면 여러 종목에 나눠 투자하는 효과를 얻을 수 있다.
예를 들어 코스피 200 ETF를 사면 코스피 대표 기업 200개에 넓게 투자하는 효과가 있다. S&amp;P 500 ETF를 사면 미국 대형주 500개 기업에 나눠 투자하는 효과가 있다. 투자금이 크지 않아도 시장 전체에 접근할 수 있는 것이 ETF의 강점이다.
초보 투자자에게 분산 투자는 특히 중요하다. 처음부터 좋은 기업을 정확히 고르는 일은 쉽지 않다. ETF를 활용하면 특정 기업을 맞히는 부담을 줄이고, 시장이나 산업의 큰 흐름에 투자할 수 있다.
다양한 자산에 투자할 수 있다 &nbsp; ETF는 주식만 담는 상품이 아니다. 채권 ETF, 금 ETF, 원유 ETF, 리츠 ETF, 배당 ETF, 테마 ETF처럼 종류가 다양하다. 국내 주식, 미국 주식, 신흥국 주식, 장기채, 단기채 같은 선택지도 있다.
이 장점은 포트폴리오를 만들 때 유용하다. 예를 들어 공격적으로 투자하고 싶다면 주식형 ETF 비중을 높일 수 있고, 변동성을 낮추고 싶다면 채권형 ETF나 현금성 ETF를 함께 고려할 수 있다.
물론 종류가 많다는 것은 그만큼 헷갈릴 수 있다는 뜻이기도 하다. 이름만 보고 투자하기보다 어떤 지수나 자산을 추종하는지, 어떤 종목이 들어 있는지 확인해야 한다.
일반 펀드보다 비용이 낮은 편이다 &nbsp; ETF는 일반적으로 운용 보수가 낮은 편이다. 특히 특정 지수를 그대로 따라가는 패시브 ETF는 사람이 계속 종목을 고르고 바꾸는 액티브 펀드보다 비용 부담이 작을 수 있다.
투자에서 비용은 생각보다 중요하다. 1년 보수 차이는 작아 보여도 장기 투자에서는 누적 차이가 커질 수 있다. 같은 지수를 추종하는 ETF라도 총보수, 기타 비용, 매매 수수료를 비교해보는 습관이 필요하다.
다만 &ldquo;ETF는 무조건 싸다&quot;라고 생각하면 안 된다. 테마형 ETF, 액티브 ETF, 해외 상장 ETF, 레버리지 ETF는 비용 구조가 다를 수 있다. 상품 설명서에서 총보수와 기타 비용을 확인하는 것이 좋다.
주식처럼 빠르게 사고팔 수 있다 &nbsp; ETF는 거래소에서 실시간으로 거래된다. 장중 가격을 보면서 원하는 가격에 매수·매도 주문을 넣을 수 있다. 일반 펀드처럼 환매에 며칠씩 걸리는 구조와 다르다.
이런 유동성은 투자자에게 편리함을 준다. 시장 상황이 바뀌었을 때 빠르게 비중을 조절할 수 있고, 현금이 필요할 때 매도 절차도 비교적 간단하다.
하지만 이 편리함이 단점으로 바뀔 수도 있다. 너무 쉽게 사고팔 수 있다 보니 장기 투자하려고 산 ETF를 단기 시세에 흔들려 자주 매매하게 될 수 있다. ETF는 거래가 편한 상품이지, 자주 매매해야 하는 상품은 아니다.
보유 자산을 비교적 투명하게 확인할 수 있다 &nbsp; ETF는 보유 종목과 비중이 비교적 투명하게 공개된다. ETF 운용사나 거래소 자료를 보면 이 ETF가 어떤 자산을 얼마나 담고 있는지 확인할 수 있다.
초보 투자자에게는 이 점이 중요하다. 이름은 비슷한 ETF라도 실제 구성 종목과 비중은 다를 수 있다. 예를 들어 같은 미국 기술주 ETF처럼 보여도 어떤 상품은 대형주 중심이고, 어떤 상품은 특정 산업에 더 집중되어 있을 수 있다.
ETF를 고를 때는 이름보다 구성 종목을 보는 것이 좋다. 내가 실제로 무엇을 사는지 알아야 시장이 흔들릴 때도 판단할 수 있다.
ETF의 단점과 주의할 점 &nbsp; ETF는 편리하지만 원금이 보장되는 상품은 아니다. 구조를 모르고 투자하면 개별 주식보다 덜 위험하다고 착각하기 쉽다. ETF도 가격이 내려갈 수 있고, 상품에 따라 위험도 차이가 크다.
원금 손실이 생길 수 있다 &nbsp; ETF는 투자 상품이기 때문에 원금이 보장되지 않는다. ETF가 담고 있는 주식, 채권, 원자재 가격이 하락하면 ETF 가격도 내려갈 수 있다.
특히 주식형 ETF는 시장 전체가 하락할 때 함께 떨어진다. S&amp;P 500 ETF나 코스피 200 ETF처럼 대표 지수를 따라가는 상품도 하락장에서 손실을 피할 수는 없다. 분산 투자는 위험을 줄이는 데 도움이 되지만, 손실 자체를 없애주지는 않는다.
추적 오차가 생길 수 있다 &nbsp; ETF는 특정 지수의 움직임을 따라가도록 만들어졌지만, 실제 수익률이 지수와 완전히 같지는 않을 수 있다. 이 차이를 추적 오차라고 한다.
추적 오차는 운용 보수, 거래 비용, 현금 보유, 리밸런싱, 복제 방식 등 여러 이유로 생긴다. 일반적인 지수형 ETF에서는 추적 오차가 크지 않은 경우가 많지만, 운용 규모가 작거나 구조가 복잡한 ETF에서는 더 눈여겨봐야 한다.
ETF를 볼 때는 단순히 최근 수익률만 보지 말고, 기초지수와 얼마나 비슷하게 움직였는지도 확인하는 것이 좋다.
상장폐지 위험이 있다 &nbsp; ETF도 거래소에 상장된 상품이기 때문에 상장폐지될 수 있다. 보통 운용 규모가 너무 작거나 거래가 거의 없거나 상품 유지 요건을 충족하지 못할 때 문제가 생길 수 있다.
ETF가 상장폐지된다고 해서 곧바로 모든 돈이 사라지는 것은 아니다. 일반적으로 보유 자산을 정리해 투자자에게 돌려주는 절차가 있다. 하지만 내가 원하는 시점에 팔지 못하거나, 손실 상태에서 정리될 수 있다는 점은 부담이다.
그래서 ETF를 고를 때는 운용 규모와 거래량을 함께 보는 것이 좋다. 너무 작은 ETF는 매매가 불편하고, 매수·매도 가격 차이도 커질 수 있다.
테마형 ETF는 변동성이 클 수 있다 &nbsp; ETF라고 해서 모두 안정적인 것은 아니다. 반도체, 2차전지, 인공지능, 바이오, 로봇 같은 테마형 ETF는 특정 산업에 집중 투자한다. 해당 산업이 좋을 때는 빠르게 오를 수 있지만, 반대로 기대가 꺾이면 하락도 클 수 있다.
테마형 ETF는 여러 종목을 담고 있어도 같은 산업 안에서 움직이는 경우가 많다. 겉으로는 분산 투자처럼 보이지만 실제로는 특정 테마에 집중 투자하는 셈이다.
초보자라면 테마형 ETF를 포트폴리오의 중심으로 두기보다 보조 비중으로 접근하는 편이 더 현실적이다.
레버리지와 인버스 ETF는 구조를 모르면 위험하다 &nbsp; 레버리지 ETF는 기초지수의 하루 수익률을 2배 또는 3배로 추종하려는 상품이다. 인버스 ETF는 기초지수가 내려갈 때 수익을 내도록 설계된 상품이다.
문제는 이 상품들이 장기 수익률을 단순히 2배, 3배로 만들어주는 구조가 아니라는 점이다. 대부분 &ldquo;하루 수익률&quot;을 기준으로 움직이기 때문에 변동성이 큰 시장에서는 예상과 다른 결과가 나올 수 있다.
레버리지와 인버스 ETF는 단기 매매 성격이 강하고, 초보자가 장기 보유용으로 접근하기에는 위험하다. ETF라는 이름만 보고 일반 지수형 ETF와 같은 수준으로 생각하면 안 된다.
ETF, 주식, 펀드 차이 한눈에 보기 &nbsp; ETF를 제대로 이해하려면 주식, 펀드와 나란히 비교해보는 것이 가장 쉽다.
구분 ETF 주식 펀드 투자 대상 지수, 산업, 자산군 등 여러 자산 개별 기업 여러 자산으로 구성된 포트폴리오 거래 방식 거래소에서 실시간 매매 거래소에서 실시간 매매 기준가로 매수·환매 운용 방식 지수 추종 또는 운용사 전략 투자자가 직접 기업 선택 운용사가 대신 운용 분산 투자 가능 직접 여러 종목을 사야 가능 가능 비용 일반 펀드보다 낮은 편 증권사 매매 수수료 중심 운용 보수와 수수료 발생 가격 확인 장중 실시간 확인 가능 장중 실시간 확인 가능 기준가 중심 적합한 경우 시장·산업 전체에 투자하고 싶을 때 특정 기업을 직접 고르고 싶을 때 직접 운용보다 맡기는 방식을 선호할 때 주식은 내가 기업을 직접 고르는 투자다. 펀드는 전문가에게 운용을 맡기는 투자다. ETF는 시장이나 자산군을 골라 주식처럼 거래하는 투자다.
그래서 초보자에게 ETF는 좋은 출발점이 될 수 있다. 특정 기업 하나를 고르는 부담을 줄이면서도, 펀드보다 직접 관리하기 쉽기 때문이다. 하지만 ETF도 결국 투자 상품이므로 가격 변동과 손실 가능성을 받아들일 수 있어야 한다.
ETF 투자 전 확인할 것 &nbsp; ETF를 고를 때는 수익률 순위만 보면 안 된다. 최근에 많이 오른 ETF는 이미 기대가 가격에 반영되어 있을 수 있고, 변동성도 클 수 있다. 적어도 아래 항목은 확인하는 것이 좋다.
어떤 지수나 자산을 추종하는가? &nbsp; ETF 이름만 보고 투자하면 위험하다. &ldquo;미국&rdquo;, &ldquo;성장&rdquo;, &ldquo;배당&rdquo;, &ldquo;테크&rdquo; 같은 단어가 들어가 있어도 실제 구성은 다를 수 있다. 이 ETF가 어떤 지수를 따라가는지, 어떤 자산을 담는지 먼저 봐야 한다.
예를 들어 미국 ETF라고 해도 S&amp;P 500, 나스닥 100, 다우존스, 배당성장주, 장기채, 리츠 등 성격이 완전히 다르다. 같은 미국 투자라도 위험도와 기대 수익률은 달라진다.
운용 규모와 거래량은 충분한가? &nbsp; 운용 규모가 크고 거래량이 많은 ETF는 매매가 비교적 수월하다. 반대로 규모가 작고 거래량이 적은 ETF는 원하는 가격에 사고팔기 어려울 수 있다.
초보자라면 같은 지수를 추종하는 ETF 중에서 운용 규모가 크고 거래가 활발한 상품을 먼저 비교하는 것이 좋다. 너무 작은 상품은 상장폐지 가능성도 함께 봐야 한다.
총보수와 기타 비용은 얼마인가? &nbsp; ETF 비용은 장기 수익률에 영향을 준다. 같은 지수를 추종한다면 비용이 낮은 ETF가 유리할 가능성이 크다. 다만 비용만 보고 고르면 안 되고, 추적 오차, 거래량, 운용 안정성도 함께 봐야 한다.
특히 해외 ETF나 테마형 ETF는 비용 구조가 다를 수 있다. 증권사 앱의 간단한 정보만 보지 말고 운용사 상품 설명도 함께 확인하는 것이 좋다.
내 투자 기간과 맞는가? &nbsp; ETF마다 어울리는 투자 기간이 다르다. 대표 지수형 ETF는 장기 투자에 자주 활용되지만, 레버리지·인버스 ETF나 일부 원자재 ETF는 단기 변동성이 매우 클 수 있다.
&ldquo;남들이 많이 산다&quot;보다 중요한 것은 내 투자 목적이다. 노후 준비인지, 중기 목돈 마련인지, 단기 매매인지에 따라 골라야 할 ETF가 달라진다.
정리 &nbsp; ETF는 펀드의 분산 투자 장점과 주식의 거래 편의성을 함께 가진 상품이다. 하나의 ETF로 여러 기업이나 자산에 투자할 수 있고, 증권사 앱에서 실시간으로 사고팔 수 있다. 그래서 초보 투자자도 시장 전체나 특정 산업에 접근하기 좋은 도구가 될 수 있다.
하지만 ETF도 원금이 보장되는 상품은 아니다. 지수형 ETF, 테마형 ETF, 채권형 ETF, 레버리지 ETF는 위험도와 구조가 모두 다르다. ETF라는 이름 하나로 안전하다고 판단하면 안 된다.
ETF를 처음 시작한다면 먼저 넓은 시장을 추종하는 대표 지수형 ETF부터 이해하는 것이 좋다. 그다음 운용 규모, 거래량, 비용, 구성 종목, 추적 오차를 차근차근 확인하면 된다. ETF 투자의 핵심은 복잡한 상품을 많이 아는 것이 아니라, 내가 실제로 무엇에 투자하는지 알고 꾸준히 관리하는 것이다.
자주 묻는 질문 &nbsp; ETF는 주식인가? &nbsp; ETF는 주식은 아니지만 주식시장에 상장되어 주식처럼 거래되는 펀드다. 주문 방식은 주식과 비슷하지만, 상품 구조는 여러 자산을 담은 펀드에 가깝다.
ETF는 초보자가 투자해도 괜찮은가? &nbsp; 대표 지수형 ETF처럼 구조가 단순한 상품은 초보자가 투자 공부를 시작하기에 좋은 편이다. 다만 원금 손실 가능성이 있고, 테마형·레버리지·인버스 ETF는 위험이 크므로 구조를 이해한 뒤 접근해야 한다.
ETF와 펀드의 가장 큰 차이는 무엇인가? &nbsp; ETF는 거래소에서 실시간으로 사고팔 수 있고, 일반 펀드는 보통 기준가로 매수·환매한다. 또 ETF는 보유 종목을 비교적 투명하게 확인할 수 있고, 일반 펀드보다 비용이 낮은 경우가 많다.
ETF도 상장폐지될 수 있나? &nbsp; ETF도 상장폐지될 수 있다. 운용 규모가 너무 작거나 거래가 부족한 상품은 주의해야 한다. 상장폐지된다고 투자금이 바로 사라지는 것은 아니지만, 원하지 않는 시점에 정리될 수 있다.
ETF 하나만 사도 분산 투자가 되는가? &nbsp; ETF 종류에 따라 다르다. S&amp;P 500 ETF처럼 넓은 시장을 담은 ETF는 분산 효과가 크지만, 특정 테마 ETF는 여러 종목을 담고 있어도 같은 산업에 집중되어 있을 수 있다. ETF의 구성 종목과 비중을 확인해야 한다.`}).add({id:15,href:"/posts/etf-tax-guide/",title:"ETF 세금 총정리",description:"국내 주식형 ETF, 국내 상장 해외 ETF, 해외 상장 ETF의 매매차익과 분배금 세금을 2026년 기준으로 쉽게 비교했다.",content:`ETF는 주식처럼 사고팔 수 있어서 세금도 주식과 똑같다고 생각하기 쉽다. 그런데 실제로는 그렇지 않다. 국내 증시에 상장된 ETF인지, 해외 거래소에 직접 상장된 ETF인지, 또 ETF가 국내 주식에 투자하는지 해외 주식에 투자하는지에 따라 세금이 달라진다.
...
ETF를 고를 때 수익률이 가장 중요한가? &nbsp; 최근 수익률만 보는 것은 위험하다. ETF를 고를 때는 추종 지수, 구성 종목, 총보수, 순자산 규모, 거래량, 환헤지 여부를 함께 확인해야 한다. 수익률은 그 결과를 보여주는 지표일 뿐, 상품의 구조를 대신 설명해주지는 않는다.`}).add({id:17,href:"/posts/etf-types-guide/",title:"ETF 종류 총정리",description:"ETF 종류를 지수형, 섹터형, 테마형, 채권형, 원자재, 리츠, 배당형, 환헤지, 레버리지·인버스 ETF까지 초보자 기준으로 정리했다.",content:`ETF를 처음 알게 되면 &ldquo;S&amp;P 500 ETF 하나 사면 되는 것 아닌가?&ldquo;라고 생각하기 쉽다. 그런데 막상 증권사 앱에서 ETF를 검색해보면 종류가 너무 많다. 지수형, 섹터형, 테마형, 채권형, 배당형, 환헤지, 레버리지, 인버스 같은 말이 한꺼번에 나오니 어떤 상품을 골라야 할지 헷갈린다.
...
ETF 종류를 먼저 나눠서 봐야 하는 이유 &nbsp; ETF는 한 가지 상품군처럼 보이지만 실제로는 위험도와 투자 목적이 크게 다르다. S&amp;P 500 ETF, 반도체 ETF, 금 ETF, 장기채 ETF, 인버스 ETF는 모두 ETF라는 이름을 달고 있지만 움직이는 방식은 전혀 다르다.
...
ETF를 고를 때는 &ldquo;요즘 수익률이 좋다&quot;보다 먼저 아래 질문을 던져야 한다.
질문 확인할 내용 무엇에 투자하는가? 주식, 채권, 원자재, 리츠, 가상자산 등 얼마나 넓게 분산되는가? 시장 전체인지, 특정 산업이나 테마인지 환율 영향을 받는가? 환노출인지, 환헤지인지 구조가 단순한가? 일반 지수형인지, 레버리지·인버스인지 투자 기간과 맞는가? 장기 투자용인지, 단기 대응용인지 ETF는 종류를 구분하는 순간 이해가 쉬워진다. 이름이 어려워 보여도 결국 &ldquo;무엇을 담고, 어떤 방향으로, 어떤 강도로 움직이는가&quot;를 확인하면 된다.
대표적인 ETF 종류 &nbsp; ETF는 투자 대상과 전략에 따라 여러 유형으로 나눌 수 있다. 아래 표는 초보자가 가장 많이 접하는 ETF 종류를 정리한 것이다.
ETF 유형 설명 주요 특징 지수형 ETF S&amp;P 500, 나스닥 100, 코스피 200 같은 시장 지수를 추종 분산 투자 효과가 크고 장기 투자에 자주 활용 섹터형 ETF 반도체, 자동차, IT, 금융, 헬스케어 같은 업종에 투자 특정 산업 성장에 집중하지만 변동성도 커질 수 있음 테마형 ETF 인공지능, 2차전지, 로봇, 고령화, 친환경 같은 테마에 투자 트렌드에 민감하고 단기 수급 영향을 많이 받을 수 있음 채권형 ETF 국채, 회사채, 단기채, 장기채 등 채권 지수를 추종 이자 수익과 안정성을 기대하지만 금리 변화에 영향 원자재 ETF 금, 은, 원유, 구리 같은 원자재 가격에 투자 물가, 경기, 수급에 민감하고 가격 변동이 클 수 있음 부동산·리츠 ETF 리츠나 부동산 관련 자산에 투자 소액으로 부동산에 간접 투자하고 배당을 기대 배당형 ETF 배당을 많이 주거나 꾸준히 늘린 기업에 투자 현금흐름을 중시하지만 성장성은 제한될 수 있음 가상자산 ETF 비트코인 등 가상자산 관련 가격을 추종 변동성이 매우 크고 제도 변화에 민감 레버리지·인버스 ETF 기초지수의 2배 수익률 또는 반대 방향 수익률을 추구 고위험 상품이고 보통 단기 대응 성격이 강함 ETF를 처음 시작한다면 지수형 ETF를 먼저 이해하는 것이 좋다. 구조가 비교적 단순하고, 시장 전체에 분산 투자하는 효과를 얻기 쉽기 때문이다. 이후 투자 목적에 따라 섹터형, 배당형, 채권형 ETF를 살펴보는 식으로 범위를 넓히면 된다.
지수형 ETF &nbsp; 지수형 ETF는 가장 기본적인 ETF다. 특정 시장 지수를 따라가도록 만들어진 상품이다. 코스피 200 ETF, S&amp;P 500 ETF, 나스닥 100 ETF가 대표적이다.
...
섹터형 ETF와 테마형 ETF &nbsp; 섹터형 ETF는 특정 업종에 투자한다. 반도체, 자동차, 금융, 헬스케어, 소비재, IT 같은 산업 단위로 묶인다. 예를 들어 반도체 ETF는 반도체 장비, 메모리, 파운드리, 설계 기업 등을 담을 수 있다.
...
채권형 ETF &nbsp; 채권형 ETF는 국채, 회사채, 단기채, 장기채 같은 채권에 투자하는 ETF다. 채권은 주식보다 안정적인 자산으로 여겨지지만, 채권형 ETF도 가격 변동이 있다.
채권 ETF에서 중요한 것은 금리다. 일반적으로 금리가 내려가면 기존 채권의 매력이 커져 채권 가격이 오를 수 있고, 금리가 오르면 채권 가격이 내려갈 수 있다. 특히 장기채 ETF는 금리 변화에 더 크게 흔들릴 수 있다.
채권형 ETF는 현금흐름을 만들거나 포트폴리오 변동성을 낮추는 용도로 활용할 수 있다. 하지만 &ldquo;채권이니까 무조건 안전하다&quot;라고 보면 안 된다. 어떤 채권을 담는지, 만기가 긴지 짧은지, 신용등급은 어떤지 확인해야 한다.
원자재 ETF &nbsp; 원자재 ETF는 금, 은, 원유, 구리 같은 원자재 가격에 투자하는 상품이다. 금 ETF는 안전자산 성격으로 관심을 받는 경우가 많고, 원유 ETF는 국제유가 흐름에 민감하게 움직인다.
원자재 ETF는 주식과 다른 흐름을 보일 수 있어 분산 투자 수단으로 활용되기도 한다. 하지만 원자재 가격은 경기, 전쟁, 공급망, 환율, 정책, 재고 상황에 따라 크게 움직일 수 있다.
특히 원유처럼 선물 구조가 들어간 ETF는 실제 유가 흐름과 ETF 수익률이 다르게 나타날 수 있다. 원자재 ETF는 단순히 &ldquo;가격이 오를 것 같다&quot;만 보고 접근하기보다 상품 구조를 더 꼼꼼히 봐야 한다.
부동산·리츠 ETF &nbsp; 부동산·리츠 ETF는 리츠(REITs)나 부동산 관련 기업에 투자한다. 리츠는 투자자 돈을 모아 오피스, 물류센터, 상업시설, 호텔 같은 부동산에 투자하고 임대수익 등을 배당하는 구조다.
...
배당형 ETF &nbsp; 배당형 ETF는 배당수익률이 높거나 배당을 꾸준히 늘려온 기업에 투자하는 ETF다. 월배당 ETF, 고배당 ETF, 배당성장 ETF 같은 이름으로 많이 보인다.
...
가상자산 ETF &nbsp; 가상자산 ETF는 비트코인 같은 가상자산 가격을 기초로 움직이는 ETF다. 현물 ETF는 실제 가상자산 가격을 직접적으로 추종하려 하고, 선물 ETF는 선물계약을 통해 가격 흐름을 따라간다.
...
환헤지 ETF와 환노출 ETF 차이 &nbsp; 해외 ETF에 투자하면 기초자산 가격뿐 아니라 환율도 수익률에 영향을 준다. 예를 들어 미국 주식 ETF에 투자할 때 미국 주식이 올라도 원·달러 환율이 크게 내려가면 원화 기준 수익률은 줄어들 수 있다. 반대로 미국 주식이 조금만 올라도 달러 가치가 함께 오르면 원화 수익률은 더 좋아질 수 있다.
이 환율 영향을 그대로 받는 상품이 환노출 ETF이고, 환율 영향을 줄이려는 상품이 환헤지 ETF다.
구분 의미 특징 환노출 ETF 기초자산 가격과 환율 변동이 함께 반영 외화 가치가 오르면 유리할 수 있지만, 외화 가치가 내리면 불리할 수 있음 환헤지 ETF 환율 변동 영향을 줄이도록 설계 기초자산 가격 흐름에 더 집중하지만 헤지 비용이 발생할 수 있음 환헤지 ETF는 보통 상품명에 (H) 또는 Hedged 표기가 붙는 경우가 많다. 환노출 ETF는 별도 표시가 없거나 UH, Unhedged로 표시되기도 한다. 다만 표기 방식은 운용사와 상품마다 다를 수 있으므로 상품 설명을 확인해야 한다.
...
레버리지 ETF와 인버스 ETF는 특히 조심해야 한다 &nbsp; 레버리지 ETF와 인버스 ETF는 일반 ETF와 다르게 단기 매매 성격이 강한 상품이다. ETF라는 이름은 같지만 장기 적립식 투자용 대표 지수 ETF와 같은 방식으로 보면 안 된다.
레버리지 ETF란 무엇인가? &nbsp; 레버리지 ETF는 기초지수의 하루 수익률을 2배 또는 3배로 추종하려는 상품이다. 예를 들어 코스피 200이 하루 1% 오르면 2배 레버리지 ETF는 약 2% 상승을 목표로 한다. 반대로 코스피 200이 하루 1% 하락하면 약 2% 하락할 수 있다.
기초지수 하루 수익률 +1% → 2배 레버리지 ETF 목표 수익률 약 +2% 기초지수 하루 수익률 -1% → 2배 레버리지 ETF 목표 수익률 약 -2%레버리지 ETF는 상승 방향을 맞히면 수익이 빠르게 커질 수 있다. 하지만 하락 방향으로 움직이면 손실도 빠르게 커진다. 특히 변동성이 큰 시장에서는 짧은 기간에도 손실 폭이 커질 수 있다.
인버스 ETF란 무엇인가? &nbsp; 인버스 ETF는 기초지수와 반대로 움직이도록 설계된 상품이다. 기초지수가 하락하면 수익을 내고, 기초지수가 상승하면 손실을 보는 구조다. 흔히 시장 하락에 대비하거나 단기 하락을 예상할 때 사용한다.
...
레버리지·인버스 ETF의 핵심은 &ldquo;하루 수익률&quot;이다 &nbsp; 레버리지와 인버스 ETF에서 가장 중요한 단어는 &ldquo;하루&quot;다. 많은 상품이 장기간 누적 수익률의 2배나 -1배를 보장하는 것이 아니라, 하루 단위 수익률을 목표로 움직인다.
...
따라서 레버리지·인버스 ETF는 구조를 이해하고 단기 전략으로 접근해야 한다. 초보자가 &ldquo;남들이 많이 산다&quot;는 이유로 장기 보유하면 생각보다 큰 손실을 볼 수 있다.
ETF 종류별로 어떻게 고르면 좋을까? &nbsp; ETF를 고를 때는 먼저 투자 목적을 정해야 한다. 목적이 없으면 최근 수익률이 높은 ETF만 따라가게 되고, 그러면 이미 많이 오른 상품을 뒤늦게 사는 실수를 하기 쉽다.
...
정리 &nbsp; ETF는 종류에 따라 성격이 크게 달라진다. 지수형 ETF는 시장 전체에 분산 투자하는 기본형에 가깝고, 섹터형·테마형 ETF는 특정 산업이나 트렌드에 더 집중한다. 채권형 ETF는 금리 변화에 영향을 받고, 원자재 ETF는 원자재 가격과 수급에 민감하다. 리츠 ETF와 배당형 ETF는 현금흐름을 기대할 수 있지만 원금 손실 가능성은 여전히 있다.
...
자주 묻는 질문 &nbsp; 채권형 ETF는 안전한 상품인가? &nbsp; 채권형 ETF는 주식형 ETF보다 변동성이 낮은 경우가 많지만 무조건 안전한 상품은 아니다. 금리가 오르면 채권 가격이 내려갈 수 있고, 장기채 ETF는 금리 변화에 더 크게 흔들릴 수 있다.
환헤지 ETF에서 H는 무슨 뜻인가? &nbsp; ETF 이름에 붙는 H는 보통 Hedged, 즉 환헤지를 의미한다. 환율 변동 영향을 줄이도록 설계된 상품이라는 뜻이다. 다만 상품마다 헤지 방식과 비용이 다르므로 설명서를 확인해야 한다.
환헤지 ETF가 환노출 ETF보다 항상 좋은가? &nbsp; 항상 좋은 것은 아니다. 달러 가치가 오르면 환노출 ETF가 더 유리할 수 있고, 달러 가치가 내려가면 환헤지 ETF가 유리할 수 있다. 환헤지에는 비용도 발생할 수 있다.
레버리지 ETF는 장기 투자해도 되나? &nbsp; 레버리지 ETF는 일반적으로 장기 투자보다 단기 대응 성격이 강하다. 하루 수익률을 2배 또는 3배로 추종하는 구조가 많아, 등락이 반복되는 시장에서는 장기 수익률이 기대와 다르게 나올 수 있다.
인버스 ETF는 언제 수익이 나나? &nbsp; 인버스 ETF는 기초지수가 하락할 때 수익이 나도록 설계된 상품이다. 반대로 시장이 상승하면 손실이 발생할 수 있다. 시장 방향을 맞히는 것이 쉽지 않기 때문에 고위험 상품으로 봐야 한다.
비트코인 ETF는 직접 비트코인을 사는 것과 같은가? &nbsp; 완전히 같지는 않다. 현물 비트코인 ETF는 비트코인 가격을 직접적으로 추종하려는 상품이고, 선물 비트코인 ETF는 선물계약을 통해 가격을 따라간다. 직접 보유와 세금, 거래 방식, 추적 구조가 다를 수 있다.`}).add({id:18,href:"/posts/hbm-ai-semiconductor-memory/",title:"HBM이란? AI 반도체와 SK하이닉스 삼성전자 주가가...",description:"HBM이 무엇인지, AI 반도체에서 왜 중요한지, SK하이닉스와 삼성전자 주가가 HBM 기대감에 움직인 이유를 초보자도 이해하기 쉽게 정리했다.",content:`요즘 주식을 공부하다 보면 반도체, AI, 엔비디아, HBM이라는 단어가 계속 나온다. 처음에는 모두 따로 노는 말처럼 보이지만, 실제로는 하나의 흐름으로 연결되어 있다. AI 서비스를 돌리려면 고성능 반도체가 필요하고, 그 반도체가 제 성능을 내려면 데이터를 아주 빠르게 주고받는 메모리가 필요하다. 여기서 등장하는 핵심 부품이 HBM이다.
...
엔비디아가 잘되면 HBM 기업도 무조건 좋은가? &nbsp; 엔비디아 AI 칩 판매가 늘면 HBM 수요에도 긍정적일 가능성이 크다. 다만 어떤 기업이 실제로 공급 계약을 따내는지, 제품 승인을 받았는지, 충분한 물량을 안정적으로 생산할 수 있는지가 더 중요하다.`}).add({id:19,href:"/docs/irp/",title:"IRP",description:"근로자인 개인이 직접 가입하고 관리하는 퇴직연금 계좌",content:""}).add({id:20,href:"/posts/irp-account-retirement-pay/",title:"IRP 계좌 개설 퇴직금 수령",description:"IRP 계좌의 뜻, 가입 대상, 퇴직금 수령 방법, 일시금과 연금 수령 차이, 세액공제와 과세이연 혜택까지 초보자도 이해하기 쉽게 정리했다.",content:`퇴직을 앞두거나 이직을 준비하다 보면 갑자기 IRP 계좌를 만들라는 말을 듣게 된다. 평소에는 잘 쓰지 않던 금융 용어라서 &ldquo;퇴직금을 그냥 내 통장으로 받으면 되는 것 아닌가?&ldquo;라는 생각이 들 수 있다.
...
IRP 계좌란 무엇인가? &nbsp; IRP는 Individual Retirement Pension의 줄임말이고, 우리말로는 개인형 퇴직연금이라고 부른다. 쉽게 말하면 개인이 직접 관리하는 노후 자금 계좌다.
IRP에는 크게 두 가지 역할이 있다. 하나는 회사에서 받은 퇴직금을 넣어두는 역할이고, 다른 하나는 내가 추가로 돈을 넣어 노후 자금을 준비하는 역할이다.
구분 설명 퇴직금 수령용 IRP 퇴직금이나 중간정산 퇴직금을 받기 위해 사용하는 계좌 적립용 IRP 본인이 추가 납입해서 세액공제와 노후 준비에 활용하는 계좌 일반 입출금 통장은 돈을 넣고 빼는 데 초점이 있다. IRP는 노후 자금 관리에 초점이 있다. 그래서 세제 혜택이 있는 대신, 중도 인출이나 해지에는 제한과 세금 부담이 붙을 수 있다.
IRP를 &ldquo;퇴직금을 받기 위해 잠깐 만드는 계좌&quot;로만 생각하면 아쉽다. 퇴직금을 그냥 찾을 수도 있지만, 상황에 따라 연금으로 나누어 받으면 세금 부담을 줄일 수 있다. 또 여유 자금이 있다면 연말정산 세액공제를 받는 절세 계좌로도 활용할 수 있다.
퇴직금은 왜 IRP로 받아야 할까? &nbsp; 2022년 4월 14일 이후에는 퇴직급여 제도 종류와 관계없이 많은 근로자가 퇴직금을 IRP 계좌로 받는 구조가 되었다. 회사에서 퇴직금을 바로 월급 통장으로 넣어주는 방식이 아니라, 퇴직연금 계좌를 통해 받게 만든 것이다.
다만 모든 경우에 무조건 IRP로 받아야 하는 것은 아니다. 일반적으로 다음과 같은 경우에는 예외가 될 수 있다.
예외 상황 설명 만 55세 이후 퇴직 연금 수령 가능 나이에 가까워져 일반 계좌 수령이 가능한 경우가 있다 퇴직급여 300만 원 이하 소액 퇴직급여는 IRP 이전 예외가 될 수 있다 퇴직금을 IRP로 받는 이유는 단순히 절차를 복잡하게 하려는 것이 아니다. 퇴직금을 한 번에 소비하지 않고, 노후 자금으로 이어갈 수 있게 만드는 목적이 크다.
...
IRP 계좌 개설 대상과 준비할 서류 &nbsp; IRP는 소득이 있는 사람이라면 가입할 수 있는 범위가 넓다. 직장인만 가능한 계좌라고 생각하기 쉽지만, 자영업자, 프리랜서, 공무원, 군인, 교직원 등도 조건을 충족하면 가입할 수 있다.
퇴직금을 받기 위한 IRP라면 보통 신분증만으로 개설이 가능한 경우가 많다. 반면 세액공제와 노후 준비를 위해 추가 납입까지 하는 적립용 IRP는 가입 유형에 따라 소득이나 재직 사실을 확인하는 서류가 필요할 수 있다.
가입 유형 준비 서류 예시 퇴직금을 받을 근로자 신분증 퇴직연금 가입 근로자 재직증명서, 근로소득원천징수영수증, 건강보험자격득실확인서 등 개인사업자 사업자등록증, 소득금액증명원, 사업소득 원천징수 관련 서류 등 공무원·군인·교직원 등 재직증명서, 근로계약서, 원천징수영수증 등 실제 필요 서류는 금융회사와 가입 유형에 따라 달라질 수 있다. 비대면 앱으로 바로 가능한 경우도 있고, 추가 확인이 필요해 영업점 방문이 편한 경우도 있다.
계좌를 만들 때는 &ldquo;퇴직금만 받고 해지할 계좌인지&rdquo;, &ldquo;앞으로 세액공제까지 받을 계좌인지&quot;를 먼저 생각하는 것이 좋다. 목적에 따라 수수료, 운용 상품, 앱 사용 편의성, 투자 상품 종류를 보는 기준이 달라진다.
퇴직금은 일시금과 연금 중 어떻게 받을까? &nbsp; IRP로 들어온 퇴직금은 크게 일시금으로 찾거나 연금으로 나눠 받을 수 있다. 여기서 세금 차이가 생긴다.
일시금으로 받는 경우 &nbsp; 당장 목돈이 필요하다면 IRP를 해지하고 퇴직금을 한 번에 받을 수 있다. 주택 구입, 대출 상환, 생활비 공백처럼 급한 사정이 있다면 일시금 수령이 현실적인 선택일 수 있다.
...
연금으로 받는 경우 &nbsp; 만 55세 이후 조건을 갖춰 연금으로 나눠 받으면 세금 부담을 줄일 수 있다. 퇴직금을 연금으로 받으면 일시금으로 받을 때보다 퇴직소득세를 줄일 수 있고, 운용수익에도 비교적 낮은 연금소득세가 적용될 수 있다.
연금 수령은 당장 큰돈이 필요한 사람에게는 답답할 수 있다. 하지만 은퇴 이후 매달 생활비를 만드는 목적이라면 일시금보다 안정적이다. 특히 퇴직금을 한 번에 받아 소비할 위험이 걱정된다면 연금 수령을 검토할 만하다.
수령 방식 장점 주의할 점 일시금 목돈을 바로 사용할 수 있다 세금 부담이 커질 수 있고 노후 자금이 빨리 줄 수 있다 연금 세금 부담을 줄이고 생활비 흐름을 만들 수 있다 장기간 나눠 받아야 하므로 당장 쓸 돈이 부족할 수 있다 결국 답은 하나로 정해져 있지 않다. 대출이 많고 현금흐름이 급하면 일시금이 필요할 수 있고, 은퇴 후 생활비가 걱정된다면 연금 수령이 더 나을 수 있다.
IRP의 핵심 혜택은 세액공제와 과세이연이다 &nbsp; IRP가 단순한 퇴직금 수령 계좌를 넘어 절세 계좌로 불리는 이유는 세제 혜택 때문이다. 핵심은 세액공제와 과세이연이다.
연말정산 세액공제 &nbsp; IRP에 내가 추가로 납입한 금액은 연말정산 때 세액공제 대상이 될 수 있다. 연금저축과 IRP를 합쳐 연간 최대 900만 원까지 세액공제 한도로 볼 수 있다.
구분 내용 연금저축 세액공제 한도 연 600만 원 연금저축 + IRP 합산 한도 연 900만 원 총급여 5,500만 원 이하 공제율 16.5% 총급여 5,500만 원 초과 공제율 13.2% 예를 들어 총급여가 5,500만 원 이하인 사람이 연금저축과 IRP를 합쳐 900만 원을 납입했다면 최대 148만 5,000원의 세액공제 효과를 기대할 수 있다.
900만 원 × 16.5% = 148만 5,000원
총급여가 5,500만 원을 초과하는 경우에는 공제율 13.2%를 적용해 최대 118만 8,000원 수준이다.
900만 원 × 13.2% = 118만 8,000원
여기서 중요한 점은 &ldquo;세액공제액이 곧바로 통장에 들어오는 환급액&quot;이라는 뜻은 아니라는 것이다. 이미 낸 세금, 다른 공제 항목, 결정세액에 따라 실제 환급액은 달라질 수 있다.
과세이연 &nbsp; 과세이연은 지금 당장 낼 세금을 나중으로 미루는 효과다. IRP 안에서 발생한 이자, 배당, 평가차익은 일반 계좌처럼 매번 바로 과세되는 구조가 아니다. 계좌 안에서 재투자되다가 나중에 연금이나 일시금으로 받을 때 과세된다.
이 차이는 장기 투자에서 꽤 중요하다. 세금을 바로 떼지 않고 계좌 안에서 계속 굴릴 수 있으면 복리 효과를 더 오래 활용할 수 있기 때문이다.
물론 세금이 사라지는 것은 아니다. 납입할 때 세액공제를 받았다면 나중에 연금으로 받을 때 연금소득세가 붙고, 중도해지나 연금 외 수령을 하면 기타소득세 부담이 생길 수 있다. 그래서 IRP는 &ldquo;세금을 아예 안 내는 계좌&quot;가 아니라 &ldquo;노후까지 가져갈수록 유리해지는 계좌&quot;라고 이해하는 게 맞다.
IRP에서 운용할 수 있는 상품과 위험자산 한도 &nbsp; IRP 계좌 안에서는 예금 같은 원리금보장형 상품뿐 아니라 펀드, ETF, TDF 같은 투자 상품도 활용할 수 있다. 그래서 투자 성향에 따라 안정적으로 운용할 수도 있고, 장기 수익률을 기대하는 방식으로 구성할 수도 있다.
다만 IRP는 노후 자금 계좌이기 때문에 위험자산 비중에 제한이 있다. 주식형 펀드나 주식 비중이 높은 상품 등 위험자산으로 분류되는 상품은 평가금액의 70% 이내에서 운용하는 것이 일반적이다.
상품 유형 특징 정기예금 원금 안정성을 중시할 때 선택하기 쉽다 펀드·ETF 시장 수익률을 기대할 수 있지만 손실 가능성이 있다 TDF 은퇴 시점에 맞춰 자산 배분이 조정되는 상품이다 채권형·혼합형 상품 주식형보다 변동성을 낮추는 데 활용할 수 있다 처음 IRP를 만들었다면 수익률만 보고 상품을 고르기보다 목적을 먼저 정하는 것이 좋다. 퇴직금을 잠시 보관했다가 곧 찾을 예정이라면 안정성이 중요하고, 10년 이상 가져갈 노후 자금이라면 장기 분산 투자를 검토할 수 있다.
또 하나 볼 것은 수수료다. IRP는 금융회사마다 운용관리수수료, 자산관리수수료, 비대면 가입 수수료 조건이 다를 수 있다. 장기 계좌일수록 작은 수수료 차이도 누적될 수 있으니 계좌 개설 전 확인하는 것이 좋다.
중도해지와 중도인출은 신중해야 한다 &nbsp; IRP는 노후 자금 계좌라서 일반 적금처럼 편하게 꺼내 쓰는 계좌가 아니다. 법에서 인정하는 사유가 있으면 중도인출이 가능할 수 있지만, 아무 때나 원하는 만큼 빼는 구조는 아니다.
...
IRP 계좌를 만들기 전 체크리스트 &nbsp; IRP 계좌는 만들기 자체는 어렵지 않다. 하지만 오래 가져갈 수 있는 계좌라서 처음에 몇 가지를 확인해두면 나중에 덜 헷갈린다.
체크 항목 확인할 내용 목적 퇴직금 수령용인지, 세액공제용인지, 장기 노후 자금용인지 수수료 비대면 가입 수수료, 운용관리수수료, 자산관리수수료 상품 종류 예금, 펀드, ETF, TDF 등 내가 원하는 상품이 있는지 앱 편의성 상품 변경, 수익률 확인, 입금 관리가 쉬운지 중도해지 부담 해지 시 세금과 수수료가 어떻게 되는지 퇴직금을 받을 목적으로 급하게 만들 때는 &ldquo;어디서든 빨리 만들면 되겠지&quot;라고 생각하기 쉽다. 하지만 나중에 세액공제 계좌로도 계속 쓸 수 있다면 금융회사 선택이 중요해진다.
이미 다른 금융회사에 IRP가 있다면 이전 가능 여부도 확인할 수 있다. 다만 상품을 그대로 옮길 수 있는지, 같은 유형인지, 이전 중 해지나 매도 처리가 필요한지에 따라 결과가 달라질 수 있다.
자주 묻는 질문 &nbsp; IRP에 1년에 얼마까지 넣을 수 있나? &nbsp; 개인형 IRP, DC형 개인부담금, 연금저축 등을 합쳐 연간 1,800만 원까지 납입할 수 있다. 다만 세액공제 한도는 연금저축과 IRP를 합쳐 일반적으로 연 900만 원까지로 보면 된다.
IRP만으로 세액공제 한도 900만 원을 채울 수 있나? &nbsp; 가능하다. 연금저축 없이 IRP에만 900만 원을 넣어도 세액공제 한도를 채울 수 있다. 다만 연금저축과 IRP는 운용 가능 상품, 중도인출 조건, 수수료 구조가 다르므로 둘을 비교해서 나눠 넣는 경우도 많다.
퇴직금을 IRP로 받은 뒤 바로 해지해도 되나? &nbsp; 가능한 경우가 많지만 세금과 수수료를 확인해야 한다. 퇴직금을 일시금으로 찾으면 퇴직소득세가 부과되고, 운용수익이나 세액공제 받은 납입금에는 별도 세금이 붙을 수 있다. 당장 목돈이 필요한 상황인지, 연금으로 받을 여지가 있는지 비교하는 것이 좋다.
IRP는 원금 보장이 되나? &nbsp; IRP 계좌 자체가 원금을 보장하는 것은 아니다. 계좌 안에서 어떤 상품을 선택하느냐에 따라 다르다. 정기예금 같은 원리금보장형 상품은 안정성이 높지만, 펀드나 ETF는 시장 상황에 따라 손실이 날 수 있다.
정리 &nbsp; IRP는 퇴직금을 받기 위한 계좌이면서, 노후 자금을 준비하고 세액공제 혜택을 받을 수 있는 절세 계좌다. 퇴직금을 일시금으로 받을지 연금으로 받을지에 따라 세금 부담이 달라지고, 추가 납입을 하면 연말정산에서 세액공제 효과도 기대할 수 있다.
다만 IRP는 아무 돈이나 넣어두는 계좌는 아니다. 중도해지 세금, 인출 제한, 상품 손실 가능성, 수수료를 함께 봐야 한다. 특히 세액공제만 보고 무리하게 납입하면 나중에 현금이 필요할 때 부담이 커질 수 있다.
IRP를 처음 만든다면 먼저 목적을 정하자. 퇴직금을 잠시 받을 계좌인지, 장기 노후 자금 계좌인지, 연말정산 절세 계좌인지에 따라 선택 기준이 달라진다. 그다음 수수료와 상품 구성을 비교하면 훨씬 덜 흔들리는 선택을 할 수 있다.`}).add({id:21,href:"/docs/isa/",title:"ISA",description:"ISA(개인종합자산관리계좌)",content:""}).add({id:22,href:"/posts/isa-account-guide-tax-saving/",title:"ISA 계좌 완벽 정리",description:"ISA 계좌의 뜻, 가입 조건, 신탁형·일임형·중개형 차이, 비과세와 분리과세 혜택, 가입 전 확인할 절세 전략까지 쉽게 정리했다.",content:`ISA 계좌, 이름은 많이 들어봤는데 막상 만들려고 하면 생각보다 헷갈린다. 예금도 된다고 하고, ETF도 된다고 하고, 세금을 줄여준다고 하는데 &ldquo;그래서 내게 진짜 필요한 계좌인가?&ldquo;라는 질문이 먼저 나온다.
...
ROE는 높을수록 무조건 좋은가? &nbsp; ROE가 높으면 수익성이 좋다는 신호일 수 있지만 무조건 좋은 것은 아니다. 부채를 많이 활용했거나 일회성 이익이 반영되면 ROE가 실제보다 좋아 보일 수 있다. 부채비율, 순이익의 지속성, 최근 몇 년간의 흐름을 함께 보는 것이 좋다.`}).add({id:29,href:"/posts/ria-account/",title:"RIA계좌란",description:"RIA 계좌의 뜻, 해외주식 양도소득세 감면 구조, 5천만 원 한도, 1년 유지 조건, 해외주식 추가 매수 시 주의할 점까지 초보자 눈높이로 정리했다.",content:`해외주식에서 수익이 났는데 막상 팔려고 하면 세금이 먼저 떠오른다. 특히 미국 주식이나 해외 ETF를 오래 들고 있다가 평가이익이 커진 사람이라면 &ldquo;팔면 양도소득세가 얼마나 나올까?&ldquo;라는 고민을 하게 된다.
...
RIA 계좌는 국내시장복귀계좌다 &nbsp; RIA는 Reshoring Investment Account의 줄임말이다. 우리말로는 국내시장복귀계좌라고 부른다. 말 그대로 해외에 투자된 자금을 국내시장으로 다시 돌아오게 하려는 목적의 계좌다.
...
감면율은 매도 시점에 따라 달라진다 &nbsp; RIA 계좌의 핵심은 &ldquo;언제 매도했는가&quot;다. 2026년 한 해 동안 한시적으로 적용되는 제도이고, 매도 결제 시점에 따라 감면율이 달라진다.
2026년 5월 27일 기준으로 정리하면 다음과 같다.
RIA 계좌 내 해외주식 매도 결제 시점 양도소득세 감면율 2026년 5월 31일까지 100% 2026년 6월 1일 ~ 2026년 7월 31일 80% 2026년 8월 1일 ~ 2026년 12월 31일 50% 예를 들어 해외주식을 팔아 양도차익이 2,000만 원 발생했다고 해보자. 일반 계좌라면 기본공제 250만 원을 제외한 1,750만 원에 대해 약 385만 원의 세금이 계산된다.
같은 상황에서 RIA 계좌를 이용하면 매도 시점에 따라 부담이 달라진다.
구분 감면율 단순 계산 세금 2026년 5월 31일까지 매도 100% 0원 2026년 6월 1일 ~ 7월 31일 매도 80% 약 77만 원 2026년 8월 1일 ~ 12월 31일 매도 50% 약 192만 5천 원 RIA 미사용 0% 약 385만 원 실제 세금은 다른 해외주식 손익, 기본공제 적용, 환율, 신고 방식에 따라 달라질 수 있다. 그래서 위 금액은 구조를 이해하기 위한 예시로 보는 것이 좋다.
한도와 대상 주식 조건을 확인해야 한다 &nbsp; RIA 계좌는 혜택 한도가 있다. 1인당 매도 금액 기준으로 최대 5천만 원까지다. 여기서 중요한 점은 수익금 5천만 원이 아니라 매도 금액 5천만 원이라는 점이다.
...
즉, RIA 계좌는 &ldquo;해외주식을 새로 사서 절세하는 계좌&quot;라기보다 &ldquo;기존에 보유하던 해외주식 수익을 국내시장으로 옮길 때 세금 부담을 줄이는 계좌&quot;에 가깝다.
RIA 계좌 사용 흐름은 이렇게 보면 된다 &nbsp; RIA 계좌의 이용 순서는 크게 다섯 단계로 나눌 수 있다.
증권사에서 RIA 계좌를 개설한다. 기존 해외주식을 RIA 계좌로 옮긴다. RIA 계좌 안에서 해외주식을 매도한다. 매도 대금이 원화로 환전된다. 원화 자금을 국내주식, 국내 주식형 펀드, 국내 주식형 ETF 또는 현금으로 1년 이상 유지한다. 가장 조심할 부분은 3번이다. 기존 일반 해외주식 계좌에서 먼저 팔아버리면 RIA 혜택을 받기 어렵다. 해외주식을 RIA 계좌로 옮긴 뒤 그 계좌 안에서 매도해야 한다.
...
다른 계좌에서 해외주식을 새로 사면 혜택이 줄 수 있다 &nbsp; RIA 계좌를 볼 때 많은 사람이 놓치는 부분이 있다. RIA 계좌로 해외주식을 팔아 절세 혜택을 받으면서, 다른 일반 계좌나 연금계좌, ISA, IRP 등에서 해외주식이나 해외투자 ETF를 새로 사면 혜택이 줄어들 수 있다는 점이다.
...
RIA 계좌가 맞는 사람과 아닌 사람 &nbsp; RIA 계좌가 잘 맞는 사람은 대체로 세 가지 조건에 가깝다.
...
자주 묻는 질문 &nbsp; RIA 계좌는 누구나 만들 수 있나? &nbsp; 대부분의 투자자는 증권사를 통해 만들 수 있지만, 실제 개설 가능 여부와 절차는 증권사별로 다를 수 있다. 증권사별로 1인 1계좌 개설이 가능하더라도 세제 혜택 한도는 전 증권사 합산 5천만 원이라는 점을 같이 봐야 한다.
해외주식을 전부 팔아야 하나? &nbsp; 아니다. 전부 팔 필요는 없다. RIA 계좌로 옮길 종목과 수량은 투자자가 선택할 수 있다. 다만 혜택 대상 수량, 매도 금액 한도, 1년 유지 조건을 고려해서 정해야 한다.
RIA 계좌에 현금으로만 두어도 되나? &nbsp; 가능한 경우가 있다. 해외주식을 RIA 계좌 안에서 매도하고 원화로 환전된 자금을 국내주식에 반드시 바로 투자해야 하는 것은 아니며, 예탁금 형태로 보유해도 1년 유지 조건을 충족할 수 있다. 다만 계좌별 안내와 세부 조건은 증권사 공지를 확인해야 한다.
국내상장 미국 ETF도 RIA 계좌에서 살 수 있나? &nbsp; 일반적으로 국내에 상장되어 있더라도 해외지수를 추종하는 ETF는 RIA 계좌의 국내 재투자 대상에서 제외될 수 있다. RIA 계좌에서 매수 가능한 ETF는 국내 상장주식 비중 요건을 충족하는 국내 주식형 ETF 중심으로 보는 것이 안전하다.
2026년이 지나도 RIA 혜택을 받을 수 있나? &nbsp; RIA 계좌 세제 혜택은 2026년 한 해를 전제로 한 한시 제도다. 2026년 12월 31일까지의 매도 시점에 따라 감면율이 적용되며, 이후 제도 연장 여부나 세부 기준은 세법과 금융회사 안내를 다시 확인해야 한다.
핵심 정리 &nbsp; RIA 계좌는 해외주식 수익을 실현하면서 국내시장으로 자금을 옮길 때 양도소득세 부담을 줄일 수 있는 국내시장복귀계좌다. 2026년 5월 31일까지는 100%, 6월 1일부터 7월 31일까지는 80%, 8월 1일부터 12월 31일까지는 50% 감면 구조로 이해하면 된다.
...
처음 사는 S&amp;P500 ETF는 몇 주부터 시작하면 좋을까? &nbsp; 처음이라면 1주로 충분하다. 중요한 것은 큰돈을 넣는 것이 아니라 매수, 체결, 평가손익, 분배금, 세금 안내를 직접 확인하는 경험이다. 1주를 사보고 상품 구조를 이해한 뒤에 적립식 투자 여부를 정해도 늦지 않다.`}).add({id:31,href:"/posts/sp500-vs-schd-which-to-buy/",title:"S&P500 vs SCHD, 뭐 사야 할까? 수익률부터...",description:"S&P500과 SCHD 중 무엇을 사야 할지 고민이라면 이 글 하나로 끝내자. 수익률, 배당, 투자 성향별 추천까지 초보자 기준으로 쉽게 정리했다.",content:`S&amp;P500 vs SCHD, 처음 투자 시작할 때 거의 무조건 마주치는 고민이다.
...
Q3. 둘 중 하나만 꼭 골라야 한다면? &nbsp; 초보자 기준에서는 S&amp;P500을 먼저 선택하는 게 더 합리적이다. 이후 상황에 따라 SCHD를 추가하면 된다.`}).add({id:32,href:"/posts/tqqq-qld-qqq-nasdaq-etf/",title:"TQQQ QLD QQQ 뜻, 나스닥 100 추종 ETF...",description:"QQQ, QLD, TQQQ의 뜻과 차이를 나스닥 100 ETF 구조, 레버리지 배율, 장단점, 초보 투자자가 조심해야 할 부분까지 쉽게 정리했다.",content:`미국 기술주 투자를 이야기할 때 나스닥 100을 빼놓기 어렵다. 애플, 마이크로소프트, 엔비디아, 아마존, 테슬라처럼 전 세계 투자자가 관심을 갖는 기업들이 많이 들어 있기 때문이다. 그래서 미국 주식에 직접 투자하지 않더라도 &ldquo;나스닥 ETF 하나쯤은 사야 하나?&ldquo;라는 고민을 하게 된다.
...
레버리지 ETF는 왜 횡보장에 불리할 수 있나? &nbsp; 레버리지 ETF는 매일 목표 배율을 맞추는 구조다. 가격이 오르내리는 과정에서 손실과 회복이 반복되면 단순 배율 계산과 다른 결과가 나온다. 특히 변동성이 큰 횡보장에서는 기초지수가 제자리여도 레버리지 ETF 수익률은 나빠질 수 있다.`}).add({id:33,href:"/posts/vix-index/",title:"VIX 지수란? 공포지수로 보는 주식시장 변동성과 투자...",description:"VIX 지수의 뜻과 계산 원리, S&P500과의 관계, 투자자가 활용하는 방법, VIX 선물과 ETF 투자 시 주의할 점을 쉽게 정리했다.",content:`주식시장이 크게 흔들릴 때 뉴스에서 자주 나오는 말이 있다. 바로 VIX 지수다. &ldquo;공포지수가 급등했다&rdquo;, &ldquo;VIX가 안정되면서 증시가 반등했다&rdquo; 같은 표현을 한 번쯤 봤을 것이다.
...
VIX ETF를 장기 보유해도 될까? &nbsp; 주의가 필요하다. VIX ETF나 ETN은 대부분 VIX 선물을 활용하기 때문에 장기 보유 수익률이 VIX 지수와 다르게 움직일 수 있다. 선물 만기 교체 비용과 큰 변동성 때문에 단기 대응 상품에 가까운 경우가 많다.`}).add({id:34,href:"/posts/sole-proprietor-vs-corporation/",title:"개인사업자와 법인사업자 차이, 창업 전에 꼭 알아야 할 기준",description:"창업할 때 개인사업자와 법인사업자 중 무엇을 선택해야 할지 설립 절차, 세금, 책임 범위, 자금 조달, 운영 방식 차이로 쉽게 정리했다.",content:`창업을 준비하다 보면 생각보다 빨리 마주치는 질문이 있다. &ldquo;개인사업자로 시작할까, 법인사업자로 시작할까?&ldquo;라는 문제다. 아이템을 정하고, 상호를 고민하고, 사업장을 알아보는 일도 중요하지만 사업 형태를 어떻게 정하느냐에 따라 세금, 책임, 회계 처리, 투자 유치 방식이 달라진다.
...
경기지역화폐 카드를 받기 전에도 충전할 수 있을까? &nbsp; 지역과 카드 상태에 따라 앱에서 충전 메뉴가 보일 수 있지만, 실제 결제는 카드 등록 이후 가능한 경우가 많다. 처음 신청했다면 카드를 수령한 뒤 앱에 등록하고 계좌 연결까지 마친 다음 충전하는 흐름으로 보는 것이 안전하다.`}).add({id:37,href:"/posts/how-to-study-economics/",title:"경제 공부하는 방법, 금융 문맹을 벗어나기 위한 현실적...",description:"경제 공부를 어디서부터 시작해야 할지 모르는 초보자를 위해 기본 용어, 경제 뉴스 읽기, 책 선택, 가계부와 소액 투자까지 현실적인 공부 방법을 정리했다.",content:`경제 공부를 해야겠다고 마음먹는 순간은 대개 불편함에서 온다. 월급은 들어오는데 돈이 어디로 나가는지 모르겠고, 금리가 오른다는데 내 대출이 왜 부담스러워지는지 모르겠고, 뉴스에서는 환율과 물가 이야기가 계속 나오는데 내 생활과 어떻게 연결되는지 감이 잡히지 않는다.
...
위기 때 주식은 모두 팔아야 할까? &nbsp; 모든 주식을 감정적으로 매도하는 것은 위험할 수 있다. 당장 쓸 돈으로 투자했다면 줄이는 것이 맞지만, 장기 자금이라면 비상금과 부채 상황을 먼저 확인한 뒤 분할 매수나 리밸런싱 기준에 따라 판단하는 것이 낫다.`}).add({id:40,href:"/posts/spillover-effect/",title:"경제용어: 스필오버 효과, 경제에서 좋은 영향과 나쁜 ...",description:"스필오버 효과의 뜻과 경제, 관광, 조직관리, 상권에서 나타나는 긍정적 영향과 부정적 영향을 초보자도 이해하기 쉽게 정리했다.",content:`경제 기사를 읽다 보면 &ldquo;스필오버 효과&quot;라는 표현이 종종 나온다. 영어로는 Spillover Effect라고 하고, 말 그대로 어떤 영향이 한곳에만 머무르지 않고 주변으로 흘러넘치는 현상을 뜻한다.
...
투자할 때도 스필오버 효과를 볼 수 있을까? &nbsp; 볼 수 있다. 특정 산업의 대규모 투자가 장비, 소재, 부품, 물류 기업으로 번질 수 있고, 한 나라의 금리 변화가 다른 나라 주식시장과 환율에 영향을 줄 수도 있다. 투자자는 직접 수혜주뿐 아니라 주변으로 번지는 영향을 함께 살펴볼 필요가 있다.`}).add({id:41,href:"/posts/financial-freedom-roadmap/",title:"경제적 자유, 누구나 이룰 수 있는 실천 로드맵",description:"경제적 자유를 막연한 꿈이 아니라 실천 가능한 목표로 만들기 위해 지출 관리, 비상금, 부채 정리, 투자, 부수입 로드맵을 정리했다.",content:`경제적 자유라는 말을 들으면 거창하게 느껴진다. 회사를 그만두고, 건물주가 되고, 배당금만으로 여행을 다니는 모습을 떠올리기 쉽다. 하지만 현실적인 경제적 자유는 그런 장면보다 훨씬 작고 구체적인 곳에서 시작된다.
...
적금 개설도 포함이 되나요? &nbsp; 입/출금 계좌만 해당된다. 적금이나 예금 게좌는 하루에 여러개 개설하여도 가능하다.`}).add({id:43,href:"/posts/fixed-variable-loan-interest/",title:"고정금리와 변동금리 차이 쉽게 정리: 대출받을 때 어떤...",description:"고정금리와 변동금리의 뜻, 대출금리 계산 구조, 시장금리 상승기와 하락기 선택 기준, 혼합금리까지 초보자도 이해하기 쉽게 정리했다.",content:`대출을 알아보다 보면 가장 헷갈리는 말 중 하나가 고정금리와 변동금리다. 은행 앱에서는 금리 숫자만 크게 보이지만, 실제로 중요한 것은 그 금리가 앞으로 계속 같은지, 일정 주기마다 바뀌는지다.
...
주식을 손해 보고 팔아도 증권거래세를 내야 할까? &nbsp; 내야 한다. 증권거래세는 이익이 아니라 매도 거래금액에 붙는 세금이다. 손실을 보고 팔아도 매도금액을 기준으로 세금이 계산되므로 잦은 매매를 할수록 거래비용이 누적될 수 있다.`}).add({id:47,href:"/posts/gross-domestic-product-gdp/",title:"국내총생산 GDP 뜻 쉽게 정리, 명목GDP와 실질GD...",description:"국내총생산 GDP의 뜻과 계산 개념, 명목GDP와 실질GDP의 차이, 1인당 GDP와 GNI까지 초보자도 이해하기 쉽게 정리했다.",content:`경제 뉴스를 보다 보면 GDP라는 단어가 정말 자주 나온다. &ldquo;한국 GDP 성장률&rdquo;, &ldquo;1인당 GDP&rdquo;, &ldquo;명목 GDP&rdquo;, &ldquo;실질 GDP&rdquo; 같은 표현이 계속 등장한다.
...
GDP와 GNI 중 무엇을 봐야 할까? &nbsp; 경제 규모와 생산활동을 보고 싶다면 GDP가 기본이다. 국민이 벌어들인 소득 흐름을 더 보고 싶다면 GNI를 함께 보면 된다.`}).add({id:48,href:"/news/2026/korea-growth-fund/",title:"국민성장펀드 출시 첫날 87% 소진, 추가 공급 검토와...",description:"국민참여형 국민성장펀드가 출시 첫날 6000억원 중 87.1%를 판매하며 흥행했다. 판매 조건, 세제 혜택, 손실 구조, 추가 공급 가능성을 정리했다.",content:`이번 브리핑은 2026년 5월 18일부터 5월 25일까지 나온 금융위원회 발표와 주요 언론 보도를 중심으로 국민참여형 국민성장펀드의 출시, 판매 실적, 추가 공급 가능성, 투자자 유의사항을 정리했다. 이미 일반 설명 글에서 다룬 상품 구조보다 최근 뉴스 흐름과 시장 영향을 중심으로 보았다.
주요 내용 &nbsp; 국민참여형 국민성장펀드는 2026년 5월 22일부터 6월 11일까지 3주간 은행 10곳과 증권사 15곳에서 선착순 판매되는 정책형 공모펀드다. 총 모집 규모는 일반 국민 자금 6000억원이며, 정부 재정 1200억원이 후순위로 참여해 펀드 전체 손실의 20% 범위에서 우선 부담하는 구조다. 금융위원회와 언론 보도에 따르면 5월 22일 판매 첫날 오후 5시까지 약 5223억5000만원이 판매돼 전체 6000억원의 87.1%가 소진됐다. 온라인 물량은 대부분 빠르게 소진됐고, 오프라인에서도 은행과 일부 증권사에서 완판이 이어졌다. 남은 물량은 주로 일부 증권사와 영업점 배정분에 집중됐다. 금융당국은 하반기 추가 공급을 검토하고 있다. 다만 구체적인 시기, 예산, 재정 투입 규모는 관계부처 협의와 수요 점검이 필요하다. 투자 대상은 반도체, AI, 바이오, 방산, 로봇, 미래차, 이차전지 등 12개 첨단전략산업과 관련 기업이다. 자펀드 결성금액의 60% 이상을 주목적 투자 대상에 넣고, 30% 이상은 비상장기업 및 코스닥 기술특례상장사 신규자금 공급 방식으로 투자한다. 투자자는 최대 40% 소득공제와 배당소득 9% 분리과세 혜택을 받을 수 있지만, 5년 환매금지형 상품이고 원금보장 상품은 아니다. 주요 트렌드 &nbsp; 정책자금과 개인 자금이 함께 첨단전략산업에 들어가는 구조가 본격화되고 있다. 세제 혜택, 손실 우선부담 구조, 첨단산업 성장 기대가 결합하면서 일반 공모펀드보다 강한 초기 수요가 확인됐다. 서민형 배정 물량에 대한 수요가 예상보다 컸다. 일부 보도는 은행권 판매 물량 중 서민형 가입자 비중이 약 40% 수준으로 추산된다고 전했다. 공모펀드 시장 침체 속에서 정책형 장기 상품이 자금 유입을 만드는 사례가 됐다. 코스닥 성장주와 비상장 혁신기업에 대한 투자 기대가 커졌지만, 실제 성과는 자펀드 운용사 선정, 투자 집행 속도, 회수 성과에 달려 있다. 핵심 이슈 &nbsp; 첫 번째 이슈는 추가 공급 여부다. 1차 물량이 빠르게 소진되면서 하반기 2차 출시 가능성이 커졌지만, 예산과 세제 효과를 함께 따져야 한다. 두 번째 이슈는 불완전판매다. 금융위원회는 원금 손실 가능성, 5년 만기, 환매 제한, 손실 우선부담 구조를 투자자가 오해하지 않도록 판매사 교육을 강조했다. 세 번째 이슈는 손실 보전 구조에 대한 오해다. 정부 재정이 펀드 전체 손실의 20% 범위에서 후순위로 부담하는 것이지, 개인별 투자 원금의 20%를 보장한다는 뜻은 아니다. 네 번째 이슈는 유동성이다. 설정 후 거래소 상장이 가능하더라도 거래가 활발하지 않거나 기준가격보다 낮은 가격에 거래될 수 있어 만기까지 보유할 수 있는 자금인지 확인해야 한다. 다섯 번째 이슈는 정책성과다. 국민성장펀드가 단순 인기 상품을 넘어 첨단산업 기업의 실제 자금 조달과 성장으로 이어지는지가 향후 평가 기준이 된다. 시장 영향 &nbsp; 국민성장펀드 흥행은 첨단산업과 코스닥 성장주 투자심리에 단기 호재로 작용했다. 특히 AI, 반도체, 보안, 혁신 성장 기업에 대한 기대가 커졌다. 정책형 장기자금이 코스닥과 비상장 성장기업에 유입될 수 있다는 점은 중장기적으로 모험자본 시장 확대에 긍정적이다. 다만 펀드가 실제로 어떤 기업에 얼마를 투자하는지는 앞으로 자펀드 집행 과정에서 확인해야 한다. 단기 테마주 매수로 바로 연결하는 것은 위험하다. 판매 초기 흥행은 금융회사에도 긍정적이다. 은행과 증권사가 전용계좌, 소득확인증명서, 투자설명서 확인 절차를 처리하면서 정책형 투자상품 판매 경험을 축적하게 됐다. 투자자 입장에서는 절세 혜택이 크더라도 5년간 자금이 묶이는 비용, 원금 손실 가능성, 거래소 상장 후 할인 거래 가능성을 함께 고려해야 한다. 향후 전망 &nbsp; 1차 물량은 일부 오프라인 배정분을 제외하면 빠르게 소진될 가능성이 높다. 남은 판매 기간에는 잔여 한도 확인과 영업점 배정 물량 여부가 중요해질 전망이다. 금융당국은 하반기 추가 공급을 검토할 가능성이 높지만, 재정 여건과 관계부처 협의가 필요해 확정 일정은 아직 유동적이다. 추가 물량이 나오면 올해 소득공제 혜택 적용 여부와 서민형 배정 비율이 다시 핵심 쟁점이 될 수 있다. 펀드 운용 측면에서는 10개 자펀드가 실제로 비상장기업, 코스닥 기술특례상장사, 첨단전략산업 기업에 얼마나 빠르게 자금을 공급하는지가 관전 포인트다. 흥행이 정책 성공으로 이어지려면 판매 실적뿐 아니라 투자 집행의 투명성, 성과 공개, 손실 위험 안내가 함께 관리돼야 한다. 주요 뉴스 &nbsp; 2026-05-24 동아일보: &ldquo;첫날 완판&rdquo; 5223억 몰린 국민성장펀드, 하반기 2차 출시 검토
...
2026-05-24 서울신문: 국민성장펀드 &ldquo;완판 행진&rdquo;… 하반기 추가 공급 검토
...
2026-05-23 조선비즈: &ldquo;손실 막아준다&rdquo; 국민성장펀드 6000억 문 열자 완판
...
2026-05-22 금융위원회: 이억원 금융위원장, &ldquo;국민참여형 국민성장펀드&rdquo; 출시 첫날 펀드가입 및 현장점검
...
2026-05-20 금융위원회: 5.22일 출시를 앞두고 &ldquo;국민참여형 국민성장펀드&rdquo; 판매를 위한 준비상황을 점검하였습니다
...
2026-05-19 금융위원회: &ldquo;국민참여형 국민성장펀드&rdquo; 가입 관련 주요 문의사항(FAQ)에 대해 답변드립니다
...
2026-05-18 뉴스핌: &ldquo;국민성장펀드, 대기업 지원 논란 넘어 더 큰 시장 만들 것&rdquo;…민관, 발전방향 논의
...
2026-05-06 대한민국 정책브리핑: &ldquo;국민참여형&rdquo; 국민성장펀드 22일 판매…투자한도 5년간 2억 원
...
개인 투자자는 그레이 캐피털리즘을 왜 신경 써야 할까? &nbsp; 회색 지대 전략으로 이익을 내는 기업은 단기 실적이 좋아 보일 수 있다. 하지만 소비자 신뢰 하락, 규제 강화, 소송, 불매운동 같은 리스크가 생기면 기업가치가 흔들릴 수 있다. 투자자는 숫자만 보지 말고 그 숫자가 만들어지는 방식도 함께 봐야 한다.`}).add({id:51,href:"/posts/employment-income-tax-vs-global-income-tax/",title:"근로소득세와 종합소득세 차이, 직장인과 사업자는 세금 ...",description:"근로소득세와 종합소득세의 차이, 직장인 연말정산과 사업자 5월 신고, 부업 소득이 있는 직장인이 종합소득세를 신고해야 하는 경우를 쉽게 정리했다.",content:`나는 직장인이라 월급에서 근로소득세가 빠진다. 그런데 사업을 하는 친구는 매년 5월에 종합소득세를 신고한다고 했다. 둘 다 소득에 붙는 세금인 것 같은데, 왜 이름도 다르고 신고 방식도 다를까.
...
근로소득세와 종합소득세는 세율이 완전히 다를까? &nbsp; 둘 다 개인 소득세 체계 안에서 계산된다. 다만 근로소득은 근로소득공제와 연말정산 구조가 적용되고, 사업소득은 수입에서 필요경비를 뺀 뒤 종합소득세 신고로 계산한다는 점이 다르다.`}).add({id:52,href:"/posts/etf-types-gold-investing-guide/",title:"ETF 금 투자 방법",description:"금 ETF 뜻과 투자 방법, 금 현물 ETF와 금 선물 ETF 차이, 장점과 단점, 김치 프리미엄과 세금까지 초보자 기준으로 정리했다.",content:`금값이 크게 움직일 때마다 금 투자에 대한 관심도 같이 커진다. 예전에는 금에 투자한다고 하면 골드바를 사거나 금 통장을 만드는 모습을 먼저 떠올렸지만, 요즘은 증권 계좌에서 금 ETF를 사는 방식도 많이 쓴다. 실물 금을 직접 보관하지 않아도 되고, 주식처럼 사고팔 수 있어서 접근성이 좋기 때문이다.
다만 금 ETF라고 해서 전부 같은 상품은 아니다. 어떤 ETF는 실제 금 현물 가격을 따라가고, 어떤 ETF는 금 선물 가격을 따라간다. 또 국내 금값을 기준으로 움직이는 상품도 있고, 국제 금값을 기준으로 움직이는 상품도 있다. 여기에 세금, 환율, 추적오차, 롤오버 비용까지 얽히면 생각보다 확인할 것이 많다.
이 글에서는 금 ETF의 기본 개념, 금 현물 ETF와 금 선물 ETF 차이, 투자 장점과 주의할 점, 세금까지 초보자 기준으로 정리하였다. 금 ETF는 편리한 상품이지만 원금 보장 상품은 아니다. 구조를 알고 투자해야 불필요한 착각을 줄일 수 있다.
금 ETF란 무엇인가? &nbsp; 금 ETF는 금 가격의 움직임을 따라가도록 만든 상장지수펀드다. ETF는 거래소에 상장되어 주식처럼 사고팔 수 있는 펀드이고, 금 ETF는 그 투자 대상이 금인 상품이라고 보면 된다.
예를 들어 금 가격이 오르면 금 ETF 가격도 대체로 오르고, 금 가격이 내리면 금 ETF 가격도 대체로 내려간다. &ldquo;대체로&quot;라고 표현하는 이유는 ETF 가격이 금값과 항상 100% 똑같이 움직이지는 않기 때문이다. 운용 방식, 환율, 수수료, 시장 수급에 따라 차이가 생길 수 있다.
금 ETF의 가장 큰 특징은 실물 금을 직접 사지 않아도 금 가격에 투자할 수 있다는 점이다. 골드바를 사면 보관과 도난 위험을 신경 써야 하고, 살 때 부가가치세와 수수료 부담도 있다. 반면 금 ETF는 증권사 앱에서 주식처럼 매수할 수 있고, 소액으로도 시작할 수 있다.
다만 금 ETF를 산다고 해서 내 이름으로 금괴가 따로 보관되는 것은 아니다. ETF라는 금융 상품을 사는 것이고, 상품 구조에 따라 금 현물, 금 선물, 해외 금 ETF, 관련 파생상품 등을 통해 금 가격을 추종한다. 그래서 투자 전에는 &ldquo;이 ETF가 어떤 금 가격을 어떻게 따라가는가&quot;를 꼭 확인해야 한다.
금 ETF에 투자하는 방법 &nbsp; 금 ETF 투자는 일반 주식이나 ETF를 매수하는 방식과 크게 다르지 않다. 증권 계좌를 만들고, 국내 주식 또는 해외 주식 거래 화면에서 원하는 금 ETF를 검색해 매수하면 된다.
초보자라면 먼저 국내 상장 금 ETF부터 살펴보는 것이 편하다. 원화로 거래할 수 있고, 국내 증권사 앱에서 바로 매수할 수 있으며, 세금 처리도 비교적 단순하다. 해외 상장 금 ETF는 달러 환전, 해외 주식 거래 수수료, 양도소득세 계산까지 함께 봐야 하므로 조금 더 복잡하다.
금 ETF를 고를 때는 상품명만 보지 말고 아래 항목을 확인하는 것이 좋다.
확인 항목 봐야 하는 이유 현물형인지 선물형인지 금 가격을 따라가는 방식과 비용 구조가 달라진다 국내 금값인지 국제 금값인지 김치 프리미엄과 환율 영향이 달라질 수 있다 환헤지 여부 원·달러 환율 변동을 반영하는지 줄이는지 확인해야 한다 총보수와 기타 비용 장기 보유할수록 비용 차이가 수익률에 영향을 준다 거래량과 순자산 거래가 너무 적으면 원하는 가격에 사고팔기 어려울 수 있다 레버리지·인버스 여부 가격 변동이 커지고 장기 투자에 부적합할 수 있다 특히 ETF 이름에 &ldquo;(H)&ldquo;가 붙어 있다면 보통 환헤지형 상품이라는 뜻이다. 환헤지형은 원·달러 환율 변동 영향을 줄이고 금 가격 자체의 움직임을 더 반영하려는 구조다. 반대로 환노출형은 금 가격뿐 아니라 환율 변화도 수익률에 영향을 줄 수 있다.
투자 방식은 단순할수록 이해하기 쉽다. 금 투자를 처음 한다면 레버리지나 인버스 상품보다 일반 금 현물 ETF나 일반 금 선물 ETF부터 구조를 확인하는 편이 낫다.
금 현물 ETF와 금 선물 ETF 차이 &nbsp; 금 ETF는 크게 금 현물 ETF와 금 선물 ETF로 나눌 수 있다. 이름은 비슷하지만 실제로는 투자 방식이 다르다.
금 현물 ETF는 현재 금 가격을 따라가도록 설계된 상품이다. 실제 금 현물 가격에 가까운 움직임을 추구하기 때문에 구조가 비교적 직관적이다. 금 가격을 장기적으로 따라가고 싶은 투자자에게 이해하기 쉬운 편이다.
금 선물 ETF는 미래의 일정 시점에 금을 사고파는 선물 계약을 활용해 금 가격을 따라가는 상품이다. 선물 계약에는 만기가 있기 때문에 만기가 가까워지면 기존 계약을 정리하고 새로운 계약으로 갈아타는 과정이 필요하다. 이 과정을 롤오버라고 한다.
구분 금 현물 ETF 금 선물 ETF 투자 대상 현재 금 현물 가격 금 선물 계약 가격 구조 이해 비교적 단순함 롤오버 구조를 이해해야 함 비용 이슈 운용보수와 추적오차 중심 운용보수, 추적오차, 롤오버 비용 가능 적합한 투자자 금 가격을 비교적 단순하게 추종하고 싶은 투자자 단기 가격 흐름이나 파생 구조를 이해하는 투자자 주의점 국내 금값 프리미엄 영향을 받을 수 있음 선물 가격 구조 때문에 실제 금값과 차이가 날 수 있음 현물 ETF가 무조건 좋고 선물 ETF가 무조건 나쁘다는 뜻은 아니다. 중요한 것은 내 투자 목적과 상품 구조가 맞는지다. 금을 포트폴리오의 일부로 길게 가져가고 싶다면 구조가 단순한 현물형이 더 이해하기 쉬울 수 있다. 반대로 단기적인 금 가격 흐름에 대응하려는 투자자라면 선물형도 선택지가 될 수 있지만, 롤오버와 가격 괴리를 더 꼼꼼히 봐야 한다.
국내 상장 금 현물 ETF 중에는 국내 금 현물 가격을 따르는 상품도 있고, 국제 금값에 간접적으로 투자하는 상품도 있다. 국내 금값이 국제 금값보다 비싸게 형성되는 시기에는 어떤 기준 가격을 따르는지에 따라 수익률이 달라질 수 있다.
금 ETF의 장점 &nbsp; 금 ETF의 장점은 접근성과 편의성이다. 실물 금을 직접 사는 것보다 시작하기 쉽고, 주식처럼 거래할 수 있으며, 보관 부담이 없다.
주식처럼 편하게 사고팔 수 있다 &nbsp; 금 ETF는 거래소에 상장되어 있으므로 증권사 앱에서 실시간으로 매매할 수 있다. 금은 국제 정세, 금리, 달러 가치, 인플레이션 우려 등에 따라 가격이 움직이는데, ETF는 이런 변화에 비교적 빠르게 대응할 수 있다.
일반 골드바나 금 통장은 매수와 매도 과정이 번거롭거나 스프레드가 크게 느껴질 수 있다. 반면 ETF는 내가 이미 주식 투자를 하고 있다면 같은 계좌 안에서 함께 관리할 수 있다.
소액으로 금 투자를 시작할 수 있다 &nbsp; 실물 금은 일정 단위로 사야 하고, 살 때 부가가치세와 수수료가 붙을 수 있다. 보관 장소도 고민해야 한다. 금 ETF는 ETF 한 주 단위로 매수할 수 있어 상대적으로 적은 돈으로 금 가격에 투자할 수 있다.
포트폴리오에서 금 비중을 5%나 10%처럼 작게 가져가고 싶을 때도 ETF가 편하다. 실물 금으로는 비중 조절이 번거롭지만, ETF는 매수와 매도를 통해 비교적 쉽게 비중을 맞출 수 있다.
절세 계좌 활용이 가능하다 &nbsp; 국내 상장 금 ETF는 ISA나 연금저축 같은 절세 계좌에서 활용할 수 있는 경우가 있다. 계좌 종류와 상품 유형에 따라 투자 가능 여부와 세제 효과는 달라질 수 있으므로, 실제 매수 전에는 사용하는 증권사 화면과 상품 설명서를 확인해야 한다.
장기 자산 배분 관점에서는 이 부분이 중요하다. 금을 단기 매매용이 아니라 포트폴리오 안정 장치로 일부 편입하려는 경우, 어떤 계좌에서 보유할지에 따라 세후 수익률이 달라질 수 있다.
금 ETF 투자 시 주의할 점 &nbsp; 금 ETF는 편리하지만 금값이 오른다고 항상 같은 비율로 오르는 것은 아니다. 또한 금 자체가 배당이나 이자를 주는 자산이 아니기 때문에, 장기 수익은 결국 가격 상승에 의존한다.
추적오차가 생길 수 있다 &nbsp; 금 ETF는 금 가격을 따라가려고 설계되지만 실제 수익률은 금 가격과 차이가 날 수 있다. 이를 추적오차라고 한다. 운용보수, 매매 비용, 환율, 현금 보유 비중, 시장 수급 등이 영향을 준다.
예를 들어 국제 금값이 5% 올랐다고 해서 내가 가진 금 ETF도 반드시 5% 오르는 것은 아니다. 상품에 따라 4.7% 오를 수도 있고, 환율 영향이 더해져 더 많이 움직일 수도 있다. 그래서 수익률을 비교할 때는 기준 금값과 ETF 가격이 얼마나 잘 따라가는지 봐야 한다.
선물 ETF는 롤오버 비용을 볼 필요가 있다 &nbsp; 금 선물 ETF는 선물 계약을 활용한다. 선물 계약은 만기가 있으므로 계속 보유하려면 기존 계약을 새 계약으로 교체해야 한다. 이때 새 계약 가격이 기존 계약보다 비싸면 비용처럼 작용할 수 있다.
이 롤오버 구조 때문에 금 선물 ETF는 장기 보유 시 실제 금 현물 가격과 수익률이 달라질 수 있다. 특히 원자재 선물 ETF는 상품 구조를 이해하지 못한 상태에서 오래 들고 가면 생각보다 수익률이 어긋나는 경우가 생긴다.
김치 프리미엄을 조심해야 한다 &nbsp; 국내 금 수요가 갑자기 몰리면 국내 금값이 국제 금값보다 비싸게 형성될 수 있다. 이를 흔히 김치 프리미엄이라고 부른다. 국내 금 현물 가격을 따라가는 ETF라면 이런 프리미엄의 영향을 받을 수 있다.
문제는 프리미엄이 붙었을 때 매수하면, 이후 국제 금값이 크게 떨어지지 않아도 국내 프리미엄이 줄어드는 과정에서 ETF 가격이 약해질 수 있다는 점이다. 그래서 국내 금 현물 기준 ETF를 볼 때는 국제 금값과 국내 금값의 차이가 과도하지 않은지도 함께 확인하는 것이 좋다.
금은 이자와 배당이 없다 &nbsp; 금은 주식처럼 배당을 주거나 채권처럼 이자를 지급하는 자산이 아니다. 금 ETF를 보유하는 동안 기대할 수 있는 핵심 수익은 가격 상승이다.
물론 일부 금 관련 ETF는 다른 전략을 섞어 분배금을 지급할 수 있지만, 일반적인 금 자체는 현금흐름을 만들어내는 자산이 아니다. 따라서 은퇴 현금흐름이나 배당 수익을 목적으로 금 ETF를 과도하게 담는 것은 목적과 맞지 않을 수 있다.
금 ETF 세금은 어떻게 될까? &nbsp; 국내 상장 금 ETF에 투자해 매매차익이 생기면 일반적으로 15.4%의 배당소득세가 부과된다. 지방소득세가 포함된 세율이다. 이름은 매매차익이지만 세법상 배당소득으로 과세되는 구조라고 이해하면 된다.
해외 상장 금 ETF에 투자하는 경우에는 해외 주식형 ETF처럼 양도소득세 체계를 봐야 한다. 연간 해외 주식 등 양도차익을 합산해 기본공제 250만원을 넘는 부분에 대해 22%의 양도소득세가 부과될 수 있다. 지방소득세가 포함된 세율이다.
정리하면 아래와 같다.
구분 과세 방식 국내 상장 금 ETF 매매차익에 대해 15.4% 배당소득세 과세 가능 해외 상장 금 ETF 연간 양도차익 250만원 초과분에 22% 양도소득세 과세 가능 ISA·연금저축 등 절세 계좌 계좌 성격에 따라 과세 이연, 저율 과세, 비과세 한도 등이 달라질 수 있음 세금은 투자 수익률을 실제로 크게 바꾸는 요소다. 같은 금 가격에 투자하더라도 국내 상장 ETF를 일반 계좌에서 살지, ISA에서 살지, 해외 상장 ETF로 살지에 따라 세후 결과가 달라질 수 있다. 특히 금융소득이 많은 사람이라면 종합과세 가능성도 함께 확인하는 것이 좋다.
금 ETF는 어떤 사람에게 맞을까? &nbsp; 금 ETF는 금을 실물로 보관하고 싶지는 않지만, 포트폴리오에 금 가격 노출을 조금 넣고 싶은 사람에게 잘 맞는다. 주식과 채권만으로 포트폴리오가 불안하게 느껴질 때, 금을 일부 편입해 자산 흐름을 분산하려는 목적에 어울린다.
반대로 금 ETF가 모든 사람에게 필요한 것은 아니다. 금은 장기적으로 배당이나 이자를 만들지 않고, 가격 변동도 작지 않다. 금값이 이미 많이 오른 뒤에는 기대감만 보고 들어갔다가 조정을 겪을 수도 있다.
초보 투자자라면 금 ETF를 주력 투자처로 보기보다 보조 자산으로 보는 편이 현실적이다. 예를 들어 전체 투자금 중 일부만 금 ETF로 두고, 나머지는 주식형 ETF, 채권형 ETF, 현금성 자산과 함께 나누는 식이다.
투자 전에는 아래 질문에 답해보면 좋다.
질문 생각해볼 점 왜 금에 투자하려는가? 단기 시세 차익인지, 장기 분산 투자인지 구분한다 얼마나 보유할 것인가? 단기라면 가격 변동, 장기라면 비용과 세금을 더 본다 어떤 금 가격을 따르는가? 국내 금값인지 국제 금값인지 확인한다 손실을 감당할 수 있는가? 금도 가격이 크게 내려갈 수 있다 계좌는 무엇을 쓸 것인가? 일반 계좌, ISA, 연금 계좌의 세금 차이를 비교한다 자주 묻는 질문 &nbsp; 금 ETF는 금값이 오르면 항상 오르나? &nbsp; 대체로 금값과 같은 방향으로 움직이지만 항상 같은 비율로 오르지는 않는다. 운용보수, 환율, 추적오차, 선물 ETF의 롤오버 비용, 시장 수급 때문에 실제 ETF 수익률은 금 가격과 달라질 수 있다.
금 현물 ETF와 금 선물 ETF 중 무엇이 더 좋나? &nbsp; 무조건 더 좋은 상품은 없다. 금 가격을 비교적 단순하게 따라가고 싶다면 현물 ETF가 이해하기 쉽고, 단기적인 가격 흐름이나 파생 구조를 활용하려면 선물 ETF도 선택지가 될 수 있다. 다만 선물 ETF는 롤오버 구조를 이해한 뒤 투자하는 것이 좋다.
금 ETF에도 배당금이 있나? &nbsp; 일반적으로 금 자체는 이자나 배당을 만들지 않는다. 그래서 금 가격을 단순 추종하는 ETF는 배당주 ETF처럼 안정적인 배당을 기대하기 어렵다. 일부 상품은 별도 전략으로 분배금을 줄 수 있으므로 상품별 분배금 정책을 확인해야 한다.
연금저축이나 ISA로 금 ETF를 살 수 있나? &nbsp; 국내 상장 금 ETF 중 일부는 ISA나 연금저축 계좌에서 매수할 수 있다. 다만 계좌 종류와 상품 유형에 따라 투자 가능 여부가 다를 수 있으므로 실제 매수 전 증권사 앱에서 매수 가능 여부와 상품 설명서를 확인해야 한다.
금 ETF와 실물 금 중 무엇이 더 낫나? &nbsp; 투자 편의성과 소액 투자를 원하면 금 ETF가 편하다. 실물 금을 직접 보유하는 만족감이나 물리적 보관을 중시한다면 골드바가 맞을 수 있다. 다만 실물 금은 부가가치세, 수수료, 보관 문제가 있고, 금 ETF는 금융 상품 리스크와 세금 구조가 있다는 차이가 있다.
마무리 &nbsp; 금 ETF는 실물 금을 직접 사지 않고도 금 가격에 투자할 수 있는 편리한 상품이다. 증권 계좌에서 주식처럼 사고팔 수 있고, 소액으로도 접근할 수 있으며, 포트폴리오 분산 수단으로 활용하기 좋다.
하지만 금 ETF도 원금 보장 상품은 아니다. 금 현물 ETF와 금 선물 ETF의 구조가 다르고, 국내 금값과 국제 금값의 차이, 환율, 추적오차, 롤오버 비용, 세금까지 함께 봐야 한다.
처음 금 ETF를 고른다면 상품명보다 구조를 먼저 확인하는 것이 좋다. &ldquo;현물인지 선물인지&rdquo;, &ldquo;국내 금값인지 국제 금값인지&rdquo;, &ldquo;환헤지인지 환노출인지&rdquo;, &ldquo;어떤 계좌에서 투자할지&quot;를 차례로 따져보면 불필요한 실수를 줄일 수 있다.`}).add({id:53,href:"/posts/economic-financial-terms-guide-download/",title:'금융 문맹 탈출 첫걸음, "경제금융용어" 무료 다운로드...',description:'금융 문맹에서 벗어나고 싶다면 한국은행 "경제금융용어" 책자부터 시작해라. 무료 다운로드 방법과 실전 활용법까지 정리했다.',content:`왜 지금 &ldquo;경제금융용어&quot;를 봐야 할까 &nbsp; 회사 일만 하면서 월급 들어오면 저축만 반복하던 시기가 있었다. 그때는 나름 안정적으로 살고 있다고 생각했는데, 어느 순간 깨달았다. 나는 금융을 전혀 모르고 있었다.
...
Q3. 이거 하나로 충분할까? &nbsp; 기초는 충분하다. 이후에는 뉴스나 투자 서적으로 확장하면 된다.`}).add({id:54,href:"/posts/financial-intelligence/",title:"금융 지능이란?",description:`금융 지능(Financial Intelligence) 은 쉽게 말해서 돈의 흐름을 이해하고, 합리적으로 돈을 관리하고, 장기적으로 자산을 늘릴 수 있는 능력을 의미한다.
...
금융 지식 감정 통제 실제 경험 결론적으로 금융 지능은 금융 지식, 합리적 판단 능력, 그리고 실제 재무 관리 경험이 결합된 개념이며, 개인의 경제적 안정과 자산 형성에 핵심적인 역할을 수행한다.`}).add({id:55,href:"/posts/",title:"금융의 모든 지식!",description:"금융 문맹 탈출 프로젝트",content:""}).add({id:56,href:"/posts/bond-investing-when-rates-fall/",title:"기준금리가 내려가면 채권 가격은 왜 오를까? 금리 하락...",description:"기준금리와 채권 가격의 반비례 관계, 금리 하락기에 채권 투자가 주목받는 이유, 직접 채권과 채권 ETF 선택 기준을 초보자도 이해하기 쉽게 정리했다.",content:`채권 투자를 처음 공부하면 가장 자주 듣는 말이 있다. &ldquo;금리가 내려가면 채권 가격은 오른다&quot;는 말이다. 말 자체는 간단한데, 막상 왜 그런지 설명하려면 조금 헷갈린다. 예금 금리가 내려가면 이자를 덜 받는 것 같은데, 채권 가격은 왜 올라간다는 걸까.
...
예금금리보다 대출금리가 더 높은 이유는 무엇일까? &nbsp; 은행은 예금으로 돈을 조달하고 대출로 돈을 운용한다. 대출금리에는 은행의 조달비용뿐 아니라 운영비, 신용위험, 가산금리 등이 반영된다. 그래서 일반적으로 대출금리는 예금금리보다 높게 형성된다.`}).add({id:58,href:"/news/2026/basic-pension-law/",title:"기초연금법 시행령 개정, 7월부터 재신청 없이 자동 신...",description:"기초연금법 시행령 개정안이 국무회의를 통과했다. 7월부터 수급희망 이력관리 대상자는 자격이 확인되면 재신청 없이 기초연금 신청으로 간주된다.",content:`이번 브리핑은 2026년 5월 26일 국무회의에서 의결된 기초연금법 시행령 개정안을 중심으로, 2026년 3월 27일부터 5월 26일까지 나온 입법예고, 복지안전매트 대책, 주요 언론 보도를 함께 정리했다. 최근 7일 안에는 같은 국무회의 의결 보도가 대부분이라, 정책 배경을 설명하기 위해 실제 조사 범위를 넓혔다.
주요 내용 &nbsp; 보건복지부는 2026년 5월 26일 국무회의에서 기초연금법 시행령 개정안이 의결됐다고 밝혔다. 핵심은 기초연금을 신청했다가 탈락했거나 수급권을 잃은 사람이 수급희망 이력관리에 등록돼 있으면, 이후 수급 가능성이 확인될 때 별도 재신청 없이 기초연금을 신청한 것으로 간주하는 것이다. 적용 시점은 행복이음 시스템 개편을 거쳐 2026년 7월분 기초연금부터다. 시행 당시 이미 수급희망 이력관리를 신청한 어르신도 적용 대상에 포함된다. 기존에는 수급 가능성이 확인돼도 신청서, 소득·재산 신고서, 금융정보 제공 동의서 등 서류를 다시 제출해야 했다. 이번 개정은 이미 보유한 인적 사항과 소득·재산 자료를 활용해 조사 후 지급 여부를 결정하도록 하는 방향이다. 2026년 3월 기준 수급 가능성이 확인된 6만7000명 중 실제 신청하지 않은 사람은 3만8000명으로 집계됐다. 정부는 이 반복 미신청 문제를 기초연금 사각지대의 핵심 원인 중 하나로 보고 있다. 이번 조치는 2026년 5월 12일 발표된 위기가구 지원을 위한 복지안전매트 강화 방안의 후속 조치다. 신청해야만 받을 수 있는 복지 체계에서 정부가 먼저 확인하고 연결하는 적극적 복지로 바뀌는 흐름이다. 주요 트렌드 &nbsp; 복지정책의 무게중심이 신청주의에서 선제 확인·자동 연계로 이동하고 있다. 고령층 대상 복지에서는 정보 접근성, 서류 준비, 주민센터 방문 부담을 줄이는 행정 절차 개선이 핵심 과제가 되고 있다. 기초연금, 장애인연금, 아동수당 등 여러 급여에서 정부 보유 정보를 활용한 자동 지급 또는 신청 간주 방식이 동시에 논의되고 있다. 복지 사각지대 발굴은 단순 체납 정보에서 전기·수도 사용량 변화, 반복 발굴 이력 등 생활 패턴 기반 분석으로 확장되고 있다. 법률 개정 전에도 시행령과 시스템 개편으로 가능한 영역부터 먼저 추진하는 단계적 제도 개선이 나타나고 있다. 핵심 이슈 &nbsp; 첫 번째 이슈는 대상 범위다. 이번 자동 신청 간주는 모든 기초연금 탈락자에게 적용되는 것이 아니라, 수급희망 이력관리에 등록된 사람을 중심으로 작동한다. 두 번째 이슈는 개인정보 활용이다. 정부가 기존 신청 과정에서 확보한 인적 사항과 소득·재산 자료를 활용하는 만큼, 행정 편의와 개인정보 보호의 균형이 중요해진다. 세 번째 이슈는 지급 결정까지의 실제 속도다. 7월분부터 적용되더라도 행복이음 시스템 개편, 지자체 조사, 대상자 통지 과정이 매끄럽게 돌아가야 체감 효과가 커진다. 네 번째 이슈는 제도 홍보다. 수급희망 이력관리에 등록해야 자동 신청 간주 혜택을 받을 수 있으므로, 기존 탈락자와 예비 신청자에게 이 제도를 충분히 알리는 것이 중요하다. 다섯 번째 이슈는 재정 영향이다. 신청하지 못해 빠졌던 대상자가 실제 수급으로 연결되면 복지 지출은 늘 수 있지만, 이는 기존 제도상 받아야 할 권리를 회복하는 성격이 강하다. 시장 영향 &nbsp; 직접적인 금융시장 영향은 제한적이다. 다만 고령층 저소득 가구의 현금흐름이 개선되면 필수소비, 의료, 지역 생활서비스 소비에는 완만한 긍정 효과가 있을 수 있다. 기초연금 수급 누락을 줄이는 정책은 지방자치단체 복지 행정과 사회보장정보시스템 고도화 수요를 키운다. 공공 IT, 복지 행정 자동화, 데이터 연계 사업의 중요성이 커질 수 있다. 고령화가 빠르게 진행되는 상황에서 기초연금 제도 접근성이 높아지면 장기적으로 노후소득보장 관련 재정 논의가 더 자주 부각될 가능성이 있다. 복지급여 자동 지급이 다른 제도로 확대되면 금융회사와 공공기관의 본인 확인, 계좌 검증, 소득·재산 자료 연계 업무도 더 촘촘해질 수 있다. 투자 관점에서는 단기 테마보다 정책 방향을 보는 것이 중요하다. 복지 자동화, 공공 데이터, 고령층 서비스 인프라가 중장기적으로 관심 영역이 될 수 있다. 향후 전망 &nbsp; 2026년 7월분 기초연금부터 자동 신청 간주가 적용되는지, 실제 지급 누락 감소 효과가 얼마나 나타나는지가 첫 번째 관전 포인트다. 수급희망 이력관리 등록률을 높이는 추가 홍보와 국민연금공단·지자체 안내가 이어질 가능성이 크다. 기초연금법뿐 아니라 아동수당법, 장애인연금법, 사회보장급여법 등 다른 복지 법제에서도 신청주의를 완화하는 개정 논의가 이어질 전망이다. 정부가 보유 정보를 활용해 복지급여를 연결하는 방식이 확대될수록 개인정보 보호, 오지급·과지급 처리, 공무원 면책 기준 같은 세부 쟁점도 중요해진다. 고령층 노후소득보장 논의는 지급액 인상, 선정기준액, 국민연금과의 관계, 신청 절차 개선이 함께 묶여 계속 다뤄질 가능성이 높다. 주요 뉴스 &nbsp; 2026-05-26 한겨레: 7월부터 기초연금 탈락해도, 수급 가능성 확인되면 &ldquo;자동 신청→지급&rdquo;
...
2026-05-26 위키트리: 국민연금공단, 기초연금 &ldquo;재신청 절차 대폭 개선&rdquo; 제때, 편하게 받는다
...
2026-05-12 이데일리: &ldquo;위기가구, 신청 안 해도 복지 지원&rdquo;…정부 &ldquo;적극적 복지&rdquo; 전환
...
다가구주택을 살 때 무엇을 확인해야 하나? &nbsp; 건축물대장상 용도, 층별 현황, 등기부등본, 실제 임대차 현황, 전입세대 여부, 불법 증축 여부를 확인해야 한다. 외관상 원룸 건물처럼 보여도 법적으로 다가구인지 다세대인지에 따라 세금과 권리관계가 달라질 수 있다.`}).add({id:60,href:"/posts/dow-jones-industrial-average/",title:"다우존스산업평균지수",description:"미국 3대 지수 중 하나인 다우존스 산업평균지수의 뜻, 30개 우량주 구성, 주가평균 방식, S&P500·나스닥과 차이, DIA ETF 투자 방법을 쉽게 정리했다.",content:`미국 주식 뉴스를 보면 &ldquo;다우지수가 올랐다&rdquo;, &ldquo;나스닥은 빠졌지만 다우는 버텼다&rdquo; 같은 표현이 자주 나온다. 처음에는 다우지수, S&amp;P500, 나스닥이 모두 비슷한 말처럼 느껴진다. 전부 미국 주식시장 분위기를 보여주는 지수이기 때문이다.
...
다우존스 산업평균지수란 &nbsp; 다우존스 산업평균지수는 미국 주식시장에 상장된 대표 우량기업 30개의 주가 흐름을 보여주는 지수다. 영어로는 Dow Jones Industrial Average라고 하고, 줄여서 DJIA, Dow 30, 다우지수라고 부른다.
이름에 &ldquo;산업평균&quot;이라는 말이 붙어 있지만, 지금은 제조업 회사만 담는 지수가 아니다. 금융, 기술, 헬스케어, 소비재, 유통, 항공, 엔터테인먼트 등 미국 경제를 대표한다고 볼 수 있는 다양한 업종의 대형 기업이 들어간다.
다우지수의 역사는 매우 길다. 찰스 다우가 만든 주가지수에서 출발했고, 현재 형태의 다우존스 산업평균지수는 1896년에 시작된 오래된 미국 대표 지수다. 그래서 숫자 자체보다 &ldquo;미국 주식시장의 전통적인 바로미터&quot;라는 상징성이 크다.
...
다우지수는 왜 30개 종목만 볼까 &nbsp; 다우지수는 미국을 대표하는 초우량 기업 30개로 구성된다. S&amp;P500이 약 500개 대형주를 담고, 나스닥종합지수가 나스닥 시장 전체 흐름을 넓게 보여주는 것과 비교하면 종목 수가 매우 적다.
...
다우지수 계산 방식은 조금 특이하다 &nbsp; 대부분의 대표 주가지수는 시가총액 가중 방식으로 계산된다. 시가총액은 &ldquo;주가 × 발행주식 수&quot;로 구한다. 회사 규모가 클수록 지수에 더 큰 영향을 주는 방식이다. S&amp;P500, 코스피, 나스닥100 같은 지수가 이런 방식에 가깝다.
그런데 다우지수는 주가평균 방식, 정확히는 가격가중 방식으로 계산된다. 쉽게 말하면 시가총액보다 &ldquo;주가가 높은 종목&quot;이 지수에 더 큰 영향을 준다.
...
그래서 다우지수를 볼 때는 &ldquo;미국 전체 시가총액의 변화&quot;라기보다 &ldquo;대표 우량주 30개 가격의 평균적인 움직임&quot;으로 이해하는 편이 낫다. 미국 시장 전체를 더 넓게 보려면 S&amp;P500을 함께 보고, 기술주 흐름을 보려면 나스닥 지수를 같이 보는 것이 좋다.
S&amp;P500·나스닥과 무엇이 다를까 &nbsp; 미국 3대 지수라고 하면 보통 다우존스 산업평균지수, S&amp;P500, 나스닥을 말한다. 셋 다 미국 주식시장 흐름을 보여주지만 성격은 다르다.
구분 다우존스 산업평균지수 S&amp;P500 나스닥 대표 성격 미국 대표 우량주 30개 미국 대형주 약 500개 기술주 중심 시장 흐름 계산 방식 가격가중 시가총액가중 시가총액가중 성격 종목 수 30개 약 500개 나스닥 상장 종목 중심 특징 전통성과 상징성 미국 시장 대표성 성장주·기술주 민감도 다우지수는 역사가 길고 언론에서 자주 인용된다. 하지만 종목 수가 적고 가격가중 방식이라 시장 전체를 보는 데는 한계가 있다. 미국 증시를 넓게 파악하려면 S&amp;P500이 더 자주 기준으로 쓰인다.
...
초보자라면 이렇게 기억하면 쉽다. 다우는 &ldquo;미국 대표 우량주 30개&rdquo;, S&amp;P500은 &ldquo;미국 대형주 전체 흐름&rdquo;, 나스닥은 &ldquo;미국 기술주와 성장주 분위기&quot;에 가깝다.
다우지수가 한국 투자자에게 중요한 이유 &nbsp; 한국 투자자가 아침에 미국 증시를 확인할 때 다우지수, S&amp;P500, 나스닥을 함께 보는 경우가 많다. 전날 미국 시장이 크게 흔들리면 한국 증시도 영향을 받을 가능성이 크기 때문이다.
...
다우지수는 특히 경기민감 대형주와 전통 산업의 분위기를 볼 때 유용하다. 금융주, 산업재, 소비재, 헬스케어 대형주가 함께 움직이기 때문에 &ldquo;미국 경제 전반에 대한 투자자 심리&quot;를 빠르게 읽는 데 도움이 된다.
다우지수에 투자하는 방법 &nbsp; 다우지수 자체는 숫자이기 때문에 직접 살 수 없다. 개인 투자자가 다우지수에 투자하려면 지수를 따라가도록 설계된 ETF를 사는 방식이 일반적이다.
...
다우지수를 볼 때 주의할 점 &nbsp; 다우지수는 오래되고 유명하지만 완벽한 지수는 아니다. 가장 큰 한계는 종목 수가 30개뿐이라는 점이다. 미국 증시 전체가 좋아도 다우지수에 포함된 일부 종목이 부진하면 다우는 약하게 보일 수 있다. 반대로 몇몇 고가 종목이 강하게 오르면 전체 시장보다 좋아 보일 수도 있다.
...
정리 &nbsp; 다우존스 산업평균지수는 미국 대표 우량기업 30개로 구성된 전통적인 주가지수다. 1896년부터 이어진 긴 역사와 상징성 때문에 지금도 미국 증시 뉴스를 대표하는 숫자로 자주 쓰인다.
...
자주 묻는 질문 &nbsp; 다우지수와 다우존스 산업평균지수는 같은 말인가? &nbsp; 일반적으로 같다. 정확한 명칭은 다우존스 산업평균지수이고, 줄여서 다우지수, DJIA, Dow 30이라고 부른다. 다우존스에는 운송지수나 유틸리티지수도 있지만, 뉴스에서 &ldquo;다우지수&quot;라고 하면 보통 다우존스 산업평균지수를 뜻한다.
다우지수는 미국 주식시장 전체를 대표하나? &nbsp; 상징성은 크지만 시장 전체를 가장 넓게 대표한다고 보기는 어렵다. 다우지수는 30개 기업만 담고 가격가중 방식으로 계산된다. 미국 대형주 전체 흐름을 보려면 S&amp;P500을 함께 보는 것이 좋다.
다우지수에 엔비디아가 포함되어 있나? &nbsp; 포함되어 있다. S&amp;P Dow Jones Indices는 2024년 11월 8일 장 시작 전부터 엔비디아를 인텔 대신 다우존스 산업평균지수에 편입한다고 발표했다. 같은 날 셔윈윌리엄스도 다우를 대신해 편입됐다.
다우지수와 S&amp;P500 중 어떤 지수가 장기투자에 더 적합한가? &nbsp; 일반적으로 장기 미국 주식 투자의 기준으로는 S&amp;P500이 더 많이 쓰인다. 종목 수가 많고 시가총액가중 방식이라 미국 대형주 시장을 더 넓게 반영하기 때문이다. 다우지수는 대표 우량주 30개의 상징성과 흐름을 보는 보조 지표로 활용하기 좋다.
DIA ETF는 배당을 받을 수 있나? &nbsp; DIA는 다우지수 구성 종목을 담는 ETF이므로 보유 종목에서 발생한 배당을 바탕으로 분배금을 지급할 수 있다. 다만 분배금 규모와 지급 시점은 ETF 운용 상황과 보유 종목 배당에 따라 달라진다. 해외 상장 ETF를 직접 보유하면 미국 배당 원천징수와 국내 세금도 함께 고려해야 한다.`}).add({id:61,href:"/posts/multi-homeowner-capital-gains-tax-surcharge/",title:"다주택자 양도소득세 중과 5월 10일부터 시행: 대상,...",description:"2026년 5월 10일부터 다시 적용될 다주택자 양도소득세 중과의 뜻, 대상, 세율, 장기보유특별공제 배제, 매도 전 체크할 내용을 쉽게 정리했다.",content:`집을 여러 채 갖고 있는 사람에게 가장 민감한 세금 중 하나가 양도소득세다. 집을 보유하는 동안에는 재산세나 종부세가 부담이고, 집을 팔 때는 양도소득세가 부담이 된다. 특히 다주택자가 조정대상지역 주택을 팔 때 적용되는 양도세 중과 는 세금 차이가 꽤 크게 벌어질 수 있다.
...
Q3. 복리 효과는 언제부터 크게 느껴지나? &nbsp; 기간이 길어질수록 차이가 커진다. 짧게 보면 거의 비슷하지만, 5년, 10년, 20년처럼 장기로 갈수록 복리의 장점이 확실해진다.`}).add({id:63,href:"/posts/loan-refinancing/",title:"대출갈아타기",description:"대출 갈아타기와 대환대출의 뜻, 가능한 대출 종류, 장단점, 중도상환수수료와 우대금리 확인법까지 초보자도 쉽게 이해하도록 정리하였다.",content:`대출을 받은 뒤 시간이 지나면 이런 생각이 든다. &ldquo;지금보다 금리를 낮출 수 없을까?&rdquo;, &ldquo;다른 은행으로 옮기면 매달 이자가 줄어들까?&rdquo;, &ldquo;예전에 급하게 받은 대출을 더 나은 조건으로 바꿀 수 있을까?&rdquo;
...
대출 갈아타기와 대환대출은 무엇일까 &nbsp; 대출 갈아타기는 기존 대출을 더 나은 조건의 새 대출로 바꾸는 것이다. 대환대출은 기존 빚을 갚기 위해 새로 대출을 받는다는 의미가 강하고, 실생활에서는 두 표현을 거의 비슷하게 쓴다.
...
핵심은 단순히 &ldquo;은행을 바꾸는 것&quot;이 아니다. 목적은 이자 부담을 줄이거나, 상환 기간을 조정하거나, 변동금리와 고정금리 같은 대출 조건을 내 상황에 맞게 바꾸는 데 있다.
어떤 대출을 갈아탈 수 있을까 &nbsp; 대출 갈아타기는 모든 대출에 항상 적용되는 것은 아니다. 금융회사와 상품, 담보 종류, 대출 실행일, 연체 여부, 신용 상태에 따라 가능 여부가 달라진다.
...
전세자금대출도 갈아타기 대상이 될 수 있다. 전세 계약 기간, 보증기관, 집주인 동의 필요 여부, 기존 보증서 조건 등을 함께 확인해야 한다. 특히 전세대출은 만기와 계약 갱신 시점이 중요하므로 &ldquo;지금 당장 낮은 금리&quot;만 보고 움직이면 일정이 꼬일 수 있다.
사업자대출, 정책금융상품, 일부 특수 목적 대출은 갈아타기가 제한될 수 있다. 정부 지원 대출이나 우대 조건이 붙은 상품은 일반 은행 상품보다 금리가 낮은 경우도 있으니, 먼저 기존 대출의 성격을 확인해야 한다.
대출 갈아타기의 장점 &nbsp; 가장 큰 장점은 이자 부담을 줄일 수 있다는 점이다. 기존 대출보다 낮은 금리로 갈아타면 매달 내는 이자가 줄고, 전체 상환 기간 동안 부담하는 총 이자도 줄어들 수 있다.
...
금리만 보고 갈아타면 안 되는 이유 &nbsp; 대출 갈아타기에서 가장 흔한 실수는 표시 금리만 보는 것이다. 기존 대출보다 새 대출 금리가 낮으면 무조건 유리해 보이지만, 실제 이득은 비용을 뺀 뒤 계산해야 한다.
...
확인 항목 봐야 할 내용 금리 차이 새 대출의 실제 적용 금리가 기존보다 얼마나 낮은가 남은 기간 이자 절감 효과가 발생할 시간이 충분한가 중도상환수수료 기존 대출을 갚을 때 비용이 얼마나 드는가 부대비용 인지세, 보증료, 등기 비용 등이 있는가 우대금리 조건을 계속 유지할 수 있는가 상환 방식 원리금균등, 원금균등, 만기일시상환 중 무엇인가 대출 갈아타기 절차는 어떻게 진행될까 &nbsp; 대출 갈아타기는 상품마다 조금씩 다르지만, 큰 흐름은 비슷하다. 먼저 기존 대출 정보를 확인한다. 대출 잔액, 금리, 만기, 상환 방식, 중도상환수수료를 알아야 비교가 가능하다.
다음으로 갈아탈 수 있는 상품을 조회한다. 이때 신용점수, 소득, 직장, 기존 대출 규모, 담보 가치 등이 반영된다. 조회 결과로 보이는 금리와 한도는 최종 승인 전까지 달라질 수 있으므로, &ldquo;예상 조건&quot;과 &ldquo;확정 조건&quot;을 구분해서 봐야 한다.
...
이런 경우에는 더 신중해야 한다 &nbsp; 첫째, 최근 신용대출을 여러 번 조회했거나 새 대출을 자주 신청한 경우다. 단기간에 여러 금융회사에서 대출 조회와 신청을 반복하면 비대면 심사에서 불리하게 작용할 수 있다. 단순 금리 비교 조회와 실제 대출 신청은 다르므로, 신청 전에는 조건을 충분히 비교하고 움직이는 편이 좋다.
...
정리 &nbsp; 대출 갈아타기는 기존 대출을 더 나은 조건의 새 대출로 바꾸는 방법이다. 신용대출, 주택담보대출, 전세자금대출 등에서 활용할 수 있고, 금리 부담을 줄이거나 상환 구조를 정리하는 데 도움이 될 수 있다.
...
자주 묻는 질문 &nbsp; 대출 갈아타기를 하면 신용점수가 떨어질까? &nbsp; 본인이 조건을 비교하기 위해 조회하는 것만으로 신용점수가 크게 떨어진다고 보기는 어렵다. 다만 실제 대출 신청을 짧은 기간에 여러 번 반복하거나, 새 대출이 늘어나면 심사에 영향을 줄 수 있다. 필요한 비교를 한 뒤 무리한 중복 신청은 피하는 것이 좋다.
대출 갈아타기는 금리가 몇 퍼센트 낮아야 유리할까? &nbsp; 정해진 기준은 없다. 대출 잔액, 남은 기간, 중도상환수수료, 부대비용에 따라 달라진다. 잔액이 크고 기간이 길수록 작은 금리 차이도 의미가 있고, 잔액이 작거나 만기가 가까우면 1%포인트 이상 낮아져도 실익이 크지 않을 수 있다.
여러 개의 대출을 한 번에 갈아탈 수 있을까? &nbsp; 서비스와 상품에 따라 다르지만, 일반적인 대출 갈아타기는 한 번에 한 계좌씩 처리되는 경우가 많다. 여러 대출을 정리하고 싶다면 각각의 금리, 수수료, 만기, 상환 방식을 따로 비교해야 한다.
중도상환수수료가 없으면 무조건 갈아타도 될까? &nbsp; 중도상환수수료가 없으면 비용 부담은 줄지만, 그래도 무조건 유리한 것은 아니다. 새 대출의 우대금리 조건, 상환 방식, 만기, 부대비용, 향후 금리 변동 가능성을 함께 봐야 한다.
대출 갈아타기 전에 가장 먼저 확인할 것은 무엇인가? &nbsp; 기존 대출의 현재 금리와 남은 원금, 만기, 월 상환액, 중도상환수수료다. 이 숫자를 모르면 새 대출이 정말 유리한지 계산하기 어렵다. 먼저 기존 조건을 정확히 확인한 뒤 새 조건과 나란히 비교하는 것이 출발점이다.`}).add({id:64,href:"/posts/loan-ltv-dti-dsr/",title:"대출 받을 때 알아야 하는 LTV, DTI, DSR",description:" ",content:`LTV, DTI, DSR은 금융기관이 주택담보대출 심사 시 차주(借主, 돈을 빌리는 사람)의 상환 능력과 담보 가치를 평가하기 위해 사용하는 대표적인 규제 지표이다. 즉, 은행이 &ldquo;이 사람이 얼마나 대출을 감당할 수 있는지&rdquo; 판단하는 핵심 지표라고 할 수 있다.
...
사람들이 자주 오해하는 점 &nbsp; LTV 70%면 무조건 70% 대출 가능 → DSR에서 막히면 불가능 소득 높으면 대출 무조건 많이 가능 → LTV 제한 있음 한 줄 정리 &nbsp; LTV = 집 기준 DTI = 주담대 중심 소득 기준 DSR = 전체 빚 기준 (현재 핵심)`}).add({id:65,href:"/posts/loan-repayment-methods/",title:"대출 상환 방법 쉽게 정리, 원리금 균등·원금 균등·만...",description:"대출 상환 방법은 매달 갚는 금액과 총이자 비용을 크게 바꾼다. 원리금 균등, 원금 균등, 만기 일시, 거치 후 상환의 차이를 쉽게 정리한다.",content:`대출을 받을 때 금리만 보는 경우가 많다. 물론 금리는 중요하다. 그런데 실제로 매달 내 통장에서 빠져나가는 돈은 &ldquo;상환 방법&quot;에 따라 크게 달라진다.
...
대출을 빨리 갚고 싶다면 어떤 순서가 좋을까? &nbsp; 일반적으로 금리가 높은 대출부터 먼저 갚는 것이 효율적이다. 다만 중도상환수수료가 있는 상품도 있으므로 실제로 갚기 전에는 수수료와 절감되는 이자를 함께 계산해야 한다.`}).add({id:66,href:"/posts/loan-glossary/",title:"대출 용어",description:` 대출이란? 돈을 빌리는 것을 말한다. 그러면 돈은 어디서 빌려야 하나? 흔하게 은행을 생각해 볼 수 있다. 그런데 처음 돈을 빌리기 위해 처음 은행에 가면 도대체 무슨 말을 하는지 알 수가 없다. 실은 나도 그랬고, 지금도 모르는 단어가 나올 때도 있다. 그래서 당황하지 말고 미리 간단히 단어라도 읶혀 가면 도움을 될 것이다. 여기에서는 최대한 쉽게 설명해 보도록 하겠다.
...
완제 &nbsp; 대출 받은 금액을 전액 상환하면 대출을 완제하였다고 한다.`}).add({id:67,href:"/posts/loan-interest-rate-structure/",title:"대출금리구조",description:"대출금리가 어떻게 정해지는지 기준금리, 가산금리, 우대금리로 나누어 초보자도 이해하기 쉽게 정리했다.",content:`대출 상담을 받으면 금리 숫자 하나만 보이기 쉽다. &ldquo;연 4.8%&ldquo;처럼 최종 금리만 들으면 비싸다, 싸다 정도는 느낄 수 있지만 왜 그 금리가 나왔는지는 잘 보이지 않는다.
...
대출금리는 세 가지로 나눠서 봐야 한다 &nbsp; 대출금리는 보통 다음 구조로 이해하면 쉽다.
대출금리 = 기준금리 + 가산금리 - 우대금리은행 앱이나 대출 약정서에서 보는 최종 금리는 이 세 가지가 합쳐진 결과다. 예를 들어 기준금리가 3.2%, 가산금리가 2.0%, 우대금리가 0.7%라면 실제 적용 금리는 연 4.5%가 된다.
구분 예시 의미 기준금리 3.2% 은행이 돈을 조달하는 기본 비용 가산금리 2.0% 고객 신용도, 비용, 위험, 은행 마진 우대금리 -0.7% 조건을 충족하면 깎아주는 금리 최종 대출금리 4.5% 실제로 내가 부담하는 금리 여기서 중요한 점은 &ldquo;기준금리&quot;라는 말이 항상 한국은행 기준금리만 뜻하지는 않는다는 것이다. 대출 상품에서 말하는 기준금리는 보통 코픽스, 금융채 금리, CD금리처럼 은행의 자금 조달 비용과 연결된 지표를 말한다.
...
기준금리는 대출금리의 출발점이다 &nbsp; 대출에서 기준금리는 은행이 돈을 마련하는 데 드는 원가에 가깝다. 은행도 고객에게 빌려줄 돈을 그냥 만들어내는 것이 아니라 예금, 적금, 은행채 발행, 금융시장 조달 등을 통해 마련한다.
대표적으로 많이 나오는 기준금리는 코픽스와 금융채 금리다.
코픽스는 은행의 조달비용을 반영한다 &nbsp; 코픽스는 은행들이 예금, 적금, 금융채 같은 방식으로 돈을 조달할 때 들어간 비용을 반영한 지표다. 주택담보대출 변동금리에서 자주 볼 수 있다.
...
금융채 금리는 은행채 시장과 연결된다 &nbsp; 금융채는 은행이나 금융회사가 자금을 조달하기 위해 발행하는 채권이다. 은행이 금융채를 발행하면 투자자에게 이자를 주고 돈을 빌리는 구조가 된다.
신용대출이나 일부 주택담보대출에서는 금융채 6개월물, 금융채 1년물, 금융채 5년물 같은 표현을 볼 수 있다. 이 금리가 오르면 은행의 조달비용이 올라가고, 대출 기준금리도 높아질 수 있다.
즉 대출에서 기준금리는 &ldquo;은행이 돈을 사오는 가격&quot;에 가깝다. 시장금리가 움직이면 기준금리도 영향을 받고, 기준금리가 움직이면 내 대출금리도 변동주기에 맞춰 달라질 수 있다.
가산금리는 은행이 붙이는 추가 금리다 &nbsp; 가산금리는 기준금리에 더해지는 금리다. 많은 사람이 대출금리를 볼 때 기준금리만 신경 쓰지만, 실제로는 가산금리가 최종 금리에 큰 영향을 준다.
가산금리에는 여러 요소가 들어간다.
고객의 신용점수와 연체 가능성 소득 안정성 담보가 있는지 여부 대출 기간과 상환 방식 은행의 업무 원가와 전산 비용 은행이 감당해야 하는 위험 비용 은행의 목표 이익률 예를 들어 같은 5,000만 원을 빌리더라도 신용점수가 높고 소득이 안정적인 사람과, 소득 변동이 크고 기존 대출이 많은 사람의 금리는 달라질 수 있다. 은행 입장에서는 돈을 돌려받지 못할 가능성이 다르기 때문이다.
...
가산금리는 은행마다 다르게 책정된다. 같은 기준금리를 쓰더라도 A은행과 B은행의 최종 금리가 다른 이유가 여기에 있다. 그래서 대출을 받을 때는 &ldquo;기준금리가 어디가 낮은가&quot;만 볼 것이 아니라 &ldquo;가산금리를 얼마나 붙였는가&quot;도 비교해야 한다.
우대금리는 조건을 맞추면 깎아주는 금리다 &nbsp; 우대금리는 대출금리에서 빼주는 금리다. 은행은 고객이 특정 조건을 충족하면 일정한 금리를 낮춰준다. 흔히 급여 이체, 카드 사용, 자동이체, 적금 가입, 앱 이용, 비대면 신청 같은 조건이 붙는다.
예를 들어 이런 식이다.
우대 조건 우대금리 예시 급여 이체 0.2%p 신용카드 사용 0.2%p 자동이체 등록 0.1%p 적금 또는 청약 가입 0.1%p 비대면 신청 0.1%p 이 조건을 모두 채우면 총 0.7%p를 깎아준다고 해보자. 기준금리 3.2%, 가산금리 2.0%인 대출이라면 우대 전 금리는 5.2%지만, 우대금리 0.7%p를 적용하면 최종 금리는 4.5%가 된다.
...
대출금리 비교할 때는 최종 금리만 보면 부족하다 &nbsp; 대출을 비교할 때 가장 먼저 보이는 것은 최종 금리다. 하지만 실제로는 그 금리가 어떻게 만들어졌는지 나눠서 봐야 한다.
예를 들어 두 은행의 최종 금리가 모두 4.5%라고 해보자.
구분 A은행 B은행 기준금리 3.0% 3.4% 가산금리 2.0% 1.6% 우대금리 -0.5% -0.5% 최종 금리 4.5% 4.5% 겉으로 보기에는 둘 다 같은 금리다. 하지만 A은행은 기준금리가 낮고 가산금리가 높다. B은행은 기준금리가 높고 가산금리가 낮다. 앞으로 시장금리가 내려가거나 올라갈 때, 어떤 기준금리를 쓰는지에 따라 금리 변동 폭이 달라질 수 있다.
...
기준금리가 코픽스인지, 금융채인지, 다른 지표인지 확인한다. 변동금리라면 금리 변경 주기가 3개월인지, 6개월인지, 1년인지 본다. 가산금리가 얼마인지 확인한다. 우대금리 조건이 현실적으로 유지 가능한지 본다. 우대금리가 빠졌을 때 최종 금리가 얼마나 오르는지 계산한다. 중도상환수수료와 상환 방식까지 함께 비교한다. 최저금리 문구만 보고 선택하면 실제 내가 받을 금리와 다를 수 있다. 대출은 &ldquo;광고에 나온 금리&quot;보다 &ldquo;내 조건으로 확정되는 금리&quot;가 중요하다.
정리 &nbsp; 대출금리는 하나의 숫자로 보이지만, 안에는 기준금리, 가산금리, 우대금리가 들어 있다. 기준금리는 은행이 돈을 조달하는 비용과 연결되고, 가산금리는 고객 위험과 은행 비용이 반영되며, 우대금리는 조건을 맞췄을 때 깎아주는 금리다.
핵심만 다시 정리하면 이렇다.
대출금리는 보통 기준금리 + 가산금리 - 우대금리 구조로 정해진다. 대출에서 말하는 기준금리는 한국은행 기준금리와 다를 수 있다. 코픽스와 금융채 금리는 대출 기준금리로 자주 쓰인다. 가산금리는 고객 신용도, 담보, 은행 비용, 위험 프리미엄이 반영되는 부분이다. 우대금리는 조건을 유지하지 못하면 줄어들 수 있다. 대출 비교는 최종 금리뿐 아니라 기준금리 종류, 가산금리, 우대 조건까지 함께 봐야 한다. 대출을 받을 때는 금리 숫자 하나만 보고 판단하지 않는 것이 좋다. 상담을 받을 때 &ldquo;기준금리는 무엇인지&rdquo;, &ldquo;가산금리는 얼마인지&rdquo;, &ldquo;우대금리는 어떤 조건인지&quot;를 나눠서 물어보면 훨씬 정확하게 비교할 수 있다.
자주 묻는 질문 &nbsp; Q1. 대출 기준금리와 한국은행 기준금리는 같은 말인가? &nbsp; 같은 말이 아니다. 한국은행 기준금리는 통화정책의 기준이 되는 금리이고, 대출 기준금리는 은행이 대출금리를 정할 때 사용하는 코픽스, 금융채 금리 같은 지표를 말하는 경우가 많다.
Q2. 기준금리가 내려가면 내 대출금리도 바로 내려가나? &nbsp; 바로 내려가지 않을 수 있다. 변동금리 대출은 정해진 변동주기에 따라 반영되고, 기준금리 종류도 상품마다 다르다. 여기에 가산금리와 우대금리 조건까지 함께 작동한다.
Q3. 우대금리는 무조건 많이 받을수록 좋은가? &nbsp; 대체로 금리를 낮출 수 있어 좋지만, 조건 유지가 가능한지 봐야 한다. 카드 실적이나 급여 이체 조건을 맞추기 어렵다면 나중에 우대금리가 빠져 실제 금리가 올라갈 수 있다.
Q4. 대출 갈아타기할 때 무엇을 가장 먼저 봐야 하나? &nbsp; 현재 대출의 최종 금리, 남은 기간, 중도상환수수료, 새 대출의 기준금리 종류와 우대 조건을 함께 봐야 한다. 단순히 새 대출 금리가 낮아 보여도 수수료와 조건을 합치면 이득이 작을 수 있다.`}).add({id:68,href:"/news/2026/taihan-fiberoptics-ai-infrastructure/",title:"대한광통신, AI 데이터센터 광케이블 기대와 1분기 적...",description:"대한광통신은 인캡아메리카 인수와 AI 데이터센터 광케이블 수요 기대가 커졌지만, 1분기 적자 지속과 밸류에이션 부담도 함께 확인됐다.",content:`이번 브리핑은 대한광통신 관련 보도가 최근 7일 안에 충분히 누적되지 않아, 신뢰할 만한 기사와 공시가 확인되는 2026년 4월 20일부터 2026년 5월 20일까지의 자료를 함께 정리했다.
...
한줄 요약 &nbsp; 대한광통신은 AI 데이터센터 광케이블과 북미 현지 생산 거점이라는 강한 성장 스토리를 확보했지만, 2026년 1분기 적자 지속 이후에는 인캡아메리카 연결 효과와 실제 수주 매출 전환을 숫자로 증명해야 하는 국면에 들어섰다.`}).add({id:69,href:"/posts/deposit-loan-interest-basics/",title:"돈을 맡기면 왜 이자를 줄까? 예금금리와 대출금리의 원리",description:"은행에 돈을 맡기면 왜 이자를 주는지, 예금금리와 대출금리는 어떻게 다른지, 은행이 돈을 버는 예대마진 구조까지 초보자 눈높이로 정리했다.",content:`은행에 돈을 맡기면 시간이 지난 뒤 이자가 붙는다. 처음 금융을 배울 때는 이 부분이 조금 이상하게 느껴질 수 있다. 은행이 내 돈을 보관해주는데 왜 오히려 나에게 돈을 더 줄까.
...
장기 미국채 ETF는 안전한 상품인가? &nbsp; 장기 미국채 ETF는 미국채에 투자하지만 가격 변동성이 작지 않다. 금리가 내려가면 크게 오를 수 있지만, 금리가 오르면 크게 떨어질 수 있다. 안정적인 현금 관리 목적이라면 장기채 ETF보다 단기채 상품이 더 적합한 경우가 많다.`}).add({id:73,href:"/posts/memory-semiconductor-supply-crunch/",title:"반도체 메모리 가격 급등, AI 수요가 D램·낸드·HB...",description:"AI 서버 수요로 HBM과 서버 D램 공급이 우선되면서 범용 D램·낸드 가격까지 급등하고 있다. 최근 메모리 반도체 수급과 시장 영향을 정리한다.",content:`주요 내용 &nbsp; 최근 메모리 반도체 시장의 핵심은 &ldquo;AI 서버가 메모리를 빨아들이고 있다&quot;는 점이다. HBM과 서버용 D램, 엔터프라이즈 SSD 수요가 급증하면서 삼성전자, SK하이닉스, 마이크론 등 주요 공급사는 수익성이 높은 서버·AI용 제품에 생산능력을 우선 배분하고 있다.
...
초보자는 개별 배당주와 배당 ETF 중 무엇이 나을까? &nbsp; 개별 기업을 분석하기 어렵다면 배당 ETF로 시작하는 것도 방법이다. 여러 종목에 나누어 투자할 수 있어 특정 기업의 배당 축소나 주가 하락 위험을 줄이는 데 도움이 된다.`}).add({id:77,href:"/posts/bank-run/",title:"뱅크런 뜻과 원인, 실제 사례로 쉽게 이해하는 은행 대...",description:"뱅크런의 뜻과 발생 원인, 실리콘밸리은행 등 실제 사례, 디지털 뱅크런의 특징과 개인이 확인해야 할 예금자보호 기준을 쉽게 정리했다.",content:`은행은 평소에는 가장 안전한 금융기관처럼 느껴진다. 월급이 들어오고, 카드값이 빠져나가고, 정기예금과 적금을 맡겨두는 곳이기 때문이다. 그런데 금융 뉴스에서 가끔 &ldquo;뱅크런 우려&rdquo;, &ldquo;대규모 예금 인출&rdquo;, &ldquo;은행 유동성 위기&rdquo; 같은 표현이 나오면 갑자기 불안해진다.
...
저축은행이나 인터넷은행도 뱅크런이 생길 수 있나? &nbsp; 가능하다. 뱅크런은 특정 금융권에만 생기는 현상이 아니라 신뢰가 흔들릴 때 발생한다. 인터넷은행은 앱으로 거래가 빠르기 때문에 인출 속도가 빠를 수 있고, 저축은행은 예금금리가 높아 큰 금액이 몰릴 수 있어 보호 한도와 상품 성격을 더 꼼꼼히 확인하는 것이 좋다.`}).add({id:78,href:"/news/2026/berkshire-hathaway-market-update/",title:"버크셔 해서웨이 최신 뉴스, 그레그 아벨 첫 분기와 포...",description:"버크셔 해서웨이의 2026년 1분기 실적, 사상 최대 현금 보유, 그레그 아벨 체제 첫 13F 포트폴리오 재편과 시장 영향을 정리한다.",content:`이번 브리핑은 2026년 5월 2일부터 5월 25일까지 나온 버크셔 해서웨이 관련 보도와 공시를 중심으로 정리했다.
버크셔 해서웨이 (Berkshire Hathaway) &nbsp; 기업 개요: 미국의 보험업(GEICO 등)을 기반으로 막대한 현금흐름(플로트)을 확보하고, 이를 철도(BNSF), 에너지(Berkshire Hathaway Energy), 제조업 및 유통업 등 다양한 실물 사업에 투자하는 지주회사이다. 주요 투자: 애플(Apple), 코카콜라(Coca-Cola), 뱅크오브아메리카(Bank of America) 등 우량 기업의 대주주로 유명하다. 주식 구조: 원주인 A주(NYSE: BRK.A)와 이를 분할한 B주(NYSE: BRK.B)로 나뉘며, A주는 주당 가격이 매우 높아 B주가 주로 거래된다. 주요 내용 &nbsp; 버크셔 해서웨이는 2026년 1분기 영업이익 113억4600만 달러를 발표했다. 전년 동기 96억4100만 달러보다 늘었고, 순이익은 101억600만 달러로 전년 동기 46억300만 달러보다 크게 증가했다. 현금 및 단기투자 자산은 2026년 3월 말 3974억 달러 수준으로 보도되며 사상 최대치에 도달했다. 버크셔는 같은 분기 순매도로 주식 포트폴리오를 줄였고, 대형 인수나 공격적 매수보다 유동성 확보를 우선하는 모습이다. 그레그 아벨 CEO 체제 첫 13F 공시에서는 델타항공과 메이시스 신규 매수, 알파벳 지분 확대, 비자·마스터카드·아마존·유나이티드헬스 등 일부 보유종목 정리가 확인됐다. 2026년 5월 2일 연례 주주총회는 워런 버핏이 CEO가 아닌 의장으로 참석한 첫 행사였다. 회의 분위기는 버핏 특유의 투자 강연보다 아벨 중심의 사업 설명과 운영 이슈 논의로 옮겨갔다. 시장의 핵심 질문은 명확하다. 버크셔가 약 4000억 달러에 가까운 현금을 언제, 어떤 가격에, 어떤 자산에 투입할 것인지다. 주요 트렌드 &nbsp; 버크셔는 기술주 중심 랠리가 강한 시장에서도 현금을 크게 쌓고 있다. 이는 단기 수익률보다 안전마진과 대형 기회를 기다리는 기존 자본 배분 원칙이 유지되고 있다는 신호로 볼 수 있다. 아벨 체제에서는 포트폴리오 조정 속도가 빨라졌다. 델타항공 신규 편입, 알파벳 확대, 결제 네트워크 일부 청산은 버핏 시대의 이미지와 완전히 같지는 않은 방향이다. 버크셔 주총의 중심도 바뀌고 있다. 투자자들은 이제 버핏의 종목 선택보다 아벨의 운영 능력, 보험·철도·에너지 사업 관리, 자사주 매입 기준을 더 직접적으로 봐야 한다. AI와 빅테크가 시장 주도권을 잡은 상황에서 버크셔의 보수적 현금 전략은 방어력으로도, 기회비용으로도 해석되고 있다. 핵심 이슈 &nbsp; 첫 번째 이슈는 현금의 활용이다. 3974억 달러 규모의 현금성 자산은 위기 때 강력한 무기가 될 수 있지만, 강세장이 이어지면 주주 입장에서는 수익률을 낮추는 요인이 될 수 있다. 두 번째는 13F 포트폴리오 재편의 의미다. 델타항공과 메이시스 신규 매수, 알파벳 확대는 아벨 체제가 기존 포트폴리오를 단순히 보존하지 않고 재검토하고 있음을 보여준다. 세 번째는 승계 신뢰다. 버핏은 여전히 의장으로 남아 있지만, 실제 경영과 상당 부분의 주식 포트폴리오 의사결정은 아벨 체제로 이동했다. 네 번째는 주가 상대 성과다. 일부 보도는 버크셔 주가가 버핏의 CEO 퇴임 발표 이후 S&amp;P 500 대비 크게 뒤처졌다고 지적했다. 시장은 버크셔의 안정성뿐 아니라 성장성과 자본 배분 속도도 요구하고 있다. 시장 영향 &nbsp; 델타항공, 메이시스, 알파벳 확대는 해당 종목에 단기적으로 &ldquo;버크셔가 검토한 자산&quot;이라는 신호를 줄 수 있다. 특히 델타항공은 팬데믹 이후 버크셔가 항공주를 다시 담았다는 점에서 상징성이 크다. 비자, 마스터카드, 아마존, 유나이티드헬스 등 일부 종목 정리는 버크셔가 장기 보유 이미지와 달리 새 체제에서 더 적극적으로 포트폴리오를 정리할 수 있음을 보여준다. 버크셔 자체 주가에는 두 가지 힘이 동시에 작용한다. 사상 최대 현금은 하락장 방어력과 향후 투자 여력을 의미하지만, 현금 비중이 큰 만큼 AI·기술주 랠리에서는 상대 수익률이 낮아질 수 있다. 국내 투자자에게는 BRK.B를 &ldquo;미국 주식 전체를 대신하는 안정형 종목&quot;으로만 보기보다, 보험·철도·에너지·제조 사업과 거대한 현금성 자산을 가진 복합 지주회사로 이해하는 것이 중요하다. 향후 전망 &nbsp; 단기적으로는 2026년 2분기 이후 자사주 매입 규모가 확대되는지, 또는 대형 인수합병 신호가 나오는지가 핵심 관전 포인트다. 주식시장이 조정을 받으면 버크셔의 현금은 강력한 매수 여력으로 재평가될 수 있다. 반대로 기술주 중심 강세장이 계속되면 &ldquo;너무 많은 현금&quot;이라는 비판이 이어질 가능성이 있다. 아벨 CEO는 버핏의 투자 원칙을 유지하겠다는 기대와, 새 시대에 맞는 포트폴리오 재편을 보여줘야 하는 압박을 동시에 받고 있다. 13F는 분기 말 보유 현황을 뒤늦게 보여주는 자료이므로, 현재의 실제 포지션과는 차이가 있을 수 있다. 투자자는 공시 숫자를 방향성 확인용으로 보고, 실시간 매매 신호처럼 해석하지 않는 편이 안전하다. 주요 뉴스 &nbsp; 2026-05-02 SEC: Berkshire Hathaway Inc. First Quarter 2026 Earnings Release
버크셔 해서웨이는 2026년 1분기 순이익 101억600만 달러, 영업이익 113억4600만 달러를 발표했다. 회사는 투자 평가손익이 분기 순이익을 크게 왜곡할 수 있다며, 투자자에게 10-Q를 함께 읽을 것을 권고했다.
2026-05-02 Financial Express: Berkshire Hathaway’s cash pile hits record $397 billion in Greg Abel’s first quarter as CEO
...
2026-05-02 Reuters: Berkshire shareholders head to Greg Abel’s first annual meeting, with Buffett in audience
...
2026-05-02 AP: Crowd shrinks as Berkshire Hathaway’s new CEO leads the annual meeting for the first time Saturday
AP는 2026년 버크셔 연례 주주총회가 버핏 중심의 행사에서 아벨 중심의 사업 논의로 바뀌었다고 전했다. 참석 규모는 과거보다 줄었지만, 보험 리스크, 에너지 수요, AI 활용 같은 실제 사업 이슈가 더 많이 다뤄졌다.
2026-05-15 AP: Berkshire Hathaway triples Alphabet stake and invests in Delta and Macy&rsquo;s under new CEO
...
2026-05-15 Reuters: Berkshire buys Delta, more Alphabet; sheds Amazon, UnitedHealth, Visa and Mastercard
...
2026-05-20 Barchart: Berkshire Hathaway Sold Off 5 Longtime Warren Buffett Stocks. What the New Abel Era Means for You.
Barchart는 아벨 체제 첫 13F가 단순한 소폭 조정이 아니라 포트폴리오 재편에 가깝다고 평가했다. 메이시스와 델타항공 신규 편입, 알파벳 확대, 뉴욕타임스 지분 확대, 셰브론 축소와 일부 종목 청산을 함께 짚었다.
한줄 요약 &nbsp; 버크셔 해서웨이는 그레그 아벨 첫 분기에 사상 최대 현금과 강한 영업이익을 보여줬지만, 시장의 관심은 이제 &ldquo;버핏 이후에도 같은 원칙으로 더 좋은 자본 배분을 할 수 있는가&quot;에 집중되고 있다.`}).add({id:79,href:"/posts/holding-tax-property-comprehensive-real-estate-tax/",title:"보유세란? 재산세, 종부세 기준과 공시가격 쉽게 정리",description:"보유세의 뜻부터 재산세와 종합부동산세 차이, 6월 1일 과세 기준일, 공시가격 조회와 이의신청, 계산 흐름까지 초보자 눈높이로 정리했다.",content:`집을 갖고 있으면 매년 세금 고지서가 온다. 집을 팔아서 차익이 생긴 것도 아닌데 왜 세금을 내야 하는지 처음에는 헷갈릴 수 있다. 이때 나오는 말이 바로 보유세다.
...
정기보험 보험 기간이 정해져 있는 보험이다. 대부분 해약해도 해약환급금이 없거나 매우 적은 소멸성 보험으로 보험료가 저렴하고 가입하기 쉽다는 특징이 있다. 양로보험 정기보험과 마찬가지로 보험기간이 정해져 있으며, 보험기간 중 사망하면 사망보험금을, 만기까지 생존해 있으면 만기보험금을 받을 수 있다. 사망보험금과 만기보험금이 동일한 금액으로 &lsquo;생사혼합형 보험&rsquo;이라고도 한다. 종신보험 피보험자가 사망할 때까지 보장이 지속되는 보험이다. 사망 시점에 사망보험금이 지급된다. 보험료는 정기보험에 비해 비싸고, 보험기간 중 중도해지 시 해약환급금이 지급된다. 보험료는 정기보험에 비해 비싸다.`}).add({id:82,href:"/posts/value-added-tax-basics/",title:"부가가치세란 어떤 세금일까, 부가세 별도와 계산 방법 ...",description:"부가가치세의 뜻과 부가세 별도 의미, 최종소비자와 사업자의 관계, 매출세액과 매입세액을 이용한 계산 방법과 신고 기간을 쉽게 정리했다.",content:`물건을 사거나 서비스를 이용할 때 &ldquo;부가세 포함&rdquo;, &ldquo;부가세 별도&quot;라는 말을 자주 듣는다. 특히 견적서를 받을 때 100만 원이라고 생각했는데 마지막에 부가세 10만 원이 붙어 110만 원이 되는 경우가 있다. 그냥 내라고 하니까 내기는 하지만, 이 돈이 정확히 어떤 세금인지 헷갈릴 수 있다.
...
매도자가 모바일 사용을 어려워하면 전자계약을 못 하나? &nbsp; 반드시 못 하는 것은 아니다. 다만 본인인증과 전자서명 과정이 필요하므로 시간이 더 걸릴 수 있다. 본인 명의 휴대폰, 인증 수단, 신분증을 미리 준비하고, 공인중개사에게 천천히 진행해달라고 요청하는 것이 좋다.`}).add({id:85,href:"/posts/real-estate-purchase-process/",title:"부동산매매절차",description:"부동산 매매 절차를 매물 탐색, 현장 확인, 등기부 확인, 계약금, 중도금, 잔금, 소유권 이전 등기 순서로 쉽게 정리했다.",content:`부동산 매매는 마음에 드는 집을 고르고 계약서에 도장만 찍으면 끝나는 일이 아니다. 매물 확인, 가격 협상, 계약금 입금, 대출 실행, 잔금 지급, 소유권 이전 등기까지 여러 단계가 이어진다.
처음 집을 사는 사람은 이 흐름을 모르면 중간에 당황하기 쉽다. 특히 &ldquo;가계약금만 먼저 보내면 된다&rdquo;, &ldquo;등기부는 계약 때 보면 된다&rdquo;, &ldquo;잔금일에 은행이 알아서 해준다&quot;처럼 대충 넘기면 큰 금액이 걸린 거래에서 위험이 커진다.
부동산 매매는 순서를 알고 움직이면 훨씬 덜 어렵다. 이 글에서는 집을 사는 사람 기준으로 매물 탐색부터 잔금 이후 처리까지 실제로 어떤 절차를 밟는지 정리하였다.
부동산 매매 절차 한눈에 보기 &nbsp; 주택 매매는 보통 아래 순서로 진행된다.
단계 핵심 내용 1. 자금 계획 세우기 보유 현금, 대출 가능 금액, 취득세와 중개수수료 계산 2. 매물 탐색 호가, 실거래가, 주변 시세, 거래량 확인 3. 현장 방문 집 상태, 누수, 소음, 일조, 주차, 관리비 확인 4. 권리관계 확인 등기부등본, 건축물대장, 임차인 여부 확인 5. 가격과 조건 협상 매매가, 잔금일, 옵션, 수리, 특약 조율 6. 계약서 작성 계약금 지급, 계약서와 특약 확정 7. 중도금 지급 계약 이후 권리 변동 재확인 8. 잔금 지급 대출 실행, 근저당 말소, 열쇠 인수, 등기 진행 9. 잔금 이후 처리 취득세 납부, 소유권 이전 등기, 전입신고, 관리사무소 명의 변경 거래마다 중도금이 없을 수도 있고, 대출 일정이나 이사 일정에 따라 잔금일까지 걸리는 시간도 다르다. 그래도 큰 흐름은 거의 비슷하다. 중요한 것은 각 단계에서 확인해야 할 서류와 돈의 흐름을 놓치지 않는 것이다.
매물 찾기 전에 자금 계획부터 세워야 한다 &nbsp; 부동산 매매의 시작은 매물 검색이 아니라 자금 계획이다. 내가 살 수 있는 집값을 정확히 알아야 불필요한 매물을 줄이고, 계약 직전 대출 문제로 흔들리는 일을 막을 수 있다.
자금 계획은 단순히 &ldquo;내 돈 + 대출 = 매매가&quot;로 끝나면 안 된다. 집을 살 때는 매매가 외에도 취득세, 지방교육세, 중개수수료, 등기비용, 국민주택채권 비용, 이사비, 관리비 정산금이 필요하다.
...
현재 바로 쓸 수 있는 현금 주택담보대출 예상 한도 신용대출 등 추가 차입 가능 여부 계약금으로 바로 낼 수 있는 금액 취득세, 중개수수료, 등기비용 등 부대비용 잔금일 전후 예비비 대출을 이용할 예정이라면 은행이나 대출 상담을 통해 대략적인 한도를 먼저 확인해야 한다. 매매계약을 먼저 하고 나중에 대출을 알아보다가 한도가 부족하면 계약금 손실 문제가 생길 수 있다.
매물 탐색과 현장 방문에서 볼 것 &nbsp; 매물을 볼 때 가장 먼저 보이는 것은 가격이다. 하지만 매물에 올라온 가격은 실제 거래가격이 아니라 집주인이 부르는 호가다. 호가와 실거래가는 다를 수 있으므로 최근 실거래가를 함께 봐야 한다.
같은 단지라도 동, 층, 향, 조망, 수리 상태, 주차 편의에 따라 가격이 달라진다. 그래서 단순히 &ldquo;이 단지는 8억&quot;처럼 보는 것보다 최근 거래된 같은 면적의 가격과 현재 나온 매물 가격을 비교해야 한다.
온라인에서 먼저 확인할 것 &nbsp; 온라인으로 매물을 볼 때는 아래 내용을 먼저 걸러보면 좋다.
최근 실거래가와 현재 호가 차이 같은 단지의 매물 수와 가격 분포 전세가율과 주변 전세 시세 관리비 수준 준공연도와 세대 수 역, 학교, 병원, 마트 등 생활 편의시설 재건축, 재개발, 토지거래허가구역 등 규제 이슈 매물이 시세보다 유난히 싸다면 이유를 확인해야 한다. 급매일 수도 있지만, 권리관계가 복잡하거나 집 상태가 좋지 않거나 세입자와 인도 일정이 맞지 않는 물건일 수도 있다.
현장 방문에서 볼 것 &nbsp; 집을 직접 보러 가면 구조나 인테리어에 먼저 눈이 간다. 하지만 실제로는 생활 불편과 수리 비용을 만들 수 있는 부분을 더 꼼꼼히 봐야 한다.
천장, 벽지, 베란다의 누수 흔적 창문 결로와 곰팡이 층간소음과 외부 소음 햇빛이 들어오는 시간과 방향 주차 공간과 출입 동선 엘리베이터 대기 시간 수도, 보일러, 전기, 배수 상태 관리사무소 분위기와 관리비 낮에 본 집과 밤에 본 집의 느낌이 다를 수 있다. 가능하다면 다른 시간대에 한 번 더 가보는 것도 좋다. 출퇴근 시간 교통, 야간 소음, 주차 상황은 낮에 잠깐 보는 것만으로는 확인하기 어렵다.
계약 전에는 등기부와 권리관계를 확인해야 한다 &nbsp; 마음에 드는 집을 찾았다면 계약 전에 권리관계를 확인해야 한다. 이 단계에서 가장 중요한 서류는 등기부등본이다.
등기부등본은 그 집의 소유자가 누구인지, 근저당권이 잡혀 있는지, 압류나 가압류가 있는지 확인할 수 있는 서류다. 계약 상대방이 실제 소유자인지 확인하지 않고 돈을 보내면 위험하다.
등기부등본에서 볼 것 &nbsp; 등기부등본을 볼 때는 최소한 아래 항목을 확인해야 한다.
계약하려는 사람이 등기부상 소유자와 같은지 공동명의라면 모든 소유자가 계약에 동의했는지 근저당권 금액이 얼마인지 압류, 가압류, 가처분, 가등기가 있는지 신탁등기 여부가 있는지 전세권이나 임차권등기가 설정되어 있는지 근저당이 있다고 해서 무조건 거래가 불가능한 것은 아니다. 주택담보대출이 있는 집은 근저당이 잡혀 있는 경우가 많다. 다만 잔금일에 매도인의 대출을 상환하고 근저당 말소가 동시에 진행되어야 한다. 이 부분은 계약서 특약으로 명확히 적어두는 것이 안전하다.
건축물대장과 임차인도 확인해야 한다 &nbsp; 아파트는 비교적 단순한 편이지만, 빌라나 단독주택은 건축물대장도 확인해야 한다. 위반건축물 여부, 실제 용도, 면적, 층수 등이 매물 설명과 다른 경우가 있기 때문이다.
세입자가 살고 있는 집이라면 임대차 계약 내용도 확인해야 한다. 세입자가 언제 나가는지, 보증금은 어떻게 반환되는지, 잔금일에 집을 비워줄 수 있는지 확인하지 않으면 입주 일정이 꼬일 수 있다.
계약금과 매매계약서 작성 &nbsp; 조건이 맞으면 매매계약서를 작성한다. 보통 계약금은 매매가의 10% 정도로 정하는 경우가 많지만, 당사자 협의에 따라 달라질 수 있다.
주의할 점은 가계약이다. &ldquo;좋은 매물이니 일단 가계약금부터 보내라&quot;는 말을 듣는 경우가 있다. 그런데 가계약금도 계약 내용이 구체적으로 정해져 있다면 법적 효력이 문제 될 수 있다. 그래서 돈을 보내기 전에 최소한 매매가, 계약금, 중도금, 잔금일, 계약 해제 조건, 특약을 문자나 문서로 명확히 남겨야 한다.
계약금은 반드시 등기부상 소유자 명의 계좌로 보내는 것이 원칙이다. 가족이나 중개사 계좌로 보내달라는 요청은 피하는 것이 좋다. 공동명의라면 소유자 전원의 동의와 위임 여부를 확인해야 한다.
계약서에 꼭 넣을 특약 &nbsp; 특약은 구두 약속을 문서로 남기는 역할을 한다. 계약서 본문에 없는 중요한 조건은 특약으로 적어두는 것이 좋다.
대표적으로 아래 내용을 검토할 수 있다.
잔금일에 매도인의 근저당을 말소한다. 잔금 지급과 동시에 소유권 이전 등기에 필요한 서류를 제공한다. 기존 임차인이 있다면 잔금일까지 명도한다. 대출이 불가능할 경우 계약 해제와 계약금 반환 조건을 정한다. 하자나 누수 발견 시 처리 주체를 정한다. 붙박이장, 에어컨, 가전 등 포함되는 옵션을 명확히 한다. 관리비, 장기수선충당금, 공과금 정산 기준을 정한다. 특히 대출을 받아야 살 수 있는 집이라면 대출 불가 시 어떻게 할지 반드시 협의해야 한다. 모든 계약에서 매수자에게 유리한 대출 특약이 자동으로 들어가는 것은 아니므로, 계약 전에 중개사와 매도인에게 명확히 이야기해야 한다.
중도금과 잔금일에 확인할 것 &nbsp; 계약 후에는 중도금과 잔금 일정에 맞춰 돈을 준비한다. 중도금이 없는 계약도 있지만, 중도금이 있다면 그 시점부터 계약 해제가 더 복잡해질 수 있다. 단순 변심으로 빠져나오기 어려워질 수 있으므로 중도금 지급 전에도 등기부등본을 다시 확인하는 것이 좋다.
잔금일은 부동산 매매에서 가장 바쁜 날이다. 대출 실행, 잔금 송금, 매도인 대출 상환, 근저당 말소, 열쇠 인수, 소유권 이전 등기 서류 전달이 한 번에 진행된다.
잔금일 전 체크리스트 &nbsp; 잔금일 며칠 전에는 아래 내용을 미리 확인해야 한다.
은행 대출 실행일과 잔금일이 같은지 확인했는가? 내 계좌의 이체 한도가 잔금 송금액보다 큰가? 계약 이후 등기부등본에 새 권리 변동이 없는가? 매도인의 근저당 말소 절차가 준비되어 있는가? 법무사에게 소유권 이전 등기 서류를 확인했는가? 중개수수료, 법무사 비용, 취득세 납부 자금을 준비했는가? 선수관리비, 관리비, 공과금 정산 금액을 확인했는가? 열쇠, 공동현관 카드, 주차 등록, 관리사무소 인계 사항을 확인했는가? 잔금은 보통 매도인 계좌로 송금한다. 매도인 대출이 남아 있다면 일부 금액은 해당 금융기관 상환 계좌로 바로 들어가기도 한다. 이때 근저당 말소가 실제로 진행되는지 법무사와 함께 확인하는 것이 안전하다.
잔금 지급 후에는 바로 열쇠를 받고 집 상태를 다시 확인한다. 계약 때 포함하기로 한 옵션이 빠져 있거나, 갑자기 생긴 파손이 있다면 현장에서 바로 이야기해야 한다.
잔금 이후 취득세와 등기까지 마무리해야 한다 &nbsp; 잔금을 보냈다고 해서 모든 절차가 끝난 것은 아니다. 법적으로 내 집이 되려면 소유권 이전 등기가 필요하다. 보통 법무사가 등기 업무를 대행하지만, 매수자도 일정과 완료 여부를 확인해야 한다.
...
부동산 매매에서 자주 하는 실수 &nbsp; 부동산 매매는 금액이 크기 때문에 작은 실수도 손실로 이어질 수 있다. 처음 집을 살 때 특히 많이 하는 실수는 아래와 같다.
...
셋째, 특약을 대충 쓰는 것이다. &ldquo;알아서 해주겠지&quot;라고 생각한 내용은 분쟁이 생기면 증명하기 어렵다. 잔금일, 명도, 하자, 옵션, 근저당 말소, 대출 불가 조건은 가능한 한 구체적으로 적어야 한다.
...
정리 &nbsp; 부동산 매매 절차는 매물 탐색, 현장 방문, 권리관계 확인, 계약, 중도금, 잔금, 소유권 이전 등기 순서로 이어진다. 겉으로는 단순해 보여도 각 단계마다 확인할 돈과 서류가 있다.
...
자주 묻는 질문 &nbsp; 부동산 매매계약 전에 가계약금을 보내도 될까? &nbsp; 가계약금도 상황에 따라 계약 효력이 문제 될 수 있으므로 신중해야 한다. 보내기 전에는 매매가, 계약금, 잔금일, 계약 해제 조건, 대출 불가 시 처리, 반환 조건을 문자나 문서로 남기는 것이 좋다. 가능하면 등기부등본과 소유자 계좌를 먼저 확인해야 한다.
등기부등본은 언제 확인해야 할까? &nbsp; 최소한 계약 전, 계약 당일, 잔금 전에는 확인하는 것이 좋다. 중도금이 있다면 중도금 지급 전에도 다시 보는 편이 안전하다. 계약 이후 새 근저당, 압류, 가압류가 생겼는지 확인해야 하기 때문이다.
잔금일에는 누가 참석하나? &nbsp; 보통 매수인, 매도인, 공인중개사, 법무사가 함께 진행한다. 대출이 있는 경우 은행 업무도 동시에 진행된다. 매도인의 기존 대출을 상환하고 근저당을 말소해야 한다면 법무사와 금융기관 확인이 특히 중요하다.
취득세는 언제까지 내야 할까? &nbsp; 일반적으로 취득일부터 60일 이내에 신고하고 납부해야 한다. 보통 잔금일을 기준으로 준비하지만, 구체적인 기한과 세액은 거래 형태와 등기 일정에 따라 달라질 수 있으므로 법무사나 관할 지자체에 확인하는 것이 좋다.
중도금이 없는 계약도 괜찮을까? &nbsp; 가능하다. 매도인과 매수인이 합의하면 계약금과 잔금만으로 진행할 수 있다. 다만 잔금일까지 기간이 길거나 매도인이 확실한 이행 의사를 원한다면 중도금을 요구할 수 있다. 중도금 지급 이후에는 계약 해제가 더 복잡해질 수 있으므로 지급 전 점검이 중요하다.`}).add({id:86,href:"/posts/diversified-investing-portfolio/",title:"분산투자 포트폴리오",description:"분산투자와 포트폴리오의 뜻, 집중투자의 위험, 상관계수가 낮은 자산을 섞는 법, 적립식 투자와 리밸런싱 방법을 쉽게 정리했다.",content:`투자를 시작하면 가장 자주 듣는 말이 있다. &ldquo;계란을 한 바구니에 담지 말라&quot;는 말이다. 말은 쉬운데 막상 내 계좌를 보면 한두 종목, 한 가지 자산, 한 번의 매수 타이밍에 돈이 몰려 있는 경우가 많다.
...
이 글에서는 분산투자와 포트폴리오의 뜻, 분산투자가 필요한 이유, 초보자가 바로 적용할 수 있는 자산 분산과 시점 분산 방법을 정리하였다. 핵심은 종목 수를 많이 늘리는 것이 아니라, 서로 다르게 움직이는 자산을 섞고 한 번에 모든 돈을 넣지 않는 것이다.
...
자산 예시 포트폴리오에서 맡는 역할 국내 주식 익숙한 기업에 투자하고 국내 경기 흐름을 반영한다 해외 주식 특정 국가에만 묶이지 않고 글로벌 성장에 참여한다 채권 주식보다 변동성을 낮추고 이자 수익을 기대한다 현금·예금 급락장 대응, 생활비, 비상금 역할을 한다 금·리츠 주식과 다른 흐름을 보일 때 보완재로 활용할 수 있다 분산투자는 큰 손실을 줄이는 데 도움이 된다 &nbsp; 투자에서 손실은 단순히 숫자만의 문제가 아니다. 10% 손실은 11.1% 수익을 내면 회복할 수 있지만, 50% 손실은 다시 100% 수익을 내야 원금으로 돌아온다. 손실이 커질수록 회복에 필요한 수익률은 훨씬 가파르게 올라간다.
...
구분 집중투자 분산투자 투자 방식 소수 종목이나 자산에 크게 투자한다 여러 종목, 자산군, 시점으로 나눈다 장점 판단이 맞으면 수익률이 클 수 있다 특정 자산 실패가 전체 계좌에 주는 충격을 줄인다 단점 판단이 틀리면 손실이 크게 집중된다 단기 고수익 기대는 낮아질 수 있다 잘 맞는 경우 분석 역량과 위험 감수력이 높은 경우 초보 투자, 장기 자금, 노후 자금 관리 서로 다르게 움직이는 자산을 섞어야 한다 &nbsp; 분산투자는 단순히 종목 수를 늘리는 것만으로 끝나지 않는다. 비슷하게 움직이는 자산만 많이 담으면 겉으로만 분산된 포트폴리오가 된다.
...
상관계수가 낮다는 말은 두 자산이 항상 같은 방향으로 움직이지 않는다는 뜻이다. 대표적으로 주식과 채권은 경제 상황과 금리 흐름에 따라 서로 다른 모습을 보일 때가 많다. 물론 모든 시기에 주식과 채권이 반대로 움직인다고 단정할 수는 없지만, 주식만 담는 것보다 포트폴리오 충격을 줄이는 데 도움이 될 수 있다.
...
다만 ETF도 분산의 방향을 확인해야 한다. 이름은 달라도 구성 종목이 비슷한 ETF를 여러 개 사면 실제로는 같은 자산을 반복해서 사는 결과가 될 수 있다. 예를 들어 미국 대형 기술주 비중이 높은 ETF를 여러 개 담으면 종목 수는 많아 보여도 기술주 쏠림이 커질 수 있다.
...
예를 들어 매달 50만 원씩 S&amp;P500 ETF와 채권형 ETF에 나눠 넣기로 정했다면, 시장 뉴스가 나올 때마다 매수 여부를 다시 판단하지 않아도 된다. 투자 판단을 매일 하는 대신, 미리 정한 규칙을 반복하는 방식이다. 초보자에게는 이 단순함이 큰 장점이 된다.
...
예시로 단순한 포트폴리오를 만들면 다음처럼 생각할 수 있다.
투자 성향 예시 비중 특징 안정형 주식 30%, 채권 40%, 현금 30% 큰 수익보다 손실 방어와 현금 확보를 중시한다 중립형 주식 60%, 채권 30%, 현금 10% 성장성과 안정성의 균형을 노린다 공격형 주식 80%, 채권 10%, 현금 10% 장기 수익을 기대하지만 변동성이 크다 이 비중은 정답이 아니라 출발점이다. 나이, 소득 안정성, 투자 기간, 대출 여부, 하락장에서 버틸 수 있는 성향에 따라 달라져야 한다.
...
처음에는 복잡하게 시작하지 않아도 된다. 내가 가진 자산을 적고, 특정 종목이나 자산에 돈이 몰려 있는지 확인하고, 매달 일정 금액을 나누어 투자하는 것부터 시작하면 된다. 분산투자는 투자 실수를 없애는 방법이 아니라, 실수를 해도 다시 회복할 수 있는 여지를 남기는 방법이다.
포트폴리오를 만들었다면 1년에 한두 번은 꼭 점검하자. 내 목표 비중과 실제 비중이 얼마나 달라졌는지, 한 업종이나 한 국가에 너무 치우치지 않았는지, 곧 써야 할 돈이 위험자산에 들어가 있지 않은지 확인하는 것만으로도 투자 습관이 좋아진다.
...
분산투자는 어떻게 시작하면 좋은가? &nbsp; 먼저 현재 자산 비중을 적어보고, 특정 종목이나 업종에 돈이 몰려 있는지 확인하면 된다. 이후 주식, 채권, 현금, ETF처럼 성격이 다른 자산으로 나누고, 한 번에 투자하기보다 매달 일정 금액을 나누어 투자하는 방식으로 시작할 수 있다.
종목을 많이 사면 무조건 분산투자인가? &nbsp; 아니다. 같은 업종, 같은 국가, 같은 테마에 속한 종목만 많이 사면 실제 위험은 크게 줄지 않을 수 있다. 종목 수보다 자산군, 업종, 국가, 투자 시점이 함께 나뉘어 있는지를 보는 것이 중요하다.
분산투자를 하면 수익률이 낮아지나? &nbsp; 단기적으로는 집중투자보다 수익률이 낮아 보일 수 있다. 하지만 분산투자의 목적은 최고 수익률을 맞히는 것이 아니라 큰 손실을 줄이고 장기 투자 확률을 높이는 데 있다. 특히 초보자나 장기 노후 자금에는 안정적으로 버티는 힘이 중요하다.`}).add({id:87,href:"/posts/illegal-building-home-purchase/",title:"불법 건축물 매매해도 괜찮을까? 위반건축물 확인 방법과...",description:"불법 건축물과 위반건축물이 무엇인지, 매매할 때 어떤 위험이 있는지, 건축물대장 확인 방법과 계약 전 체크포인트를 누구나 이해하기 쉽게 정리하였다.",content:`집을 보러 다니다 보면 생각보다 자주 듣는 말이 있다. &ldquo;이 부분은 불법 건축물이긴 한데 사는 데는 전혀 지장 없어요&rdquo;, &ldquo;나중에 양성화되면 괜찮아져요&rdquo;, &ldquo;다들 이렇게 하고 살아요&rdquo; 같은 말이다. 처음 집을 사는 사람 입장에서는 이 말이 꽤 그럴듯하게 들린다. 집이 깨끗하고 가격도 괜찮으면 더 흔들린다.
...
사모펀드가 위험한 이유는 무엇인가? &nbsp; 투자 대상이 복잡하고, 비상장 자산처럼 가격 확인이 어려운 자산에 투자하는 경우가 많으며, 자금이 오래 묶일 수 있기 때문이다. 수익 가능성이 큰 만큼 손실 가능성과 환매 제한도 함께 봐야 한다.`}).add({id:89,href:"/posts/samsung-electro-mechanics-ai-components/",title:"삼성전기, AI 부품 대형 수주와 MLCC·FC-BGA...",description:"삼성전기가 1.5조원대 실리콘 커패시터 공급계약과 AI 서버용 MLCC·FC-BGA 수요 확대로 주가와 실적 기대가 동시에 재평가되고 있다.",content:`주요 내용 &nbsp; 삼성전기 이슈의 중심은 AI 서버용 고부가 부품이다. 2026년 5월 20일 회사가 약 1조 5,000억 원 규모의 실리콘 커패시터 공급계약을 발표하면서, 기존 MLCC와 FC-BGA 중심의 성장 기대에 새로운 축이 더해졌다.
...
한줄 요약 &nbsp; 삼성전자 노사는 5월 20일 오전 결렬 후 같은 날 밤 잠정합의안을 마련해 21일 총파업을 유보했으며, 시장의 다음 관심은 5월 22~27일 조합원 찬반투표 결과와 성과급 제도 변화로 이동했다.`}).add({id:91,href:"/posts/samsung-securities-isa-event/",title:"삼성증권 중개형 ISA 개설 이벤트 혜택 정리: 신규·...",description:"삼성증권 중개형 ISA 이벤트의 기간, 신규 개설 혜택, 타사 ISA 이전 금액 2배 인정, 국내주식 첫 거래 혜택과 주의사항을 쉽게 정리했다.",content:`요즘 ISA 계좌 하나쯤은 다들 고민한다. 절세에 좋다는 건 알겠는데, 막상 만들려고 하면 증권사도 많고 이벤트도 자주 바뀌어서 언제 개설해야 할지 애매하다.
...
상품권을 받으려고 국내주식을 거래해도 될까? &nbsp; 원래 국내주식이나 ETF를 살 계획이 있었다면 이벤트 혜택을 함께 확인해볼 수 있다. 하지만 상품권 5,000원을 받기 위해 필요 없는 거래를 만드는 것은 좋지 않다. 주식 거래에는 가격 변동 위험이 있고, 작은 이벤트 혜택보다 투자 손실이 훨씬 클 수 있다.`}).add({id:92,href:"/posts/delisting-rules-tightened/",title:"상장폐지 요건 강화, 동전주와 부실기업 퇴출 기준 쉽게 정리",description:"상장폐지 뜻부터 2026년 강화되는 시가총액, 동전주, 완전자본잠식, 공시위반 기준과 개인 투자자가 확인해야 할 점을 쉽게 정리했다.",content:`주식을 하다 보면 &ldquo;상장폐지&quot;라는 말이 가장 무섭게 들릴 때가 있다. 주가가 많이 빠지는 것도 힘들지만, 상장폐지는 아예 시장에서 거래할 자격을 잃는 일이기 때문이다. 특히 코스닥 소형주나 동전주를 매매하는 사람이라면 상장폐지 요건이 어떻게 바뀌는지 꼭 알아둘 필요가 있다.
...
초보자는 어떻게 접근하는 것이 좋나? &nbsp; 처음에는 종목명보다 산업 구조를 먼저 이해하는 것이 좋다. 이후 실제 매출 가능성, 공시, 사업 협약, 밸류에이션을 확인하고, 투자하더라도 전체 자산 중 작은 비중으로 접근하는 편이 안전하다.`}).add({id:95,href:"/posts/why-stablecoins-were-created/",title:"스테이블코인은 왜 만들어졌을까? 비트코인과 다른 점 쉽...",description:"스테이블코인이 비트코인의 가격 변동성 문제에서 어떻게 탄생했는지, USDT와 USDC의 역할, 송금·결제·디지털자산 시장에서의 쓰임새를 쉽게 설명한다.",content:`스테이블코인이라는 말을 자주 듣지만, 처음 접하면 조금 헷갈린다. 코인인데 가격이 안정적이라니, 비트코인이나 이더리움처럼 오르내리는 자산과 무엇이 다른지 감이 잘 오지 않는다.
...
스테이블코인은 은행 송금을 대체할 수 있나? &nbsp; 일부 영역에서는 가능성이 있다. 지갑 간 전송은 빠르고 국경을 넘기 쉽기 때문이다. 다만 실제 생활에서 쓰려면 규제, 신원확인, 세금, 현금화, 소비자 보호 문제가 함께 해결되어야 한다.`}).add({id:96,href:"/news/2026/spacex-starship-defense-contract/",title:"스페이스X 최신 뉴스, 스타십 FAA 조사와 미 우주군...",description:"스페이스X의 스타십 12차 시험비행, FAA 조사, 미 우주군 22.9억 달러 우주 데이터망 계약, 스타링크 가격 논란과 시장 영향을 정리한다.",content:`이번 브리핑은 2026년 5월 22일부터 5월 27일까지 나온 스페이스X 관련 보도와 공식 발표를 중심으로 정리했다. 핵심은 스타십 V3 시험비행이 기술적으로 의미 있는 진전을 보였지만, 슈퍼헤비 부스터 이상으로 FAA 조사를 받게 됐고, 동시에 국방 우주통신 계약과 스타링크 가격 논란이 부각됐다는 점이다.
주요 내용 &nbsp; 스페이스X는 2026년 5월 22일 텍사스 스타베이스에서 스타십 12차 시험비행을 진행했다. 이번 비행은 스타십 V3와 슈퍼헤비 V3가 처음 투입된 시험으로, 모의 스타링크 위성 배치와 인도양 제어 낙하 등 주요 목표 상당수를 달성했다. 다만 슈퍼헤비 부스터는 분리 이후 멕시코만 복귀 과정에서 계획된 제어 착수에 실패했다. FAA는 2026년 5월 27일 이를 사고 조사 대상인 mishap으로 판단하고, 스페이스X 주도의 조사와 시정 조치를 감독하겠다고 밝혔다. 미 우주군은 2026년 5월 26일 스페이스X에 22억9000만 달러 규모의 Space Data Network Backbone 계약을 부여했다. 이 사업은 저궤도 위성망을 활용해 군사 센서와 무기체계를 연결하는 고속 데이터 전송 기반을 구축하는 것이 목표다. NASA 상업승무원 수송에서는 보잉 스타라이너 지연 리스크가 이어지면서 스페이스X 드래곤 의존도가 더 커지는 흐름이 나타나고 있다. SpaceNews 보도에 따르면 NASA는 스페이스X 상업승무원 계약에 추가 임무를 붙이는 방안을 추진하고 있다. 스타링크는 국방 수요 확대의 수혜를 받는 동시에 가격 협상 논란도 안고 있다. Defense News는 Reuters 보도를 인용해 미 국방부와 스페이스X가 이란 전쟁 중 스타링크 가격 인상 문제를 두고 이견을 보였다고 전했다. 주요 트렌드 &nbsp; 스페이스X의 사업 축은 민간 발사 서비스에서 스타링크, 국방 통신망, 달·화성 탐사 인프라로 넓어지고 있다. 스타십은 이 확장의 비용 구조를 바꾸는 핵심 플랫폼으로 평가된다. 국방 분야에서는 상업 저궤도 위성망을 군 통신·감시·미사일 방어 체계에 결합하려는 움직임이 빨라지고 있다. 스페이스X는 스타링크와 스타실드 역량을 기반으로 이 시장에서 강한 위치를 확보하고 있다. 규제 리스크는 계속 남아 있다. 스타십은 시험비행으로 데이터를 축적하는 개발 방식이 강점이지만, 매번 공공 안전과 환경 규제 절차를 통과해야 다음 비행으로 넘어갈 수 있다. NASA와 미 국방부 모두 스페이스X 의존도가 높아지고 있다. 이는 매출 안정성에는 긍정적이지만, 가격 협상과 공급망 집중 리스크라는 정책적 논쟁도 키운다. 핵심 이슈 &nbsp; 첫 번째 이슈는 FAA 조사 기간이다. FAA가 최종 보고서와 시정 조치를 승인해야 스타십-슈퍼헤비의 다음 비행이 가능하기 때문에, 조사 속도는 스타십 개발 일정에 직접 영향을 준다. 두 번째는 스타십 V3의 성능 검증이다. 이번 비행은 모의 위성 배치와 재진입 데이터를 확보했다는 점에서 진전이지만, 엔진 이상과 부스터 제어 실패는 재사용 로켓으로 가기 위한 남은 과제를 보여준다. 세 번째는 국방 계약 확대다. 22억9000만 달러 계약은 단순 위성 인터넷을 넘어 군사 데이터 백본으로 스페이스X의 역할이 커지고 있음을 의미한다. 네 번째는 고객 집중과 가격 논란이다. 정부 고객이 늘수록 매출 가시성은 좋아지지만, 국방·안보 분야에서는 가격, 통제권, 대체 공급자 확보 문제가 함께 따라온다. 시장 영향 &nbsp; 비상장사인 스페이스X 자체 주식은 일반 투자자가 직접 접근하기 어렵지만, 관련 생태계에는 영향이 크다. 위성 부품, 발사 인프라, 지상국, 우주 통신 장비 기업은 스페이스X의 발사 빈도와 정부 계약 확대에 민감하게 움직일 수 있다. 스타십 개발이 일정대로 진전되면 저궤도 위성 발사 단가 하락 압력이 커진다. 이는 스타링크 확장에는 긍정적이지만, 기존 발사체 업체와 일부 위성 사업자에는 경쟁 부담으로 작용할 수 있다. 미 우주군 계약은 방산 우주 분야의 투자 테마를 강화한다. 특히 광통신 위성망, 저지연 데이터 전송, 우주 기반 미사일 추적·방어 체계 관련 기업들이 간접 수혜 후보로 거론될 수 있다. 반대로 FAA 조사 장기화나 스타링크 가격 논란이 커지면 스페이스X의 정책 리스크가 부각될 수 있다. 정부 의존도가 높은 사업일수록 기술력만큼 규제 대응과 공공 신뢰 관리가 중요하다. 향후 전망 &nbsp; 단기 관전 포인트는 FAA 조사의 종료 시점과 다음 스타십 시험비행 승인 여부다. 스타십이 재사용성과 위성 대량 배치 능력을 증명하려면 반복 비행 속도가 중요하다. 국방 분야에서는 Space Data Network Backbone의 추가 계약자 선정과 스페이스X의 실제 납품 일정이 중요하다. 미 우주군은 2027년 말까지 완전 운용 가능한 시제품 역량을 요구하고 있다. NASA 쪽에서는 스타라이너 지연이 길어질수록 드래곤 추가 임무 가능성이 커진다. 이는 스페이스X에는 안정적 현금흐름이지만, 미국 유인 우주수송 체계의 공급자 다양성 논란도 이어질 수 있다. 투자자 입장에서는 스페이스X를 단순 로켓 회사가 아니라 발사, 위성 인터넷, 국방 데이터망, 심우주 인프라를 묶은 플랫폼 기업으로 봐야 한다. 다만 그만큼 기술 일정, 규제 승인, 정부 계약 정치 리스크를 함께 점검해야 한다. 주요 뉴스 &nbsp; 2026-05-22 Reuters: SpaceX&rsquo;s Starship flight hits most targets in pre-IPO test
Reuters는 스페이스X가 스타십 V3 첫 시험비행에서 모의 위성 배치와 인도양 제어 낙하 등 주요 목표 상당수를 달성했다고 보도했다. 다만 상단 스타십 엔진 일부 이상과 슈퍼헤비 부스터의 계획된 복귀 실패가 확인돼, 완전 재사용 체계로 가기까지는 추가 검증이 필요하다고 짚었다.
2026-05-24 SpaceNews: NASA to add missions to SpaceX commercial crew contract
SpaceNews는 NASA가 국제우주정거장 유인 수송 공백을 줄이기 위해 스페이스X 상업승무원 계약에 추가 임무를 더하려 한다고 전했다. 보잉 스타라이너 인증 지연이 계속되는 상황에서, 드래곤은 NASA의 핵심 유인 수송 수단으로 더 큰 비중을 갖게 됐다.
2026-05-26 U.S. Space Force: U.S. Space Force Advances Space Data Network Backbone for Global Warfighter Connectivity
미 우주군은 스페이스X에 22억9000만 달러 규모의 Space Data Network Backbone 계약을 부여했다고 발표했다. 이 사업은 저궤도 위성 기반의 고속·저지연 데이터 전송망을 구축해 군사 센서와 작전 체계를 전 세계적으로 연결하는 것을 목표로 한다.
2026-05-26 Defense News: Pentagon spars with SpaceX over Starlink price hike during Iran war
Defense News는 Reuters 보도를 인용해 미 국방부와 스페이스X가 이란 전쟁 중 스타링크 서비스 가격을 두고 이견을 보였다고 전했다. 기사에 따르면 국방부는 상업 위성통신 조달에서 경쟁 환경을 만들겠다는 입장을 냈고, 이는 스타링크의 국방 수요 확대가 가격·대체 공급자 논쟁과 함께 갈 수 있음을 보여준다.
2026-05-27 Reuters: FAA orders SpaceX to investigate Starship booster mishap
Reuters는 FAA가 스타십 12차 시험비행 중 슈퍼헤비 부스터의 멕시코만 복귀 실패를 조사하라고 스페이스X에 명령했다고 보도했다. FAA는 부상자나 공공 재산 피해는 보고되지 않았지만, 조사 보고서와 시정 조치를 승인한 뒤에야 복귀 비행을 허용하겠다는 입장이다.
2026-05-27 AP: SpaceX&rsquo;s Starship rockets are grounded pending investigation after test flight
AP는 스타십 로켓이 FAA 조사 완료 전까지 추가 비행을 할 수 없는 상태라고 전했다. 보도에 따르면 스타십 우주선은 모의 위성 20개를 방출하고 인도양에 도달했지만, 부스터는 엔진 이상으로 멕시코만에 강하게 떨어졌다.
한줄 요약 &nbsp; 스페이스X는 스타십 V3와 국방 우주통신 계약으로 성장성을 다시 보여줬지만, FAA 조사와 스타링크 가격 논란은 기술 기업을 넘어 국가 인프라 기업이 된 스페이스X가 감당해야 할 새로운 리스크다.`}).add({id:97,href:"/posts/market-capitalization-meaning/",title:"시가총액",description:"시가총액의 뜻과 계산법, 주가와의 차이, 대형주·중형주·소형주 구분, 투자할 때 활용하는 방법을 초보자도 이해하기 쉽게 정리했다.",content:`주식 앱을 열면 종목 이름 옆에 주가가 먼저 보인다. 그래서 처음에는 &ldquo;주가가 높은 회사가 더 큰 회사 아닌가?&ldquo;라고 생각하기 쉽다. 하지만 주가만 보고 기업 규모를 판단하면 크게 착각할 수 있다.
...
시가총액 뜻, 기업의 전체 시장가치다 &nbsp; 시가총액은 기업이 발행한 주식 전체를 현재 시장 가격으로 평가한 금액이다. 쉽게 말해 &ldquo;주식시장에서 이 회사 전체를 얼마로 보고 있는가&quot;를 나타내는 숫자다.
계산식은 간단하다.
구분 계산식 시가총액 현재 주가 x 발행주식수 예를 들어 어떤 회사의 주가가 10,000원이고 발행주식수가 1억 주라면 시가총액은 1조 원이다.
...
주가만 보면 기업 규모를 착각하기 쉽다 &nbsp; 시가총액을 이해해야 하는 이유는 주가만으로 기업의 크기를 비교할 수 없기 때문이다. 주가는 &ldquo;주식 1주의 가격&quot;일 뿐이고, 시가총액은 &ldquo;회사 전체의 시장가치&quot;다.
예를 들어 A회사의 주가는 100,000원이고 발행주식수는 1,000만 주라고 해보자. B회사의 주가는 10,000원이지만 발행주식수는 5억 주라고 해보자.
구분 주가 발행주식수 시가총액 A회사 100,000원 1,000만 주 1조 원 B회사 10,000원 5억 주 5조 원 겉으로 보면 A회사 주가가 B회사보다 10배 비싸다. 하지만 회사 전체 가치로 보면 B회사가 A회사보다 5배 크다.
그래서 &ldquo;주가가 비싸다&quot;와 &ldquo;회사가 비싸게 평가된다&quot;는 말은 다르다. 한 주 가격이 높다고 고평가라고 단정할 수 없고, 한 주 가격이 낮다고 싼 주식이라고 판단해서도 안 된다.
주식 초보자가 가장 많이 하는 실수 중 하나가 &ldquo;1주 가격이 싸니까 부담이 적다&quot;라고 생각하는 것이다. 하지만 기업가치를 비교할 때는 주가보다 시가총액을 먼저 봐야 한다.
대형주, 중형주, 소형주는 시가총액으로 나눈다 &nbsp; 시가총액은 기업 규모를 나누는 기준으로도 쓰인다. 보통 시가총액이 큰 기업을 대형주, 중간 규모 기업을 중형주, 작은 기업을 소형주라고 부른다.
...
중요한 것은 이름보다 성격이다.
대형주 &nbsp; 대형주는 시가총액이 큰 기업이다. 삼성전자, 현대차, 네이버처럼 이미 시장에서 규모와 인지도가 큰 회사들이 여기에 속한다.
대형주는 거래량이 많고 정보가 비교적 풍부하다. 기관투자자와 외국인 투자자도 많이 거래하기 때문에 유동성이 좋다. 대신 이미 많은 기대가 가격에 반영되어 있어 단기간에 몇 배씩 오르는 경우는 상대적으로 드물다.
중형주 &nbsp; 중형주는 대형주보다 규모는 작지만 어느 정도 사업 기반을 갖춘 기업이다. 성장성과 안정성 사이에 있는 경우가 많다.
실적이 좋아지거나 산업 흐름을 잘 타면 대형주보다 주가 탄력이 클 수 있다. 반대로 사업이 흔들리면 변동성도 커질 수 있다. 그래서 중형주는 재무 상태와 업황을 함께 보는 것이 중요하다.
소형주 &nbsp; 소형주는 시가총액이 작은 기업이다. 아직 시장에서 충분히 평가받지 못한 성장 기업이 있을 수도 있고, 반대로 사업 기반이 약한 기업도 있다.
소형주는 작은 호재에도 주가가 크게 움직일 수 있다. 하지만 거래량이 적고 정보가 부족한 경우도 많아 리스크가 크다. 초보 투자자라면 단순히 &ldquo;작으니까 많이 오를 수 있다&quot;는 기대만으로 접근하면 위험하다.
시가총액은 어디에 쓰일까 &nbsp; 시가총액은 단순히 기업 크기를 보는 데서 끝나지 않는다. 주식시장에서는 여러 중요한 판단에 활용된다.
...
시가총액을 투자에 활용하는 방법 &nbsp; 시가총액은 좋은 주식을 골라주는 자동 정답은 아니다. 하지만 기업을 보는 첫 번째 기준으로는 매우 유용하다.
...
시가총액을 볼 때 주의할 점 &nbsp; 시가총액이 크다고 무조건 안전한 것은 아니다. 대형주도 실적이 악화되거나 산업 경쟁력이 약해지면 주가가 크게 떨어질 수 있다. 반대로 시가총액이 작다고 무조건 위험한 것도 아니다. 성장 초기의 좋은 기업이 아직 작게 평가받는 경우도 있다.
...
결국 시가총액은 시작점이지 결론이 아니다. &ldquo;이 회사가 현재 얼마짜리로 평가받고 있는가&quot;를 확인한 뒤, 그 가격이 실적과 자산, 성장성에 비해 적절한지 따져봐야 한다.
정리 &nbsp; 시가총액은 현재 주가에 발행주식수를 곱해 계산한 기업의 전체 시장가치다. 주가가 높다고 큰 회사가 아니고, 주가가 낮다고 싼 회사도 아니다. 기업 규모와 시장 평가를 보려면 주가보다 시가총액을 먼저 확인해야 한다.
...
자주 묻는 질문 &nbsp; 시가총액이 크면 좋은 회사인가? &nbsp; 시가총액이 크다는 것은 시장에서 큰 가치로 평가받고 있다는 뜻이지, 무조건 좋은 회사라는 뜻은 아니다. 실적, 부채, 성장성, 산업 경쟁력을 함께 봐야 한다.
주가가 낮은 종목은 저평가된 주식인가? &nbsp; 아니다. 주가가 낮아 보여도 발행주식수가 많으면 시가총액은 클 수 있다. 저평가 여부는 시가총액과 이익, 자산, 성장성을 함께 비교해야 판단할 수 있다.
시가총액은 매일 바뀌나? &nbsp; 주가가 매일 움직이기 때문에 시가총액도 매일 바뀐다. 주식 수가 변하는 증자, 감자, 자사주 소각 같은 이벤트가 있을 때도 달라질 수 있다.
투자할 때 시가총액만 보면 충분한가? &nbsp; 충분하지 않다. 시가총액은 기업 규모와 시장 평가를 보는 출발점이다. 실제 투자 판단은 실적, 현금흐름, 부채, 산업 전망, 밸류에이션을 함께 봐야 한다.`}).add({id:98,href:"/posts/personal-credit-loan-basics/",title:"신용대출 완벽 개념정리: 뜻, 금리, 한도, 마이너스통...",description:"신용대출의 뜻과 담보대출과의 차이, 금리와 한도 결정 기준, 건별대출과 마이너스통장, 상환 방식과 주의사항을 초보자도 이해하기 쉽게 정리했다.",content:`급하게 돈이 필요할 때 가장 먼저 떠올리는 대출이 신용대출이다. 집이나 자동차 같은 담보가 없어도 신청할 수 있고, 모바일 앱으로 비교적 빠르게 한도와 금리를 확인할 수 있기 때문이다.
...
신용대출을 빨리 갚으면 좋은가? &nbsp; 이자 부담을 줄일 수 있다는 점에서는 좋다. 다만 건별 신용대출은 상품에 따라 중도상환수수료가 있을 수 있으므로, 조기 상환 전에 수수료와 절감되는 이자를 함께 비교해야 한다.`}).add({id:99,href:"/posts/credit-score-management/",title:"신용점수관리",description:"신용점수가 대출 금리와 금융생활에 왜 중요한지, 좋은 빚과 나쁜 빚을 구분하는 법, 신용점수를 지키고 올리는 습관을 쉽게 정리하였다.",content:`돈을 빌릴 때 가장 먼저 떠오르는 것은 &ldquo;얼마나 빌릴 수 있을까&quot;다. 그런데 금융회사는 그보다 먼저 &ldquo;이 사람이 약속한 날짜에 잘 갚을 사람인가&quot;를 본다. 이때 참고하는 대표적인 기준이 신용점수다.
...
신용과 빚은 어떤 관계일까 &nbsp; 신용은 쉽게 말해 &ldquo;믿음&quot;이다. 금융생활에서의 신용은 돈을 빌린 사람이 약속한 날짜에 갚을 것이라는 믿음을 뜻한다. 친구에게 돈을 빌릴 때도 마찬가지다. 친구가 돈을 빌려주는 이유는 &ldquo;다음 주에 꼭 갚을게&quot;라는 말을 어느 정도 믿기 때문이다.
...
그래서 신용과 빚은 따로 움직이지 않는다. 신용이 있어야 빚을 낼 수 있고, 빚을 어떻게 관리하느냐에 따라 신용이 다시 달라진다. 이 구조를 이해하면 &ldquo;빚은 무조건 나쁘다&quot;거나 &ldquo;신용점수는 나중에 보면 된다&quot;는 식으로 단순하게 생각하기 어렵다.
빚은 무조건 나쁜 것일까 &nbsp; 빚은 목적과 상환 계획에 따라 의미가 달라진다. 나쁜 것은 빚 자체가 아니라, 갚을 계획 없이 무리하게 빌리는 습관이다.
예를 들어 학자금 대출은 당장 등록금이 부족한 사람이 공부를 이어갈 수 있게 도와주는 수단이 될 수 있다. 졸업 후 소득이 생겼을 때 갚아나갈 계획이 있다면 미래를 위한 투자에 가까운 빚으로 볼 수 있다.
주택담보대출도 마찬가지다. 집값 전부를 한 번에 마련하기 어려운 상황에서, 소득 범위 안에서 장기적으로 갚을 수 있다면 자산 형성의 출발점이 될 수 있다. 중요한 것은 &ldquo;내가 매달 얼마를 벌고, 얼마까지 갚을 수 있는지&quot;를 먼저 계산하는 것이다.
...
신용점수는 왜 중요할까 &nbsp; 우리나라 개인 신용점수는 보통 1,000점 만점 기준으로 표시된다. 점수가 높을수록 금융회사 입장에서는 돈을 빌려줘도 잘 갚을 가능성이 높다고 본다. 반대로 점수가 낮으면 대출이 거절되거나, 승인되더라도 금리가 높아질 수 있다.
신용점수가 중요한 가장 현실적인 이유는 이자 차이다. 대출 금리가 1%포인트만 달라도 금액이 커지고 기간이 길어질수록 부담은 크게 벌어진다. 신용점수 관리는 결국 &ldquo;필요할 때 더 비싼 돈을 빌리지 않기 위한 준비&quot;이기도 하다.
신용점수는 연체 여부만 보는 숫자가 아니다. 대출이 얼마나 있는지, 신용카드를 어떻게 쓰는지, 금융거래 기간이 얼마나 되는지, 여러 금융회사에서 과도하게 빌리고 있지는 않은지 등을 함께 본다. 즉 &ldquo;한 번도 연체한 적 없는데 왜 점수가 안 오르지?&ldquo;라는 일이 생길 수 있다.
...
신용점수를 떨어뜨리는 행동 &nbsp; 신용점수는 올리는 데 시간이 걸리지만, 떨어지는 것은 빠를 수 있다. 특히 연체는 가장 조심해야 한다. 카드값, 대출 이자, 원금 상환일을 놓치면 신용평가에 좋지 않은 기록으로 남을 수 있다.
여러 금융회사에서 한도까지 돈을 빌리는 것도 좋지 않다. 연체가 없더라도 이미 빚이 많아 보이면 금융회사는 상환 부담이 크다고 판단할 수 있다. &ldquo;아직 안 밀렸으니 괜찮다&quot;가 아니라 &ldquo;앞으로도 안정적으로 갚을 수 있나&quot;가 중요하다.
...
목적 없는 소비성 대출도 위험하다. 여행, 명품, 전자기기, 과시용 소비를 위해 빚을 내는 것은 남는 자산보다 부담이 더 커질 가능성이 높다. 빚을 내기 전에는 &ldquo;이 돈을 빌려서 내 미래 현금흐름이 좋아지는가&quot;를 생각해보는 편이 좋다.
신용점수 올리는 현실적인 방법 &nbsp; 신용점수를 올리는 방법은 특별한 비법보다 기본 습관에 가깝다. 핵심은 연체하지 않고, 빚을 과하게 늘리지 않고, 정상적인 거래 기록을 꾸준히 쌓는 것이다.
1. 연체는 무조건 피하기 &nbsp; 가장 중요한 것은 납부일을 지키는 것이다. 카드값, 대출 이자, 휴대폰 요금, 공과금은 자동이체를 걸어두는 것이 좋다. 자동이체 계좌에 잔액이 부족하면 실패할 수 있으니 월급일 이후로 결제일을 맞추거나, 비상금을 조금 남겨두는 습관도 필요하다.
이미 연체가 생겼다면 금액이 작더라도 빨리 정리해야 한다. 연체는 기간이 길어질수록 회복이 어려워진다. 여러 건이 있다면 오래된 연체, 금액이 커질 연체, 금융권 연체부터 우선순위를 잡는 것이 현실적이다.
2. 빚은 감당 가능한 만큼만 쓰기 &nbsp; 대출 한도가 나온다고 전부 빌려도 되는 것은 아니다. 한도는 금융회사가 정한 최대치일 뿐, 내 생활이 편안하게 감당할 수 있는 금액과는 다르다. 월 상환액이 소득에서 너무 큰 비중을 차지하면 작은 변수에도 흔들릴 수 있다.
대출을 받기 전에는 매달 갚을 원리금, 고정지출, 비상금, 앞으로 생길 큰 지출을 함께 계산해야 한다. 특히 변동금리 대출은 금리가 오르면 월 상환액이 늘어날 수 있다. 지금 겨우 맞는 계획은 나중에 버티기 어려울 수 있다.
3. 금융거래 기록을 꾸준히 만들기 &nbsp; 신용카드는 무조건 피해야 하는 물건이 아니다. 감당 가능한 범위에서 쓰고, 결제일에 전액 갚는 기록은 신용거래 이력으로 남는다. 다만 한도에 가깝게 쓰거나 할부를 반복하는 것은 좋지 않다.
신용카드가 부담스럽다면 체크카드 사용, 통신요금 자동이체, 공과금 납부 이력 관리부터 시작해도 된다. 일부 신용평가 서비스에서는 국민연금, 건강보험료, 통신요금 같은 비금융 납부 정보를 제출해 신용평가에 반영할 수 있다.
4. 고금리 빚부터 줄이기 &nbsp; 여러 빚이 있다면 금리가 높은 것부터 줄이는 것이 보통 유리하다. 현금서비스, 카드론, 대부업, 고금리 제2금융권 대출은 이자 부담이 빠르게 커질 수 있다. 여유 자금이 생기면 소비를 늘리기보다 이런 빚을 먼저 줄이는 편이 신용과 현금흐름에 도움이 된다.
다만 중도상환수수료가 있는 대출도 있으므로 무조건 갚기 전에 조건을 확인해야 한다. 대환대출을 고려할 때도 새 대출의 금리, 수수료, 기간, 총 이자 비용을 함께 봐야 한다.
생활 속 사례로 보는 신용관리 &nbsp; 대학생이 학자금 대출을 받아 등록금을 마련했다고 해보자. 대출 목적은 분명하고, 졸업 후 상환 계획도 있다. 재학 중에는 장학금, 아르바이트, 생활비 관리를 통해 추가 빚을 줄이고, 취업 후 자동이체로 성실히 갚아나간다면 신용관리 측면에서도 나쁘지 않은 흐름을 만들 수 있다.
...
정리 &nbsp; 신용점수는 금융생활의 성적표라기보다, 내가 돈과 약속을 어떻게 다뤄왔는지 보여주는 기록에 가깝다. 점수가 높으면 대출과 카드 심사에서 선택지가 넓어질 수 있고, 금리 면에서도 유리한 조건을 기대할 수 있다.
...
자주 묻는 질문 &nbsp; 신용점수는 몇 점이면 좋은 편인가? &nbsp; 일반적으로 점수가 높을수록 유리하지만, 특정 점수 하나만으로 좋고 나쁨을 단정하기는 어렵다. 금융회사마다 심사 기준이 다르고 소득, 직업, 기존 대출, 연체 이력도 함께 본다. 그래도 900점대는 보통 우량한 신용으로 보는 경우가 많고, 점수가 낮을수록 대출 금리나 한도에서 불리해질 수 있다.
신용점수를 조회하면 점수가 떨어지나? &nbsp; 본인이 금융앱이나 신용평가사 서비스를 통해 신용점수를 확인하는 것은 일반적으로 점수 하락 요인이 아니다. 오히려 내 점수를 주기적으로 확인하면 연체, 대출 증가, 카드 사용 변화가 점수에 어떻게 반영되는지 볼 수 있어 관리에 도움이 된다.
신용카드를 안 쓰면 신용점수에 좋은가? &nbsp; 무조건 좋다고 보기 어렵다. 신용거래 기록이 너무 없으면 평가할 자료가 부족할 수 있다. 신용카드를 쓴다면 한도에 가깝게 쓰지 않고, 결제일에 전액 갚는 방식이 좋다. 카드 사용이 부담스럽다면 체크카드와 자동이체 납부 기록부터 꾸준히 만드는 것이 낫다.
연체금을 갚으면 신용점수가 바로 회복되나? &nbsp; 연체금을 갚는 것은 반드시 필요하지만, 점수가 바로 크게 오르지 않을 수 있다. 연체 이력은 일정 기간 영향을 줄 수 있고, 이후 정상적인 상환 기록이 쌓이면서 천천히 회복되는 경우가 많다. 그래서 가장 좋은 관리는 연체가 생기기 전에 막는 것이다.
대출이 하나도 없으면 신용점수가 높아지나? &nbsp; 대출이 없는 것은 부채 부담이 적다는 점에서 긍정적일 수 있다. 하지만 신용거래 기록이 거의 없다면 점수 상승이 느릴 수도 있다. 중요한 것은 대출이 있느냐 없느냐보다, 감당 가능한 범위에서 빌리고 약속대로 갚아온 기록이 있는가다.`}).add({id:100,href:"/posts/isa-account-type-trust/",title:"ISA 신탁형",description:"신탁형 ISA의 뜻, 운용 가능 상품, 국내 상장주식 투자 가능 여부, 손익통산, 신탁보수, 중개형 ISA와의 차이를 초보자도 이해하기 쉽게 정리했다.",content:`ISA 계좌를 알아보다 보면 신탁형, 일임형, 중개형이라는 말이 계속 나온다. 이름만 봐서는 차이가 잘 안 느껴진다. 특히 신탁형 ISA는 &ldquo;은행에서 만드는 ISA인가?&rdquo;, &ldquo;국내 주식도 살 수 있나?&rdquo;, &ldquo;중개형 ISA와 뭐가 다른가?&rdquo; 같은 질문이 자연스럽게 생긴다.
...
Q5. 신탁형 ISA는 원금보장 상품인가? &nbsp; 아니다. 계좌 안에 예금보호 대상 상품이 있으면 해당 상품은 보호 대상이 될 수 있지만, 펀드나 주식 같은 투자성 상품은 원금손실이 발생할 수 있다.`}).add({id:101,href:"/posts/medical-expense-insurance-non-covered-items/",title:"실비보험 비급여 보장 총정리, 급여와 비급여 차이부터 ...",description:"실비보험에서 헷갈리는 급여와 비급여 차이, 비급여 보장 항목, 자기부담금, 도수치료·MRI·수액 청구 시 주의할 점을 누구나 이해하기 쉽게 정리하였다.",content:`병원비 영수증을 보면 급여, 비급여라는 단어가 나온다. 처음에는 그냥 병원에서 쓰는 어려운 말처럼 보이지만, 실비보험을 청구할 때는 이 두 단어를 반드시 알아야 한다. 내가 낸 병원비 중 어디까지 건강보험이 적용됐는지, 어디까지 실비보험으로 받을 수 있는지가 여기서 갈리기 때문이다.
...
비급여 진료를 받으면 어떤 서류를 챙겨야 할까? &nbsp; 기본적으로 진료비 영수증과 진료비 세부내역서를 챙기는 것이 좋다. 항목에 따라 처방전, 진단서, 의사 소견서, 통원확인서가 추가로 필요할 수 있으므로 보험사 앱의 청구 안내를 함께 확인해야 한다.`}).add({id:102,href:"/posts/medical-expense-insurance-claim-documents/",title:"실비보험 청구서류 정리, 통원·입원·약제비 청구 방법까...",description:"실비보험의 뜻과 통원·입원·약제비 청구서류, 진료비 영수증과 세부내역서 차이, 청구기간과 실손24 활용법을 누구나 이해하기 쉽게 정리하였다.",content:`살면서 아프지 않은 사람은 거의 없다. 가벼운 감기처럼 병원비가 몇천 원으로 끝날 때도 있지만, 검사나 치료가 이어지면 갑자기 몇십만 원이 나가기도 한다. 여유 자금이 있으면 버틸 수 있지만, 예상하지 못한 병원비는 누구에게나 부담이 된다.
...
4세대 실손보험으로 전환하면 보험료가 항상 싸질까? &nbsp; 초기 보험료는 낮아질 수 있지만, 비급여 진료를 많이 청구하면 이후 보험료가 오를 수 있다. 전환 전에는 줄어드는 보험료와 줄어드는 보장, 자기부담금 증가 가능성을 함께 비교해야 한다.`}).add({id:104,href:"/posts/stock-investing-beginner-guide/",title:"주식투자 입문",description:"주식투자를 처음 시작하는 초보자가 계좌 개설 전 알아야 할 위험 관리, 종목 선택, 분산 투자, 장기 투자 원칙과 흔한 실수를 쉽게 정리했다.",content:`주식투자를 시작하려고 하면 마음이 복잡해진다. 주변에서는 누가 어떤 종목으로 돈을 벌었다고 하고, 뉴스에서는 AI, 반도체, 2차전지, 바이오 같은 이야기가 계속 나온다. 증권 앱을 열면 당장이라도 매수 버튼을 눌러야 할 것 같지만, 막상 내 돈을 넣으려면 겁이 난다.
...
주가가 떨어지면 무조건 버텨야 할까? &nbsp; 무조건 버티는 것은 장기투자가 아니다. 회사의 실적과 경쟁력이 유지되는데 시장 전체 하락으로 빠진 것인지, 기업 자체의 문제가 생긴 것인지 확인해야 한다. 처음 매수한 이유가 깨졌다면 매도도 검토해야 한다.`}).add({id:105,href:"/news/2026/nvidia-earnings-preview/",title:"엔비디아 1분기 실적 발표 전 관전 포인트, AI 반도...",description:"엔비디아가 2026년 5월 21일 한국시간 새벽 2027회계연도 1분기 실적을 발표한다. 매출 컨센서스, 블랙웰 출하, 중국 수출 변수와 국내 반도체주 영향을 정리한다.",content:`이번 브리핑은 2026년 5월 15일부터 5월 20일까지 나온 엔비디아 실적 발표 일정, 시장 컨센서스, AI 반도체 수요, 중국 수출 규제, 국내 반도체주 영향 관련 보도를 중심으로 정리했다. 작성 시점은 2026년 5월 20일 밤 한국시간으로, 엔비디아의 2027회계연도 1분기 실적은 아직 공식 발표 전이다.
...
한줄 요약 &nbsp; 엔비디아의 5월 실적 발표는 매출 서프라이즈보다 2분기 가이던스, 블랙웰 출하, 중국 매출 회복 가능성, HBM 수요 지속성을 확인하는 이벤트이며 국내 반도체주 투자심리에도 곧바로 영향을 줄 수 있다.`}).add({id:106,href:"/posts/pension-types/",title:"연금종류총정리",description:"국민연금, 직역연금, 퇴직연금, 개인연금, 기초연금, 주택연금, 농지연금까지 주요 연금 종류와 차이를 초보자도 이해하기 쉽게 정리했다.",content:`연금은 막연하게 &ldquo;나중에 받는 돈&rdquo; 정도로 생각하기 쉽다. 월급에서 국민연금이 빠져나가고, 회사에서는 퇴직연금을 운용한다고 하고, 은행이나 증권사에서는 연금저축과 IRP를 권한다. 부모님 세대 이야기를 들으면 기초연금, 주택연금 같은 말도 자주 나온다.
문제는 이름은 전부 연금인데 성격이 꽤 다르다는 점이다. 어떤 연금은 의무적으로 가입하고, 어떤 연금은 내가 선택해서 준비한다. 어떤 연금은 소득이 있어야 쌓이고, 어떤 연금은 집이나 농지를 담보로 매달 받는 구조다.
이 글에서는 연금 종류를 한 번에 이해할 수 있도록 크게 공적연금, 직역연금, 퇴직연금, 개인연금, 자산담보형 연금으로 나눠 정리하였다. 처음 보는 사람도 &ldquo;나는 어떤 연금을 기본으로 보고, 무엇을 추가로 준비해야 하는지&rdquo; 감을 잡는 데 초점을 맞췄다.
연금은 크게 세 층으로 보면 쉽다 &nbsp; 연금은 종류가 많지만, 구조를 단순하게 보면 세 층으로 나눌 수 있다.
구분 대표 연금 핵심 역할 1층 국민연금, 공무원연금, 군인연금, 사학연금 국가 또는 공적 제도가 보장하는 기본 노후소득 2층 퇴직연금 DB형, DC형, IRP 직장에서 쌓는 퇴직 이후 자금 3층 연금저축, 개인형 IRP 추가납입, 연금보험 개인이 스스로 준비하는 추가 노후자금 보완 기초연금, 주택연금, 농지연금 소득, 주택, 농지 등 조건에 따라 받는 보완 장치 가장 먼저 봐야 할 것은 1층이다. 직장인이든 자영업자든 대부분은 국민연금이 기본이다. 다만 공무원, 군인, 사립학교 교직원처럼 특정 직업군은 국민연금 대신 별도 직역연금에 가입한다.
그다음은 퇴직연금이다. 회사생활을 한다면 퇴직금이 그냥 회사 장부에 남는 방식이 아니라, 금융회사 계좌에서 DB형이나 DC형으로 관리되는 경우가 많다. 퇴사하거나 이직할 때는 IRP로 옮겨 관리하기도 한다.
마지막은 개인연금이다. 연금저축, IRP 추가납입, 연금보험처럼 내가 직접 가입하고 납입하는 상품이다. 세액공제 혜택이 있는 상품도 있고, 보험 성격이 강한 상품도 있다. 여기부터는 &ldquo;얼마나 오래 유지할 수 있는지&quot;가 중요하다.
국민연금은 대부분의 사람이 가입하는 기본 연금이다 &nbsp; 국민연금은 대한민국의 대표적인 공적연금이다. 18세 이상 60세 미만 국민 중 소득이 있는 사람은 원칙적으로 가입 대상이 된다. 직장인은 사업장가입자, 자영업자나 프리랜서는 지역가입자로 보는 식이다.
...
국민연금은 단순히 노령연금만 있는 제도가 아니다. 가입자가 장애를 입었을 때 지급되는 장애연금, 가입자나 수급자가 사망했을 때 유족에게 지급되는 유족연금도 포함한다. 그래서 &ldquo;노후 용돈&quot;이라기보다 기본 생활 안전망에 가깝다.
...
직업에 따라 국민연금 대신 받는 연금도 있다 &nbsp; 국민연금과 별도로 특정 직업군을 위한 공적연금도 있다. 대표적으로 공무원연금, 군인연금, 사학연금, 별정우체국연금이 있다.
...
사학연금은 사립학교 교직원, 조교, 연구원 등 일정 요건을 갖춘 사립학교 구성원이 가입하는 연금이다. 국공립학교 교원과 사립학교 교원이 같은 &ldquo;교사&quot;로 보이더라도 가입하는 연금제도가 다를 수 있다.
...
또 하나 주의할 점은 기초연금과의 관계다. 공무원연금, 군인연금, 사학연금 등 직역연금 수급권자는 기초연금 대상에서 제외되거나 제한될 수 있다. 부모님이나 본인의 노후 현금흐름을 계산할 때 &ldquo;연금이 있으니 다 받을 수 있겠지&quot;라고 단순하게 보면 안 된다.
퇴직연금은 회사에서 쌓이는 두 번째 노후자금이다 &nbsp; 퇴직연금은 직장에서 일하면서 쌓이는 퇴직급여를 금융회사 계좌에 적립하고 운용하는 제도다. 크게 DB형, DC형, IRP로 나눠 보면 이해하기 쉽다.
구분 뜻 특징 DB형 확정급여형 퇴직 시 받을 금액이 근속연수와 평균임금 중심으로 정해짐 DC형 확정기여형 회사가 넣어주는 부담금이 정해지고, 운용 결과에 따라 수령액이 달라짐 IRP 개인형 퇴직연금 퇴직금 이전, 이직 후 관리, 개인 추가납입에 활용 DB형은 회사가 운용 책임을 지는 방식에 가깝다. 근로자 입장에서는 퇴직할 때 받을 금액이 상대적으로 예측 가능하다. 대신 내가 직접 투자 상품을 골라 수익률을 높이는 구조는 아니다.
...
퇴직연금에서 가장 흔한 실수는 &ldquo;어차피 회사가 알아서 하겠지&rdquo; 하고 방치하는 것이다. 특히 DC형이나 IRP는 내가 선택한 상품과 수익률이 장기 수령액에 영향을 준다. 원리금보장 상품만 둘지, 일부를 투자형 상품으로 운용할지 정도는 최소한 확인하는 게 좋다.
개인연금은 부족한 부분을 내가 채우는 연금이다 &nbsp; 개인연금은 국민연금과 퇴직연금만으로 부족한 노후자금을 채우기 위해 스스로 준비하는 연금이다. 대표적으로 연금저축, IRP 추가납입, 연금보험이 있다.
...
그래서 개인연금은 &ldquo;최대한 많이 넣기&quot;보다 &ldquo;오래 유지할 수 있는 만큼 넣기&quot;가 더 중요하다. 비상금이 부족하거나 고금리 대출이 있는 상태에서 무리하게 연금 한도를 채우는 것은 좋은 순서가 아니다.
기초연금, 주택연금, 농지연금은 보완 장치로 봐야 한다 &nbsp; 기초연금은 만 65세 이상 어르신 중 소득과 재산을 반영한 소득인정액이 일정 기준 이하일 때 받을 수 있는 공적 지원이다. 국민연금처럼 보험료를 내고 받는 구조가 아니라, 노후 소득이 낮은 사람을 지원하는 복지 성격이 강하다.
...
주택연금은 집을 팔지 않고 현금흐름을 만들 수 있다는 장점이 있다. 하지만 담보대출 성격이 있기 때문에, 상속 계획이나 이사 가능성까지 같이 봐야 한다. &ldquo;집은 있는데 생활비가 부족한 은퇴 가구&quot;에는 현실적인 선택지가 될 수 있지만, 모든 사람에게 정답은 아니다.
...
이 세 가지는 국민연금이나 퇴직연금처럼 모두에게 자동으로 쌓이는 연금이 아니다. 나이, 소득, 재산, 보유자산 조건을 충족해야 한다. 따라서 &ldquo;나중에 기초연금이나 주택연금이 있겠지&quot;라고만 생각하기보다, 국민연금과 퇴직연금을 기본으로 두고 보완 수단으로 보는 게 현실적이다.
내 연금은 어떤 순서로 점검하면 좋을까 &nbsp; 연금 종류를 많이 아는 것보다 중요한 건 내 상황에 맞게 순서를 잡는 것이다. 복잡하게 느껴진다면 아래 순서대로 확인하면 된다.
국민연금 가입기간과 예상연금액을 확인한다. 직장인이라면 퇴직연금이 DB형인지 DC형인지 확인한다. 퇴직연금이 DC형이나 IRP라면 어떤 상품에 들어 있는지 본다. 여유자금이 있다면 연금저축과 IRP 세액공제 한도를 검토한다. 부모님 세대라면 기초연금, 주택연금, 농지연금 대상 여부를 확인한다. 사회초년생이라면 국민연금과 퇴직연금 구조를 이해하고, 연금저축은 소액으로 시작해도 충분하다. 월 10만 원이라도 오래 유지하면 &ldquo;연금계좌를 운용하는 습관&quot;이 생긴다.
...
정리 &nbsp; 연금 종류는 많지만 역할을 나눠 보면 훨씬 단순해진다. 국민연금과 직역연금은 기본 노후소득, 퇴직연금은 직장에서 쌓는 두 번째 노후자금, 개인연금은 부족한 부분을 스스로 채우는 수단이다. 기초연금, 주택연금, 농지연금은 조건에 따라 활용하는 보완 장치로 보면 된다.
핵심은 &ldquo;내가 받을 수 있는 연금이 무엇인지&quot;와 &ldquo;그 연금만으로 생활비가 충분한지&quot;를 분리해서 보는 것이다. 받을 연금이 있다고 해서 노후 준비가 끝난 것은 아니다. 예상수령액을 확인하고, 부족한 부분을 퇴직연금과 개인연금으로 채워야 한다.
...
자주 묻는 질문 &nbsp; 국민연금만 있으면 노후 준비가 충분할까? &nbsp; 대부분은 충분하다고 보기 어렵다. 국민연금은 기본 생활을 보완하는 성격이 강하고, 실제 수령액은 가입기간과 소득에 따라 달라진다. 퇴직연금과 개인연금을 함께 보는 게 현실적이다.
연금저축과 IRP는 둘 다 가입해야 할까? &nbsp; 반드시 둘 다 가입해야 하는 것은 아니다. 연금저축만으로도 세액공제를 받을 수 있다. 다만 연금저축과 IRP를 합치면 세액공제 대상 한도를 더 크게 활용할 수 있으므로, 여유자금과 중도해지 가능성을 함께 보고 결정하는 게 좋다.
주택연금에 가입하면 집을 바로 넘겨야 할까? &nbsp; 아니다. 주택연금은 집을 담보로 제공하고 그 집에 계속 거주하면서 매달 연금을 받는 구조다. 다만 대출 성격이 있으므로 상속, 이사, 주택 처분 계획을 함께 고려해야 한다.
기초연금은 국민연금을 받으면 못 받을까? &nbsp; 국민연금을 받는다고 무조건 기초연금을 못 받는 것은 아니다. 다만 국민연금 수급액, 소득인정액, 재산 상황에 따라 기초연금액이 줄거나 대상에서 제외될 수 있다. 정확한 여부는 복지로 모의계산이나 국민연금공단 상담으로 확인하는 게 좋다.`}).add({id:107,href:"/posts/pension-savings-irp-tax-credit/",title:"연금저축·IRP 세액공제 총정리: 한도, 환급액, IS...",description:"연금저축과 IRP 세액공제 한도, 소득별 공제율, 최대 환급액, ISA 만기자금 전환까지 연말정산 전에 알아둘 내용을 초보자 눈높이로 정리했다.",content:`연말정산을 할 때마다 &ldquo;이번에는 돌려받을까, 더 낼까&rdquo; 하는 생각이 먼저 든다. 연말정산은 1년 동안 미리 낸 세금과 실제로 부담해야 할 세금을 다시 맞추는 과정이다. 미리 낸 세금이 많으면 환급을 받고, 적게 냈으면 추가로 납부한다.
...
연말에 한 번에 넣어도 세액공제가 될까? &nbsp; 해당 과세기간 안에 납입했다면 연말에 한 번에 넣어도 세액공제 대상이 될 수 있다. 다만 금융회사별 입금 마감 시간이나 처리일이 다를 수 있으니 12월 말에 너무 늦게 넣는 건 피하는 게 좋다.`}).add({id:108,href:"/posts/pension-savings/",title:"연금저축",description:"연금저축의 기본 개념, 세액공제 한도, 연금저축펀드와 보험 차이, 중도해지 세금까지 초보자도 이해하기 쉽게 정리했다.",content:`연금저축은 이름만 보면 단순한 저축상품처럼 느껴진다. 하지만 실제로는 노후자금을 준비하면서 세액공제까지 받을 수 있는 개인연금 계좌에 가깝다. 직장인이라면 연말정산에서 자주 듣고, 자영업자라면 종합소득세를 줄이는 방법으로 자주 접하게 된다.
문제는 처음 볼 때 용어가 꽤 헷갈린다는 점이다. 연금저축펀드, 연금저축보험, IRP, 세액공제, 과세이연 같은 단어가 한꺼번에 나온다. 그래서 &ldquo;좋다는데 뭘 가입해야 하지?&rdquo;, &ldquo;중간에 돈이 필요하면 어떻게 하지?&rdquo;, &ldquo;얼마를 넣어야 하지?&rdquo; 같은 질문이 자연스럽게 생긴다.
이 글에서는 연금저축이 무엇인지, 어떤 혜택이 있는지, 가입 전에 무엇을 조심해야 하는지 초보자 눈높이에서 정리하였다.
연금저축이란 무엇인가? &nbsp; 연금저축은 개인이 노후 생활비를 준비할 수 있도록 만든 장기 금융상품이다. 정부가 노후 준비를 장려하기 위해 세제 혜택을 붙여둔 제도라고 보면 이해하기 쉽다.
핵심 구조는 단순하다.
지금 연금저축 계좌에 돈을 넣는다. 납입한 금액 중 일정 한도까지 세액공제를 받는다. 계좌 안에서 펀드나 보험 방식으로 돈을 운용한다. 만 55세 이후 요건을 충족해 연금으로 나눠 받는다. 여기서 중요한 점은 연금저축이 &ldquo;당장 쓰는 돈&quot;을 넣는 계좌가 아니라는 것이다. 이름 그대로 미래의 연금으로 받기 위한 돈이다. 그래서 세금 혜택이 있는 대신, 중도해지하거나 연금이 아닌 방식으로 꺼내면 불이익이 생길 수 있다.
...
연금저축을 하는 가장 큰 이유는 세액공제다 &nbsp; 연금저축이 자주 추천되는 가장 큰 이유는 세액공제다. 세액공제는 계산된 세금에서 일정 금액을 직접 빼주는 방식이다. 소득을 줄여주는 소득공제보다 체감이 더 직접적일 때가 많다.
2026년 기준으로 연금저축은 연 600만 원까지 세액공제 대상이 된다. IRP까지 함께 활용하면 연금계좌 합산으로 연 900만 원까지 세액공제를 받을 수 있다.
구분 세액공제 대상 한도 연금저축 연 600만 원 연금저축 + IRP 합산 연 900만 원 연금계좌 납입 한도 연 1,800만 원 공제율은 소득 구간에 따라 다르다. 지방소득세를 포함하면 보통 16.5% 또는 13.2%로 계산한다.
소득 구간 세액공제율 연금저축 600만 원 납입 시 최대 공제액 총급여 5,500만 원 이하 또는 종합소득금액 4,500만 원 이하 16.5% 99만 원 총급여 5,500만 원 초과 또는 종합소득금액 4,500만 원 초과 13.2% 79만 2천 원 예를 들어 총급여 5,500만 원 이하인 직장인이 연금저축에 600만 원을 넣었다면 계산상 최대 99만 원의 세액공제 효과가 생긴다.
600만 원 × 16.5% = 99만 원
총급여 5,500만 원 초과 구간이라면 최대 79만 2천 원이다.
600만 원 × 13.2% = 79만 2천 원
다만 이 금액이 무조건 그대로 환급된다는 뜻은 아니다. 이미 낸 세금, 다른 공제 항목, 최종 결정세액에 따라 실제 환급액은 달라진다. 연금저축의 세액공제는 &ldquo;받을 수 있는 최대 세금 절감 효과&quot;로 이해하는 게 정확하다.
연금저축펀드와 연금저축보험은 성격이 다르다 &nbsp; 연금저축은 하나의 상품명이라기보다 제도에 가깝다. 실제로 가입할 때는 금융회사와 운용 방식에 따라 연금저축펀드, 연금저축보험 등으로 나뉜다.
연금저축펀드 &nbsp; 연금저축펀드는 주로 증권사나 자산운용사를 통해 가입하는 투자형 연금저축이다. 계좌 안에서 펀드나 ETF 등을 선택해 운용할 수 있다.
...
연금저축보험 &nbsp; 연금저축보험은 보험사를 통해 가입하는 방식이다. 보통 보험사가 정한 구조에 따라 장기간 납입하고, 나중에 연금으로 받는 형태다.
...
연금저축신탁 &nbsp; 연금저축신탁은 과거 은행에서 판매하던 형태지만, 2018년 이후 신규 판매가 중단되었다. 기존에 가입한 계좌가 있다면 유지 여부를 검토할 수 있지만, 새로 가입하는 사람은 보통 연금저축펀드와 연금저축보험 중에서 선택하게 된다.
연금으로 받으면 세금이 낮아지고, 중간에 깨면 세금이 커질 수 있다 &nbsp; 연금저축의 세금 구조는 &ldquo;넣을 때 혜택을 받고, 나중에 연금으로 받을 때 낮은 세율로 과세되는 방식&quot;이다.
...
연금 수령 나이 연금소득세율 만 70세 미만 5.5% 만 70세 이상 만 80세 미만 4.4% 만 80세 이상 3.3% 반대로 중도해지하거나 연금이 아닌 방식으로 돈을 찾으면 세액공제를 받은 납입금과 운용수익에 대해 기타소득세 16.5%가 부과될 수 있다. 그래서 연금저축은 단기 목돈을 넣어두는 통장처럼 쓰면 안 된다.
...
연금저축과 IRP는 함께 쓰지만 같은 상품은 아니다 &nbsp; 연금저축을 알아보다 보면 IRP도 함께 나온다. 둘 다 노후 준비를 위한 연금계좌이고 세액공제 혜택이 있지만, 운용 방식과 제약이 다르다.
...
구분 연금저축 IRP 세액공제 한도 연 600만 원 연금저축과 합산해 연 900만 원 가입 대상 누구나 가입 가능 소득이 있는 사람 중심 운용 상품 펀드, ETF, 보험 등 상품별로 다름 예금, 펀드, ETF, 리츠 등 다양 위험자산 한도 상품 구조에 따라 다름 위험자산 70% 한도 중도인출 상대적으로 가능 사유 제한이 강한 편 초보자라면 연금저축부터 이해하는 게 좋다. 연금저축은 구조가 비교적 단순하고, 세액공제 한도도 600만 원으로 명확하다. 이후 현금흐름에 여유가 있고 절세 한도를 더 채우고 싶다면 IRP를 추가로 검토하면 된다.
중요한 건 세액공제만 보고 무리하게 납입하지 않는 것이다. IRP까지 포함해 900만 원 한도를 채우면 절세 효과는 커지지만, 그만큼 당장 쓸 수 있는 현금도 줄어든다. 연금계좌는 오래 유지할수록 장점이 살아나는 계좌다.
어떤 사람에게 연금저축이 잘 맞을까? &nbsp; 연금저축은 모든 사람에게 무조건 1순위 상품은 아니다. 하지만 다음에 해당한다면 꽤 현실적인 선택지가 될 수 있다.
연말정산이나 종합소득세에서 세액공제 항목을 찾고 있다. 노후 준비를 시작해야 한다고 느끼지만 방법을 모르겠다. 매달 일정 금액을 장기적으로 묶어둘 수 있다. 단기 목돈보다 장기 자산 형성이 더 중요하다. 투자형 상품의 변동성을 어느 정도 이해하고 있다. 반대로 다음 상황이라면 서두르지 않는 편이 낫다.
비상금이 거의 없다. 고금리 카드론, 현금서비스, 신용대출이 있다. 1~2년 안에 써야 할 목돈을 넣으려 한다. 중도해지 가능성이 높다. 투자상품 손실 가능성을 전혀 감당하기 어렵다. 연금저축은 &ldquo;세금을 아끼는 상품&quot;이면서 동시에 &ldquo;돈을 오래 묶어두는 계좌&quot;다. 세액공제라는 장점만 보면 좋아 보이지만, 유지 기간과 현금흐름을 함께 봐야 한다.
처음 시작한다면 월 10만 원이나 20만 원처럼 부담 없는 금액이 낫다. 나중에 소득이 늘고 생활비 구조가 안정되면 납입액을 늘리면 된다. 연금저축은 한 번에 크게 넣는 것보다 오래 유지하는 힘이 더 중요하다.
정리 &nbsp; 연금저축은 노후자금을 준비하면서 세액공제 혜택을 받을 수 있는 대표적인 개인연금 계좌다. 연 600만 원까지 세액공제 대상이 되고, IRP까지 함께 활용하면 연금계좌 합산으로 연 900만 원까지 공제 한도가 커진다.
...
연금저축을 시작할 때는 &ldquo;얼마를 돌려받을 수 있나&quot;보다 &ldquo;이 돈을 오래 유지할 수 있나&quot;를 먼저 봐야 한다. 세액공제는 좋은 혜택이지만, 비상금과 현금흐름이 먼저다. 오래 유지할 수 있는 금액으로 시작하면 연금저축은 절세와 노후 준비를 함께 챙기는 현실적인 도구가 될 수 있다.
자주 묻는 질문 &nbsp; 연금저축은 누구나 가입할 수 있나? &nbsp; 가능하다. 연금저축은 나이와 소득 여부에 관계없이 가입할 수 있다. 다만 세액공제 효과는 실제로 낼 세금이 있을 때 더 크게 느껴진다.
연금저축은 얼마부터 넣는 게 좋을까? &nbsp; 정답은 없다. 세액공제 한도만 보면 연 600만 원, 월 50만 원이 기준이지만 처음부터 이 금액을 무리해서 채울 필요는 없다. 월 10만 원이나 20만 원처럼 오래 유지할 수 있는 금액부터 시작하는 편이 현실적이다.
연금저축펀드와 연금저축보험 중 무엇이 더 좋을까? &nbsp; 투자상품을 직접 고르고 장기 수익률을 기대한다면 연금저축펀드가 잘 맞을 수 있다. 안정적인 구조와 보험사 상품이 더 익숙하다면 연금저축보험을 볼 수 있다. 다만 보험은 사업비와 해지환급금 구조를 반드시 확인해야 한다.
연금저축을 중간에 해지하면 어떻게 되나? &nbsp; 세액공제를 받은 납입금과 운용수익에 대해 기타소득세 16.5%가 부과될 수 있다. 그래서 연금저축은 단기 목돈 보관용이 아니라 노후자금 계좌로 보는 게 좋다.`}).add({id:109,href:"/posts/deposit-vs-savings/",title:"예금과 적금 차이, 이자 계산까지 쉽게 이해하기",description:"예금과 적금은 돈을 맡기는 방식부터 이자 계산 구조까지 다르다. 목돈이 있을 때와 매달 저축할 때 어떤 상품이 유리한지 쉽게 설명한다.",content:`예금과 적금은 둘 다 은행에 돈을 맡기고 이자를 받는 저축 상품이다. 그런데 막상 가입하려고 보면 &ldquo;예금이랑 적금이 뭐가 다르지?&rdquo;, &ldquo;금리가 같으면 이자도 같은 것 아닌가?&rdquo; 같은 생각이 들 수 있다.
...
미국 직원은 팁을 못 받으면 최저임금도 못 받는 걸까? &nbsp; 연방 기준으로는 팁과 현금 임금을 합친 금액이 최저임금에 미치지 못하면 고용주가 차액을 보전해야 한다. 다만 실제 현장에서는 팁이 직원 소득에서 큰 비중을 차지하고, 주마다 임금 기준도 다르기 때문에 팁이 생계와 깊게 연결되어 있다.`}).add({id:111,href:"/posts/withholding-tax-system/",title:"원천징수 제도 뜻 쉽게 정리, 세전·세후 월급 차이까지...",description:"원천징수 제도의 뜻과 원천징수의무자, 세전·세후 월급 차이, 근로소득세가 미리 빠지는 이유, 연말정산과의 관계를 누구나 이해하기 쉽게 정리하였다.",content:`월급을 받으면 세전, 세후라는 말을 자주 듣는다. 연봉 계약서에는 분명 5,000만 원이라고 적혀 있는데, 실제 통장에 들어오는 돈을 계산해보면 생각보다 적다. 대략 &ldquo;세금 떼고 들어오는 돈이구나&rdquo; 정도는 알지만, 정확히 무엇이 빠지는지는 헷갈린다.
...
은행을 고를 때는 이름값만 보지 말고 내가 실제로 쓸 기능을 기준으로 보면 된다. 급여 계좌, 자동이체, 대출, 예금 금리, 모바일 앱 사용성, 지점 접근성, 보안 기능을 함께 비교하면 내 생활에 맞는 은행을 고르기 훨씬 쉽다.`}).add({id:113,href:"/posts/bank-vs-savings-bank/",title:"은행과 저축은행의 차이",description:`은행은 제1금융권이라고 하고, 이를 제외한 대부분의 금융기관을 제2금융권이라고 한다.
...
인버스 ETF와 레버리지 ETF 뜻 &nbsp; 인버스 ETF는 기초지수가 하락할 때 수익이 나도록 설계된 ETF다. 예를 들어 코스피200 인버스 ETF라면 코스피200 지수의 하루 수익률과 반대로 움직이는 것을 목표로 한다. 코스피200이 하루 동안 1% 하락하면 인버스 ETF는 대략 1% 상승하는 구조다.
...
구분 인버스 ETF 레버리지 ETF 기본 방향 기초지수와 반대로 움직임 기초지수와 같은 방향으로 더 크게 움직임 대표 구조 지수 -1%이면 ETF +1% 목표 지수 +1%이면 ETF +2% 목표 활용 목적 하락장 대응, 단기 헤지 상승장 단기 대응 위험 지수가 오르면 손실 지수가 내리면 손실이 더 커짐 핵심 주의점 하락 예측이 틀리면 손실 변동성이 크고 손실 속도가 빠름 여기서 인버스 2X ETF라는 상품도 있다. 흔히 &ldquo;곱버스&quot;라고 부른다. 기초지수가 하루 1% 하락하면 ETF가 대략 2% 상승하도록 설계된 상품이다. 반대로 기초지수가 하루 1% 상승하면 ETF는 대략 2% 하락한다. 방향이 반대이고 배율도 2배라 위험이 더 크다.
왜 투자자들이 인버스·레버리지 ETF에 관심을 가질까? &nbsp; 인버스·레버리지 ETF는 시장 전체 흐름에 빠르게 대응할 수 있다는 장점이 있다. 개별 종목을 고르지 않아도 코스피200, 코스닥150, 나스닥100 같은 지수의 방향에 투자할 수 있다.
...
하지만 접근성이 좋다고 해서 위험이 낮은 것은 아니다. 인버스·레버리지 ETF는 파생상품 구조가 들어간 고위험 ETF다. 특히 초보 투자자가 &ldquo;지수가 오를 것 같다&rdquo;, &ldquo;이제는 떨어질 것 같다&quot;는 감만으로 들어가면 손실이 빠르게 커질 수 있다.
하루 수익률 추종과 복리 효과 &nbsp; 인버스·레버리지 ETF에서 가장 중요한 개념은 하루 수익률 추종이다. 이 상품들은 보통 기초지수의 누적 수익률이 아니라 매일매일의 수익률을 기준으로 목표 수익률을 맞춘다.
...
구분 시작 1일 후 2일 후 누적 수익률 기초지수 1,000 975 1,000 0% 2배 레버리지 ETF 1,000 950 998.6 -0.14% 이 차이는 매일의 수익률을 다시 기준으로 계산하기 때문에 생긴다. 시장이 한 방향으로 강하게 움직이면 레버리지 ETF가 유리하게 작동할 수 있다. 하지만 위아래로 크게 흔들리는 장에서는 지수가 제자리여도 ETF는 손실이 누적될 수 있다.
인버스 ETF도 마찬가지다. 단순히 &ldquo;지수가 결국 떨어질 것 같다&quot;만 보고 오래 들고 가면 기대와 다른 결과가 나올 수 있다. 하루 단위 수익률을 매일 반영하는 구조이기 때문에, 투자 기간이 길어질수록 기초지수의 누적 등락과 ETF 수익률 사이에 차이가 커질 수 있다.
인버스·레버리지 ETF 투자 방법 &nbsp; 국내 상장 인버스·레버리지 ETF는 일반 ETF처럼 증권사 앱에서 거래할 수 있다. 다만 일반 주식형 ETF와 달리 사전 교육 이수와 증권사별 거래 조건이 붙을 수 있다.
기본적인 흐름은 아래와 같다.
증권사 계좌를 개설한다. 금융투자교육원에서 레버리지 ETP 교육을 이수한다. 교육 이수 번호나 수료 정보를 거래 증권사에 등록한다. 증권사에서 요구하는 기본 예탁금 조건을 확인한다. 국내주식 또는 ETF 주문 화면에서 원하는 종목을 검색한다. 기초지수, 배율, 인버스 여부, 거래량, 보수, 괴리율을 확인한다. 투자 기간과 손절 기준을 정한 뒤 소액으로 거래한다. 국내에 상장된 레버리지·인버스 ETF나 ETN에 투자하려면 금융투자교육원에서 레버리지 ETP 교육을 받아야 한다. 교육을 마치면 이수 번호나 수료증이 나오고, 이를 증권사 앱에 등록해야 거래가 가능하다.
...
금융투자교육원 바로가기 &nbsp; 투자 전 꼭 확인해야 할 위험 &nbsp; 인버스·레버리지 ETF는 방향을 맞혔을 때 수익이 빠르게 날 수 있지만, 방향이 틀리면 손실도 빠르게 커진다. 특히 레버리지와 곱버스는 일반 ETF보다 가격 변동이 훨씬 크다.
장기 보유에 적합하지 않을 수 있다 &nbsp; 인버스·레버리지 ETF는 단기 거래를 목적으로 설계된 상품에 가깝다. 하루 수익률을 매일 반영하는 구조라 시장이 크게 출렁이면 시간이 지날수록 수익률이 기대와 달라질 수 있다.
특히 박스권 장세에서는 지수가 크게 움직이지 않았는데도 ETF 가격이 조금씩 깎이는 일이 생길 수 있다. 그래서 이 상품은 &ldquo;사놓고 기다리는 ETF&quot;라기보다 &ldquo;명확한 시나리오와 기간을 정하고 쓰는 ETF&quot;에 가깝다.
손실 속도가 빠르다 &nbsp; 2배 레버리지 ETF는 지수가 5% 하락하면 대략 10% 하락할 수 있다. 인버스 2X ETF는 지수가 5% 상승하면 대략 10% 하락할 수 있다. 방향을 잘못 잡으면 일반 ETF보다 훨씬 빠르게 손실이 커진다.
또 손실이 커진 뒤 원금을 회복하기도 어렵다. 50% 손실이 나면 원래 금액으로 돌아오기 위해서는 100% 수익이 필요하다. 배율이 높은 상품일수록 손실 관리가 먼저다.
괴리율과 추적오차를 봐야 한다 &nbsp; ETF 가격은 이론상 가치와 시장 가격이 다를 수 있다. 이를 괴리율이라고 한다. 거래가 몰리거나 시장 변동성이 커지면 ETF 가격이 실제 가치보다 비싸거나 싸게 거래될 수 있다.
...
해외 3배·4배 상품은 더 위험하다 &nbsp; 해외에는 3배, 4배 레버리지 ETF도 있다. 상승장에서 수익률이 커 보이지만, 하락장에서는 손실도 훨씬 빠르다. 하루 변동률이 큰 자산에 3배·4배 배율이 붙으면 짧은 기간에도 계좌가 크게 흔들릴 수 있다.
초보 투자자라면 배율이 높을수록 &ldquo;기회가 크다&quot;보다 &ldquo;판단이 틀렸을 때 버틸 여지가 줄어든다&quot;는 점을 먼저 봐야 한다.
인버스와 레버리지 ETF를 쓸 때의 기준 &nbsp; 인버스·레버리지 ETF는 포트폴리오의 중심 자산으로 두기보다, 제한된 비중으로 단기 전략에 쓰는 편이 현실적이다. 특히 초보자라면 투자 전에 매수 이유, 보유 기간, 손절 기준을 먼저 적어두는 것이 좋다.
아래 기준을 정하지 못했다면 매수를 미루는 편이 낫다.
질문 확인할 내용 왜 이 상품을 사는가? 단순한 감인지, 구체적인 시장 시나리오가 있는지 얼마나 보유할 것인가? 하루, 며칠, 몇 주 등 기간을 정했는지 틀렸을 때 어떻게 할 것인가? 손절 기준과 최대 손실 한도를 정했는지 전체 자산 중 비중은 얼마인가? 손실이 나도 생활과 장기 투자에 영향이 없는지 기초지수는 무엇인가? 코스피200, 코스닥150, 나스닥100 등 무엇을 따라가는지 배율은 몇 배인가? -1배, 2배, -2배, 3배 등 구조를 이해했는지 인버스 ETF는 하락장에서 수익을 낼 수 있는 도구지만, 시장이 예상과 반대로 반등하면 손실이 난다. 레버리지 ETF는 상승장에서 수익을 키울 수 있지만, 하락장에서 손실도 커진다. 둘 다 &ldquo;방향성 투자&quot;라는 점을 잊으면 안 된다.
자주 묻는 질문 &nbsp; 인버스 ETF는 공매도와 같은 건가? &nbsp; 같은 것은 아니다. 공매도는 주식을 빌려 팔고 나중에 되사는 거래 방식이고, 인버스 ETF는 기초지수와 반대로 움직이도록 설계된 ETF를 사는 방식이다. 결과적으로 하락장에서 수익을 기대한다는 점은 비슷하지만 구조와 거래 방식은 다르다.
레버리지 ETF는 장기 투자하면 안 되나? &nbsp; 무조건 안 된다고 할 수는 없지만, 일반 지수 ETF처럼 장기 보유하기에는 구조가 복잡하다. 하루 수익률을 매일 2배로 반영하기 때문에 변동성이 큰 장에서는 기초지수 누적 수익률의 2배와 다른 결과가 나올 수 있다. 초보자라면 단기 전략 상품으로 이해하는 편이 안전하다.
곱버스는 무엇인가? &nbsp; 곱버스는 보통 인버스 2X ETF를 뜻한다. 기초지수가 하루 1% 하락하면 약 2% 상승하고, 기초지수가 하루 1% 상승하면 약 2% 하락하도록 설계된 상품이다. 하락장에 베팅하는 효과가 2배라 수익과 손실 변동이 모두 크다.
인버스·레버리지 ETF를 사려면 교육을 꼭 들어야 하나? &nbsp; 국내 상장 레버리지·인버스 ETF나 ETN을 거래하려면 금융투자교육원의 레버리지 ETP 교육 이수가 필요하다. 교육 이수 후 증권사에 이수 정보를 등록해야 거래할 수 있다. 증권사에 따라 기본 예탁금 조건도 있을 수 있다.
인버스 ETF는 주식시장 하락을 완벽히 방어해주나? &nbsp; 아니다. 인버스 ETF는 하루 수익률을 반대로 추종하는 상품이므로 장기간 보유하면 실제 시장 하락률과 수익률이 달라질 수 있다. 또 타이밍을 잘못 잡아 시장이 반등하면 손실이 발생한다. 보유 주식의 헤지 수단으로 쓸 때도 비중과 기간을 정해야 한다.
마무리 &nbsp; 인버스 ETF는 시장이 하락할 때 수익을 추구하는 상품이고, 레버리지 ETF는 시장이 상승할 때 더 큰 수익을 추구하는 상품이다. 둘 다 주식처럼 쉽게 거래할 수 있지만, 구조는 일반 ETF보다 훨씬 공격적이다.
...
처음 투자한다면 큰돈을 넣기보다 구조를 이해하는 데 집중하는 것이 좋다. 교육 이수, 예탁금 조건, 기초지수, 배율, 괴리율, 손절 기준을 확인한 뒤에도 확신이 없다면 굳이 매수하지 않는 것이 더 나은 선택일 수 있다.`}).add({id:115,href:"/posts/inflation-meaning-and-causes/",title:"인플레이션",description:"인플레이션 뜻과 원인, CPI 계산법, 디플레이션·스태그플레이션 차이까지 초보자도 이해하기 쉽게 정리한다.",content:`마트에서 같은 장바구니를 채웠는데 결제 금액이 예전보다 훨씬 커진 느낌을 받을 때가 있다. 김밥, 커피, 외식비, 택시비처럼 자주 쓰는 항목이 조금씩 오르면 체감은 더 크다. 이때 뉴스에서 자주 나오는 말이 바로 인플레이션이다.
인플레이션은 단순히 &ldquo;물건값이 오른다&rdquo; 정도로 끝나는 말이 아니다. 내 월급의 실제 가치, 예금 이자, 대출 금리, 주식과 부동산 같은 자산 가격에도 영향을 준다. 그래서 경제 공부를 처음 시작한다면 인플레이션부터 이해하는 게 좋다.
인플레이션 뜻, 물가가 계속 오르는 현상 &nbsp; 인플레이션(Inflation)은 한 나라의 물건과 서비스 가격이 전반적으로 계속 오르는 현상이다. 여기서 중요한 말은 &ldquo;전반적으로&quot;와 &ldquo;계속&quot;이다.
...
이 차이를 이해하면 뉴스에서 &ldquo;물가가 올랐다&quot;는 말을 들을 때 단순히 가격표만 보는 게 아니라, 내 돈의 힘이 얼마나 약해졌는지도 함께 볼 수 있다.
인플레이션 원인, 수요와 비용을 보면 이해된다 &nbsp; 인플레이션의 원인은 복잡해 보이지만 크게 두 방향으로 보면 쉽다. 하나는 사람들이 많이 사려고 해서 가격이 오르는 경우이고, 다른 하나는 물건을 만드는 비용이 올라서 가격이 오르는 경우다.
수요 견인 인플레이션 &nbsp; 수요 견인 인플레이션은 말 그대로 수요가 물가를 끌어올리는 현상이다. 사람들이 물건을 더 많이 사려고 하는데 공급이 바로 따라오지 못하면 가격이 오른다.
...
비용 인상 인플레이션 &nbsp; 비용 인상 인플레이션은 물건을 만드는 비용이 올라서 생긴다. 원유, 곡물, 전기요금, 임금, 물류비, 임대료 같은 비용이 오르면 기업은 이전 가격으로 팔기 어려워진다.
...
인플레이션이 생활에 미치는 영향 &nbsp; 인플레이션이 적당한 수준이면 경제가 성장하는 과정에서 자연스럽게 나타날 수 있다. 소비가 늘고 기업 매출이 증가하며 고용과 임금이 함께 좋아지는 흐름이라면 물가 상승 자체가 무조건 나쁜 신호는 아니다.
...
투자 관점에서도 인플레이션은 중요하다. 물가가 오르는 시기에는 기업의 매출이 늘어 보일 수 있지만, 원가 부담이 더 크면 이익은 줄어들 수 있다. 그래서 단순히 &ldquo;물가가 오르면 자산 가격도 오른다&quot;라고 외우기보다, 금리와 기업 이익, 가계 소비가 함께 어떻게 움직이는지 봐야 한다.
인플레이션율과 CPI 계산법 &nbsp; 인플레이션이 얼마나 심한지는 보통 소비자물가지수, 즉 CPI(Consumer Price Index)를 기준으로 본다. CPI는 사람들이 자주 소비하는 대표 상품과 서비스의 가격 변화를 묶어서 평균적인 물가 흐름을 보여주는 지표다.
인플레이션율 계산식은 단순하다.
인플레이션율(%) = (현재 CPI - 기준 시점 CPI) / 기준 시점 CPI x 100예를 들어 지난해 CPI가 100이고 올해 CPI가 104라면 계산은 이렇게 된다.
(104 - 100) / 100 x 100 = 4%이 경우 물가상승률은 4%다. 반대로 CPI가 100에서 98로 내려가면 물가상승률은 -2%가 된다. 이처럼 물가가 전반적으로 내려가는 현상을 디플레이션이라고 한다.
...
디플레이션, 스태그플레이션, 하이퍼인플레이션 차이 &nbsp; 인플레이션을 이해할 때 함께 알아두면 좋은 용어가 있다. 디플레이션, 스태그플레이션, 하이퍼인플레이션이다. 셋 다 물가와 관련 있지만 경제에 주는 의미는 다르다.
디플레이션 &nbsp; 디플레이션은 물가가 전반적으로 계속 내려가는 현상이다. 겉으로 보면 물건값이 싸지는 것이니 좋아 보일 수 있다. 하지만 경제 전체로 보면 위험할 수 있다.
사람들이 &ldquo;조금만 기다리면 더 싸질 것&quot;이라고 생각하면 소비를 미룬다. 소비가 줄면 기업 매출이 줄고, 기업은 투자와 고용을 줄일 수 있다. 그러면 소득이 줄고 다시 소비가 줄어드는 악순환이 생길 수 있다.
스태그플레이션 &nbsp; 스태그플레이션은 경기 침체와 물가 상승이 동시에 나타나는 현상이다. 경기는 안 좋은데 생활비는 오르는 상태라서 일반적인 인플레이션보다 더 까다롭다.
...
하이퍼인플레이션 &nbsp; 하이퍼인플레이션은 물가가 통제하기 어려울 정도로 폭등하는 극단적인 상황이다. 돈의 가치가 빠르게 떨어져서 월급을 받아도 며칠 뒤에는 같은 물건을 사기 어려워질 수 있다.
일반적인 경제 상황에서 자주 겪는 일은 아니지만, 정부 재정이 무너지고 화폐 신뢰가 크게 훼손될 때 발생할 수 있다. 그래서 물가 안정은 단순히 가격 문제가 아니라 경제 신뢰의 문제이기도 하다.
인플레이션 시기에 개인이 봐야 할 것 &nbsp; 인플레이션을 알았다고 해서 물가를 직접 낮출 수는 없다. 하지만 내 돈을 관리하는 방식은 바꿀 수 있다.
...
정리 &nbsp; 인플레이션은 물가가 전반적으로 계속 오르는 현상이고, 동시에 돈의 구매력이 낮아지는 현상이다. 원인은 크게 수요가 늘어 가격이 오르는 경우와 생산 비용이 올라 가격이 오르는 경우로 나눌 수 있다.
...
자주 묻는 질문 &nbsp; 인플레이션이 오르면 월급도 같이 오르나? &nbsp; 꼭 그렇지는 않다. 임금이 오를 수는 있지만 물가가 더 빠르게 오르면 실제 구매력은 줄어든다. 그래서 월급의 숫자보다 실질소득을 함께 봐야 한다.
인플레이션율이 낮아졌는데 왜 물가는 여전히 비싸게 느껴지나? &nbsp; 인플레이션율이 낮아졌다는 말은 가격 상승 속도가 느려졌다는 뜻이지, 가격이 예전 수준으로 내려갔다는 뜻은 아니다. 또 내가 자주 사는 품목의 가격이 많이 올랐다면 체감물가는 공식 지표보다 높게 느껴질 수 있다.
디플레이션은 물가가 내려가니 좋은 것 아닌가? &nbsp; 단기적으로는 좋아 보일 수 있지만 경제 전체로는 위험할 수 있다. 소비가 미뤄지고 기업 매출이 줄면 투자와 고용이 위축될 수 있기 때문이다.
인플레이션 시기에는 예금보다 투자가 무조건 좋은가? &nbsp; 무조건 그렇지는 않다. 비상금과 단기 자금은 안정성이 중요하다. 다만 장기 자금은 물가상승률을 고려해 실질 수익률을 따져봐야 한다.`}).add({id:116,href:"/posts/isa-account-type-managed/",title:"ISA 일임형",description:"일임형 ISA의 뜻, 모델포트폴리오 구조, 신탁형 ISA와의 차이, 가입 절차, 수수료와 주의사항까지 초보자도 이해하기 쉽게 정리했다.",content:`투자는 하고 싶은데 어떤 상품을 골라야 할지 막막할 때가 있다. ETF를 사야 할지, 펀드를 골라야 할지, 안전자산 비중은 얼마나 둬야 할지 생각하다 보면 계좌 개설 단계에서 멈추기도 한다.
...
Q5. 일임형 ISA 수수료는 얼마나 중요한가? &nbsp; 매우 중요하다. 일임운용 수수료뿐 아니라 포트폴리오에 들어 있는 펀드나 ETF의 보수까지 장기 수익률에 영향을 준다. 가입 전 총비용을 확인해야 한다.`}).add({id:117,href:"/posts/funding-plan-for-home-purchase/",title:"자금조달계획서 제출 대상과 증빙서류 총정리: 작성 방법...",description:"자금조달계획서가 무엇인지, 제출 대상과 기한, 자기자금·대출·증여 작성 방법, 증빙서류와 반려를 막는 체크포인트까지 누구나 이해하기 쉽게 정리하였다.",content:`집을 사기로 마음먹고 계약까지 진행하면 생각보다 많은 서류를 만나게 된다. 그중 처음 집을 사는 사람이 가장 헷갈려 하는 서류가 자금조달계획서다. 이름부터 딱딱하고, 돈의 출처를 적어야 한다고 하니 괜히 긴장되기도 한다.
...
관리사무소가 납부확인서를 안 주면 어떻게 하나? &nbsp; 아파트 사용자가 장기수선충당금 납부 확인을 요구하면 관리주체는 지체 없이 확인서를 발급해야 한다. 먼저 관리사무소에 정식으로 요청하고, 필요하면 요청 날짜와 담당자, 답변 내용을 기록해두는 것이 좋다.`}).add({id:120,href:"/posts/reconstruction-redevelopment-difference/",title:"재건축 재개발 차이, 분담금과 이주비 절차까지 쉽게 정리",description:"재건축과 재개발의 차이, 사업 절차, 조합원 요건, 분담금과 부담금, 이주비와 주거이전비까지 초보자 기준으로 쉽게 정리했다.",content:`부동산 뉴스를 보다 보면 재건축과 재개발이라는 말이 자주 나온다. 둘 다 오래된 주거 환경을 새롭게 바꾸는 사업이라 비슷해 보이지만, 실제로는 대상과 절차, 돈이 들어가는 방식이 꽤 다르다.
...
아무나 전입세대확인서를 발급받을 수 있을까? &nbsp; 아니다. 개인정보가 포함된 서류라서 소유자, 임차인, 매매계약자, 임대차계약자, 금융기관 등 법령상 신청 자격이 있는 사람이나 기관이 신청할 수 있다. 신청 유형에 따라 계약서, 위임장, 신분증 같은 서류가 필요할 수 있다.`}).add({id:123,href:"/posts/tax-saving-vs-tax-evasion/",title:"절세와 탈세 차이, 합법적으로 세금 줄이는 기준과 탈세 사례",description:"절세와 탈세의 차이를 세법상 기준, 증빙자료, 소득공제와 세액공제, 가공경비와 수입 누락 사례로 초보자도 이해하기 쉽게 정리했다.",content:`세금은 가능하면 줄이고 싶다. 월급을 받는 사람도 연말정산 환급액이 커지면 기분이 좋고, 사업자는 종합소득세나 부가가치세 신고 때 비용을 빠짐없이 인정받고 싶다. 그런데 여기서 자주 헷갈리는 말이 있다. 바로 &ldquo;절세&quot;와 &ldquo;탈세&quot;다.
...
사이드카와 서킷브레이커 중 무엇이 더 강한 조치일까? &nbsp; 서킷브레이커가 더 강한 조치다. 사이드카는 프로그램 매매만 제한하지만, 서킷브레이커는 시장 전체 매매를 일정 시간 중단한다. 따라서 투자자가 체감하는 영향도 서킷브레이커가 훨씬 크다.`}).add({id:128,href:"/posts/fractional-stock-trading/",title:"주식 소수점 거래 방법과 장단점, 주식 모으기로 소액 ...",description:"주식 소수점 거래의 뜻과 장단점, 주문 방법, 주식 모으기 활용법, 수수료와 의결권 등 초보자가 꼭 확인할 주의점을 쉽게 정리했다.",content:`비싼 주식을 사고 싶은데 한 주 가격이 부담스러울 때가 있다. SK하이닉스, 현대자동차, 삼성바이오로직스처럼 한 주 가격이 몇십만 원을 넘는 종목은 초보자가 선뜻 매수하기 어렵다. 관심은 있지만 &ldquo;일단 한 주부터 사보자&quot;는 말 자체가 부담이 되는 경우가 많다.
...
해외 주식도 같은 계좌에서 살 수 있을까? &nbsp; 대부분의 증권사 종합매매계좌에서 해외 주식 거래를 신청하면 가능하다. 다만 해외 주식은 환전, 거래 시간, 세금, 수수료가 국내 주식과 다르다. 미국 주식을 살 생각이라면 해외 주식 거래 신청뿐 아니라 환율과 양도소득세도 함께 공부하는 것이 좋다.`}).add({id:130,href:"/posts/stock-deposit/",title:"주식 예수금 뜻: D+2 출금, 주문가능금액, 미수금까...",description:"주식 예수금의 뜻과 D+2 출금 구조, 주문가능금액과 출금가능금액의 차이, 미수금과 반대매매 위험까지 초보자 눈높이로 정리했다.",content:`주식을 처음 팔아보면 이상한 순간이 온다. 분명히 매도 체결은 됐는데 은행 계좌로 바로 돈을 빼려고 하면 출금 가능 금액이 늘어나지 않는다. 앱에는 예수금, D+1, D+2, 주문가능금액 같은 말이 같이 나오니 더 헷갈린다.
...
공매도와 무차입 공매도는 같은 말일까? &nbsp; 다르다. 일반적인 공매도는 주식을 빌린 뒤 파는 차입 공매도다. 반면 무차입 공매도는 주식을 빌리지 않고 먼저 파는 방식으로, 국내에서는 원칙적으로 금지되어 있다. 투자자가 문제 삼는 경우도 대부분 불법적인 무차입 공매도나 제도 운영의 불공정성에 대한 우려와 관련이 있다.`}).add({id:133,href:"/posts/blue-chip-yellow-chip-red-chip/",title:"주식 용어: 블루칩 옐로우칩 레드칩 뜻과 차이 쉽게 이해하기",description:"주식시장에서 자주 쓰이는 블루칩, 옐로우칩, 레드칩의 뜻과 차이를 초보 투자자도 이해할 수 있게 사례와 함께 정리했다.",content:`주식 뉴스를 보다 보면 &ldquo;블루칩 중심으로 매수세가 들어왔다&rdquo;, &ldquo;옐로우칩이 강세를 보였다&rdquo;, &ldquo;홍콩 증시의 레드칩이 주목받았다&rdquo; 같은 표현을 만날 때가 있다. 처음 들으면 색깔로 주식을 나누는 것처럼 느껴지지만, 실제로는 기업의 규모, 안정성, 시장에서의 위치를 설명하는 용어다.
...
주택담보대출은 고정금리와 변동금리 중 무엇이 좋을까? &nbsp; 정답은 없다. 금리 상승이 걱정되고 월 상환액을 안정적으로 관리하고 싶다면 고정금리나 혼합형이 편할 수 있다. 반대로 금리 하락 가능성을 보고 초기 금리를 낮추고 싶다면 변동금리를 검토할 수 있다. 다만 변동금리는 금리가 오를 때 상환 부담이 커질 수 있다.`}).add({id:140,href:"/posts/house-type/",title:"주택의 종류",description:"주택 종류에 대해서 알아본다.",content:`주택이란? &nbsp; 주택은 주택법 제2조(정의)에 따라서 단독주택과 공동주택으로 구분된다.
...
아파트 &nbsp; 주택으로 쓰는 층수가 5층 이상인 주택을 말한다.`}).add({id:141,href:"/posts/isa-account-type/brokerage/",title:"ISA 중개형",description:"중개형 ISA의 뜻, 가입 자격, 납입한도, 비과세와 분리과세 혜택, 편입 가능 상품, 중도인출, 만기 후 연금계좌 이전까지 쉽게 정리했다.",content:`주식이나 ETF 투자를 시작하면 세금 이야기를 피하기 어렵다. 배당소득세, 이자소득세, 해외 ETF 과세, 금융소득종합과세 같은 단어가 나오면 투자보다 세금이 더 어렵게 느껴진다.
...
처음이라면 주거래 은행과 연결이 편한 증권사 하나, 수수료와 주문 기능이 좋은 증권사 하나를 비교해보는 것부터 시작해도 충분하다. 이후 투자 방식이 정해지면 해외 주식, 공모주, 연금 계좌처럼 목적에 맞게 증권사 계좌를 추가하면 된다.`}).add({id:143,href:"/posts/direct-vs-indirect-investing/",title:"직접투자와 간접투자 차이, 종류와 장단점 쉽게 정리",description:"직접투자와 간접투자의 뜻, 대표적인 종류, 각각의 장점과 단점, 초보자가 어떤 방식으로 시작하면 좋은지 현실적인 기준으로 정리하였다.",content:`투자를 시작하려고 하면 가장 먼저 부딪히는 고민이 있다. 내가 직접 종목을 고를 것인지, 아니면 펀드나 ETF처럼 누군가 운용하는 상품을 활용할 것인지다. 주변에서는 &ldquo;좋은 주식을 직접 사야 돈을 번다&quot;고 말하기도 하고, 또 다른 쪽에서는 &ldquo;초보자는 분산투자 상품부터 해야 한다&quot;고 말한다.
...
간접투자는 안전한 투자인가? &nbsp; 간접투자도 원금 손실이 날 수 있다. 펀드나 ETF가 여러 자산에 나눠 투자한다고 해서 손실이 사라지는 것은 아니다. 투자 대상, 보수, 환매 조건, 변동성을 확인해야 한다.`}).add({id:144,href:"/posts/rolling-effect/",title:"채권 용어: 롤링 효과, 채권 가격이 만기가 가까워질수...",description:"롤링 효과의 뜻과 채권 가격, 잔존기간, 수익률곡선의 관계를 초보자도 이해하기 쉽게 예시와 함께 정리했다.",content:`채권 투자를 공부하다 보면 &ldquo;롤링 효과&quot;라는 용어를 듣게 된다. 처음 들으면 어려운 전문 용어처럼 느껴지지만, 핵심은 단순하다. 시간이 지나면서 채권의 남은 만기가 짧아지고, 그 과정에서 채권 가격이 오를 수 있다는 뜻이다.
...
카드를 고를 때는 &ldquo;혜택이 많다&quot;는 말보다 내 소비 패턴에 맞는지를 먼저 봐야 한다. 전월 실적, 할인 한도, 제외 업종, 연회비를 확인하고, 사용하지 않은 포인트는 카드포인트 통합조회에서 주기적으로 확인하면 카드 생활을 더 알뜰하게 관리할 수 있다.`}).add({id:148,href:"/posts/carry-trade/",title:"캐리 트레이드란? 금리 차이로 수익을 노리는 외환 투자...",description:"캐리 트레이드의 뜻과 작동 원리, 금리 차익과 환율 변동 수익, 장점과 위험, 개인 투자자가 주의할 점을 쉽게 정리했다.",content:`환율 뉴스를 보다 보면 &ldquo;엔 캐리 트레이드 청산&rdquo;, &ldquo;달러 강세와 캐리 트레이드&rdquo;, &ldquo;고금리 통화로 자금이 이동한다&rdquo; 같은 표현이 나온다. 주식이나 예금보다 낯선 말이라 어렵게 느껴지지만, 핵심은 단순하다. 금리가 낮은 통화로 돈을 조달하고, 금리가 높은 통화에 투자해 차이를 노리는 전략이다.
...
엔 캐리 트레이드는 무엇인가? &nbsp; 엔 캐리 트레이드는 금리가 낮은 엔화로 자금을 조달해 상대적으로 금리가 높은 통화나 자산에 투자하는 전략을 말한다. 일본의 저금리 환경 때문에 오랫동안 대표적인 캐리 트레이드 사례로 언급되었다. 다만 일본 금리와 글로벌 위험 심리가 바뀌면 엔 캐리 트레이드도 빠르게 청산될 수 있다.`}).add({id:149,href:"/posts/stock-candlestick-chart/",title:"캔들차트 보는 법",description:"캔들차트의 시가, 종가, 고가, 저가부터 몸통과 꼬리, 양봉과 음봉, 분봉·일봉·주봉, 대표 캔들 패턴까지 초보자 눈높이로 정리했다.",content:`주식 앱을 열면 가장 먼저 보이는 것이 차트다. 그런데 초보자에게 차트는 꽤 낯설다. 빨간색과 파란색 막대가 계속 이어져 있고, 위아래로 선이 달려 있는데 이것이 무엇을 의미하는지 모르면 주가가 올랐는지 내렸는지도 헷갈릴 수 있다.
...
캔들차트는 가격 흐름을 압축해서 보여준다 &nbsp; 캔들차트는 일정 기간 동안 주가가 어떻게 움직였는지 하나의 막대로 보여주는 차트다. 일봉 차트라면 캔들 하나가 하루의 움직임을 나타내고, 주봉 차트라면 캔들 하나가 일주일의 움직임을 나타낸다.
캔들 하나에는 네 가지 가격이 들어간다.
구분 뜻 시가 장이 시작될 때 처음 형성된 가격 종가 장이 끝날 때 마지막으로 형성된 가격 고가 해당 기간 동안 가장 높았던 가격 저가 해당 기간 동안 가장 낮았던 가격 예를 들어 어떤 주식이 오전 9시에 10,000원으로 시작해서 장중 10,800원까지 올랐다가 9,700원까지 밀렸고, 결국 10,500원에 마감했다고 해보자. 이 하루의 시가, 고가, 저가, 종가가 캔들 하나에 들어간다.
...
몸통과 꼬리를 먼저 이해해야 한다 &nbsp; 캔들은 크게 몸통과 꼬리로 나뉜다. 몸통은 시가와 종가 사이의 구간이고, 꼬리는 고가와 저가까지의 흔들림을 보여준다.
...
모양 기본 해석 긴 몸통 한쪽 방향의 힘이 강했다 짧은 몸통 시가와 종가가 비슷해 방향성이 약했다 긴 윗꼬리 위로 올랐지만 매도 압력에 밀렸다 긴 아래꼬리 아래로 밀렸지만 매수세가 들어와 회복했다 꼬리가 거의 없음 장중 흔들림이 상대적으로 작았다 예를 들어 긴 아래꼬리가 달린 캔들은 장중에 크게 하락했지만 저가에서 매수세가 들어와 다시 끌어올린 흔적일 수 있다. 반대로 긴 윗꼬리는 장중에 상승을 시도했지만 위에서 매물이 많이 나오며 눌린 흔적으로 볼 수 있다.
하지만 여기서 바로 결론을 내리면 안 된다. 긴 아래꼬리가 나왔다고 무조건 반등하는 것은 아니고, 긴 윗꼬리가 나왔다고 무조건 하락하는 것도 아니다. 캔들이 나온 위치, 거래량, 이전 흐름을 같이 봐야 의미가 살아난다.
양봉과 음봉은 시가와 종가의 관계다 &nbsp; 캔들차트에서 색깔은 보통 양봉과 음봉을 구분한다. 국내 주식 앱에서는 대체로 빨간색이 양봉, 파란색이 음봉으로 표시된다. 해외 차트나 일부 앱에서는 초록색과 빨간색을 쓰기도 하므로 색상 설정은 확인하는 것이 좋다.
...
구분 조건 의미 양봉 종가 &gt; 시가 시작보다 높게 마감했다 음봉 종가 &lt; 시가 시작보다 낮게 마감했다 도지 종가와 시가가 거의 비슷함 매수와 매도가 팽팽했다 초보자가 자주 헷갈리는 부분이 있다. 양봉이라고 해서 반드시 전날보다 오른 것은 아니다. 양봉은 &ldquo;오늘 시가보다 오늘 종가가 높다&quot;는 뜻이다. 만약 전날 종가가 12,000원이었고, 오늘 10,000원으로 시작해서 10,500원에 끝났다면 오늘 캔들은 양봉이지만 전날 대비로는 하락한 날이다.
그래서 캔들을 볼 때는 시가와 종가의 관계뿐 아니라 전일 종가 대비 등락률도 함께 봐야 한다. 주식 앱에서 표시되는 등락률과 캔들 색깔이 가끔 다르게 느껴지는 이유가 여기에 있다.
캔들 모양은 투자 심리를 보여준다 &nbsp; 캔들 하나는 가격 정보이면서 동시에 투자자 심리의 흔적이다. 누가 이겼는지, 어디에서 매물이 나왔는지, 어느 가격에서 매수세가 들어왔는지를 추정하는 단서가 된다.
장대양봉 &nbsp; 장대양봉은 몸통이 긴 양봉이다. 시가보다 종가가 크게 높게 끝났다는 뜻이다. 보통 강한 매수세가 들어왔거나, 호재가 나오면서 시장의 기대가 커졌을 때 나타난다.
하락이 길게 이어진 뒤 거래량이 늘며 장대양봉이 나오면 반등의 시작일 수 있다. 반대로 이미 많이 오른 자리에서 장대양봉이 나오면 단기 과열 신호일 수도 있다. 같은 장대양봉이라도 위치에 따라 해석이 달라진다.
장대음봉 &nbsp; 장대음봉은 몸통이 긴 음봉이다. 시가보다 종가가 크게 낮게 끝났다는 뜻이다. 매도세가 강하게 나온 날로 볼 수 있다.
...
도지 캔들 &nbsp; 도지는 시가와 종가가 거의 비슷한 캔들이다. 몸통이 매우 짧고 위아래 꼬리가 달리면 십자 모양처럼 보인다.
...
긴 꼬리 캔들 &nbsp; 윗꼬리가 길면 장중에는 가격이 올랐지만 결국 밀려서 마감했다는 뜻이다. 위쪽 가격대에서 매도 물량이 많았거나, 단기 차익실현이 강하게 나온 상황일 수 있다.
아래꼬리가 길면 장중에는 가격이 밀렸지만 저가에서 매수세가 들어와 회복했다는 뜻이다. 하락장에서는 매수세 유입의 단서가 될 수 있고, 상승장 중 조정에서는 눌림목 신호로 해석되기도 한다.
분봉, 일봉, 주봉은 투자 기간에 맞춰 본다 &nbsp; 캔들차트는 기간에 따라 여러 종류로 나뉜다. 1분봉, 5분봉, 15분봉 같은 분봉도 있고, 하루 단위의 일봉, 일주일 단위의 주봉, 한 달 단위의 월봉도 있다.
차트 종류 캔들 하나가 의미하는 기간 주로 보는 사람 분봉 1분, 5분, 15분 등 짧은 시간 단기 매매, 데이트레이딩 일봉 하루 일반 개인 투자자, 스윙 투자 주봉 일주일 중장기 투자자 월봉 한 달 장기 투자자, 큰 추세 확인 초보자는 일봉부터 보는 것이 좋다. 일봉은 하루 단위의 흐름을 보여주기 때문에 너무 빠르게 흔들리지 않으면서도 주가 흐름을 파악하기 쉽다.
...
대표적인 캔들 패턴은 위치와 함께 봐야 한다 &nbsp; 캔들 패턴은 특정 모양이 반복될 때 투자자들이 의미를 부여한 것이다. 패턴 이름을 외우는 것보다 &ldquo;어떤 자리에서 나왔는지&quot;를 보는 것이 더 중요하다.
망치형 &nbsp; 망치형은 몸통이 위쪽에 있고 아래꼬리가 긴 형태다. 하락 흐름 이후 저점 부근에서 나오면 매수세가 들어왔다는 신호로 볼 수 있다.
예를 들어 주가가 며칠 동안 계속 빠지다가 어느 날 장중 크게 밀렸지만, 장 마감에는 상당 부분 회복했다고 해보자. 이때 긴 아래꼬리 캔들이 만들어지면 저가에서 사려는 사람이 늘었다는 단서가 된다.
교수형 &nbsp; 교수형은 망치형과 비슷하게 생겼지만 주로 상승 흐름 이후 고점 부근에서 해석한다. 아래꼬리가 길다는 것은 장중에 매도세가 강하게 나왔다는 뜻이기도 하다.
상승이 길게 이어진 뒤 교수형 모양이 나오면 매수세가 이전만큼 강하지 않을 수 있다. 다만 다음 날 바로 하락이 이어지는지, 거래량이 늘었는지 확인해야 한다.
역망치형 &nbsp; 역망치형은 몸통이 아래쪽에 있고 윗꼬리가 긴 형태다. 하락 흐름 이후 저점 부근에서 나오면 반등 시도를 보여주는 신호로 볼 수 있다.
다만 윗꼬리가 길다는 것은 위로 올랐다가 밀렸다는 뜻이기도 하다. 그래서 역망치형은 다음 캔들이 양봉으로 이어지거나 저점을 지켜주는지 확인하는 것이 중요하다.
유성형 &nbsp; 유성형은 역망치형과 비슷하게 생겼지만 상승 흐름 이후 고점 부근에서 나올 때 주의 신호로 본다. 장중에는 강하게 올랐지만 결국 위에서 밀렸다는 뜻이기 때문이다.
특히 주가가 단기간 많이 오른 상태에서 긴 윗꼬리와 큰 거래량이 함께 나오면 차익실현 매물이 많았을 가능성이 있다. 이때는 무리하게 따라 사기보다 다음 흐름을 확인하는 편이 낫다.
패턴 주로 보는 위치 기본 해석 망치형 하락 후 저점 부근 반등 시도 가능성 교수형 상승 후 고점 부근 상승세 둔화 가능성 역망치형 하락 후 저점 부근 반등 시도 가능성 유성형 상승 후 고점 부근 하락 전환 가능성 캔들차트만으로 매매하면 위험하다 &nbsp; 캔들차트는 유용하지만 단독으로 쓰기에는 한계가 있다. 캔들은 과거 가격 움직임을 보여주는 도구이지, 미래를 확정해주는 도구가 아니다.
...
함께 볼 것 이유 거래량 실제로 많은 사람이 참여한 움직임인지 확인할 수 있다 이동평균선 단기 흐름과 중장기 추세를 함께 볼 수 있다 지지선·저항선 가격이 자주 멈추는 구간을 파악할 수 있다 뉴스와 실적 주가 움직임의 원인을 확인할 수 있다 거래량 없는 장대양봉은 힘이 약할 수 있고, 거래량이 크게 늘어난 장대음봉은 단순한 흔들림이 아닐 수 있다. 이동평균선 위에서 나오는 양봉과 장기 하락 추세에서 나오는 양봉도 의미가 다르다.
초보자에게 가장 중요한 것은 &ldquo;캔들 하나로 결론 내리지 않는 것&quot;이다. 캔들은 판단을 돕는 단서일 뿐, 투자 결정을 대신해주지는 않는다.
초보자가 캔들차트를 볼 때 체크할 순서 &nbsp; 차트를 처음 보면 어디부터 봐야 할지 막막하다. 이럴 때는 순서를 정해두면 훨씬 편하다.
먼저 일봉으로 최근 3개월 흐름을 본다. 주봉으로 큰 추세가 상승인지 하락인지 확인한다. 최근 캔들의 몸통과 꼬리가 어디로 길게 나왔는지 본다. 양봉과 음봉이 연속으로 나오는지 확인한다. 거래량이 평소보다 늘었는지 본다. 주요 지지선과 저항선 근처인지 확인한다. 뉴스, 실적, 공시처럼 가격을 움직인 이유가 있는지 확인한다. 예를 들어 관심 종목이 장기 하락 중인데 최근 저점에서 긴 아래꼬리 양봉이 나오고 거래량이 늘었다면 반등 가능성을 살펴볼 수 있다. 하지만 아직 주봉 추세가 하락이고 위쪽에 강한 저항선이 있다면 무리하게 큰 금액을 넣기보다 관찰하거나 분할 매수로 접근하는 편이 더 현실적이다.
반대로 주가가 이미 많이 오른 상태에서 긴 윗꼬리 캔들이 반복되고 거래량이 늘고 있다면 조심해야 한다. 위에서 팔려는 사람이 많아지고 있을 수 있기 때문이다.
자주 묻는 질문 &nbsp; 캔들차트는 주식 초보도 꼭 알아야 하나? &nbsp; 기본은 알아두는 것이 좋다. 캔들차트를 몰라도 장기 투자를 할 수는 있지만, 최소한 시가, 종가, 고가, 저가와 양봉·음봉 정도는 알아야 주가 흐름을 읽기 쉽다.
양봉이면 무조건 좋은 신호인가? &nbsp; 아니다. 양봉은 시가보다 종가가 높다는 뜻일 뿐이다. 전날 종가보다 낮게 끝났다면 전체 흐름은 약할 수 있다. 위치, 거래량, 전후 흐름을 함께 봐야 한다.
긴 아래꼬리가 나오면 바로 사도 되나? &nbsp; 바로 매수 신호로 단정하면 위험하다. 긴 아래꼬리는 저가에서 매수세가 들어왔다는 단서지만, 추세가 바뀌었다는 확정 신호는 아니다. 다음 캔들과 거래량, 지지선 유지 여부를 확인하는 것이 좋다.
초보자는 분봉과 일봉 중 무엇을 봐야 하나? &nbsp; 일봉부터 보는 것이 좋다. 분봉은 짧은 움직임이 많아 초보자가 흔들리기 쉽다. 장기 투자나 일반적인 주식 공부라면 일봉으로 흐름을 보고, 주봉으로 큰 추세를 확인하는 방식이 더 적합하다.
정리 &nbsp; 캔들차트는 주가의 시가, 종가, 고가, 저가를 한눈에 보여주는 도구다. 몸통은 시가와 종가의 차이를 보여주고, 꼬리는 장중 가격이 어디까지 흔들렸는지를 보여준다. 양봉은 시가보다 종가가 높은 캔들, 음봉은 시가보다 종가가 낮은 캔들이다.
...
초보자라면 일봉과 주봉을 중심으로 큰 흐름을 보고, 캔들 모양은 보조 단서로 활용하는 것이 좋다. 차트는 미래를 맞히는 도구가 아니라 가능성을 점검하는 도구다. 이 관점만 지켜도 캔들차트를 훨씬 차분하게 볼 수 있다.`}).add({id:150,href:"/posts/etf-types-covered-call-guide/",title:"ETF 커버드콜",description:"커버드콜 뜻과 콜옵션 매도 구조, 커버드콜 ETF가 분배금을 만드는 방식, 상승 수익 제한과 원금 손실 위험까지 초보자 기준으로 정리했다.",content:`커버드콜 ETF는 월배당 ETF와 함께 자주 언급되는 상품이다. 이름만 보면 어려워 보이지만, 핵심은 비교적 단순하다. 주식이나 채권 같은 기초자산을 보유하면서 그 자산의 콜옵션을 팔아 옵션 프리미엄을 받는 전략이다.
최근에는 &ldquo;연 10% 목표 분배&rdquo;, &ldquo;월분배&rdquo;, &ldquo;프리미엄&rdquo; 같은 표현이 붙은 커버드콜 ETF가 늘었다. 그래서 안정적으로 현금흐름을 받을 수 있는 상품처럼 느껴질 수 있다. 하지만 커버드콜 ETF는 예금이나 확정금리 상품이 아니다. 기초자산이 크게 하락하면 손실이 날 수 있고, 반대로 기초자산이 크게 상승할 때는 수익이 제한될 수 있다.
이 글에서는 커버드콜의 뜻, 콜옵션 매도 구조, 커버드콜 ETF가 수익을 만드는 방식, 투자 전 꼭 봐야 할 위험성을 초보자 기준으로 정리하였다.
커버드콜이란 무엇인가? &nbsp; 커버드콜은 기초자산을 보유한 상태에서 그 기초자산의 콜옵션을 매도하는 투자 전략이다. 영어로 covered call이라고 부르며, 여기서 covered는 &ldquo;기초자산을 이미 보유하고 있다&quot;는 의미에 가깝다.
...
쉽게 말하면 커버드콜은 &ldquo;일정한 프리미엄을 받는 대신, 큰 상승 수익 일부를 포기하는 전략&quot;이다. 그래서 시장이 완만하게 오르거나 옆으로 움직일 때 비교적 잘 맞고, 강한 상승장에서는 일반 주식 보유보다 수익이 낮아질 수 있다.
콜옵션 매도를 이해해야 한다 &nbsp; 커버드콜을 이해하려면 콜옵션과 콜옵션 매도부터 알아야 한다. 옵션이라는 단어가 어렵게 느껴질 수 있지만, &ldquo;권리&quot;와 &ldquo;의무&quot;로 나누면 훨씬 쉽다.
...
구분 의미 콜옵션 매수자 정해진 가격에 기초자산을 살 수 있는 권리를 가진다 콜옵션 매도자 프리미엄을 받는 대신, 권리 행사 시 기초자산을 넘겨줘야 한다 행사가격 옵션 계약에서 미리 정한 매매 가격 프리미엄 옵션 권리를 사고팔 때 오가는 대가 커버드콜은 여기서 콜옵션을 &ldquo;그냥&rdquo; 파는 것이 아니라, 기초자산을 보유한 상태에서 판다. 그래서 콜옵션 매수자가 권리를 행사하더라도 이미 보유한 주식이나 자산으로 대응할 수 있다. 이 점이 기초자산 없이 옵션만 파는 전략과 다르다.
커버드콜 전략 예시 &nbsp; 커버드콜의 손익 구조는 숫자로 보면 더 이해하기 쉽다.
...
주가가 내려갈 때 &nbsp; A주식이 9,000원으로 내려가면 콜옵션 매수자는 굳이 11,000원에 살 권리를 행사할 이유가 없다. 시장에서 9,000원에 살 수 있기 때문이다. 이 경우 옵션은 행사되지 않고, 투자자는 A주식 100주를 그대로 보유한다.
...
구분 손익 A주식 가격 하락 -10만원 콜옵션 매도 프리미엄 +5만원 최종 손익 -5만원 커버드콜이 하락 위험을 어느 정도 줄인다는 말은 이 구조에서 나온다. 다만 손실이 완전히 사라지는 것은 아니다. 주가가 크게 하락하면 프리미엄보다 더 큰 손실이 발생할 수 있다.
주가가 올라갈 때 &nbsp; 이번에는 A주식이 12,000원으로 올랐다고 하자. 콜옵션 매수자는 12,000원짜리 주식을 11,000원에 살 수 있으므로 권리를 행사할 가능성이 높다. 그러면 콜옵션 매도자는 보유한 A주식을 11,000원에 넘겨줘야 한다.
투자자는 주식을 10,000원에 사서 11,000원에 넘기므로 주식 매매에서는 10만원 이익을 얻는다. 여기에 콜옵션 매도 프리미엄 5만원을 더하면 최종 이익은 15만원이다.
구분 손익 A주식 매매 이익 +10만원 콜옵션 매도 프리미엄 +5만원 최종 손익 +15만원 그런데 커버드콜을 쓰지 않고 그냥 A주식을 보유했다면 어떨까. 10,000원에 산 주식이 12,000원이 되었으므로 20만원 이익을 얻었을 것이다. 커버드콜 전략을 사용하면서 11,000원 이상 상승분을 포기한 셈이다.
이것이 커버드콜의 핵심 단점이다. 하락장에서는 프리미엄이 손실을 일부 완충할 수 있지만, 강한 상승장에서는 수익이 행사가격 부근에서 제한될 수 있다.
커버드콜 ETF는 어떻게 수익을 만들까? &nbsp; 커버드콜 ETF는 개인이 직접 옵션을 매도하는 대신, ETF 운용사가 정해진 규칙에 따라 기초자산을 보유하고 콜옵션을 매도하는 상품이다. 투자자는 일반 ETF처럼 증권사 앱에서 매수하면 되고, 운용사는 ETF 안에서 커버드콜 전략을 실행한다.
커버드콜 ETF의 수익원은 보통 세 가지로 나눠볼 수 있다.
수익원 설명 기초자산 가격 상승 ETF가 보유한 주식, 채권, 지수 등이 오를 때 생기는 수익 옵션 프리미엄 콜옵션을 매도하고 받는 대가 배당 또는 이자 기초자산에서 발생하는 배당금이나 채권 이자 이 중 투자자에게 가장 눈에 띄는 것은 분배금이다. 커버드콜 ETF는 옵션 프리미엄과 배당 등을 재원으로 월분배금을 지급하는 경우가 많다. 그래서 안정적인 현금흐름을 원하는 투자자들이 관심을 가진다.
...
커버드콜 ETF가 잘 맞는 시장 &nbsp; 커버드콜 ETF는 모든 시장에서 유리한 전략이 아니다. 특히 기초자산이 강하게 상승하는 장에서는 일반 지수 ETF보다 수익률이 낮아질 수 있다. 콜옵션을 매도한 대가로 상승 수익 일부를 포기하기 때문이다.
...
시장 환경 커버드콜 ETF에서 생길 수 있는 문제 강한 상승장 기초자산 상승분을 온전히 따라가지 못할 수 있다 급락장 옵션 프리미엄보다 기초자산 손실이 훨씬 커질 수 있다 변동성 급등 옵션 전략의 손익 변동이 커질 수 있다 기초자산과 옵션 대상이 다른 경우 예상과 다른 방향으로 손실이 확대될 수 있다 즉 커버드콜 ETF는 &ldquo;시장 하락을 완벽히 막아주는 상품&quot;이 아니다. 프리미엄이 완충 장치가 될 수는 있지만, 기초자산 하락이 크면 원금 손실이 그대로 발생할 수 있다.
커버드콜 ETF 투자 전 꼭 확인할 것 &nbsp; 커버드콜 ETF는 이름만 보고 고르면 위험하다. 특히 상품명에 들어간 숫자와 &ldquo;프리미엄&quot;이라는 단어를 오해하기 쉽다.
금융감독원은 2024년 7월 커버드콜 ETF 관련 소비자 유의사항을 발표했다. 핵심은 커버드콜 ETF의 목표 분배율이 확정 수익이 아니고, &ldquo;프리미엄&quot;이라는 단어가 우수 상품이라는 뜻이 아니라 옵션 프리미엄이라는 점이다.
투자 전에는 아래 항목을 확인해야 한다.
확인 항목 이유 목표 분배율 확정 수익률이 아니라 운용사가 제시한 목표일 뿐이다 프리미엄의 의미 추가 수익 보장이라는 뜻이 아니라 옵션 매도 대가를 뜻한다 상승 수익 제한 기초자산이 크게 오를 때 일반 ETF보다 덜 오를 수 있다 하락 손실 가능성 기초자산 하락분은 ETF 가격에 반영될 수 있다 기초자산과 옵션 대상 ETF가 보유한 자산과 매도하는 옵션의 대상이 다르면 위험이 커질 수 있다 총보수와 기타 비용 장기 보유 시 비용이 총수익률에 영향을 준다 예를 들어 ETF가 보유한 자산은 기술주 10개인데, 콜옵션 매도 대상은 나스닥 100 지수라면 두 자산의 움직임이 완전히 같지 않을 수 있다. 기술주 10개는 하락하고 나스닥 100은 상승하는 상황이 생기면, 보유 자산 손실과 옵션 손실이 동시에 나타날 수 있다.
또 상품명에 &ldquo;10% 프리미엄&quot;처럼 숫자가 들어가도 이것을 연 10% 확정 수익으로 보면 안 된다. 목표 분배율은 말 그대로 목표다. 시장 상황과 운용 결과에 따라 실제 분배금과 기준가격은 달라질 수 있다.
커버드콜 ETF는 누구에게 맞을까? &nbsp; 커버드콜 ETF는 높은 성장성보다 꾸준한 현금흐름을 중시하는 투자자에게 관심을 받을 수 있다. 특히 일정 금액의 분배금을 받으면서 포트폴리오 변동성을 조금 낮추고 싶은 사람에게 선택지가 될 수 있다.
...
투자자 상황 검토 포인트 월분배 현금흐름을 원한다 분배금뿐 아니라 기준가격 변화를 함께 봐야 한다 횡보장 대응 수단을 찾는다 강한 상승장에서는 일반 지수 ETF보다 불리할 수 있다 포트폴리오 일부로 활용한다 전체 자산을 커버드콜 ETF에 몰아넣는 것은 위험하다 옵션 구조를 공부할 의향이 있다 콜옵션 매도, 행사가격, 프리미엄을 이해해야 한다 반대로 장기적으로 시장 상승을 최대한 따라가고 싶은 투자자라면 일반 지수 ETF가 더 단순할 수 있다. 커버드콜 ETF는 상승 수익 일부를 포기하는 구조이므로, 강한 상승장을 기대한다면 전략과 맞지 않을 수 있다.
자주 묻는 질문 &nbsp; 커버드콜 ETF는 원금 보장 상품인가? &nbsp; 아니다. 커버드콜 ETF는 주식이나 채권 등 기초자산 가격이 하락하면 손실이 날 수 있는 투자 상품이다. 옵션 프리미엄이 손실을 일부 줄일 수는 있지만, 하락 폭이 크면 원금 손실이 발생할 수 있다.
커버드콜 ETF의 분배율은 확정 수익률인가? &nbsp; 확정 수익률이 아니다. ETF 이름이나 설명에 표시된 분배율은 운용사가 목표로 제시하는 수치인 경우가 많다. 시장 상황과 운용 결과에 따라 실제 분배금은 달라질 수 있고, ETF 가격도 함께 움직인다.
커버드콜 ETF는 상승장에서 불리한가? &nbsp; 강한 상승장에서는 불리할 수 있다. 콜옵션을 매도한 상태라 기초자산이 행사가격 이상으로 크게 오르면 상승분을 온전히 누리기 어렵다. 대신 횡보장이나 완만한 상승장에서는 옵션 프리미엄이 수익률에 도움이 될 수 있다.
월배당 ETF와 커버드콜 ETF는 같은 뜻인가? &nbsp; 같은 뜻은 아니다. 월배당 ETF는 매월 분배금을 지급하는 ETF를 뜻하고, 커버드콜 ETF는 콜옵션 매도 전략을 쓰는 ETF를 뜻한다. 다만 많은 커버드콜 ETF가 옵션 프리미엄을 활용해 월분배 구조를 만들기 때문에 함께 언급되는 경우가 많다.
커버드콜 ETF를 고를 때 가장 먼저 볼 것은 무엇인가? &nbsp; 분배율보다 구조를 먼저 봐야 한다. 어떤 기초자산을 보유하는지, 어떤 옵션을 매도하는지, 기초자산과 옵션 대상이 같은지, 상승 수익 제한과 하락 손실 가능성이 어느 정도인지 확인하는 것이 중요하다.
마무리 &nbsp; 커버드콜은 기초자산을 보유하면서 콜옵션을 매도해 프리미엄을 받는 전략이다. 이 전략을 ETF 안에 넣은 상품이 커버드콜 ETF다. 구조를 이해하면 왜 분배금이 나오는지, 왜 상승장에서 수익이 제한될 수 있는지, 왜 하락장에서 원금 손실이 날 수 있는지 자연스럽게 보인다.
커버드콜 ETF는 나쁜 상품도 아니고 무조건 좋은 상품도 아니다. 횡보장이나 완만한 상승장에서 현금흐름을 만들기 위한 도구로는 쓸 수 있지만, 높은 분배율만 보고 예금처럼 접근하면 위험하다.
투자 전에는 목표 분배율, 기초자산, 옵션 매도 대상, 총보수, 총수익률을 함께 확인해야 한다. 커버드콜 ETF는 &ldquo;얼마를 주느냐&quot;보다 &ldquo;어떤 대가로 그 분배금을 만드는가&quot;를 이해하는 것이 먼저다.`}).add({id:151,href:"/posts/kospi-kosdaq-nasdaq/",title:"코스피, 코스닥, 나스닥 간단 설명",description:"주식 투자에 관심이 있다면 반드시 구분해서 이해해야 할 지수가 바로 코스피, 코스닥, 나스닥이다. 각각의 개념과 차이점에 설명한다.",content:`코스피 (KOSPI) &nbsp; 정식 명칭: Korea Composite Stock Price Index 운영 기관: 한국거래소 개념 &nbsp; 대한민국 유가증권시장(대형 우량기업 시장) 에 상장된 기업들의 주가를 종합해 만든 대표 지수이다.
...
콜옵션과 풋옵션은 초보자가 직접 투자해도 괜찮나? &nbsp; 옵션은 만기, 변동성, 시간 가치가 얽힌 파생상품이라 초보자가 바로 직접 거래하기에는 어렵다. 먼저 구조와 손익 계산을 이해하고, 옵션 전략이 들어간 금융상품을 볼 때 설명서를 읽는 용도로 접근하는 것이 현실적이다.`}).add({id:153,href:"/posts/land-transaction-permit-system/",title:"토지거래허가제란? 실거주 의무와 계약 전 체크 포인트 ...",description:"토지거래허가제가 무엇인지, 허가 대상과 실거주 의무, 허가 없는 계약의 효력, 계약 전 확인해야 할 서류와 위반 시 제재를 쉽게 정리했다.",content:`부동산 뉴스를 보다 보면 &ldquo;토지거래허가구역&rdquo;, &ldquo;토허제&rdquo;, &ldquo;실거주 2년&rdquo; 같은 말이 자주 나온다. 이름만 보면 땅을 사고팔 때만 해당되는 제도처럼 느껴지지만, 실제로는 아파트 매매에도 영향을 줄 수 있다. 특히 서울 전역이나 경기 일부 지역처럼 아파트가 토지거래허가구역으로 지정된 곳에서는 일반적인 매매계약처럼 생각하고 접근하면 낭패를 볼 수 있다.
...
DB형에서 DC형으로 바꾸는 것이 좋을까? &nbsp; 임금피크제, 임금 정체, 투자 성향, 퇴직까지 남은 기간에 따라 다르다. 한 번 전환하면 되돌리기 어려운 경우도 있으므로 회사 퇴직연금 규약과 금융회사 안내를 확인한 뒤 결정하는 것이 좋다.`}).add({id:155,href:"/posts/etf-types-retirement-pension-investing/",title:"ETF 퇴직연금 투자방법",description:"퇴직연금 ETF의 뜻, DC형과 IRP 투자 가능 여부, ETF 매수 방법, 주문 시간, 상품 종류, 위험자산 70% 한도까지 쉽게 정리했다.",content:`퇴직연금 계좌를 열어보면 예금, 펀드, TDF 같은 상품만 있는 줄 알기 쉽다. 그런데 DC형이나 IRP 계좌에서는 ETF도 투자할 수 있다. 노후자금이라고 해서 무조건 예금만 넣어두는 것이 아니라, 증권거래소에 상장된 ETF를 활용해 국내외 주식, 채권, 리츠, 자산배분 상품에 투자할 수 있는 것이다.
다만 퇴직연금 ETF는 일반 주식계좌에서 ETF를 사고파는 것과 조금 다르다. 투자 가능한 계좌가 정해져 있고, 현금성 자산이 있어야 매수할 수 있으며, 주문 시간과 체결 방식도 금융기관별 기준에 따라 다르게 적용될 수 있다. 또 위험자산은 일정 비율 이상 담을 수 없다는 제한도 있다.
이 글에서는 퇴직연금 ETF가 무엇인지, 누가 투자할 수 있는지, 실제 매수할 때 어떤 절차를 거치는지 초보자 기준으로 정리하였다.
퇴직연금 ETF란 무엇인가? &nbsp; 퇴직연금 ETF란 퇴직연금 계좌에 쌓인 돈으로 ETF에 투자하는 것을 말한다. 여기서 퇴직연금 계좌는 주로 DC형과 IRP를 뜻한다.
ETF는 거래소에 상장되어 주식처럼 사고팔 수 있는 펀드다. 일반 계좌에서는 증권사 앱으로 ETF를 직접 매수하듯이, 퇴직연금 계좌에서도 금융기관 앱이나 홈페이지를 통해 ETF를 선택하고 매수 지시를 낼 수 있다.
퇴직연금 ETF의 핵심은 &ldquo;노후자금으로 ETF를 운용한다&quot;는 점이다. 일반 투자 계좌에서 ETF를 사면 단기 매매도 가능하지만, 퇴직연금 계좌는 기본적으로 장기 운용을 전제로 한다. 그래서 상품을 고를 때도 단기 수익률보다 장기적으로 어떤 자산에 노출될지 먼저 봐야 한다.
퇴직연금 ETF로 투자할 수 있는 상품은 금융기관별로 다르다. 모든 ETF를 무조건 살 수 있는 것은 아니고, 각 금융기관이 퇴직연금 편입 기준을 충족한다고 판단한 ETF만 선택할 수 있다.
퇴직연금 ETF는 누가 투자할 수 있을까? &nbsp; 퇴직연금 ETF는 모든 퇴직연금 가입자가 이용할 수 있는 것은 아니다. 일반적으로 DC형과 IRP 가입자가 투자할 수 있고, DB형 가입자는 직접 ETF를 매수할 수 없다.
구분 ETF 직접 투자 가능 여부 이유 DB형 불가 회사가 퇴직연금 자산을 운용하고 근로자는 정해진 계산식에 따라 퇴직급여를 받음 DC형 가능 회사가 부담금을 넣어주고 근로자가 직접 운용 IRP 가능 개인이 퇴직금이나 추가 납입금을 직접 운용 DB형은 확정급여형이다. 회사가 퇴직연금 자산을 운용하고, 근로자는 퇴직 직전 평균임금과 근속연수 등을 기준으로 퇴직급여를 받는다. 그래서 근로자가 직접 ETF를 고르는 구조가 아니다.
DC형은 확정기여형이다. 회사가 매년 정해진 금액을 근로자 계좌에 넣어주고, 근로자가 그 돈을 직접 운용한다. 따라서 DC형에서는 ETF를 활용해 주식형, 채권형, 자산배분형 상품에 투자할 수 있다.
IRP는 개인형퇴직연금이다. 퇴직금을 옮겨 받거나, 개인이 추가로 납입해 세액공제 혜택을 받으며 운용할 수 있다. IRP에서도 ETF 투자가 가능하지만, 금융기관별 상품 라인업과 매매 방식은 확인해야 한다.
다만 연금 등록 계좌, 미성년자 계좌, 비과세이연계좌 등 일부 계좌에서는 ETF 매매가 제한될 수 있다. 실제 가능 여부는 본인이 이용하는 은행이나 증권사의 퇴직연금 메뉴에서 확인하는 것이 정확하다.
퇴직연금 ETF 매수 방법 &nbsp; 퇴직연금 ETF를 매수하려면 먼저 계좌 안에 매수 가능한 현금성 자산이 있어야 한다. 일반 주식계좌처럼 보유 중인 상품을 바로 팔고 즉시 다른 ETF를 사는 구조와 다를 수 있다.
퇴직연금 계좌에서 ETF를 사는 흐름은 보통 다음과 같다.
단계 확인할 내용 1단계 DC형 또는 IRP 계좌에서 ETF 매매가 가능한지 확인 2단계 매수 가능 금액과 현금성 자산 확인 3단계 투자 가능한 ETF 목록에서 상품 선택 4단계 주문 금액 또는 수량 입력 5단계 주문 시간과 취소 가능 여부 확인 6단계 체결 결과와 결제 예정일 확인 현금성 자산이 있어야 매수할 수 있다 &nbsp; 퇴직연금 ETF는 현금성 자산을 통해 매수한다. 계좌에 이미 매수 가능 금액이 충분하다면 별도의 매도 없이 ETF 매수 지시를 낼 수 있다.
반대로 돈이 모두 예금, 펀드, TDF 같은 기존 상품에 들어가 있다면 ETF를 바로 살 수 없을 수 있다. 이 경우 기존 보유 상품을 매도해 현금성 자산으로 바꿔야 한다.
주의할 점은 기존 상품을 매도했다고 해서 바로 ETF 매수 가능 금액으로 바뀌지 않을 수 있다는 점이다. 상품별로 환매와 입금에 걸리는 시간이 다르고, 일정 기간은 입금예정상품 상태로 표시될 수 있다. 이 금액은 실제 입금되기 전까지 바로 사용할 수 없을 수 있다.
입금예정상품으로 자동 매수 지시를 낼 수 있다 &nbsp; 일부 금융기관에서는 입금예정상품을 활용한 ETF 매수 기능을 제공한다. 아직 계좌에 실제로 들어오지 않은 금액에 대해 미리 ETF 매수 지시를 내고, 돈이 입금되면 자동으로 ETF 매수가 진행되는 방식이다.
예를 들어 퇴직연금 계좌에 정기 부담금이 들어오거나 기존 상품 환매대금이 입금될 예정이라면, 해당 금액을 활용해 ETF 매수 신청을 미리 해둘 수 있다. 적립식 투자처럼 운용하고 싶을 때 편리하다.
다만 입금예정상품 매수도 체결 시점과 가격이 확정되어 있는 것은 아니다. 시장 상황에 따라 체결 시간이 늦어질 수 있고, 실제 체결 가격이 순자산가치(NAV)나 시장가와 차이 날 수 있다.
최소 주문 가능 금액을 확인해야 한다 &nbsp; 퇴직연금 ETF는 최소 1주 이상 체결될 수 있는 금액으로 주문해야 한다. 금융기관에 따라 매수 주문 가능 금액은 자동으로 계산되어 표시된다.
예를 들어 어떤 ETF의 전일 종가가 40,000원이라면, 실제 매수 주문 가능 금액은 그보다 넉넉하게 잡힐 수 있다. 참고 자료에서는 전일 종가의 130% 이상을 주문 가능 금액으로 보는 예시가 제시되어 있다. 즉 전일 종가가 40,000원이라면 52,000원 이상이 필요할 수 있다는 뜻이다.
이 기준은 금융기관과 상품에 따라 달라질 수 있으므로, 주문 화면에 표시되는 매수 가능 금액을 확인해야 한다.
퇴직연금 ETF 매매 시간과 결제 기준 &nbsp; 퇴직연금 ETF는 일반 주식처럼 내가 원하는 순간에 바로 체결되는 구조와 다를 수 있다. 정규시장 시간과 금융기관의 주문 처리 기준에 따라 체결일, 결제일, 취소 가능 시간이 달라진다.
참고 자료 기준으로 영업일 주문 시간은 다음처럼 이해할 수 있다.
거래 시간 주문 처리 취소 가능 여부 00:05~08:00 당일 장중 주문·체결, T+2영업일 결제 당일 08:00까지 가능 08:00~15:15 당일 장중 주문·체결, T+2영업일 결제 취소 불가 15:15~23:55 다음 영업일 장중 주문·체결, T+3영업일 결제 다음 영업일 08:00까지 가능 00:05부터 08:00 사이에 입력한 주문은 당일 장중 체결 대상으로 처리될 수 있지만, 08:00 이후에는 취소가 어려울 수 있다. 15:15 이후 주문은 다음 영업일 주문으로 넘어갈 수 있어 결제 일정도 하루 밀릴 수 있다.
휴일에도 주문 입력은 가능할 수 있다. 다만 실제 체결과 결제는 다음 영업일 기준으로 처리된다.
휴일 거래 시간 주문 처리 취소 가능 여부 00:05~23:55 다음 영업일 장중 주문·체결, T+2영업일 결제 다음 영업일 08:00까지 가능 여기서 중요한 것은 퇴직연금 ETF 매매가 일반 주식 매매처럼 단타에 적합한 구조가 아니라는 점이다. 오늘 매수 체결된 ETF는 보통 매수 체결 완료 다음 영업일부터 매도할 수 있고, 매도한 ETF 자금도 다음 영업일부터 다른 ETF 매수에 활용할 수 있다. ETF 외 다른 상품으로 변경할 때는 결제와 입금 일정이 더 길어질 수 있다.
금융기관별 시스템 점검, 한국거래소 휴장일, 상품 종류에 따라 시간이 달라질 수 있으므로 실제 주문 전에는 본인이 이용하는 금융기관의 안내를 확인해야 한다.
퇴직연금 ETF 상품 종류 &nbsp; 퇴직연금 계좌에서 살 수 있는 ETF는 투자 지역과 투자 테마로 나눠볼 수 있다. 일반 ETF 시장에는 상품이 매우 많지만, 퇴직연금 계좌에서는 금융기관 기준을 충족한 상품만 편입할 수 있다.
지역별 ETF &nbsp; 퇴직연금 ETF는 국내 투자 ETF와 해외 투자 ETF로 나눌 수 있다.
유형 설명 국내 투자 ETF 국내 상장 종목, 국내 대표지수, 국내 산업·그룹 관련 상품 해외 투자 ETF 미국, 중국, 홍콩 등 해외 주식·채권 관련 상품 국내 투자 ETF는 코스피 200, 국내 배당주, 국내 채권, 국내 산업 테마 등을 담을 수 있다. 해외 투자 ETF는 S&amp;P 500, 나스닥 100, 미국채, 글로벌 주식, 해외 섹터 ETF 등이 포함될 수 있다.
해외 ETF 성격의 국내 상장 ETF에 투자할 때는 환율 영향도 함께 봐야 한다. 환헤지 상품인지, 환노출 상품인지에 따라 원화 기준 수익률이 달라질 수 있다.
테마별 ETF &nbsp; 퇴직연금 계좌에서 선택할 수 있는 ETF는 투자 대상에 따라 다음처럼 나눠볼 수 있다.
유형 설명 대표지수형 코스피, S&amp;P 500, 나스닥 100 같은 대표 주가지수 추종 섹터·테마형 반도체, 바이오, 2차전지 등 특정 산업이나 테마에 투자 채권·혼합형 채권에 투자하거나 주식과 채권을 함께 담는 상품 자산배분형 TDF, TRF 등 생애주기나 목표 비중에 맞춰 운용 대체투자형 리츠, 금 등 주식·채권 외 자산에 투자 초보자라면 대표지수형과 채권·혼합형부터 이해하는 것이 좋다. 대표지수형은 구조가 비교적 단순하고, 채권·혼합형은 포트폴리오 변동성을 낮추는 데 활용할 수 있다.
섹터·테마형 ETF는 수익률이 좋아 보일 때 관심이 커지지만, 특정 산업에 집중되어 있어 하락폭도 클 수 있다. 퇴직연금은 노후자금이므로 단기 유행을 쫓기보다 장기적으로 감당 가능한 비중인지 먼저 봐야 한다.
퇴직연금 ETF의 70% 한도와 안전자산 &nbsp; 퇴직연금 ETF에서 가장 중요한 제한 중 하나가 위험자산 70% 한도다. 퇴직연금 감독 규정상 주식형이나 주식혼합형처럼 위험자산으로 분류되는 상품은 전체 적립금의 70%까지만 투자할 수 있다. 나머지 30%는 안전자산으로 운용해야 한다.
예를 들어 IRP 계좌에 1,000만 원이 있다면 위험자산으로 분류되는 주식형 ETF는 최대 700만 원까지만 담을 수 있다. 나머지 300만 원은 예금, 원리금보장형 상품, 일부 채권형 상품 등 안전자산 기준을 충족하는 상품으로 구성해야 한다.
계좌 금액 위험자산 최대 70% 안전자산 최소 30% 500만 원 350만 원 150만 원 1,000만 원 700만 원 300만 원 3,000만 원 2,100만 원 900만 원 이 제한 때문에 퇴직연금 계좌에서는 내가 원한다고 해서 주식형 ETF만 100% 담을 수 없다. 이미 위험자산 비중이 70%를 넘었거나, 추가 매수 후 70%를 초과하게 되면 주식형 ETF 추가 매수가 제한될 수 있다.
다만 모든 ETF가 같은 위험자산으로 분류되는 것은 아니다. 채권형, 원리금보장형, 일부 자산배분형 상품은 안전자산 또는 다른 기준으로 분류될 수 있다. 정확한 분류는 금융기관 상품 화면에서 확인해야 한다.
이 70% 한도는 불편해 보일 수 있지만, 노후자금이 한쪽으로 지나치게 쏠리는 것을 막는 장치이기도 하다. 퇴직연금 ETF를 운용할 때는 주식형 ETF와 안전자산을 함께 고려해 포트폴리오를 짜야 한다.
퇴직연금 ETF 투자 전 체크리스트 &nbsp; 퇴직연금 ETF는 장기 투자에 어울리는 도구지만, 아무 ETF나 사도 된다는 뜻은 아니다. 노후자금은 회복할 시간이 제한될 수 있기 때문에 상품 구조를 더 조심해서 봐야 한다.
먼저 내가 사용하는 계좌가 DC형인지 IRP인지 확인해야 한다. DB형이라면 근로자가 직접 ETF를 고르는 구조가 아니다. DC형이나 IRP라면 금융기관 앱에서 ETF 매매 가능 여부와 편입 가능 상품 목록을 확인한다.
다음으로 현금성 자산과 위험자산 비중을 확인한다. 현금성 자산이 부족하면 ETF 매수가 안 될 수 있고, 위험자산 70% 한도에 걸리면 주식형 ETF 추가 매수가 제한될 수 있다.
ETF를 고를 때는 최근 수익률보다 투자 대상을 먼저 봐야 한다. S&amp;P 500 ETF인지, 나스닥 100 ETF인지, 국내 반도체 ETF인지, 채권형 ETF인지에 따라 위험이 완전히 다르다.
마지막으로 수수료와 환율, 결제 일정을 확인한다. 해외 자산 ETF는 환율 변동이 수익률에 영향을 줄 수 있고, 환헤지 상품은 비용이 발생할 수 있다. 퇴직연금 ETF는 주문 취소 가능 시간과 체결 일정도 일반 주식계좌와 다를 수 있다.
간단히 정리하면 아래 순서로 보면 된다.
체크 항목 확인 질문 계좌 DC형 또는 IRP인가? 상품 내 금융기관에서 매수 가능한 ETF인가? 현금 매수 가능한 현금성 자산이 있는가? 한도 위험자산 70% 제한에 걸리지 않는가? 구조 어떤 지수나 자산을 추종하는가? 비용 총보수, 기타 비용, 매매 비용은 어떤가? 환율 해외 자산이면 환헤지 여부를 확인했는가? 일정 주문 시간, 취소 가능 시간, 결제일을 확인했는가? 정리 &nbsp; 퇴직연금 ETF는 DC형과 IRP 계좌에 쌓인 노후자금으로 ETF에 투자하는 방식이다. 일반 주식계좌처럼 ETF를 활용할 수 있지만, 퇴직연금 계좌 특유의 제한과 절차가 있다. DB형 가입자는 직접 ETF를 매수할 수 없고, DC형과 IRP 가입자가 주로 대상이다.
ETF를 매수하려면 계좌 안에 현금성 자산이 있어야 한다. 기존 상품을 매도해 현금화해야 할 수도 있고, 입금예정상품을 활용해 자동 매수 지시를 낼 수도 있다. 주문 시간과 취소 가능 여부, 체결일과 결제일은 금융기관 기준에 따라 달라질 수 있으므로 주문 전에 확인해야 한다.
퇴직연금 ETF에서 꼭 기억해야 할 것은 위험자산 70% 한도다. 주식형 ETF만 100% 담을 수 없고, 나머지는 안전자산으로 운용해야 한다. 퇴직연금은 단기 수익보다 오래 버틸 수 있는 포트폴리오가 중요하다. ETF를 고를 때도 수익률 순위보다 투자 대상, 위험도, 비용, 환율, 자산배분을 먼저 보는 습관이 필요하다.
자주 묻는 질문 &nbsp; 퇴직연금 ETF는 DB형에서도 살 수 있나? &nbsp; DB형에서는 근로자가 직접 ETF를 매수하는 구조가 아니다. 퇴직연금 ETF 투자는 일반적으로 DC형과 IRP 계좌에서 가능하다.
퇴직연금 ETF를 사려면 현금이 있어야 하나? &nbsp; ETF 매수 가능 금액만큼의 현금성 자산이 필요하다. 기존 상품에 돈이 들어가 있다면 매도 후 현금성 자산으로 전환되어야 ETF 매수가 가능할 수 있다.
퇴직연금 ETF는 당일 사고 당일 팔 수 있나? &nbsp; 퇴직연금 ETF는 일반 주식계좌의 단타 매매와 다르다. 오늘 매수 체결된 ETF는 보통 매수 체결 완료 다음 영업일부터 매도할 수 있다. 금융기관별 기준을 확인해야 한다.
퇴직연금으로 주식형 ETF를 100% 살 수 있나? &nbsp; 일반적으로 위험자산으로 분류되는 주식형·주식혼합형 ETF는 최대 70%까지만 투자할 수 있다. 나머지 30%는 안전자산으로 운용해야 한다.
퇴직연금 ETF는 여러 개를 동시에 살 수 있나? &nbsp; 금융기관에 따라 여러 ETF를 동시에 선택해 매매할 수 있다. 다만 각 상품의 매수 가능 금액, 위험자산 한도, 주문 시간, 체결 방식은 확인해야 한다.
퇴직연금 ETF도 손실이 날 수 있나? &nbsp; 손실이 날 수 있다. ETF는 예금처럼 원금이 보장되는 상품이 아니며, 주식·채권·환율·금리·시장 상황에 따라 가격이 변동한다. 투자 결과는 가입자에게 귀속된다.`}).add({id:156,href:"/posts/retirement-pension-default-option/",title:"퇴직연금 디폴트옵션",description:"퇴직연금 디폴트옵션의 뜻, 적용 대상, 발동 방식, 위험등급별 포트폴리오와 TDF·BF·SVF·SOC 상품 차이를 초보자도 이해하기 쉽게 정리하였다.",content:`퇴직연금 계좌를 열어두고도 한 번도 운용 상품을 바꿔본 적이 없다면 디폴트옵션을 알아둘 필요가 있다. 퇴직연금은 오래 묵혀두는 돈이라 작은 수익률 차이도 시간이 지나면 꽤 크게 벌어진다.
...
Q5. 이자는 언제 들어오나? &nbsp; 보통 한 달에 한 번 특정 요일에 지급되는 경우가 많지만, 최근 인터넷 은행들은 고객이 원할 때 언제든 이자를 받을 수 있는 서비스를 제공하기도 한다. 상품 설명서의 이자 계산 및 지급 시기를 확인해 보는 것이 좋다.`}).add({id:159,href:"/posts/what-is-fund/",title:"펀드란",description:"펀드의 뜻과 운용 구조, 장점과 단점, 종류, 수수료, 환매 방식까지 초보 투자자가 가입 전 꼭 알아야 할 내용을 쉽게 정리했다.",content:`주식 투자를 시작해보려고 하면 가장 먼저 막히는 부분이 종목 선택이다. 어떤 회사를 사야 하는지, 언제 사야 하는지, 떨어질 때는 버텨야 하는지 팔아야 하는지 판단하기가 쉽지 않다. 그래서 직접 투자보다 부담이 덜한 방법을 찾다가 &ldquo;펀드&quot;라는 말을 자주 만나게 된다.
펀드는 여러 투자자의 돈을 모아 전문가가 대신 운용하는 투자 상품이다. 내가 직접 개별 종목을 고르지 않아도 되고, 비교적 적은 금액으로 여러 자산에 나누어 투자할 수 있다는 점 때문에 초보 투자자에게 자주 추천된다.
다만 펀드가 무조건 안전한 상품은 아니다. 예금처럼 원금이 보장되는 상품이 아니고, 수익이 나지 않아도 보수는 계속 발생한다. 펀드는 &ldquo;전문가가 대신 해주는 투자&quot;이지 &ldquo;손실이 없는 투자&quot;가 아니다. 이 글에서는 펀드의 뜻, 운용 구조, 종류, 수수료, 환매할 때 확인할 점까지 한 번에 정리하였다.
펀드란 무엇인가 &nbsp; 펀드는 여러 사람의 돈을 모아 하나의 큰 자금으로 만든 뒤, 자산운용사가 주식, 채권, 부동산, 원자재 같은 자산에 투자하는 상품이다. 투자설명서나 약관에서는 펀드를 &ldquo;집합투자기구&quot;라고 표현하기도 하는데, 일반 투자자가 이해하기 쉽게 말하면 여러 사람의 돈을 모아 운용하는 투자 바구니다.
...
펀드는 어떻게 운용될까 &nbsp; 펀드는 투자자, 판매사, 자산운용사, 수탁사가 역할을 나누어 움직인다. 이 구조를 알면 내 돈이 어디로 가고, 누가 무엇을 하는지 이해하기 쉽다.
펀드를 움직이는 4가지 주체 &nbsp; 투자자: 펀드에 돈을 넣는 사람이다. 여러 투자자의 돈이 모여 펀드 자금이 된다. 판매사: 은행, 증권사, 보험사처럼 펀드를 판매하는 곳이다. 가입 절차와 상품 안내를 맡는다. 자산운용사: 실제 투자 전략을 세우고 어떤 자산을 살지 결정하는 곳이다. 펀드매니저가 운용을 담당한다. 수탁사: 투자자의 돈과 자산을 보관하고 관리하는 기관이다. 보통 은행이 맡으며 운용사가 돈을 마음대로 쓰지 못하도록 관리하는 역할을 한다. 초보자가 특히 알아둘 부분은 자산운용사가 돈을 직접 보관하지 않는다는 점이다. 운용사는 &ldquo;무엇을 사고팔지&quot;를 지시하고, 실제 자산 보관은 수탁사가 한다. 이 구조 덕분에 운용사와 투자자 자산이 분리된다.
내 돈이 움직이는 과정 &nbsp; 펀드 가입 흐름은 대체로 단순하다. 먼저 은행이나 증권사 앱에서 펀드를 고르고 돈을 납입한다. 이 돈은 수탁사에 보관되고, 자산운용사는 시장 상황에 맞춰 주식이나 채권 매수를 지시한다. 이후 펀드가 보유한 자산의 가치가 오르거나 내리면 그 결과가 기준가에 반영된다.
기준가는 펀드의 현재 가치를 보여주는 가격이다. 주식의 주가처럼 매일 변한다고 보면 된다. 내가 환매를 신청하면 환매 기준가를 바탕으로 받을 금액이 계산된다.
펀드의 장점과 단점 &nbsp; 펀드의 가장 큰 장점은 분산 투자와 편의성이다. 직접 주식을 사려면 어떤 종목을 담을지 고민해야 하지만, 펀드는 운용사가 미리 정한 전략에 따라 여러 자산에 나누어 투자한다.
펀드의 장점 &nbsp; 첫째, 소액으로도 분산 투자가 가능하다. 주식형 펀드 하나만 사도 여러 기업에 나누어 투자하는 효과가 생길 수 있다. 채권형 펀드나 혼합형 펀드를 활용하면 주식과 채권 비중도 조절할 수 있다.
...
펀드의 단점 &nbsp; 첫째, 원금 손실 가능성이 있다. 펀드는 예금자보호 대상 예금이 아니다. 시장이 하락하면 원금보다 적은 금액을 돌려받을 수 있다.
...
펀드 종류는 이렇게 나뉜다 &nbsp; 펀드는 기준에 따라 여러 방식으로 나눌 수 있다. 처음에는 용어가 많아 복잡해 보이지만, 크게 &ldquo;무엇에 투자하는가&rdquo;, &ldquo;언제 돈을 뺄 수 있는가&rdquo;, &ldquo;어떻게 운용하는가&rdquo; 정도로 보면 된다.
투자 대상에 따른 구분 &nbsp; 구분 주요 특징 주식형 펀드 주식 비중이 높은 펀드로 기대수익률과 변동성이 모두 큰 편이다 채권형 펀드 채권 비중이 높은 펀드로 주식형보다 변동성이 낮은 편이다 혼합형 펀드 주식과 채권을 함께 담아 위험과 수익의 균형을 맞춘다 부동산 펀드 부동산, 리츠, 부동산 관련 자산에 투자한다 특별자산 펀드 금, 원유, 농산물, 인프라 등 일반 주식·채권 외 자산에 투자한다 파생형 펀드 선물, 옵션 등 파생상품을 활용한다 MMF 단기 채권, 기업어음 등 만기가 짧은 금융상품에 투자한다 초보자라면 처음부터 고위험 테마형 펀드보다 주식형, 채권형, 혼합형처럼 구조가 비교적 이해하기 쉬운 상품부터 보는 편이 낫다.
환매 가능 여부에 따른 구분 &nbsp; 언제든 환매할 수 있는 펀드를 개방형 펀드라고 한다. 반대로 정해진 만기 전에는 환매가 제한되는 펀드를 폐쇄형 펀드라고 한다. 일반 투자자가 은행이나 증권사 앱에서 자주 보는 펀드는 대부분 개방형이다.
하지만 개방형이라고 해서 환매 신청 즉시 돈이 입금되는 것은 아니다. 환매 가능 여부와 현금 입금 시점은 다른 문제다. 상품 설명서에서 &ldquo;환매 대금 지급일&quot;을 따로 확인해야 한다.
운용 방식에 따른 구분 &nbsp; 인덱스 펀드는 코스피200, S&amp;P500 같은 특정 지수를 따라가도록 운용한다. 시장 평균에 가까운 성과를 목표로 하기 때문에 보수가 낮은 편인 경우가 많다.
액티브 펀드는 펀드매니저가 시장 평균보다 높은 수익률을 목표로 종목과 비중을 적극적으로 조정한다. 잘 운용되면 지수보다 높은 성과를 낼 수 있지만, 기대만큼 성과가 나오지 않거나 보수 부담이 커질 수 있다.
초보자라면 &ldquo;인덱스는 시장을 따라가는 방식&rdquo;, &ldquo;액티브는 시장을 이기려는 방식&quot;으로 기억하면 쉽다.
펀드 수수료와 클래스는 꼭 확인해야 한다 &nbsp; 펀드는 수익률만 보면 안 된다. 수수료와 보수를 함께 봐야 실제 수익률을 제대로 판단할 수 있다. 펀드 비용은 크게 수수료와 보수로 나뉜다.
...
A, C, e, P 클래스의 의미 &nbsp; 펀드 이름 끝에 A, C, e, P 같은 알파벳이 붙어 있는 경우가 많다. 이것은 같은 펀드를 비용 구조에 따라 나눈 클래스다.
A 클래스: 가입할 때 선취 판매수수료를 내는 대신, 보유 기간 중 보수가 상대적으로 낮은 편이다. 장기 투자에 유리할 수 있다. C 클래스: 가입할 때 선취 수수료가 없거나 낮은 대신, 매년 나가는 보수가 높은 편이다. 짧게 투자할 때 검토할 수 있지만 장기 보유 시 비용 부담이 커질 수 있다. e 클래스: 온라인 전용 클래스다. 은행 창구보다 모바일 앱이나 홈페이지에서 가입하는 구조라 비용이 낮은 경우가 많다. P 클래스: 연금저축이나 IRP 같은 연금계좌에서 가입하는 연금 전용 클래스다. 세액공제와 노후 준비 목적을 함께 고려할 때 사용된다. 예를 들어 같은 펀드라도 A-e, C-e처럼 온라인 클래스가 따로 있을 수 있다. 창구에서 추천받은 상품이라도 앱에서 온라인 클래스를 검색해보면 더 낮은 보수의 선택지가 보일 때가 있다.
환매할 때 확인할 점 &nbsp; 펀드에서 돈을 빼는 것을 환매라고 한다. 주식을 팔듯이 &ldquo;매도&quot;라고 생각해도 되지만, 실제 처리 방식은 주식과 다르다.
...
환매 신청 후 어떤 기준가가 적용되는가 환매 대금은 며칠 뒤 입금되는가 단기 환매 시 환매수수료가 있는가 특히 전세금, 세금, 카드값처럼 날짜가 정해진 돈은 펀드에 넣어두면 위험하다. 환매가 늦어질 수 있고, 시장이 하락한 시점에 어쩔 수 없이 팔아야 할 수도 있기 때문이다. 펀드는 여유 자금으로 접근하는 것이 기본이다.
펀드 가입 전 체크리스트 &nbsp; 펀드는 이름이 비슷해도 속은 꽤 다르다. 가입 전에는 최소한 아래 항목은 확인하는 것이 좋다.
투자 목적: 단기 여유자금인지, 장기 자산 형성인지 먼저 정한다. 투자 기간: 6개월 안에 쓸 돈인지, 3년 이상 묶어둘 수 있는 돈인지 구분한다. 위험 등급: 1등급에 가까울수록 위험이 높은 상품이다. 내 투자성향과 맞는지 확인한다. 투자 대상: 국내 주식, 해외 주식, 채권, 부동산, 원자재 중 무엇에 투자하는지 본다. 총보수: 같은 유형의 펀드끼리 총보수를 비교한다. 과거 수익률: 참고만 하고, 최근 성과만 보고 결정하지 않는다. 환매 조건: 환매 기준가, 입금일, 환매수수료를 확인한다. 개인적으로 초보 투자자라면 &ldquo;수익률이 높은 펀드&quot;보다 &ldquo;내가 이해할 수 있는 펀드&quot;를 먼저 고르는 편이 낫다고 본다. 이해하지 못한 상품은 손실이 났을 때 버텨야 할지, 줄여야 할지 판단하기 어렵다.
정리 &nbsp; 펀드는 여러 투자자의 돈을 모아 전문가가 대신 운용하는 투자 상품이다. 소액으로 분산 투자할 수 있고, 직접 종목을 고르는 부담을 줄일 수 있다는 장점이 있다. 그래서 투자 경험이 적은 사람이 첫 투자 상품으로 검토하기 좋다.
...
자주 묻는 질문 &nbsp; 펀드와 직접 투자의 가장 큰 차이는 무엇인가? &nbsp; 직접 투자는 내가 종목을 고르고 사고파는 방식이고, 펀드는 자산운용사가 대신 투자 대상을 고르고 운용하는 방식이다. 직접 투자는 자유도가 높지만 공부와 시간이 많이 필요하다. 펀드는 편리하지만 보수 비용이 발생하고, 운용 성과가 좋지 않을 수도 있다.
펀드와 ETF는 어떻게 다른가? &nbsp; ETF도 넓게 보면 펀드의 한 종류다. 차이는 거래 방식이다. 일반 펀드는 하루에 한 번 계산되는 기준가를 바탕으로 가입과 환매가 이루어진다. ETF는 거래소에 상장되어 주식처럼 장중에 실시간으로 사고팔 수 있다.
펀드는 얼마부터 투자할 수 있나? &nbsp; 상품과 판매사에 따라 다르지만, 보통 소액으로도 시작할 수 있다. 적립식 펀드는 매달 일정 금액을 자동으로 투자하는 방식이라 투자 습관을 만들기 좋다. 다만 금액이 작아도 원금 손실 가능성은 같으므로 상품 구조를 확인해야 한다.
적립식 펀드와 거치식 펀드는 무엇이 다른가? &nbsp; 적립식은 매달 정해진 금액을 나누어 투자하는 방식이고, 거치식은 목돈을 한 번에 넣는 방식이다. 적립식은 투자 시점을 분산하는 효과가 있어 초보자에게 부담이 덜하다. 거치식은 시장이 오를 때 수익이 크게 날 수 있지만, 반대로 하락장에 들어가면 손실도 크게 느껴질 수 있다.
펀드 운용사가 망하면 투자금도 사라지나? &nbsp; 일반적으로 펀드 자산은 운용사 자산과 분리되어 수탁사가 보관한다. 운용사는 투자 지시를 하는 역할이고 투자자 자산을 직접 보관하지 않는다. 다만 펀드가 투자한 자산 가격이 하락하면 손실은 투자자가 부담한다. 운용사 문제와 시장 손실은 구분해서 봐야 한다.`}).add({id:160,href:"/posts/inclusive-wage-contract-requirements/",title:"포괄임금제 계약 요건 3가지, 초과근무수당 임금체불 피...",description:"포괄임금제 뜻과 유효 요건, 근로계약서에 반드시 적어야 할 시간외근무 시간과 수당, 초과근무수당 정산 기준을 쉽게 정리했다.",content:`직원을 채용할 때 &ldquo;월급에 야근수당까지 포함되어 있다&quot;는 식으로 근로계약을 맺는 사업장이 있다. 특히 작은 회사나 자영업 현장에서는 매달 연장근로수당을 따로 계산하기 번거롭다는 이유로 포괄임금제나 고정OT 계약을 쓰는 경우가 많다.
...
&ldquo;월급에 모든 수당 포함&quot;이라고 쓰면 충분할까? &nbsp; 충분하지 않다. 기본급, 포함되는 수당 종류, 포함 시간, 수당 금액, 초과 시 별도 지급 기준을 구체적으로 적어야 한다. 그래야 실제 근로시간 기준 법정수당과 비교할 수 있다.`}).add({id:161,href:"/posts/stock-foreign-investing-guide/",title:"해외 주식 투자",description:"해외 주식 투자를 처음 시작하는 사람을 위해 증권사 계좌 개설, 해외 주식 거래 신청, 환전, 거래시간, 가격제한폭, 세금까지 쉽게 정리했다.",content:`해외 주식은 이제 특별한 사람만 하는 투자가 아니다. 국내 증권사 앱에서 미국 주식, 일본 주식, 중국 주식까지 비교적 쉽게 살 수 있고, 엔비디아, 테슬라, 애플, 마이크로소프트처럼 매일 뉴스에 나오는 기업도 많다.
...
해외 주식은 무엇을 사는 투자일까 &nbsp; 해외 주식은 한국이 아닌 다른 나라 주식시장에 상장된 주식을 말한다. 미국 나스닥과 뉴욕증권거래소에 상장된 애플, 엔비디아, 테슬라, 마이크로소프트 같은 기업이 대표적이다. 중국, 홍콩, 일본, 유럽 시장에 상장된 기업도 해외 주식에 포함된다.
...
처음에는 &ldquo;좋은 종목을 고르는 법&quot;보다 &ldquo;해외 주식 거래 구조를 이해하는 것&quot;이 먼저다. 주문이 언제 체결되는지, 원화가 어떻게 달러로 바뀌는지, 주식을 팔아 수익이 나면 어떤 세금이 생기는지부터 알아야 한다.
해외 주식 투자 첫 단계는 계좌 개설이다 &nbsp; 해외 주식을 사려면 해외 주식 거래가 가능한 증권사 계좌가 필요하다. 이미 국내 주식 계좌를 갖고 있다면 새 계좌를 만들지 않고, 기존 계좌에서 해외 주식 거래 신청만 하면 되는 경우가 많다. 증권사마다 메뉴 이름은 조금 다르지만 보통 &ldquo;해외주식 거래 신청&rdquo;, &ldquo;외화증권 거래 약정&rdquo;, &ldquo;해외주식 서비스 신청&rdquo; 같은 이름으로 제공된다.
...
확인 항목 봐야 하는 이유 해외 주식 거래 수수료 매수와 매도 때 비용이 발생한다 환전 우대율 원화를 달러로 바꿀 때 실제 비용에 영향을 준다 거래 가능 국가 미국만 가능한지, 일본·중국·홍콩도 가능한지 다르다 원화 주문 서비스 환전 없이 원화로 주문할 수 있는지 확인할 수 있다 프리마켓·애프터마켓 미국 정규장 외 거래 가능 시간이 다르다 초보자라면 처음부터 여러 증권사를 동시에 쓰기보다 한 곳에서 주문, 환전, 입출금, 세금 자료 조회 흐름을 익히는 것이 좋다. 여러 증권사를 쓰면 수수료 비교에는 유리할 수 있지만, 나중에 해외 주식 양도소득세를 계산할 때 손익을 합산해야 해서 관리가 복잡해진다.
해외 주식을 사려면 환전을 이해해야 한다 &nbsp; 국내 주식은 원화로 바로 사고팔 수 있다. 하지만 미국 주식을 사려면 보통 원화를 달러로 바꾸는 과정이 필요하다. 이 과정이 환전이다.
...
환전할 때는 환전 수수료도 붙는다. 증권사 앱에서 보이는 &ldquo;환전 우대 90%&rdquo; 같은 문구는 이 수수료를 얼마나 깎아주는지를 뜻한다. 우대율이 높을수록 일반적으로 투자자에게 유리하지만, 기준 환율과 실제 적용 환율도 함께 확인해야 한다.
...
환율은 수익률에도 영향을 준다 &nbsp; 해외 주식은 주가만 오르면 끝나는 투자가 아니다. 원화 기준 수익률은 주가와 환율이 함께 만든다.
...
개별 해외 주식을 직접 사는 경우에는 기본적으로 환율에 노출된다고 이해하면 쉽다. 그래서 미국 주식을 살 때는 주가 전망뿐 아니라 &ldquo;달러가 너무 비싼 시점에 한 번에 많이 환전하는 것은 아닌가&quot;도 함께 생각하는 것이 좋다.
국가별 거래 시간과 주문 단위가 다르다 &nbsp; 해외 주식은 거래 시간이 한국과 다르다. 한국 주식시장은 보통 오전 9시부터 오후 3시 30분까지 열리지만, 미국 주식은 한국 시간으로 밤에 열린다. 미국은 서머타임 적용 여부에 따라 한국 시간 기준 거래 시간이 달라진다.
...
구분 초보자가 확인할 점 미국 주식 한국 시간 밤에 거래되며 서머타임을 확인해야 한다 중국 주식 시장별 거래 시간과 매매 단위가 다르다 홍콩 주식 점심 휴장과 종목별 매매 단위를 확인해야 한다 일본 주식 종목별 거래 단위가 다를 수 있다 가격제한폭도 다르다. 한국 주식은 하루 상한가와 하한가가 보통 30%로 제한된다. 하지만 미국 주식은 한국식 상·하한가 제도가 없다. 좋은 뉴스나 나쁜 뉴스가 나오면 하루에도 큰 폭으로 오르내릴 수 있다.
이 차이를 모르고 미국 주식을 국내 주식처럼 생각하면 변동성에 놀라기 쉽다. 특히 실적 발표, 금리 발표, 미국 소비자물가지수(CPI), 연방공개시장위원회(FOMC) 같은 일정 전후에는 주가가 크게 움직일 수 있다.
어떤 정보를 보고 투자 판단을 해야 할까 &nbsp; 해외 주식은 익숙한 기업이 많아서 쉬워 보인다. 아이폰을 쓰니까 애플을 사고, 전기차가 유명하니까 테슬라를 사고, AI 뉴스가 많으니까 엔비디아를 사는 식으로 접근하기 쉽다. 하지만 제품을 아는 것과 투자 대상을 이해하는 것은 다르다.
...
이 기업은 무엇으로 돈을 버는가? 최근 매출과 이익은 늘고 있는가? 주가가 이미 너무 많이 오른 상태는 아닌가? 금리, 환율, 경기 둔화에 얼마나 민감한가? 내가 손실을 봐도 보유할 만큼 이해한 기업인가? 개별 종목이 어렵다면 해외 지수를 추종하는 ETF로 시작하는 방법도 있다. 예를 들어 S&amp;P500이나 나스닥100을 추종하는 ETF는 여러 기업에 분산 투자하는 효과가 있다. 다만 ETF도 환헤지 여부, 운용보수, 추적 지수, 상장 국가, 세금이 다르므로 상품명을 보고 대충 고르면 안 된다.
해외 주식 세금은 배당과 매도차익을 나눠서 본다 &nbsp; 해외 주식으로 돈을 벌었다면 세금도 확인해야 한다. 크게 배당소득세와 양도소득세로 나뉜다.
...
해외 주식 양도소득세 계산 흐름 = 연간 해외 주식 매도 이익과 손실 합산 - 필요경비 - 기본공제 250만 원 x 22%예를 들어 한 해 해외 주식 매도차익이 600만 원이고 필요경비를 단순화해 제외하면, 250만 원을 공제한 350만 원에 대해 22%를 계산한다. 이 경우 예상 세금은 77만 원이다.
...
처음 해외 주식을 살 때의 현실적인 순서 &nbsp; 해외 주식을 처음 시작한다면 큰돈을 먼저 넣기보다 과정을 작게 경험하는 것이 낫다. 처음부터 종목 선정, 환율, 세금, 야간 거래를 모두 완벽히 알기는 어렵다. 대신 한 번의 소액 거래로 전체 흐름을 익히면 다음 판단이 훨씬 쉬워진다.
현실적인 순서는 아래와 같다.
1. 해외 주식 거래가 가능한 증권사 계좌를 만든다. 2. 해외 주식 거래 신청과 투자자 정보 확인을 마친다. 3. 환전 우대율과 거래 수수료를 확인한다. 4. 원화 주문을 쓸지, 직접 환전할지 정한다. 5. 관심 종목이나 ETF를 1주 또는 소액으로 매수한다. 6. 체결, 평가손익, 환율 반영 방식을 확인한다. 7. 매도 후 세금 자료가 어떻게 잡히는지 익힌다.처음부터 &ldquo;어떤 주식이 오를까&quot;에만 집중하면 중요한 비용을 놓치기 쉽다. 환전 비용, 거래 수수료, 실시간 시세 이용료, 세금까지 포함해야 실제 수익률이 보인다.
...
해외 주식은 구조를 알고 천천히 시작하자 &nbsp; 해외 주식은 글로벌 기업에 직접 투자할 수 있다는 점에서 매력적이다. 하지만 국내 주식보다 환율, 거래 시간, 국가별 제도, 세금이라는 변수가 더 많다. 그래서 처음에는 수익률보다 거래 구조를 먼저 익히는 것이 중요하다.
...
자주 묻는 질문 &nbsp; 해외 주식은 국내 주식 계좌로 살 수 있을까? &nbsp; 대부분의 증권사 종합매매계좌에서 해외 주식 거래 신청을 하면 살 수 있다. 다만 증권사마다 거래 가능 국가, 환전 방식, 수수료, 원화 주문 서비스가 다르므로 신청 전에 조건을 확인해야 한다.
미국 주식을 사려면 꼭 달러로 환전해야 할까? &nbsp; 직접 달러로 환전해서 주문하는 방식이 기본이지만, 증권사에 따라 원화 주문 서비스를 이용할 수 있다. 원화 주문을 쓰더라도 실제로는 환전 과정이 반영되므로 적용 환율과 수수료를 확인해야 한다.
해외 주식 수익이 나면 무조건 세금을 내야 할까? &nbsp; 배당을 받으면 국가별 원천징수가 적용될 수 있고, 해외 주식을 팔아 연간 양도차익이 기본공제 250만 원을 넘으면 양도소득세를 신고하고 납부해야 할 수 있다. 여러 증권사를 이용했다면 손익을 합산해야 한다.
환헤지 ETF와 환노출 ETF는 무엇이 다를까? &nbsp; 환헤지 ETF는 환율 변동 영향을 줄이고 기초 자산 수익률에 더 집중하도록 설계된 상품이고, 환노출 ETF는 환율 변동이 수익률에 반영되는 상품이다. 환율 하락이 걱정되면 환헤지가 유리할 수 있지만, 환헤지 비용이 생길 수 있다.`}).add({id:162,href:"/posts/foreign-stock-capital-gains-tax/",title:"해외주식 양도소득세 신고 방법, 250만 원 공제와 세...",description:"해외주식 양도소득세 신고 대상, 국내주식과 다른 과세 방식, 기본공제 250만 원, 세율 22%, 홈택스 신고 방법과 가산세를 쉽게 정리했다.",content:`해외주식을 하다 보면 매수와 매도 타이밍에는 민감해도 세금은 뒤로 미루기 쉽다. 특히 테슬라, 엔비디아, 애플, 마이크로소프트처럼 익숙한 미국 주식으로 수익이 났다면 &ldquo;증권사 계좌에 돈이 들어왔으니 끝난 것 아닌가&quot;라고 생각할 수 있다.
...
누수는 화재보험으로 보장될까? &nbsp; 상품과 특약에 따라 가능하다. 다만 기본 화재보험에 자동 포함되지 않을 수 있고, 노후 배관 교체비처럼 보장되지 않는 항목도 있다. 가입 전 누수 특약이 우리 집 손해와 아랫집 배상까지 포함하는지 확인해야 한다.`}).add({id:164,href:"/posts/etf-hedged-unhedged/",title:"환헤지 환노출 ETF 차이",description:"환헤지와 환노출 ETF의 뜻, 상품명 (H) 표시, 환율이 오르거나 내릴 때 수익률이 어떻게 달라지는지 초보자 기준으로 쉽게 정리했다.",content:`해외 주식 ETF를 고르다 보면 상품명 뒤에 (H)가 붙은 것을 자주 보게 된다. 예를 들어 &ldquo;미국S&amp;P500(H)&ldquo;처럼 표시된 상품이다. 처음 보면 단순한 상품 코드처럼 보이지만, 실제로는 환율 변동을 얼마나 반영할지 알려주는 중요한 표시다.
해외 ETF 수익률은 주가만으로 결정되지 않는다. 미국 주식이 올라도 원·달러 환율이 많이 떨어지면 원화 기준 수익률은 줄어들 수 있고, 반대로 주식은 조금 빠졌는데 환율이 오르면서 손실이 덜해질 수도 있다. 그래서 해외 ETF를 살 때는 &ldquo;이 ETF가 환헤지인지, 환노출인지&quot;를 확인해야 한다.
이 글에서는 환헤지와 환노출 ETF의 차이, 환율 상승·하락에 따른 유불리, 초보 투자자가 어떤 기준으로 선택하면 좋은지 정리하였다.
환헤지와 환노출 뜻 &nbsp; 해외 자산에 투자하는 ETF는 크게 환헤지 ETF와 환노출 ETF로 나눌 수 있다. 둘의 차이는 환율 변동을 최대한 막을 것인지, 그대로 반영할 것인지에 있다.
...
구분 환헤지 ETF 환노출 ETF 표시 상품명에 (H)가 붙는 경우가 많음 (UH) 또는 별도 표시 없음 환율 영향 최대한 줄임 그대로 반영 수익률 기준 기초지수 수익률 중심 기초지수 수익률 + 환율 변동 유리한 환경 원·달러 환율 하락 예상 원·달러 환율 상승 예상 예를 들어 미국 S&amp;P500 지수를 따라가는 ETF가 있다고 하자. 같은 지수를 추종하더라도 환헤지 상품과 환노출 상품의 원화 기준 수익률은 달라질 수 있다. 주가지수는 똑같이 움직였는데 환율 처리 방식이 다르기 때문이다.
환헤지 ETF는 어떤 원리로 움직일까 &nbsp; 환헤지는 쉽게 말해 미래의 환율 영향을 줄이기 위해 미리 방어 장치를 걸어두는 방식이다. 실제 ETF 운용에서는 선물환 같은 파생상품을 활용해 환율 변동을 상쇄하려고 한다.
...
여기서 헷갈리기 쉬운 표현이 &ldquo;환율이 떨어진다&quot;는 말이다. 보통 원·달러 환율이 떨어진다는 것은 달러 가치가 내려가고 원화 가치가 올라간다는 뜻이다.
원·달러 환율 하락 = 달러 약세 = 원화 강세 원·달러 환율 상승 = 달러 강세 = 원화 약세해외 ETF를 원화로 평가하는 투자자 입장에서는 달러 약세가 꼭 반가운 일만은 아니다. 내가 가진 달러 자산을 원화로 바꿔 계산할 때 가치가 줄어들 수 있기 때문이다.
환헤지 ETF 장단점 &nbsp; 환헤지 ETF의 가장 큰 장점은 환율 변수를 줄여준다는 점이다. 미국 주식 ETF를 샀다면 미국 주식시장 흐름에 집중하면 되고, 원·달러 환율이 하루하루 어떻게 움직이는지에 덜 흔들릴 수 있다.
...
환노출 ETF 장단점 &nbsp; 환노출 ETF는 환율 변동을 그대로 안고 가는 상품이다. 단순히 보면 위험이 하나 더 생기는 것처럼 느껴지지만, 장점도 있다.
...
환율이 오를 때와 내릴 때 무엇이 유리할까 &nbsp; 환헤지와 환노출의 유불리는 환율 방향에 따라 달라진다. 단순화하면 다음처럼 이해할 수 있다.
환율 방향 달러 가치 유리할 가능성이 큰 상품 이유 원·달러 환율 상승 달러 강세 환노출 ETF 환차익이 수익률에 더해질 수 있음 원·달러 환율 하락 달러 약세 환헤지 ETF 환차손을 줄이는 효과를 기대할 수 있음 예를 들어 미국 주식이 10% 상승했다고 가정해보자. 같은 기간 원·달러 환율도 올랐다면 환노출 ETF는 주식 수익률에 환율 상승 효과까지 더해질 수 있다. 환헤지 ETF는 주식 상승분 중심으로 움직이고, 환율 상승으로 얻을 수 있는 추가 이익은 제한된다.
반대로 미국 주식이 10% 올랐는데 원·달러 환율이 크게 떨어졌다면 환노출 ETF의 수익률은 줄어든다. 환헤지 ETF는 이 환율 하락 영향을 줄이도록 설계되어 있어 상대적으로 유리할 수 있다.
다만 환율 방향을 정확히 맞히는 것은 매우 어렵다. 환율은 금리 차이, 경기 전망, 외국인 자금 흐름, 지정학적 이슈, 중앙은행 정책 등 여러 요인에 따라 움직인다. 그래서 초보 투자자가 &ldquo;환율을 맞혀서 ETF를 갈아타겠다&quot;는 전략은 생각보다 난도가 높다.
초보 투자자는 어떻게 선택하면 좋을까 &nbsp; 환헤지와 환노출 중 무엇이 무조건 좋다고 말하기는 어렵다. 투자 기간, 환율 전망, 보유 비중, 심리적 부담에 따라 선택이 달라진다.
